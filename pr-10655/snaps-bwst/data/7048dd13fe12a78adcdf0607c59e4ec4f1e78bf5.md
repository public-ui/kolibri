...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 439px, received 500px by 382px. 16330 pixels (ratio 0.08 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    ...
    - generic [ref=e30]:
      ...
      - alert [ref=e40]:
        - generic [ref=e41]: Note
        - generic [ref=e42]: 
        - generic [ref=e43]: This field cannot be edited
    - generic [ref=e45]:
      - generic [ref=e49] [cursor=pointer]: "Comparison: Editable"
      - 'textbox "Comparison: Editable" [ref=e53]': This field is editable
```
