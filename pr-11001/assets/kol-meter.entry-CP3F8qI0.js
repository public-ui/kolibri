import{c as e,r as t,s as n}from"./index-DcDxiC7I-CYkNunzJ.js";import{t as r}from"./base-web-component--IgFgz37-CZuvR3uB.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{f as i,r as a,u as o}from"./variant-quote-g1yu-uOI-RBMWZwQI.js";import"./label-BDgaSpkn-CYrOk3f0.js";import{t as s}from"./label-04api6ef-wiJABEbl.js";import{t as c}from"./i18n-s5q4We3h-BbMfRbW6.js";import{n as l,r as u,t as d}from"./value-number-clamped-jAjWFlQu-BweD-qZU.js";var f=a(`high`,0,o),p=a(`low`,0,o),m=a(`min`,0,o),h=a(`optimum`,0,o),g=[`horizontal`,`vertical`],_=a(`orientation`,`horizontal`,e=>{let t=i(e);if(g.includes(t))return t;throw Error(`Invalid orientation: ${t}`)}),v=a(`value`,0,o,e=>e>=0),y={optional:[m,_,u],required:[s,l,v]};function b(e,t,n,r,i,a){let o=r??t,s=i??n;if(a===void 0)return e>=o&&e<=s?`optimum`:`suboptimal`;let c=e<o,l=e>s,u=!c&&!l;return a<o?c?`optimum`:u?`suboptimal`:`critical`:a>s?l?`optimum`:u?`suboptimal`:`critical`:u?`optimum`:`suboptimal`}var x=e=>{let{high:t,label:r,low:i,max:a,min:o,optimum:s,orientation:l,unit:u,value:d}=e,f=l===`vertical`,p=u===`%`,m=p?Math.round((d-o)/(a-o)*100):d,h=b(d,o,a,i,t,s),g=i!==void 0||t!==void 0,_=``;g&&(_=c(h===`critical`?`kol-meter-state-critical`:h===`optimum`?`kol-meter-state-optimum`:`kol-meter-state-suboptimal`));let v=p?c(`kol-live-value`,{placeholders:{value:String(m),unit:u}}):c(`kol-live-value-bounded`,{placeholders:{value:String(m),max:String(a),unit:u}}),y=g?`${v} – ${_}`:v,x=a.toString().length>o.toString().length?a.toString().length+`ch`:o.toString().length+`ch`;return n(`div`,{class:{"kol-meter":!0,"kol-meter--vertical":f}},n(`div`,{class:`kol-meter__bar`},n(`div`,{class:`kol-meter__bar-label`},r,g&&n(`span`,{class:`kol-meter__bar-state kol-meter__bar-state--${h}`},` – `,_)),n(`div`,{class:`kol-meter__bar-track`},n(`meter`,{"aria-label":r,"aria-valuetext":y,high:t,low:i,max:a,min:o,optimum:s,value:d})),n(`span`,{class:`kol-meter__value-unit`},n(`span`,{class:`kol-meter__value`,style:{"min-width":x}},m),n(`span`,{class:`kol-meter__unit`},u))))},S=`@charset "UTF-8";
