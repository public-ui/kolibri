...
Locator: locator('[data-visual-block="selection"]')
  918 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: table-stateless-with-selection--selection.png

Call log:
  - Expect "soft toHaveScreenshot(table-stateless-with-selection--selection.png)" with timeout 10000ms
    - verifying given screenshot expectation
  - waiting for locator('[data-visual-block="selection"]')
    - locator resolved to <div class="w-full" data-visual-block="selection">…</div>
