...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  259 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: scenarios-focus-elements-component-button.png

Call log:
  - Expect "soft toHaveScreenshot(scenarios-focus-elements-component-button.png)" with timeout 10000ms
