import{C as e,o as t,r as n,s as r,u as i}from"./index-D6cOagpA.js";import{t as a}from"./base-web-component-D909Fl-Y-DjL1hhrh.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import"./_Uint8Array-kJHDjtoP-CTkgs_0o.js";import{n as o,s}from"./normalizers-YTKt4bXw-DBJHEXp-.js";import{t as c}from"./label-Zuw86z1N-LrwFVxZ7.js";import{n as l}from"./variant-quote-Dn7fuaYQ-Bb_jRCJT.js";import{t as u}from"./href-gzZZ8o5E-CNtiu6Gb.js";var d=o(`quote`,``,s),f={optional:[c,l],required:[u,d]},p=i.forBlock(`kol-quote`),m=p(`blockquote`),h=p(`cite`),g=p(`figcaption`),_=p(`quote`),v=n=>{let{href:r,label:i,quote:a,variant:o}=n,s=a===``,c=p({[o]:!0});return t(`figure`,{class:c},o===`block`?t(`blockquote`,{class:m,cite:r},a,t(`span`,{"aria-hidden":s?void 0:`true`,hidden:!s},t(`slot`,{name:`expert`}))):t(`q`,{class:_,cite:r},a,t(`span`,{"aria-hidden":s?void 0:`true`,hidden:!s},t(`slot`,{name:`expert`}))),typeof i==`string`&&i.length>0&&t(`figcaption`,{class:g},t(`cite`,{class:h},t(e,{_href:r,_label:i,_target:`_blank`}))))},y=`@charset "UTF-8";
