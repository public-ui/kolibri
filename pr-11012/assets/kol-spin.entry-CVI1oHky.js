import{c as e,r as t,s as n}from"./index-DcDxiC7I-BcBHUXxd.js";import{t as r}from"./base-web-component--IgFgz37-CZuvR3uB.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{p as i,r as a,s as o}from"./variant-quote-DeZzWGZI-Br1H0IlA.js";import"./label-BDgaSpkn-CXRZiwxy.js";import{t as s}from"./label-C-mcs1F6-Cvb7VVrq.js";import"./i18n-s5q4We3h-B74aFsPA.js";import{t as c}from"./component-24FieOYf-DG8Qwffs.js";var l=a(`show`,!1,o),u=[`dot`,`cycle`,`none`],d=a(`variant`,`dot`,e=>{let t=i(e);if(u.includes(t))return t;throw Error(`Invalid spin variant: ${t}`)},()=>!0),f={optional:[s,l,d]},p=`@charset "UTF-8";
...
}`,m=class extends r{constructor(t){super(),e(this,t)}watchShow(e){this.applyShow(e)}watchLabel(e){s.apply(e,e=>this.setRenderProp(`label`,e))}watchVariant(e){d.apply(e,e=>this.setRenderProp(`variant`,e))}componentWillLoad(){this.initRenderProps(f),this.applyShow(this._show),s.apply(this._label,e=>this.setRenderProp(`label`,e)),d.apply(this._variant,e=>this.setRenderProp(`variant`,e))}applyShow(e){l.apply(e,e=>this.setRenderProp(`show`,e))}render(){return n(t,{key:`0cf6dc9fac16cf04ac4c8088fa0e53265949b07c`},n(c,{key:`f43e7439735310b5341af3d48ffb55a7cfbf17b8`,show:this.getRenderProp(`show`),label:this.getRenderProp(`label`),variant:this.getRenderProp(`variant`)}))}static get watchers(){return{_show:[`watchShow`],_label:[`watchLabel`],_variant:[`watchVariant`]}}};m.style={default:p};export{m as kol_spin};