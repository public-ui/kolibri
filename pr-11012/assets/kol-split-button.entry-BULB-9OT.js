import{_ as e,c as t,o as n,s as r}from"./index-DcDxiC7I-CEwv2uDY.js";import{a as i,t as a}from"./behavior-iJpU4AKD-BJi6HxZW.js";import{i as o,r as s,t as c}from"./index-BWJzRRT_.js";import{i as l,n as u}from"./dev.utils-BRNeztdD-DH8dEXrf.js";import{n as d,t as f}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as p}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import"./variant-quote-DeZzWGZI-XPOvY9Cp.js";import{t as m}from"./disabled-DPo78Oje-Bbfra81q.js";import"./label-BDgaSpkn-BXm1w35p.js";import"./label-C-mcs1F6-B_mP-OZF.js";import{t as h}from"./clsx-COFh-Vc8-DWAop4cA.js";import{n as g,r as _,t as v}from"./element-interaction-DkGO5I_0-CYEJb_Yf.js";import"./block-bem-UDOF3rAN-DhTVVOg_.js";import"./component-Bh3trbTp-BislnGmP.js";import"./component-zqA_GCVc-BIQLLxrs.js";import{t as y}from"./i18n-s5q4We3h-Batnr_Eu.js";import{n as b}from"./component-D2A6cZw8-51BNhbu-.js";import"./variant-class-name-D1gM1t9T-BXRaoBLD.js";import"./component-JTlUjHZD-CL4qEEH-.js";import{t as x}from"./component-DWslkzV8-BVweRCxw.js";import"./align-B29XBdiy-DzkYK9to.js";import{t as S}from"./label-with-expert-slot-DQT5alA4-CAEP1nzg.js";import{a as C,c as w,d as T,f as E,l as D,o as O,p as k,r as A,s as j,t as M,u as N}from"./variant-Bd451cbV-D95miYy5.js";import{t as P}from"./name-ygfuf6Ck-lKuc-D8j.js";import{a as F,n as I,r as L,t as R}from"./api-DquRPbhk-DjGC205O.js";import"./controller-DM5oLtDk-DI0rUYaf.js";import"./aria-details-CaVxOiaf-BVKQbljv.js";import"./associated.controller-DxVdCvBV-NuBFC6TA.js";import{t as z}from"./base-CNBT1A3h-xGt4Whr9.js";import{n as B,r as V,t as H}from"./controller-Dudry2jv-4tGS4gff.js";var U={required:[S],optional:[M,A,R,I,L,F,C,m,O,i,j,S,w,P,V,D,N,T,E,k]},W=t=>{let n=new B,r=new a(f.stateLess),i=v(),o,p=d(U);delete p.tabIndex;let h=e=>{m.apply(e,e=>{p.disabled=e})};h(t.disabled),O.apply(t.hideLabel,e=>{p.hideLabel=e}),N.apply(t.icons,e=>{p.icons=e}),j.apply(!1,e=>{p.inline=e}),E.apply(`top`,e=>{p.tooltipAlign=e}),F.apply(`button`,e=>{p.type=e}),S.apply(t.label,e=>{p.label=e}),V.apply(t.popoverAlign,e=>{p.popoverAlign=e,n.setAlign(e)}),k.apply(e(`buttonVariantDefault`,t.getFlagHost())??`normal`,e=>{p.variant=e}),p.ariaDescriptionId=l(),p.popoverId=u(`popover`);let g=e=>{let n=t.getEventTarget();n&&s(n,e)},_=e=>{t.setOpen(e.newState===`open`)};return p.handleClick=e=>{e.stopPropagation(),r.hideTooltip(),n.setShow(!t.getOpen()),g(c.click)},p.handleMouseDown=()=>g(c.mousedown),p.handleFocus=()=>g(c.focus),p.handleBlur=()=>g(c.blur),p.refButton=e=>{i(e),n.setTriggerElement(e)},p.refPopover=e=>{o=e,n.setPopoverElementRef(e)},p.refTooltip=r.setTooltipElementRef,r.componentWillLoad({label:p.label,align:p.tooltipAlign}),{getFcProps:()=>Object.assign(Object.assign({},p),{popoverOpen:t.getOpen()}),hide:()=>n.setShow(!1),setDisabled:h,syncListeners:()=>{i.el&&r.syncListeners(void 0,i.el,!0),o?.addEventListener(`toggle`,_)},destroy:()=>{r.destroy(),o&&=(o.removeEventListener(`toggle`,_),void 0),n.destroy()}}},G=o.forBlock(`kol-split-button`),K=G(`button`),q=G(`horizontal-line`),J=G(`root`),Y=G(`secondary-button`),X=e=>{let{buttonProps:t,buttonWrapperClass:n,class:i,dropdownProps:a,refDropdown:o}=e;return r(b,{block:`kol-split-button`,class:i},r(`div`,{class:J},r(`div`,{class:h(K,n)},r(x,Object.assign({},t))),r(`div`,{class:q}),r(`div`,{class:Y,ref:o},r(H,Object.assign({},a)))))},Z=`@charset "UTF-8";
