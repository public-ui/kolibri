import{_ as e,c as t,o as n,r,s as i}from"./index-DcDxiC7I-DhLhilaF.js";import"./index-Pdnhklwg.js";import{n as a,t as o}from"./dev.utils-BRNeztdD-DJ_0gVb8.js";import{t as s}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as c}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import"./variant-quote-DeZzWGZI-BvNrWwxa.js";import{t as l}from"./level-CI04b2eF-DISMagHJ.js";import{t as u}from"./disabled-DPo78Oje-BtEZiSiK.js";import"./label-BDgaSpkn-CHY7JIRP.js";import{t as d}from"./label-C-mcs1F6-DnBYt6V8.js";import{t as f}from"./open-7VzvTKQV-BXkY7QiQ.js";import"./Heading-B-bvl0rB-CYljoYuR.js";import{n as p,r as m,t as h}from"./element-interaction-DkGO5I_0-CYEJb_Yf.js";import"./block-bem-UDOF3rAN-eZBIP0G2.js";import"./component-Bh3trbTp-8XXLiWWc.js";import"./component-zqA_GCVc-B3-WfOz8.js";import{a as g,i as _,n as v,r as y,t as b}from"./toggle-handler-BL-9UOFz-C5JfxFtv.js";var x=`@charset "UTF-8";
...
@layer kol-component {
  ...
  .kol-details__heading:not([aria-disabled=true]) {
    cursor: pointer;
  }
  .kol-details__heading {
...
}`,S=class extends s{constructor(e){super(),t(this,e),this.detailsId=a(`details`),this.ctaRef=h(()=>this.getRenderProp(`disabled`)===!0),this.hasLoaded=!1,this.openAnimation=_({getTransitionMs:()=>this.transitionMs,setDetailsOpen:e=>this.detailsOpen=e,setExpanded:e=>this.expanded=e}),this.controlId=o(this.detailsId,`control`),this.detailsOpen=!1,this.expanded=!1,this.headingId=o(this.detailsId,`heading`),this.transitionMs=300,this.handleToggle=g({getHost:()=>this.host,getOn:()=>this.getRenderProp(`on`),isDisabled:()=>this.getRenderProp(`disabled`)===!0,isOpen:()=>this.getRenderProp(`open`)===!0,setOpen:e=>this._open=e}),this._disabled=!1,this._level=0,this._open=!1}componentWillLoad(){this.initRenderProps(y),this.transitionMs=e(`collapsibleTransitionMs`,this.host)??300,this.watchDisabled(this._disabled),this.watchLabel(this._label),this.watchLevel(this._level),this.watchOn(this._on),this.watchOpen(this._open)}componentDidLoad(){this.hasLoaded=!0}disconnectedCallback(){this.openAnimation.dispose()}async focus(e){}async click(){}render(){return i(r,{key:`3a52faeef93178617cd45eab8aa9cbd3343a3f00`},i(b,{key:`0c69d3bfe13d42132062053dd440861e2ea3b27f`,block:`kol-details`,contentClass:`indented-text`,controlId:this.controlId,detailsOpen:this.detailsOpen,disabled:this.getRenderProp(`disabled`),expanded:this.expanded,handleToggle:this.handleToggle,headingId:this.headingId,icons:`kolicon-chevron-right`,label:this.getRenderProp(`label`),level:this.getRenderProp(`level`),on:this.getRenderProp(`on`),open:this.getRenderProp(`open`),refHeadingButton:this.ctaRef,transitionMs:this.transitionMs},i(`slot`,{key:`898e7187652021f37925f3d4409589ef326441ad`})))}watchDisabled(e){u.apply(e,e=>this.setRenderProp(`disabled`,e))}watchLabel(e){d.apply(e,e=>this.setRenderProp(`label`,e))}watchLevel(e){l.apply(e,e=>this.setRenderProp(`level`,e))}watchOn(e){v.apply(e,e=>this.setRenderProp(`on`,e))}watchOpen(e){f.apply(e,e=>{this.setRenderProp(`open`,e),this.openAnimation.syncOpen(e,this.hasLoaded)})}get host(){return n(this)}static get watchers(){return{_disabled:[`watchDisabled`],_label:[`watchLabel`],_level:[`watchLevel`],_on:[`watchOn`],_open:[`watchOpen`]}}};c([m(`ctaRef`)],S.prototype,`focus`,null),c([p(`ctaRef`)],S.prototype,`click`,null),S.style={default:x};export{S as kol_details};