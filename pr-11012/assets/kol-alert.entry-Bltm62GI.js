import{c as e,o as t,r as n,s as r}from"./index-DcDxiC7I-BS4PUKKr.js";import{t as i}from"./behavior-iJpU4AKD-B8Trw4TZ.js";import{r as a,t as o}from"./index-CEKlVKTv.js";import{i as s,n as c}from"./dev.utils-BRNeztdD-eU0ZKCdZ.js";import{t as l}from"./base-web-component--IgFgz37-CZuvR3uB.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import"./variant-quote-DeZzWGZI-D4dIHjtY.js";import{t as u}from"./level-CI04b2eF-BgunJlcA.js";import"./label-BDgaSpkn-CSKq0KL_.js";import{t as d}from"./label-C-mcs1F6-DUAHRtKk.js";import"./Heading-B-bvl0rB-CR1yEPeX.js";import{t as f}from"./element-interaction-DkGO5I_0-CYEJb_Yf.js";import"./block-bem-UDOF3rAN-Bidfn5kp.js";import"./component-Bh3trbTp-Dadz-cTh.js";import"./component-zqA_GCVc-BxGfo5zT.js";import{t as p}from"./i18n-s5q4We3h-B77I6eog.js";import{t as m}from"./has-closer-Do41dobk-Lj2aimV3.js";import{i as h,n as g,r as _,t as v}from"./api-BramIhek-BKn0OXFT.js";import"./component-D2A6cZw8-DSWcf6uh.js";import"./variant-class-name-D1gM1t9T-aqZUM8tP.js";import"./component-JTlUjHZD-CwhmXc1f.js";import"./component-DWslkzV8-DNeXwfzx.js";import{t as y}from"./component-CYSzEMzf-C7mwPzxi.js";import"./align-B29XBdiy-CBq7BN2x.js";var b=`@charset "UTF-8";
/*
...
}`,x=class extends l{constructor(t){super(),e(this,t),this.translateCloseAlert=p(`kol-close-alert`),this.closerRef=f(),this.closerTooltipBehavior=new i(this.stateAccess),this.handleAlertTimeout=()=>{this.watchAlert(!1)},this.handleCloserClick=e=>{var t,n;e.stopPropagation(),this.closerTooltipBehavior.hideTooltip(),(n=(t=this._on)?.onClose)==null||n.call(t,new Event(`Close`)),this.host&&a(this.host,o.close)},this.headingId=c(`alert-heading`),this.closerAriaDescriptionId=s(),this._alert=!1,this._hasCloser=!1,this._level=0,this._type=`default`,this._variant=`msg`}componentWillLoad(){this.initRenderProps(g),this.watchAlert(this._alert),this.watchHasCloser(this._hasCloser),this.watchLabel(this._label),this.watchLevel(this._level),this.watchType(this._type),this.watchVariant(this._variant),this.closerTooltipBehavior.componentWillLoad({label:this.translateCloseAlert,align:`left`})}componentDidRender(){this.closerRef.el&&this.closerTooltipBehavior.syncListeners(void 0,this.closerRef.el,!0)}disconnectedCallback(){this.closerTooltipBehavior.destroy(),this.syncAlertEffects(!1)}render(){return r(n,{key:`9006cf7eb3d370c05924733cef29658fa26c1ddb`},r(y,{key:`173e76ed86f9c130d0d9b9ca83c2cc676e97ed90`,alert:this.getRenderProp(`alert`),handleCloserClick:this.handleCloserClick,closerAriaDescriptionId:this.closerAriaDescriptionId,hasCloser:this.getRenderProp(`hasCloser`),headingId:this.headingId,label:this.getRenderProp(`label`),level:this.getRenderProp(`level`),refCloserButton:this.closerRef,refCloserTooltip:this.closerTooltipBehavior.setTooltipElementRef,type:this.getRenderProp(`type`),variant:this.getRenderProp(`variant`)},r(`slot`,{key:`3474a161e43a00801df4bb4b7ed071ad86aeb8fa`})))}watchAlert(e){v.apply(e,e=>{this.setRenderProp(`alert`,e),this.syncAlertEffects(e)})}watchHasCloser(e){m.apply(e,e=>this.setRenderProp(`hasCloser`,e))}watchLabel(e){d.apply(e,e=>this.setRenderProp(`label`,e))}watchLevel(e){u.apply(e,e=>this.setRenderProp(`level`,e))}watchType(e){_.apply(e,e=>this.setRenderProp(`type`,e))}watchVariant(e){h.apply(e,e=>this.setRenderProp(`variant`,e))}syncAlertEffects(e){if(clearTimeout(this.alertTimeout),e){if(typeof navigator<`u`&&typeof navigator.vibrate==`function`){let e=navigator.userActivation;if((e?.isActive||e?.hasBeenActive)&&matchMedia(`(any-pointer: coarse)`).matches)try{navigator.vibrate([100,75,100,75,100])}catch{}}this.alertTimeout=setTimeout(()=>this.handleAlertTimeout(),1e4)}}get host(){return t(this)}static get watchers(){return{_alert:[`watchAlert`],_hasCloser:[`watchHasCloser`],_label:[`watchLabel`],_level:[`watchLevel`],_type:[`watchType`],_variant:[`watchVariant`]}}};x.style={default:b};export{x as kol_alert};