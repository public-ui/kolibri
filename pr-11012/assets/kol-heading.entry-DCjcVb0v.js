import{c as e,r as t,s as n}from"./index-DcDxiC7I-BS4PUKKr.js";import{t as r}from"./base-web-component--IgFgz37-CZuvR3uB.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{p as i,r as a}from"./variant-quote-DeZzWGZI-D4dIHjtY.js";import{t as o}from"./level-CI04b2eF-BgunJlcA.js";import{t as s}from"./clsx-COFh-Vc8-DWAop4cA.js";import{t as c}from"./label-with-expert-slot-DQT5alA4-iM2bKQfS.js";var l=a(`secondaryHeadline`,``,i),u={optional:[o,l],required:[c]};function d(e){return e>=1&&e<=6?`h${e}`:`strong`}var f=e=>{let{label:t,level:r,secondaryHeadline:i}=e,a=d(r);return i?n(`hgroup`,{class:`kol-heading-group`},n(a,{class:s(`kol-headline`,`kol-headline--${a}`,`kol-headline--group`,`kol-headline--primary`)},t,n(`slot`,{name:`expert`,slot:`expert`})),n(`p`,{class:`kol-headline kol-headline--group kol-headline--secondary`},i)):n(a,{class:s(`kol-headline`,`kol-headline--${a}`,`kol-headline--single`)},t,n(`slot`,{name:`expert`,slot:`expert`}))},p=`@charset "UTF-8";
/*
