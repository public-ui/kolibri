import{_ as e,c as t,o as n,r,s as i}from"./index-DcDxiC7I-BS4PUKKr.js";import"./behavior-iJpU4AKD-B8Trw4TZ.js";import"./index-CEKlVKTv.js";import{i as a}from"./dev.utils-BRNeztdD-eU0ZKCdZ.js";import"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as o}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import"./variant-quote-DeZzWGZI-D4dIHjtY.js";import"./disabled-DPo78Oje-XvrHqKEK.js";import"./label-BDgaSpkn-CSKq0KL_.js";import"./label-C-mcs1F6-DUAHRtKk.js";import{n as s,r as c}from"./element-interaction-DkGO5I_0-CYEJb_Yf.js";import"./block-bem-UDOF3rAN-Bidfn5kp.js";import"./component-Bh3trbTp-Dadz-cTh.js";import"./component-zqA_GCVc-BxGfo5zT.js";import"./i18n-s5q4We3h-B77I6eog.js";import"./component-D2A6cZw8-DSWcf6uh.js";import"./variant-class-name-D1gM1t9T-aqZUM8tP.js";import"./component-JTlUjHZD-CwhmXc1f.js";import"./align-B29XBdiy-CBq7BN2x.js";import"./label-with-expert-slot-DQT5alA4-iM2bKQfS.js";import"./variant-Bd451cbV-C62KkSLO.js";import"./href-D5Num3co-B4TpRywv.js";import"./link-target-CRLfzp48-CwkFHWGO.js";import"./api-BzHujZS4-B3UEm4PP.js";import{t as l}from"./access-and-short-key-ijzCZfHm-Dx5Q-CAn.js";import{t as u}from"./base-KSivK53x-DixsMLaX.js";var d=`@charset "UTF-8";
...
}`,f=class extends u{constructor(n){super(),t(this,n),this.ariaCurrent=``,this.ariaDescriptionId=a(),this.expertSlot=!1,this._disabled=!1,this._hideLabel=!1,this._inline=!1,this._tooltipAlign=`right`,this._variant=e(`buttonVariantDefault`,this.host)??`normal`}componentWillLoad(){this.initLinkRenderProps(),this.watchAccessKey(this._accessKey),this.watchAriaCurrentValue(this._ariaCurrentValue),this.watchAriaControls(this._ariaControls),this.watchAriaDescription(this._ariaDescription),this.watchCustomClass(this._customClass),this.watchDisabled(this._disabled),this.watchDownload(this._download),this.watchHideLabel(this._hideLabel),this.watchHref(this._href),this.watchIcons(this._icons),this.watchInline(this._inline),this.watchLabel(this._label),this.watchOn(this._on),this.watchShortKey(this._shortKey),this.watchTarget(this._target),this.watchTooltipAlign(this._tooltipAlign),this.watchVariant(this._variant),l(this._accessKey,this._shortKey),this.initLinkBehaviors()}componentDidRender(){this.syncTooltipListeners()}disconnectedCallback(){this.destroyLinkBehaviors()}async focus(e){}async click(){}render(){return i(r,{key:`dca00e58d5b00e49eb97af50e31739099c2bbf29`},this.renderLinkFC())}watchAccessKey(e){this.applyAccessKey(e)}watchAriaCurrentValue(e){this.applyAriaCurrentValue(e)}watchAriaControls(e){this.applyAriaControls(e)}watchAriaDescription(e){this.applyAriaDescription(e)}watchCustomClass(e){this.applyCustomClass(e)}watchDisabled(e){this.applyDisabled(e)}watchDownload(e){this.applyDownload(e)}watchHideLabel(e){this.applyHideLabel(e)}watchHref(e){this.applyHref(e)}watchIcons(e){this.applyIcons(e)}watchInline(e){this.applyInline(e)}watchLabel(e){this.applyLabel(e)}watchOn(e){this.applyOn(e)}watchRole(){}watchShortKey(e){this.applyShortKey(e)}watchTarget(e){this.applyTarget(e)}watchTooltipAlign(e){this.applyTooltipAlign(e)}watchVariant(e){this.applyVariant(e)}get host(){return n(this)}static get watchers(){return{_accessKey:[`watchAccessKey`],_ariaCurrentValue:[`watchAriaCurrentValue`],_ariaControls:[`watchAriaControls`],_ariaDescription:[`watchAriaDescription`],_customClass:[`watchCustomClass`],_disabled:[`watchDisabled`],_download:[`watchDownload`],_hideLabel:[`watchHideLabel`],_href:[`watchHref`],_icons:[`watchIcons`],_inline:[`watchInline`],_label:[`watchLabel`],_on:[`watchOn`],_role:[`watchRole`],_shortKey:[`watchShortKey`],_target:[`watchTarget`],_tooltipAlign:[`watchTooltipAlign`],_variant:[`watchVariant`]}}};o([c(`ctaRef`)],f.prototype,`focus`,null),o([s(`ctaRef`)],f.prototype,`click`,null),f.style={default:d};export{f as kol_link_button};