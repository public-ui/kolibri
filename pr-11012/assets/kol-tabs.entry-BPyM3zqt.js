import{C as e,X as t,c as n,nt as r,o as i,r as a,s as o,z as s}from"./index-DcDxiC7I-CbP2SlBS.js";import{r as c,t as l}from"./behavior-iJpU4AKD-kmckcXvK.js";import{i as u,r as d,t as f}from"./index-BhlZcGUp.js";import{i as p,n as m}from"./dev.utils-BRNeztdD-BuPLdmml.js";import{t as h}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as g}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{d as _,i as v,l as y,o as b,p as x,r as S,s as C}from"./variant-quote-DeZzWGZI-BRc1k9vn.js";import"./disabled-DPo78Oje-ZSTFKgvz.js";import"./label-BDgaSpkn-DaCr9Q3a.js";import"./label-C-mcs1F6-D0-C5zBM.js";import{n as w,r as T,t as E}from"./element-interaction-DkGO5I_0-CYEJb_Yf.js";import"./block-bem-UDOF3rAN-BiDSR6g1.js";import"./component-Bh3trbTp-FNJ2GSzq.js";import"./component-zqA_GCVc-GItYu7UQ.js";import{t as D}from"./i18n-s5q4We3h-DCeuCTtD.js";import{n as O}from"./component-D2A6cZw8-DmOXFNIV.js";import"./variant-class-name-D1gM1t9T-DbQrwo13.js";import"./component-JTlUjHZD-DVywfkXk.js";import{t as k}from"./component-DWslkzV8-BZOUnuOU.js";import"./align-B29XBdiy-DY2IZDF5.js";import{t as A}from"./label-with-expert-slot-DQT5alA4-DD0ihDzH.js";import"./variant-Bd451cbV-DeVHsArq.js";import"./name-ygfuf6Ck-CXhzkYEA.js";import"./api-DquRPbhk-CTGmeKTa.js";import{t as j}from"./resolve-props-30YuzYBw-iTKKJhEB.js";import{n as M}from"./keyboard-DNd73LVa-BCj4IeP3.js";var N=S(`hasCreateButton`,!1,C),P=S(`selected`,0,_),F=[`select-automatic`,`select-manual`],I=S(`behavior`,`select-automatic`,e=>x(e),e=>v(e,F)),L=S(`tabs`,[],e=>b(e),e=>e.every(e=>typeof e==`object`&&!!e&&typeof e._label==`string`&&e._label.length>0),{hints:(e,t)=>r(`KolTabs`,t.length)}),R=S(`on`,{},e=>{let t=y(e),n={};return typeof t.onCreate==`function`&&(n.onCreate=t.onCreate),typeof t.onSelect==`function`&&(n.onSelect=t.onSelect),n}),z={required:[A,L],optional:[c,N,P,I,R]},B=()=>{let e=new l(h.stateLess),n=p(),r,i,a,o,s=(e,t)=>{a&&d(a,e,t)},c=n=>{n.stopPropagation(),e.hideTooltip();let a=r?.on.onClick;typeof a==`function`&&(t(n,o),a(n,i)),s(f.click,i)},u=e=>{var t,n;(n=r==null?void 0:(t=r.on).onMouseDown)==null||n.call(t,e),s(f.mousedown)},m=e=>{var t,n;(n=r==null?void 0:(t=r.on).onFocus)==null||n.call(t,e),s(f.focus)},g=e=>{var t,n;(n=r==null?void 0:(t=r.on).onBlur)==null||n.call(t,e),s(f.blur)},_=e=>{a=e},v=e=>{o=e};return{getButton:(t,a)=>(r=j(t,a),i=t._value,e.componentWillLoad({label:r.label,align:r.tooltipAlign}),{buttonProps:Object.assign(Object.assign({},r),{ariaDescriptionId:n,handleBlur:g,handleClick:c,handleFocus:m,handleMouseDown:u,refButton:v,refTooltip:e.setTooltipElementRef}),refBox:_}),getButtonElement:()=>o,syncListeners:()=>{o&&e.syncListeners(void 0,o,!0)},destroy:()=>{e.destroy()}}},V=u.forBlock(`kol-tabs`),H=V(`button-create`),U=V(`button-group`),W=V(`content`),G=V(`tab`),K=e=>{let{align:t,class:n,createButton:r,handleBlur:i,handleKeyDown:a,hasCreateButton:s,label:c,refContent:l,refRoot:u,tabButtons:d}=e;return o(O,{block:`kol-tabs`,modifiers:{[`align-${t}`]:!0},class:n,ref:u},o(`div`,{"aria-label":c,class:U,role:`tablist`,onKeyDown:a,onBlur:i},d.map(({buttonProps:e,refBox:t})=>o(`div`,{class:G,ref:t},o(k,Object.assign({},e)))),s&&o(`div`,{class:H,ref:r.refBox},o(k,Object.assign({},r.buttonProps)))),o(`div`,{class:W,ref:l}))},q=`@charset "UTF-8";
