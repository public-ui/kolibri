import{B as e,a as t,c as n,d as r,o as i,s as a,u as o}from"./index-B17M4jfV.js";import{i as s,n as c}from"./dev.utils-DEzQ6pd0-CuLz7cp9.js";import{n as l,t as u}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as d}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./factory-BzFtzYNQ-BDt8p9uY.js";import{t as f}from"./disabled-CcpRdyuF-c5gRde7P.js";import"./label-BJf95S0B-vGq1tv7E.js";import"./label-P4YO9nHc-B8ZLftSs.js";import"./variant-quote-Cpb7i7xZ-D_rNmaNU.js";import{t as p}from"./clsx-COFh-Vc8-DWAop4cA.js";import{n as m,r as h,t as g}from"./element-interaction-DORv36BQ-BSHBQDXV.js";import"./block-bem-BgSBtveW-1mt7Z8UN.js";import"./component-CDTVZl9D-BG_m_KvL.js";import"./component-Cq8UCJaB-Dopef3By.js";import{t as _}from"./i18n-Dml_FUAi-CNSGMumo.js";import{t as v}from"./component-D8GgztdU-F5pSMwHb.js";import"./component-CmhC279f-CNcQwroh.js";import"./component-DhIi80e5-CWv0U8x6.js";import{t as y}from"./component-BBo-Uz07-PwHVIAy7.js";import"./align-Dm5aJHmk-CPa4dDPF.js";import{i as b,t as x}from"./behavior-9V2YyR6G-CvcpBmU5.js";import{t as S}from"./label-with-expert-slot-BWkGY8Ja-Ch9YJC1O.js";import{n as C}from"./variant-DsCLOeRW-AIirBdmt.js";import{a as w,c as T,d as E,f as D,l as O,o as k,r as A,s as j,t as M,u as N}from"./tooltip-align-Bll38cQa-hQaN5tmI.js";import{t as P}from"./name-C2NaB-SA-CoNMBu0Y.js";import{a as F,n as I,r as L,t as R}from"./api-BPFbJ97d-CtwvbACp.js";import"./controller-FFmWV-jZ-DKUyPTPB.js";import"./aria-details-ChvorFzb-uIdMhSUL.js";import"./associated.controller-BWuEwiKu-r1xmQA1s.js";import{t as z}from"./base-BV3vlz1r-CzQV1Lo1.js";import{n as B,r as V,t as H}from"./controller-UyQxT8J1-VoLhRPlN.js";var U={required:[S],optional:[M,A,R,I,L,F,w,f,k,b,j,S,T,P,V,O,N,E,D,C]},W=t=>{let r=new B,i=new x(u.stateLess),a=g(),d,p=l(U);delete p.tabIndex;let m=e=>{f.apply(e,e=>{p.disabled=e})};m(t.disabled),k.apply(t.hideLabel,e=>{p.hideLabel=e}),N.apply(t.icons,e=>{p.icons=e}),j.apply(!1,e=>{p.inline=e}),D.apply(`top`,e=>{p.tooltipAlign=e}),F.apply(`button`,e=>{p.type=e}),S.apply(t.label,e=>{p.label=e}),V.apply(t.popoverAlign,e=>{p.popoverAlign=e,r.setAlign(e)}),C.apply(e(`buttonVariantDefault`,t.getFlagHost())??`normal`,e=>{p.variant=e}),p.ariaDescriptionId=s(),p.popoverId=c(`popover`);let h=e=>{let n=t.getEventTarget();n&&o(n,e)},_=e=>{t.setOpen(e.newState===`open`)};return p.handleClick=e=>{e.stopPropagation(),i.hideTooltip(),r.setShow(!t.getOpen()),h(n.click)},p.handleMouseDown=()=>h(n.mousedown),p.handleFocus=()=>h(n.focus),p.handleBlur=()=>h(n.blur),p.refButton=e=>{a(e),r.setTriggerElement(e)},p.refPopover=e=>{d=e,r.setPopoverElementRef(e)},p.refTooltip=i.setTooltipElementRef,i.componentWillLoad({label:p.label,align:p.tooltipAlign}),{getFcProps:()=>Object.assign(Object.assign({},p),{popoverOpen:t.getOpen()}),hide:()=>r.setShow(!1),setDisabled:m,syncListeners:()=>{a.el&&i.syncListeners(void 0,a.el,!0),d?.addEventListener(`toggle`,_)},destroy:()=>{i.destroy(),d&&=(d.removeEventListener(`toggle`,_),void 0),r.destroy()}}},G=r.forBlock(`kol-split-button`),K=G(`button`),q=G(`horizontal-line`),J=G(`root`),Y=G(`secondary-button`),X=e=>{let{buttonProps:t,buttonWrapperClass:n,class:r,dropdownProps:a,refDropdown:o}=e;return i(v,{block:`kol-split-button`,class:r},i(`div`,{class:J},i(`div`,{class:p(K,n)},i(y,Object.assign({},t))),i(`div`,{class:q}),i(`div`,{class:Y,ref:o},i(H,Object.assign({},a)))))},Z=`@charset "UTF-8";
