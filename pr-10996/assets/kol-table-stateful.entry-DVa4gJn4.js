import{A as e,Ct as t,Dt as n,E as r,G as i,a,c as o,ft as s,nt as c,o as l,q as u,r as d,s as f,u as p,ut as m,yt as h}from"./index-lVXQQPAt.js";import{r as g}from"./label-BJf95S0B-B0D8_uXF.js";import{t as _}from"./i18n-Dml_FUAi-D3ecqXCp.js";import{t as v}from"./aria-labelledby-6-ki3akM-C6lJ0lQF.js";import{t as y}from"./aria-labelledby-CdnfplEg-D5eG5reQ.js";import{t as b}from"./keyboard-DNd73LVa-BCj4IeP3.js";var x=(e,n,r={})=>{t(e,`_allowMultiSort`,n,Object.assign({defaultValue:!1},r))},S=(e,n)=>{t(e,`_hasSettingsMenu`,n)},C=[`top`,`bottom`,`both`],w=(e,t)=>{n(e,`_paginationPosition`,e=>typeof e==`string`&&C.includes(e),new Set([`PaginationPositionPropType {${C.join(`, `)}`]),t,{defaultValue:`bottom`})},T=(e,t)=>{n(e,`_on`,e=>typeof e==`object`&&!!e,new Set([`TableStatefulCallbacksPropType {Events.onSelectionChange}`]),t)},E=(e,t,n)=>{u(t,()=>{m(t,()=>{t===void 0&&(t=[]);try{t=s(t)}catch{}Array.isArray(t)&&t.every(e=>typeof e==`object`&&!!e)&&h(e,`_data`,t,n)})})},D=(e,t,n)=>{u(t,()=>{m(t,()=>{t===void 0&&(t=[]);try{t=s(t)}catch{}Array.isArray(t)&&t.every(e=>typeof e==`object`&&!!e)&&h(e,`_dataFoot`,t,n)})})},O=(e,t)=>{n(e,`_fixedCols`,e=>Array.isArray(e)&&e.length===2&&typeof e[0]==`number`&&typeof e[1]==`number`&&Number.isInteger(e[0])&&Number.isInteger(e[1])&&e[0]>=0&&e[1]>=0,new Set([`FixedColsPropType [leftFixed: number, rightFixed: number]`]),t)},k=(e,t)=>{(e=>e&&c(e)&&typeof e.label==`function`&&(!e.selectedKeys||Array.isArray(e.selectedKeys)))(typeof t==`string`?(()=>{try{return s(t)}catch{return}})():t)&&h(e,`_selection`,t)},A=`@charset "UTF-8";
/*
