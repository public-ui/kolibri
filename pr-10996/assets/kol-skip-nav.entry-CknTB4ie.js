import{St as e,U as t,_t as n,a as r,c as i,d as a,o,r as s,s as c,u as l}from"./index-B17M4jfV.js";import{i as u}from"./dev.utils-DEzQ6pd0-CuLz7cp9.js";import{n as d,t as f}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as p}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{i as m,l as h}from"./factory-BzFtzYNQ-BDt8p9uY.js";import{t as g}from"./disabled-CcpRdyuF-c5gRde7P.js";import"./label-BJf95S0B-vGq1tv7E.js";import"./label-P4YO9nHc-B8ZLftSs.js";import"./variant-quote-Cpb7i7xZ-D_rNmaNU.js";import{r as _,t as v}from"./element-interaction-DORv36BQ-BSHBQDXV.js";import"./block-bem-BgSBtveW-1mt7Z8UN.js";import"./component-CDTVZl9D-BG_m_KvL.js";import"./component-Cq8UCJaB-Dopef3By.js";import"./i18n-Dml_FUAi-CNSGMumo.js";import"./component-D8GgztdU-F5pSMwHb.js";import"./component-CmhC279f-CNcQwroh.js";import"./component-DhIi80e5-CWv0U8x6.js";import"./align-Dm5aJHmk-CPa4dDPF.js";import{t as y}from"./behavior-9V2YyR6G-CvcpBmU5.js";import{t as b}from"./label-with-expert-slot-BWkGY8Ja-Ch9YJC1O.js";import"./variant-DsCLOeRW-AIirBdmt.js";import{d as x,f as S,l as C,n as w,o as T,r as E,s as D,t as O,u as k}from"./tooltip-align-Bll38cQa-hQaN5tmI.js";import{t as A}from"./href-Bx1WJivH-DdczBwrG.js";import{t as j}from"./link-target-Dfqkcfd1-DNMzp7-C.js";import{a as M,i as N,n as P,o as F,t as I}from"./api-BE-NPeCz-Cr-ofVbA.js";import{t as L}from"./access-and-short-key-ijzCZfHm-Dx5Q-CAn.js";import{n as R,t as z}from"./unique-nav-labels-DWO8JUzQ-CYqE3XIr.js";var B=m(`links`,[],e=>h(e),e=>e.every(e=>typeof e==`object`&&(typeof e._href==`string`||typeof e._label==`string`)),{hints:(t,n)=>e(`KolSkipNav`,n.length)}),V={required:[B,b]},H=a.forBlock(`kol-skip-nav`),U=H(),W=H(`list`),G=H(`list-item`),K=({label:e,linkItems:t})=>o(`nav`,{class:U,"aria-label":e},o(`ul`,{class:W},t.map((e,t)=>o(`li`,{class:G,key:t},o(I,Object.assign({},e.fcProps)))))),q=(e,t)=>{let r=new y(f.stateLess),a=v(),o=d(F);delete o.tabIndex;let s=(e,t)=>e.apply(t,t=>{o[e.propName]=t});s(O,e._accessKey),s(w,e._ariaControls),s(P,e._ariaCurrentValue),s(E,e._ariaDescription),s(g,e._disabled),s(N,e._download),s(T,e._hideLabel),s(A,e._href),s(k,e._icons),s(D,e._inline??!0),s(b,e._label),s(M,e._on),s(C,e._shortKey),typeof e._tabIndex==`number`&&s(x,e._tabIndex),s(j,e._target),s(S,e._tooltipAlign),L(e._accessKey,e._shortKey),r.componentWillLoad({label:(()=>{let e=o.label;if(typeof e==`string`&&e.length>0)return e;let t=o.href;return typeof t==`string`?t:``})(),align:o.tooltipAlign}),o.ariaCurrent=``,o.ariaDescriptionId=u(),o.expertSlot=e._label===``;let c=()=>typeof o.href==`string`?o.href:``;return o.handleAnchorClick=e=>{if(r.hideTooltip(),o.disabled===!0){e.preventDefault();return}let s=c(),u=o.on;typeof u?.onClick==`function`&&(n(e,a.el),u.onClick(e,s));let d=t();d&&l(d,i.click,s)},o.refAnchor=e=>{a(e)},o.refTooltip=r.setTooltipElementRef,{fcProps:o,getAnchor:()=>a.el,syncTooltipListeners:()=>{a.el&&r.syncListeners(void 0,a.el,!0)},destroy:()=>{r.destroy()}}},J=`@charset "UTF-8";
