import{St as e,U as t,_t as n,a as r,c as i,d as a,o,r as s,s as c,u as l}from"./index-lVXQQPAt.js";import{i as u}from"./dev.utils-DEzQ6pd0-BOWRFc71.js";import{n as d,t as f}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as p}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{i as m,l as h}from"./factory-BzFtzYNQ-cX485yYV.js";import{t as g}from"./disabled-CcpRdyuF-yFy4nfeZ.js";import"./label-BJf95S0B-B0D8_uXF.js";import"./label-P4YO9nHc-BT9DyhW2.js";import"./variant-quote-Cpb7i7xZ-Dy5TelWT.js";import{r as _,t as v}from"./element-interaction-DORv36BQ-BSHBQDXV.js";import"./block-bem-BgSBtveW-CREiy0yY.js";import"./component-CDTVZl9D-CMxON9t_.js";import"./component-Cq8UCJaB-4SAyYYL4.js";import"./i18n-Dml_FUAi-D3ecqXCp.js";import"./component-D8GgztdU-BT2fi0rx.js";import"./component-CmhC279f-CcK-g5LO.js";import"./component-DhIi80e5-B17TDzX5.js";import"./align-Dm5aJHmk-C_UM0T5G.js";import{t as y}from"./behavior-9V2YyR6G-cEVvt52Q.js";import{t as b}from"./label-with-expert-slot-BWkGY8Ja-DZhTM37F.js";import"./variant-DsCLOeRW-lelV1ra9.js";import{d as x,f as S,l as C,n as w,o as T,r as E,s as D,t as O,u as k}from"./tooltip-align-Bll38cQa-vvvH4ggD.js";import{t as A}from"./href-Bx1WJivH-c89fOXNg.js";import{t as j}from"./link-target-Dfqkcfd1-rH0X_ZAS.js";import{a as M,i as N,n as P,o as F,t as I}from"./api-BE-NPeCz-D0-F1dz9.js";import{t as L}from"./access-and-short-key-ijzCZfHm-Dx5Q-CAn.js";import{n as R,t as z}from"./unique-nav-labels-DWO8JUzQ-iM6PLjeZ.js";var B=m(`links`,[],e=>h(e),e=>e.every(e=>typeof e==`object`&&(typeof e._href==`string`||typeof e._label==`string`)),{hints:(t,n)=>e(`KolSkipNav`,n.length)}),V={required:[B,b]},H=a.forBlock(`kol-skip-nav`),U=H(),W=H(`list`),G=H(`list-item`),K=({label:e,linkItems:t})=>o(`nav`,{class:U,"aria-label":e},o(`ul`,{class:W},t.map((e,t)=>o(`li`,{class:G,key:t},o(I,Object.assign({},e.fcProps)))))),q=(e,t)=>{let r=new y(f.stateLess),a=v(),o=d(F);delete o.tabIndex;let s=(e,t)=>e.apply(t,t=>{o[e.propName]=t});s(O,e._accessKey),s(w,e._ariaControls),s(P,e._ariaCurrentValue),s(E,e._ariaDescription),s(g,e._disabled),s(N,e._download),s(T,e._hideLabel),s(A,e._href),s(k,e._icons),s(D,e._inline??!0),s(b,e._label),s(M,e._on),s(C,e._shortKey),typeof e._tabIndex==`number`&&s(x,e._tabIndex),s(j,e._target),s(S,e._tooltipAlign),L(e._accessKey,e._shortKey),r.componentWillLoad({label:(()=>{let e=o.label;if(typeof e==`string`&&e.length>0)return e;let t=o.href;return typeof t==`string`?t:``})(),align:o.tooltipAlign}),o.ariaCurrent=``,o.ariaDescriptionId=u(),o.expertSlot=e._label===``;let c=()=>typeof o.href==`string`?o.href:``;return o.handleAnchorClick=e=>{if(r.hideTooltip(),o.disabled===!0){e.preventDefault();return}let s=c(),u=o.on;typeof u?.onClick==`function`&&(n(e,a.el),u.onClick(e,s));let d=t();d&&l(d,i.click,s)},o.refAnchor=e=>{a(e)},o.refTooltip=r.setTooltipElementRef,{fcProps:o,getAnchor:()=>a.el,syncTooltipListeners:()=>{a.el&&r.syncListeners(void 0,a.el,!0)},destroy:()=>{r.destroy()}}},J=`@charset "UTF-8";
