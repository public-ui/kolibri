import{At as e,a as t,jt as n,o as r,s as i}from"./index-DRk6qtI6.js";import{n as a,t as o}from"./dev.utils-W9Q9EkQD-CsCxFZJQ.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import"./_Uint8Array-kJHDjtoP-CTkgs_0o.js";import"./normalizers-B5NKuJgN-DgMe6KLR.js";import"./label-BT-6lb8r-DzgowoYz.js";import"./base-web-component-CArCAUxk-CFT6uR2x.js";import"./base-controller-CXhqh4cR-BNzx0WwK.js";import{n as s,t as c}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{t as l}from"./clsx-COFh-Vc8-alQuJLqj.js";import"./component--kVItxH9-qBzxZvjX.js";import"./component-CBypoTPN-DuDlSsF7.js";import"./component-rq1Vzq3l-DqVStSyE.js";import"./align-floating-elements-CqZdcuwL--wG9JOHG.js";import"./align-DdWzcKWR-CuLnyFYZ.js";import"./controller-CJs4fTO0-XjIHW5Wh.js";import"./Heading-BjXtppmV-DfLVqv4F.js";import"./disabled-DzYBnXfG-BKlVOkdb.js";import"./label-BiOix5de-DYnmgBfI.js";import"./element-focus-BQXzaLL9-oq1SsV6e.js";import{n as u,r as d,t as f}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./i18n-COPUp6ul-B03ONGLX.js";import"./Alert-D1gd3tPi-oKw43uSE.js";import"./icons-BfxrxChI-CfHvdW3J.js";import"./access-and-short-key-C7QS_Tel-_FKjugmX.js";import"./hide-label-jbOZNqJV-BAwA1mfV.js";import"./tooltip-align-BZrIplzz-DwhvB4gc.js";import"./variant-class-name-B1jsQGPM-BLAPHzSR.js";import"./aria-labelledby-6-ki3akM-C6lJ0lQF.js";import"./aria-details-CG4GFq8t-BhEjdV4n.js";import"./associated.controller-CZr-baYX-D3ILyysL.js";import{a as p,c as m,l as h,o as g,s as _,t as v}from"./FormFieldStateWrapper-vBENRjKZ-WXdvsdjC.js";import{n as y,t as b}from"./controller-icon-D9VJxsJs-CujgR_hq.js";import{t as x}from"./placeholder-B4wceSsL-BoaQjSIM.js";import{t as S}from"./required-By197yB9-BkeiDvkH.js";import{t as C}from"./read-only-DIC7Vhiy-P0HzoIj9.js";import{n as w,t as T}from"./max-length-behavior-CwWwTrov-Dw2csPXR.js";import{t as E}from"./spell-check-CKvoSTJE-Ciss0eC9.js";import{t as D}from"./rows-BwZCT-gJ-Dc4H4mco.js";var O=[`vertical`,`none`],k=e=>typeof e==`string`&&O.includes(e),A=(e,t)=>{n(e,`_resize`,k,new Set(O),t,{defaultValue:`vertical`})},j=e=>{let{class:t,msg:n,touched:i,readonly:a,disabled:o,required:c,ariaDescribedBy:u,hideLabel:d,label:f}=e,h=s(e,[`class`,`msg`,`touched`,`readonly`,`disabled`,`required`,`ariaDescribedBy`,`hideLabel`,`label`]),_={"kol-textarea--disabled":!!o,"kol-textarea--required":!!c,"kol-textarea--touched":!!i,"kol-textarea--readonly":!!a,[`kol-textarea--${g(n)}`]:m(n,i)},v=Object.assign(Object.assign({class:l(`kol-textarea`,_,t),required:c,disabled:o,readonly:a},p({ariaDescribedBy:u,hideLabel:d,label:f})),h);return r(`textarea`,Object.assign({},v))};function M(e,t){let n=[..._(e).ariaDescribedBy,...t.ariaDescribedBy??[]],r=Object.assign(Object.assign({id:e._id,hideLabel:e._hideLabel,label:e._label,value:e._value,accessKey:e._accessKey,disabled:e._disabled,name:e._name,rows:e._rows,readonly:e._readOnly,required:e._required,placeholder:e._placeholder,touched:e._touched,msg:e._msg},t),{ariaDescribedBy:n});return`_maxLength`in e&&`_maxLengthBehavior`in e&&e._maxLengthBehavior===`hard`&&(r.maxLength=e._maxLength),`_shortKey`in e&&(r[`aria-keyshortcuts`]=e._shortKey),r}var N=e=>{var{state:t}=e,n=s(e,[`state`]);return r(j,Object.assign({},M(t,n)))},P=class extends y{constructor(e,t,n){super(e,t,n),this.afterSyncCharCounter=()=>{typeof this.component._value==`string`&&(this.component.state._currentLength=this.component._value.length,this.updateCurrentLengthDebounced(this.component._value.length))},this.component=e}validateHasCounter(e){h(this.component,e)}validateMaxLengthBehavior(e){w(this.component,e)}validateMaxLength(e){T(this.component,e,{hooks:{afterPatch:this.afterSyncCharCounter}})}validatePlaceholder(e){x(this.component,e)}validateReadOnly(e){C(this.component,e)}validateResize(e){A(this.component,e)}validateRequired(e){S(this.component,e)}validateRows(e){D(this.component,e)}validateSpellCheck(e){E(this.component,e)}validateValue(t){e(this.component,`_value`,t,{hooks:{afterPatch:this.afterSyncCharCounter}}),this.setFormAssociatedValue(this.component._value)}componentWillLoad(){super.componentWillLoad(),this.validateHasCounter(this.component._hasCounter),this.validateMaxLengthBehavior(this.component._maxLengthBehavior),this.validateMaxLength(this.component._maxLength),this.validatePlaceholder(this.component._placeholder),this.validateReadOnly(this.component._readOnly),this.validateRequired(this.component._required),this.validateResize(this.component._resize),this.validateRows(this.component._rows),this.validateSpellCheck(this.component._spellCheck),this.validateValue(this.component._value)}},F=`@charset "UTF-8";
/*
...
@font-face {
  ...
  src: url("kolicons.eot?t=1782254680899"); /* IE9*/
  src: url("kolicons.eot?t=1782254680899#iefix") format("embedded-opentype"), url("kolicons.woff2?t=1782254680899") format("woff2"), url("kolicons.woff?t=1782254680899") format("woff"), url("kolicons.ttf?t=1782254680899") format("truetype"), url("kolicons.svg?t=1782254680899#kolicons") format("svg"); /* iOS 4.1- */
}
@layer kol-component {
