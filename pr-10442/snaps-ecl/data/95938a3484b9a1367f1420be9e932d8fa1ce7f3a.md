...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 200px by 632px, received 200px by 608px. 10564 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: snapshot-for-textarea-with-counter.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-textarea-with-counter.png)" with timeout 10000ms
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    - generic [ref=e8]:
      - generic [ref=e12] [cursor=pointer]: Textarea with soft max length
      - textbox "Textarea with soft max length" [ref=e16]: Lorem Ipsum
      - generic [ref=e17]: You have 9 characters remaining.
      - generic [ref=e18]: You have 9 characters remaining.
      - generic [ref=e19]: You can enter up to 20 characters
    - generic [ref=e21]:
    ...
    - generic [ref=e32]:
      ...
      - generic [ref=e41]: 11/20 characters
      - generic [ref=e42]: 11 of 20 characters
      - generic [ref=e43]: You can enter up to 20 characters
    - generic [ref=e45]:
      - generic [ref=e49] [cursor=pointer]: Textarea with counter
      - textbox "Textarea with counter" [ref=e53]: Lorem Ipsum
      - generic [ref=e54]: 11 characters
      - generic [ref=e55]: 11 characters
```
