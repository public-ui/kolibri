...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 148px, received 500px by 232px. 4367 pixels (ratio 0.04 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    - generic [ref=e8]:
      ...
      - generic [ref=e22]: You can enter up to 30 characters
    - generic [ref=e24]:
      - generic [ref=e28] [cursor=pointer]: max length ohne counter?
      - generic [ref=e30]:
        - generic [ref=e32]: 
        - textbox "max length ohne counter?" [ref=e34]: "12"
      - generic [ref=e35]: You can enter up to 3 characters
```
