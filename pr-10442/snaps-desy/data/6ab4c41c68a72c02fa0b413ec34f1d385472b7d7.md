...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 120px, received 500px by 202px. 1753 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: snapshot-for-input-text-counter-noColumns.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-input-text-counter-noColumns.png)" with timeout 10000ms
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    - generic [ref=e8]:
      - generic [ref=e12] [cursor=pointer]: Name
      - generic [ref=e14]:
        - generic [ref=e16]: 
        - textbox "Name" [ref=e18]: Anderson-Clark
      - generic [ref=e19]: 14/30 characters
      - generic [ref=e20]: 14 of 30 characters
      - generic [ref=e21]: You can enter up to 30 characters
    - generic [ref=e23]:
      - generic [ref=e27] [cursor=pointer]: max length ohne counter?
      - generic [ref=e29]:
        - generic [ref=e31]: 
        - textbox "max length ohne counter?" [ref=e33]: "12"
      - generic [ref=e34]: You can enter up to 3 characters
```
