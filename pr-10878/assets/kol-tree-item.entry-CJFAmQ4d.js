import{M as e,o as t,s as n}from"./index-BusxfCxP.js";var r=`@charset "UTF-8";
...
}`,i=class{constructor(e){n(this,e)}async focus(e){return this.element?.focus(e)}async expand(){return Promise.resolve(this.element?.expand())}async collapse(){return Promise.resolve(this.element?.collapse())}async isOpen(){return await this.element?.isOpen()??!1}render(){return t(e,{key:`83ba33e39d2010347bb60432534cfdf138f02ece`,_active:this._active,_label:this._label,_open:this._open,_href:this._href,ref:e=>this.element=e},t(`slot`,{key:`6f120be2b910c103f766810dd4f9d3b6b91125a0`}))}};i.style={default:r};export{i as kol_tree_item};