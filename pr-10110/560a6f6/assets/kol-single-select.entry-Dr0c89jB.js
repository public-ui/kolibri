import{Dt as e,Tt as t,a as n,kt as r,o as i,s as a}from"./index-BSGGOvOX.js";import{n as o}from"./dev.utils-BRffKFmN-MZdsZQLU.js";import"./normalizers-BZrXYlGW-DFgf_j5x.js";import"./label-CSEcI_DU-CpOpyYRC.js";import"./base-controller-4nyun1vN-DtXcpAuf.js";import{t as s}from"./base-web-component-BT6jbe_v-Vp21XLG3.js";import{t as c}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{t as l}from"./clsx-COFh-Vc8-alQuJLqj.js";import{t as u}from"./component-BKvFZabC-D-oQIdWM.js";import"./align-tkjswpJx-C9KYZMTv.js";import"./controller-C1oVs8dr-liKwO98A.js";import"./component-Bpa5h0dJ-DceD7fHS.js";import"./label-with-expert-slot-Drx1G6Cn-BfocAi9N.js";import"./name-CRrqyGmF-CoE1K1V0.js";import{t as d}from"./controller-CsTLANdH-D8hpVpjw.js";import{n as f}from"./render-BEG0vlR0-DJAT10Ty.js";import"./Heading-CU0xxgIR-aWfS-FTs.js";import"./disabled-ZHo6H_KF-Cy9bo-cy.js";import"./label-BRWfnFOs-Bk8RnvdF.js";import"./element-focus-Cp994Rrk-BCxGGpIg.js";import"./element-click-CCljCb-a-Bw1_18r4.js";import{r as p,t as m}from"./element-interaction-Cfs3SP0D-C57YAP3J.js";import{t as h}from"./i18n-Apwu2-qw-C16NGsSc.js";import"./Alert-BE0aizNs-D4fSCyyH.js";import"./icons-DG7BiB2o-BS8maPOf.js";import"./access-and-short-key-ijzCZfHm-Dx5Q-CAn.js";import"./aria-labelledby-6-ki3akM-C6lJ0lQF.js";import"./aria-details-DR-Z9997-NU8BhK7p.js";import"./associated.controller-CT6Lmd81-D5FAKFl7.js";import"./hide-label-BhB7rwXD-CZx2aYsh.js";import"./tooltip-align-B74tZ8---C4vmg2Q8.js";import"./isObject-Ciga7TRp-DPhgIU_g.js";import{s as g,t as _}from"./FormFieldStateWrapper-BskvNQO0-DybEG1Ns.js";import{n as v,t as y}from"./controller-icon-DGMLFvyt-r93jYGOp.js";import"./Input-CO4XOu40-CqATI_vB.js";import{t as b}from"./InputStateWrapper-AG1PMZLr-DGsbDWUh.js";import{n as x,t as S}from"./CustomSuggestionsOptionsGroup-DL2UmQ5M-BCqa5uf9.js";import{t as C}from"./placeholder-CfKbi1n1-05XR6A4Y.js";import{t as w}from"./required-C5vGoMQK-Nfs9-jvs.js";import"./orientation-BVJmIODT-C8V9RaZd.js";import{i as T,r as E}from"./controller-DSjMHDvm-DQrN9lUD.js";var D=class extends v{constructor(e,t,n){super(e,t,n),this.keyOptionMap=new Map,this.afterPatchOptions=(e,t,n,r)=>{r===`_value`&&this.setFormAssociatedValue(e)},this.beforePatchOptions=(e,t)=>{let n=t.has(`_options`)?t.get(`_options`):this.component.state._options;Array.isArray(n)&&n.length>0&&(this.keyOptionMap.clear(),E(this.keyOptionMap,n))},this.component=e}validateOptions(e){T(this.component,e,{hooks:{afterPatch:this.afterPatchOptions,beforePatch:this.beforePatchOptions}})}validateRequired(e){w(this.component,e)}validateValue(e){r(this.component,`_value`,e=>e!==void 0,new Set([`StencilUnknown`]),e)}validatePlaceholder(e){C(this.component,e)}validateHasClearButton(e){t(this.component,`_hasClearButton`,e)}validateRows(t){e(this.component,`_rows`,t)}componentWillLoad(){super.componentWillLoad(),this.validateOptions(this.component._options),this.validateRequired(this.component._required),this.validateValue(this.component._value),this.validatePlaceholder(this.component._placeholder),this.validateHasClearButton(this.component._hasClearButton),this.validateRows(this.component._rows)}},O=`@charset "UTF-8";
/*
...
@font-face {
  ...
  src: url("kolicons.eot?t=1782398197988"); /* IE9*/
  src: url("kolicons.eot?t=1782398197988#iefix") format("embedded-opentype"), url("kolicons.woff2?t=1782398197988") format("woff2"), url("kolicons.woff?t=1782398197988") format("woff"), url("kolicons.ttf?t=1782398197988") format("truetype"), url("kolicons.svg?t=1782398197988#kolicons") format("svg"); /* iOS 4.1- */
}
@layer kol-component {
...
@layer kol-component {
  ...
  .kol-single-select__delete .kol-button__button, .kol-single-select__delete .kol-button__anchor {
    /* The user agent styles of <button> do not inherit font and color. */
    color: inherit;
    display: flex;
    min-height: var(--a11y-min-size);
