...
@layer kol-component {
  ...
  .kol-combobox__delete .kol-button__button {
    color: inherit;
    display: flex;
    flex: 1;
    /* The user agent styles of <button> do not inherit font and color. */
