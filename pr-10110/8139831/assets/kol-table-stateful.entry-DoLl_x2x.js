import{D as e,Tt as t,Y as n,a as r,d as i,f as a,ft as o,j as s,kt as c,mt as l,o as u,q as d,r as f,s as p,xt as m}from"./index-BYMCFgVO.js";import{r as h}from"./label-BRWfnFOs-BycHJj1i.js";import{t as g}from"./i18n-Apwu2-qw-iclJaiOA.js";import{t as _}from"./aria-labelledby-6-ki3akM-C6lJ0lQF.js";import{t as v}from"./aria-labelledby-mJ17Cl5c-DJQldXI5.js";import{a as y,i as b,n as x,o as S,s as C,t as w}from"./table-selection-5GZ5QkoT-D3EHTf8q.js";import{t as T}from"./keyboard-DNd73LVa-BCj4IeP3.js";var E=(e,n,r={})=>{t(e,`_allowMultiSort`,n,Object.assign({defaultValue:!1},r))},D=[`top`,`bottom`,`both`],O=(e,t)=>{c(e,`_paginationPosition`,e=>typeof e==`string`&&D.includes(e),new Set([`PaginationPositionPropType {${D.join(`, `)}`]),t,{defaultValue:`bottom`})},k=`@charset "UTF-8";
@layer kol-component {
  :host {
    display: block;
  }
