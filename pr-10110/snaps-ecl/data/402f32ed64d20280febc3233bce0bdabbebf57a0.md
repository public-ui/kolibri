...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 504px, received 800px by 420px. 9882 pixels (ratio 0.03 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    - generic [ref=e8]:
      - strong [ref=e9]:
        - button "Heading Accordion Tab 1 (open)" [expanded] [ref=e11] [cursor=pointer]:
          - generic [ref=e13]:
            - generic [ref=e14]: 
            - generic [ref=e15]: Heading Accordion Tab 1 (open)
      - region "Heading Accordion Tab 1 (open)" [ref=e18]:
        - paragraph [ref=e19]: Contents Accordion Tab 1
    - strong [ref=e22]:
      - button "Heading Accordion Tab 2" [ref=e24] [cursor=pointer]:
        - generic [ref=e26]:
          - generic [ref=e27]: 
          - generic [ref=e28]: Heading Accordion Tab 2
    - strong [ref=e31]:
      - button "Heading Accordion Tab 3 (deactivated)" [disabled] [ref=e33]:
        - generic [ref=e35]:
          - generic [ref=e36]: 
          - generic [ref=e37]: Heading Accordion Tab 3 (deactivated)
    - generic [ref=e39]:
      - strong [ref=e40]:
        - button "Heading Accordion Tab 4 (disabled and open)" [disabled] [expanded] [ref=e42]:
          - generic [ref=e44]:
            - generic [ref=e45]: 
            - generic [ref=e46]: Heading Accordion Tab 4 (disabled and open)
      - region "Heading Accordion Tab 4 (disabled and open)" [ref=e49]:
        - paragraph [ref=e50]: Contents Accordion Tab 4
```
