import{n as e,o as t,r as n,s as r}from"./index-BeHHBS-4.js";import{c as i,i as a,r as o}from"./normalizers-BZrXYlGW-Fy82_0aI.js";import{t as s}from"./label-CSEcI_DU-wyMDh_Qt.js";import{t as c}from"./base-controller-4nyun1vN-B6TZOjpw.js";import{t as l}from"./base-web-component-BT6jbe_v-Vp21XLG3.js";import{t as u}from"./i18n-Apwu2-qw-HHmq0fjy.js";var d=o(`show`,!1,a),f=[`dot`,`cycle`,`none`],p=o(`variant`,`dot`,e=>{let t=i(e);if(f.includes(t))return t;throw Error(`Invalid spin variant: ${t}`)},()=>!0);function m(n){switch(n){case`cycle`:return t(`span`,{class:`kol-spin__loader kol-spin__spinner--${n}__element`});case`none`:return t(`slot`,{name:`expert`});default:return t(e,null,t(`span`,{class:`kol-spin__spinner-element 
