import{Dt as e,Tt as t,_ as n,a as r,kt as i,o as a,s as o}from"./index-wZJurBVY.js";import{n as s}from"./dev.utils-VBoUDs60-CKGx0g3b.js";import"./base-web-component-BT6jbe_v-Vp21XLG3.js";import{t as c}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{t as l}from"./clsx-COFh-Vc8-DWAop4cA.js";import"./Heading-RSuzeiY3-DQueqlHV.js";import"./disabled-tmA090zy-CR5ltIW7.js";import"./label-43VWIjgW-x-6vaYCh.js";import{r as u,t as d}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import"./_Uint8Array-kJHDjtoP-CTkgs_0o.js";import"./normalizers-DwZ6RXph-Cz2b2arT.js";import{t as f}from"./i18n-DppON4Nc-hBSUdL7u.js";import{t as p}from"./component-Cbqr3hDZ-xufXmU1K.js";import"./Alert-BrThwIQc-gyrR6YIM.js";import"./label-B4jhdB3Q-CKMkleq6.js";import"./variant-quote-B7A0-G7t-POD2erUr.js";import"./component-C2H99wHM-CKCuQFuJ.js";import"./icons-CxQkiQI9-BCzv568x.js";import"./access-and-short-key-BVBIy6Bf-DPU_Pjgv.js";import"./hide-label-Dqs_owkY-Cq0TkRZc.js";import"./align-CMg-YzqB-BzuzUIef.js";import"./tooltip-align-BCIioKJU-C2cPoLoS.js";import"./variant-class-name-9vl8S3-X-Z7-I49jN.js";import"./component-CJNiKkbd-CzvqfcVj.js";import"./align-floating-elements-DjivLyM2-DIQNqCvs.js";import"./controller-CpsgJ1zD-C_iT8TkL.js";import"./aria-details-Bm1c0NRK-CL0gBa44.js";import"./associated.controller-B22ATw25-DbgpQQ4d.js";import{s as m,t as h}from"./FormFieldStateWrapper-B42l6zXe-DySUbLWR.js";import{n as g,t as _}from"./controller-icon-2XQ_1N28-Ca5eh5Qo.js";import"./Input-i4ObCLuq-3Zi_rIG-.js";import{t as v}from"./InputStateWrapper-bwkYJ-Z5-Diif0JQJ.js";import{n as y,t as b}from"./CustomSuggestionsOptionsGroup-BOmzHi-1-CEIeIPlp.js";import{t as x}from"./placeholder-S0DMyipR-C-N_rK99.js";import{t as S}from"./required-16oQLXa0-ms5ff-24.js";import"./orientation-HCX-2i6Q-DxQwoZ8W.js";import{i as C,r as w}from"./controller-CL0cL-eC-Dfz_TUp2.js";var T=class extends g{constructor(e,t,n){super(e,t,n),this.keyOptionMap=new Map,this.afterPatchOptions=(e,t,n,r)=>{r===`_value`&&this.setFormAssociatedValue(e)},this.beforePatchOptions=(e,t)=>{let n=t.has(`_options`)?t.get(`_options`):this.component.state._options;Array.isArray(n)&&n.length>0&&(this.keyOptionMap.clear(),w(this.keyOptionMap,n))},this.component=e}validateOptions(e){C(this.component,e,{hooks:{afterPatch:this.afterPatchOptions,beforePatch:this.beforePatchOptions}})}validateRequired(e){S(this.component,e)}validateValue(e){i(this.component,`_value`,e=>e!==void 0,new Set([`StencilUnknown`]),e)}validatePlaceholder(e){x(this.component,e)}validateHasClearButton(e){t(this.component,`_hasClearButton`,e)}validateRows(t){e(this.component,`_rows`,t)}componentWillLoad(){super.componentWillLoad(),this.validateOptions(this.component._options),this.validateRequired(this.component._required),this.validateValue(this.component._value),this.validatePlaceholder(this.component._placeholder),this.validateHasClearButton(this.component._hasClearButton),this.validateRows(this.component._rows)}},E=`@charset "UTF-8";
/*
