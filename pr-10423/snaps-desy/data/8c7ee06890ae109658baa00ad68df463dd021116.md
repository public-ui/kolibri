...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 1176px, received 800px by 1296px. 294750 pixels (ratio 0.29 of all image pixels) are different.
...
```yaml
- main [ref=e4]:
  - heading "badge button" [level=1] [ref=e5]
  - generic [ref=e6]:
    - generic [ref=e8]:
      - generic [ref=e11]: black
      - button "Remove" [ref=e13] [cursor=pointer]:
        - generic [ref=e16]: 
    - generic [ref=e18]:
      - generic [ref=e21]: teal
      - button "Remove" [ref=e23] [cursor=pointer]:
        - generic [ref=e26]: 
    - generic [ref=e28]:
      - generic [ref=e31]: blue
      - button "Remove" [ref=e33] [cursor=pointer]:
        - generic [ref=e36]: 
    - generic [ref=e38]:
      - generic [ref=e40]:
        - generic [ref=e41]: 
        - generic [ref=e42]: red with icon
      - button "Remove" [ref=e44] [cursor=pointer]:
        - generic [ref=e47]: 
    - generic [ref=e49]:
      - generic [ref=e51]:
        - generic [ref=e52]: 
        - generic [ref=e53]: purple with icon
