...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 204px, received 300px by 214px. 2920 pixels (ratio 0.05 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - toolbar "Toolbar" [ref=e7]:
    ...
    - button "Next" [ref=e14] [cursor=pointer]:
      - generic [ref=e17]: 
    - link "Simple Link 1" [ref=e19] [cursor=pointer]:
      - /url: "#/back-page"
      - generic [ref=e22]: Simple Link 1
    - link "Simple Link 3" [disabled] [ref=e24]:
      - /url: "#/back-page"
      - generic [ref=e27]: Simple Link 3
    - button "Bold" [ref=e29] [cursor=pointer]:
      - generic [ref=e32]: Bold
```
