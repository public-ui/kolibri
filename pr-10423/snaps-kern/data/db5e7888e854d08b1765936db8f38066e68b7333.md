...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 78px, received 300px by 84px. 2272 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: snapshot-for-scenarios-focus-elements-component-badge.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-scenarios-focus-elements-component-badge.png)" with timeout 10000ms
