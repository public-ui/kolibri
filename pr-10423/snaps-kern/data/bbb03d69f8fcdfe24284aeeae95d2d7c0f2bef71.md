...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 471px, received 500px by 474px. 7594 pixels (ratio 0.04 of all image pixels) are different.

  Snapshot: snapshot-for-input-text-readonly-noColumns.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-input-text-readonly-noColumns.png)" with timeout 10000ms
...
```yaml
- main [ref=e4]:
  - heading "input-text readonly" [level=1] [ref=e5]
  - generic [ref=e6]:
    - generic [ref=e8]:
      - generic [ref=e12] [cursor=pointer]: Readonly with placeholder
      - textbox "Readonly with placeholder" [ref=e16]:
        - /placeholder: Placeholder text
    - generic [ref=e18]:
      - generic [ref=e22] [cursor=pointer]: Readonly with value
      - textbox "Readonly with value" [ref=e26]: This field is readonly
    - generic [ref=e28]:
      - generic [ref=e32] [cursor=pointer]: Readonly with info message
      - textbox "Readonly with info message" [ref=e36]: Read-only value
      - alert [ref=e37]:
        - generic [ref=e38]:
          - generic [ref=e39]: Note
          - generic [ref=e40]: 
          - generic [ref=e42]: This field cannot be edited
    - generic [ref=e44]:
      - generic [ref=e48] [cursor=pointer]: "Comparison: Editable"
      - 'textbox "Comparison: Editable" [ref=e52]': This field is editable
```
