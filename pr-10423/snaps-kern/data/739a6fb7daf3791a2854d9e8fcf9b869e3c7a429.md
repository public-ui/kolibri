...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 168px, received 300px by 180px. 1129 pixels (ratio 0.03 of all image pixels) are different.

  Snapshot: snapshot-for-scenarios-focus-elements-component-inputRadio.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-scenarios-focus-elements-component-inputRadio.png)" with timeout 10000ms
