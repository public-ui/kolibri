...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 584px, received 800px by 614px. 15813 pixels (ratio 0.04 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    - link "Simple Link" [ref=e9] [cursor=pointer]:
      - /url: "#/back-page"
      - generic [ref=e12]: Simple Link
    - link "Simple Link (disabled)" [disabled] [ref=e15]:
      - /url: "#/back-page"
      - generic [ref=e18]: Simple Link (disabled)
    - link "Icon Link" [ref=e21] [cursor=pointer]:
      - /url: "#/back-page"
      - generic [ref=e24]: 
    - link "Icon Link (disabled)" [disabled] [ref=e27]:
      - /url: "#/back-page"
      - generic [ref=e30]: 
    - paragraph [ref=e31]:
      - text: In this paragraph, a link is inserted that contains no additional attributes.
      - link "Simple Link" [ref=e34] [cursor=pointer]:
        - /url: "#/back-page"
        - generic [ref=e37]: Simple Link
      - text: It is rendered by default as a
      - strong [ref=e38]: inline element
      - text: .
    - paragraph [ref=e39]:
      - text: In this paragraph, a link is inserted that is rendered as an inline-block element.
      - link "Simple Link" [ref=e42] [cursor=pointer]:
        - /url: "#/back-page"
        - generic [ref=e44]:
          - generic [ref=e45]: Simple Link
          - generic [ref=e46]: S
      ...
      - link "Simple Link" [ref=e49] [cursor=pointer]:
        - /url: "#/back-page"
        - generic [ref=e52]: Simple Link
      - text: ", therefore, I span the entire width of the parent element, causing a line break."
    - link "Special Variant Link" [ref=e55] [cursor=pointer]:
      - /url: "#/back-page"
      - generic [ref=e58]: Special Variant Link
```
