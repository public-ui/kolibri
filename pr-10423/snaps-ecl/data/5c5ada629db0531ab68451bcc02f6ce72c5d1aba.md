...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 833px, received 800px by 845px. 1790 pixels (ratio 0.01 of all image pixels) are different.
        ...
        - list [ref=e53]:
          ...
          - listitem [ref=e72]:
            - button "One page further" [ref=e74] [cursor=pointer]:
              - generic [ref=e77]: 
          - listitem [ref=e78]:
            - button "Directly to the last page" [ref=e80] [cursor=pointer]:
              - generic [ref=e83]: 
      - generic [ref=e86]:
        - generic [ref=e90] [cursor=pointer]: Entries per page
        - combobox "Entries per page" [ref=e95] [cursor=pointer]:
          - option "✓ 10" [selected]
          - option "20"
          - option "50"
          - option "100"
