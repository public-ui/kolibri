...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 412px, received 500px by 436px. 10871 pixels (ratio 0.05 of all image pixels) are different.
    ...
    - generic [ref=e28]:
      ...
      - alert [ref=e37]:
        - generic [ref=e38]:
          ...
          - generic [ref=e40]: 
          - generic [ref=e41]: Error message
    - generic [ref=e43]:
      - generic [ref=e47] [cursor=pointer]: "Comparison: Enabled"
      - 'textbox "Comparison: Enabled" [ref=e51]': This field is enabled
```
