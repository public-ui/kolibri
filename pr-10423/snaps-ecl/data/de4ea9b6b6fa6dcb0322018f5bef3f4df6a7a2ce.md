...
- Name: theme-snapshots.spec.js >> snapshot for scenarios/focus-elements?component=inputFileMultiple
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 110px, received 300px by 116px. 1819 pixels (ratio 0.06 of all image pixels) are different.

  Snapshot: snapshot-for-scenarios-focus-elements-component-inputFileMultiple.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-scenarios-focus-elements-component-inputFileMultiple.png)" with timeout 10000ms
...
- main [ref=e4]:
  - generic [ref=e7]:
    - generic [ref=e11] [cursor=pointer]: Files (multiple)
    - generic [ref=e14]:
      - generic [ref=e15]: Choose a file or drop it here...
      - button "Files (multiple)" [ref=e16] [cursor=pointer]
