...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 116px, received 800px by 122px. 1509 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: snapshot-for-tabs-create-button.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-tabs-create-button.png)" with timeout 10000ms
...
- main [ref=e4]:
  ...
  - generic [ref=e7]:
    - tablist "Tabs with create button" [ref=e8]:
      ...
      - button "New …" [ref=e20] [cursor=pointer]:
        - generic [ref=e22]:
          - generic [ref=e23]: 
          - generic [ref=e24]: New …
    - tabpanel "First tab" [ref=e26]:
      - generic [ref=e27]: Contents of First tab
```
