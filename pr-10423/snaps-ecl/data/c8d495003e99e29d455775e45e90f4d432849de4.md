...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 136px, received 800px by 142px. 3215 pixels (ratio 0.03 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e7]:
    - heading "All Button Variants" [level=2] [ref=e9]: All Button Variants
    - generic [ref=e10]:
