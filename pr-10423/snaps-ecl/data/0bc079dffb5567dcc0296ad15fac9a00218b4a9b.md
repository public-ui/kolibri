...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 1552px, received 800px by 1720px. 293033 pixels (ratio 0.22 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    - link "Primary" [ref=e9] [cursor=pointer]:
      - /url: "#/back-page"
      - generic [ref=e12]: Primary
    - link "Secondary" [ref=e15] [cursor=pointer]:
      - /url: "#/back-page"
      - generic [ref=e18]: Secondary
    - link "Normal" [ref=e21] [cursor=pointer]:
      - /url: "#/back-page"
      - generic [ref=e24]: Normal
    - link "Danger" [ref=e27] [cursor=pointer]:
      - /url: "#/back-page"
      - generic [ref=e30]: Danger
    - link "Ghost" [ref=e33] [cursor=pointer]:
      - /url: "#/back-page"
      - generic [ref=e36]: Ghost
    - link "Access Key" [ref=e39] [cursor=pointer]:
      - /url: "#/back-page"
      - generic [ref=e41]:
        - generic [ref=e42]: Access Key
        - generic [ref=e43]: c
    - link "Short Key" [ref=e46] [cursor=pointer]:
      - /url: "#/back-page"
      - generic [ref=e48]:
        - generic [ref=e49]: Short Key
        - generic [ref=e50]: s
```
