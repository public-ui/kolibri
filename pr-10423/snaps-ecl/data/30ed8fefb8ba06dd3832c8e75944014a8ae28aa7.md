...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 412px, received 500px by 436px. 11848 pixels (ratio 0.06 of all image pixels) are different.
    ...
    - generic [ref=e28]:
      ...
      - alert [ref=e37]:
        - generic [ref=e38]:
          ...
          - generic [ref=e40]: 
          - generic [ref=e41]: This field cannot be edited
    - generic [ref=e43]:
      - generic [ref=e47] [cursor=pointer]: "Comparison: Editable"
      - 'textbox "Comparison: Editable" [ref=e51]': This field is editable
```
