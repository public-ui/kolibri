...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 108px, received 300px by 114px. 1080 pixels (ratio 0.04 of all image pixels) are different.

  Snapshot: snapshot-for-scenarios-focus-elements-component-inputText.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-scenarios-focus-elements-component-inputText.png)" with timeout 10000ms
