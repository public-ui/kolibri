...
- Name: theme-snapshots.spec.js >> snapshot for scenarios/focus-elements?component=button
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 76px, received 300px by 82px. 706 pixels (ratio 0.03 of all image pixels) are different.

  Snapshot: snapshot-for-scenarios-focus-elements-component-button.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-scenarios-focus-elements-component-button.png)" with timeout 10000ms
...
```yaml
- main [ref=e4]:
  - button "Button here" [ref=e8] [cursor=pointer]:
    - generic [ref=e11]: Button here
```
