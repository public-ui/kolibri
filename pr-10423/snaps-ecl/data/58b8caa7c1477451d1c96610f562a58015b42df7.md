...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 301px, received 800px by 313px. 8941 pixels (ratio 0.04 of all image pixels) are different.
...
- main [ref=e4]:
  - generic [ref=e5]:
    ...
    - group "Combined input field" [ref=e24]:
      ...
      - generic [ref=e35]:
        - generic [ref=e39] [cursor=pointer]: First input
        - textbox "First input" [ref=e43]
      - generic [ref=e45]:
        - generic [ref=e49] [cursor=pointer]: Second input with error
        - textbox "Second input with error" [ref=e53]
```
