...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  3303 pixels (ratio 0.02 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    - table "Table with selection radio" [ref=e11]:
      - caption [ref=e12]: Table with selection radio
      - rowgroup [ref=e13]:
    ...
    - button "getSelection()" [ref=e51] [cursor=pointer]:
      - generic [ref=e54]: getSelection()
```
