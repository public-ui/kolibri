...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 379px, received 500px by 403px. 13936 pixels (ratio 0.07 of all image pixels) are different.

  Snapshot: snapshot-for-input-text-disabled-noColumns.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-input-text-disabled-noColumns.png)" with timeout 10000ms
...
```yaml
- main [ref=e4]:
  - heading "input-text disabled" [level=1] [ref=e5]
  - generic [ref=e6]:
    - generic [ref=e8]:
      - generic [ref=e12]: Disabled with placeholder
      - textbox "Disabled with placeholder" [disabled] [ref=e16]:
        - /placeholder: Placeholder text
    - generic [ref=e18]:
      - generic [ref=e22]: Disabled with value
      - textbox "Disabled with value" [disabled] [ref=e26]: This field is disabled
    - generic [ref=e28]:
      - generic [ref=e32]: Disabled with error message
      - textbox "Disabled with error message" [disabled] [ref=e36]: Invalid value
      - alert [ref=e37]:
        - generic [ref=e38]:
          - generic [ref=e39]: Error
          - generic [ref=e40]: 
          - generic [ref=e42]: Error message
    - generic [ref=e44]:
      - generic [ref=e48] [cursor=pointer]: "Comparison: Enabled"
      - 'textbox "Comparison: Enabled" [ref=e52]': This field is enabled
```
