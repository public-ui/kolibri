...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 84px, received 300px by 90px. 1502 pixels (ratio 0.06 of all image pixels) are different.

  Snapshot: snapshot-for-scenarios-focus-elements-component-tabs.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-scenarios-focus-elements-component-tabs.png)" with timeout 10000ms
