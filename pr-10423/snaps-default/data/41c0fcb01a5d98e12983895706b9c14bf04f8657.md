...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 379px, received 500px by 403px. 16081 pixels (ratio 0.08 of all image pixels) are different.
  ...
  - generic [ref=e6]:
    ...
    - generic [ref=e19]:
      - generic [ref=e20] [cursor=pointer]:
        - generic [ref=e23]: Readonly with value
        - generic [ref=e24]: (read-only)
      - textbox "Readonly with value" [ref=e28]: This field is readonly
    - generic [ref=e30]:
      - generic [ref=e31] [cursor=pointer]:
        - generic [ref=e34]: Readonly with info message
        - generic [ref=e35]: (read-only)
      - textbox "Readonly with info message" [ref=e39]: Read-only value
      - alert [ref=e40]:
        - generic [ref=e41]:
          - generic [ref=e42]: Note
          - generic [ref=e43]: 
          - generic [ref=e45]: This field cannot be edited
    - generic [ref=e47]:
      - generic [ref=e51] [cursor=pointer]: "Comparison: Editable"
      - 'textbox "Comparison: Editable" [ref=e55]': This field is editable
```
