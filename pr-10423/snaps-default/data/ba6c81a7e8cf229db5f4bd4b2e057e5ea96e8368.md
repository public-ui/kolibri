...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Snapshot: snapshot-for-scenarios-focus-elements-component-inputPassword.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-scenarios-focus-elements-component-inputPassword.png)" with timeout 10000ms
