...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 356px, received 500px by 380px. 16821 pixels (ratio 0.09 of all image pixels) are different.
  ...
  - generic [ref=e6]:
    ...
    - generic [ref=e19]:
      - generic [ref=e22] [cursor=pointer]:
        - generic [ref=e23]: With short key (Alt+N)
        - generic [ref=e24]: "n"
      - textbox "With short key (Alt+N)" [ref=e28]: Press Alt+N to focus
    - generic [ref=e30]:
      - generic [ref=e33] [cursor=pointer]:
        - generic [ref=e34]: Access key (Alt+E)
        - generic [ref=e35]: e
      - textbox "Access key (Alt+E)" [ref=e39]:
        - /placeholder: Email address
    - generic [ref=e41]:
      - generic [ref=e44] [cursor=pointer]:
        - generic [ref=e45]: Short key (Alt+P)
        - generic [ref=e46]: p
      - textbox "Short key (Alt+P)" [ref=e50]:
