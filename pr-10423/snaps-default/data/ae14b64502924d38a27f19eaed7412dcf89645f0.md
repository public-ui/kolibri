...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 101px, received 300px by 107px. 2532 pixels (ratio 0.08 of all image pixels) are different.

  Snapshot: snapshot-for-scenarios-focus-elements-component-inputNumber.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-scenarios-focus-elements-component-inputNumber.png)" with timeout 10000ms
