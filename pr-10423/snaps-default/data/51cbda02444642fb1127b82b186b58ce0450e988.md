...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 200px by 179px, received 200px by 191px. 1121 pixels (ratio 0.03 of all image pixels) are different.

  Snapshot: snapshot-for-tabs-icons-only.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-tabs-icons-only.png)" with timeout 10000ms
...
- main [ref=e4]:
  ...
  - generic [ref=e7]:
    - tablist "Tabs with icons" [ref=e8]:
