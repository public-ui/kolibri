...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 250px by 290px, received 250px by 302px. 9242 pixels (ratio 0.13 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    ...
    - strong [ref=e18]: "Unset background:"
    - generic [ref=e20]:
      - generic [ref=e24] [cursor=pointer]: First name
      - textbox "First name" [ref=e28]: John Doe
```
