...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 297px, received 800px by 315px. 20690 pixels (ratio 0.09 of all image pixels) are different.
...
- main [ref=e4]:
  - generic [ref=e5]:
    ...
    - group "Street Address" [ref=e28]:
      ...
      - textbox "Street name" [ref=e43]
      - textbox "House number" [ref=e49]:
        - /placeholder: Number
```
