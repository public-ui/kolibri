...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 77px, received 300px by 83px. 3155 pixels (ratio 0.13 of all image pixels) are different.

  Snapshot: snapshot-for-scenarios-focus-elements-component-accordion.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-scenarios-focus-elements-component-accordion.png)" with timeout 10000ms
