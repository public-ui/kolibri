...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Snapshot: snapshot-for-scenarios-focus-elements-component-inputEmail.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-scenarios-focus-elements-component-inputEmail.png)" with timeout 10000ms
