...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 190px, received 800px by 202px. 5255 pixels (ratio 0.04 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e7]:
    - tablist "Regular tabs" [ref=e8]:
      - tab "First tab" [selected] [ref=e10] [cursor=pointer]:
        - generic [ref=e13]: First tab
      - tab "Second Tab" [ref=e15] [cursor=pointer]:
        - generic [ref=e18]: Second Tab
      - tab "Disabled Tab" [disabled] [ref=e20]:
        - generic [ref=e23]: Disabled Tab
      - tab "Last tab" [ref=e25] [cursor=pointer]:
        - generic [ref=e28]: Last tab
    - tabpanel "First tab" [ref=e30]:
      - generic [ref=e31]: Contents of Tab 1
  - generic [ref=e33]:
    - tablist "Tabs with icons" [ref=e34]:
      - tab "First tab" [selected] [ref=e36] [cursor=pointer]:
        - generic [ref=e38]:
          - generic [ref=e39]: 
          - generic [ref=e40]: First tab
      - tab "Second Tab" [ref=e42] [cursor=pointer]:
        - generic [ref=e44]:
          - generic [ref=e45]: 
          - generic [ref=e46]: Second Tab
      - tab "Disabled Tab" [disabled] [ref=e48]:
        - generic [ref=e50]:
          - generic [ref=e51]: 
          - generic [ref=e52]: Disabled Tab
      - tab "Last tab" [ref=e54] [cursor=pointer]:
        - generic [ref=e56]:
          - generic [ref=e57]: 
          - generic [ref=e58]: Last tab
    - tabpanel "First tab" [ref=e60]:
      - generic [ref=e61]: Contents of Tab 1
```
