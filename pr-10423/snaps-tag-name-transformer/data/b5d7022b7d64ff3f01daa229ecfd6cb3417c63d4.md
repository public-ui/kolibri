...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 324px by 724px, received 324px by 730px. 1489 pixels (ratio 0.01 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e34]:
    ...
    - generic [ref=e47]: <KolInputText _icons='fa-solid fa-city' _label="Input with Icon" />
```
