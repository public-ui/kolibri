...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 281px, received 800px by 293px. 12112 pixels (ratio 0.06 of all image pixels) are different.
...
- main [ref=e4]:
  - generic [ref=e5]:
    ...
    - group "Combined input field" [ref=e25]:
      ...
      - generic [ref=e36]:
        - generic [ref=e40] [cursor=pointer]: First input
        - textbox "First input" [ref=e44]
      - generic [ref=e46]:
        - generic [ref=e50] [cursor=pointer]: Second input with error
        - textbox "Second input with error" [ref=e54]
```
