...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  667 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: snapshot-for-drawer-basic-align-left.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-drawer-basic-align-left.png)" with timeout 10000ms
