...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  3092 pixels (ratio 0.01 of all image pixels) are different.
...
- main [ref=e4]:
  - generic [ref=e7]:
    - generic [ref=e8]:
      ...
      - generic [ref=e10]: 
      - strong [ref=e12]: Component is DEPRECATED
    - generic [ref=e13]:
      - generic:
        - text: The Modal component was renamed to Dialog. Please use the Dialog sample instead.
        - link "Open Dialog samples Opens in new tab." [ref=e16] [cursor=pointer]:
          - /url: /#/dialog
          - generic [ref=e19]: Open Dialog samples
          - img "Opens in new tab." [ref=e20]: 
  - heading "modal basic" [level=1] [ref=e21]
  - generic [ref=e22]:
    - generic [ref=e23]:
      - button "Open blank dialog" [ref=e26] [cursor=pointer]:
        - generic [ref=e29]: Open blank dialog
      - dialog "Blank dialog" [ref=e30]:
        - generic [ref=e31]:
          - paragraph [ref=e32]: You must add styling and a close button yourself.
          - button "Open card dialog" [ref=e35] [cursor=pointer]:
            - generic [ref=e38]: Open card dialog
          - button "Close" [ref=e41] [cursor=pointer]:
            - generic [ref=e44]: Close
    - generic [ref=e45]:
      - button "Open card dialog" [ref=e48] [cursor=pointer]:
        - generic [ref=e51]: Open card dialog
      - dialog "Card dialog" [ref=e52]:
        - article "Card dialog" [ref=e54]:
          - strong [ref=e55]: Card dialog
          - paragraph [ref=e57]: This variant wraps content inside a KolCard.
          - generic [ref=e58]:
