...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 439px, received 500px by 463px. 14218 pixels (ratio 0.07 of all image pixels) are different.
  ...
  - generic [ref=e6]:
    ...
    - generic [ref=e18]:
      - generic [ref=e19] [cursor=pointer]:
        - generic [ref=e22]: Readonly with value
        - text: (read-only)
      - textbox "Readonly with value" [ref=e26]: This field is readonly
    - generic [ref=e28]:
      - generic [ref=e29] [cursor=pointer]:
        - generic [ref=e32]: Readonly with info message
        - text: (read-only)
