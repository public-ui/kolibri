...
- Name: theme-snapshots.spec.js >> snapshot for input-password/show-password?noColumns
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 293px, received 500px by 311px. 6770 pixels (ratio 0.05 of all image pixels) are different.

  Snapshot: snapshot-for-input-password-show-password-noColumns.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-input-password-show-password-noColumns.png)" with timeout 10000ms
...
```yaml
- main [ref=e4]:
  - heading "input-password show-password" [level=1] [ref=e5]
  - generic [ref=e7]:
    - paragraph [ref=e8]:
      - generic [ref=e9]: Form fields marked with an asterisk (*) are mandatory.
    - generic:
      - generic [ref=e11]:
        - generic [ref=e15] [cursor=pointer]: Password
        - generic [ref=e17]:
          - textbox "Password" [ref=e19]:
            - /placeholder: With 'Show password' button
          - button "Show" [ref=e22] [cursor=pointer]:
            - generic [ref=e25]: 
      - generic [ref=e27]:
        - generic [ref=e31] [cursor=pointer]: Password
        - generic [ref=e33]:
          - textbox "Password" [ref=e35]:
            - /placeholder: With 'Show password' button
          - button "Show" [ref=e38] [cursor=pointer]:
            - generic [ref=e41]: 
      - generic [ref=e43]:
        - generic [ref=e47]: Password
        - generic [ref=e49]:
          - textbox "Password" [disabled] [ref=e51]:
            - /placeholder: With 'Show password' button and disabled
          - button "Show" [disabled] [ref=e54]:
            - generic [ref=e57]: 
```
