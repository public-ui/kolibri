...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 200px by 312px, received 200px by 324px. 1769 pixels (ratio 0.03 of all image pixels) are different.
  ...
  - generic [ref=e6]:
    ...
    - generic [ref=e33]:
      ...
      - region "With Table" [ref=e43]:
        - table "Table for demonstration purposes with different text align properties" [ref=e47]:
          - caption [ref=e48]: Table for demonstration purposes with different text align properties
          - rowgroup [ref=e49]:
            - row "left center right" [ref=e50]:
              - columnheader "left" [ref=e51]
              - columnheader "center" [ref=e52]
              - columnheader "right" [ref=e53]
          - rowgroup [ref=e54]:
            - row "Left Example Center Example Right Example" [ref=e55]:
              - cell "Left Example" [ref=e56]
              - cell "Center Example" [ref=e57]
              - cell "Right Example" [ref=e58]
```
