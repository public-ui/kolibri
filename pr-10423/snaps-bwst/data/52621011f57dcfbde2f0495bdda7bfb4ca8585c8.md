...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 78px, received 300px by 84px. 2226 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: snapshot-for-scenarios-focus-elements-component-splitButton.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-scenarios-focus-elements-component-splitButton.png)" with timeout 10000ms
