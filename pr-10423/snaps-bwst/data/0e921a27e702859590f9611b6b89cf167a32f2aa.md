...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 310px, received 500px by 322px. 2474 pixels (ratio 0.02 of all image pixels) are different.
...
- main [ref=e4]:
  - generic [ref=e5]:
    ...
    - generic [ref=e27]:
      - paragraph [ref=e28]:
        - generic [ref=e29]: Form fields marked with an asterisk (*) are mandatory.
      - generic [ref=e30]:
