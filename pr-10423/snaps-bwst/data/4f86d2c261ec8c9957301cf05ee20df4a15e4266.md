...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 101px, received 300px by 107px. 1640 pixels (ratio 0.06 of all image pixels) are different.

  Snapshot: snapshot-for-scenarios-focus-elements-component-combobox.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-scenarios-focus-elements-component-combobox.png)" with timeout 10000ms
