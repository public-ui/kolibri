...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 441px, received 500px by 471px. 11025 pixels (ratio 0.05 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    ...
    - generic [ref=e18]:
      - generic [ref=e22] [cursor=pointer]: Email address
      - textbox "Email address" [ref=e26]:
        - /placeholder: user@example.com
    - generic [ref=e28]:
      - generic [ref=e32] [cursor=pointer]: Phone number
      - textbox "Phone number" [ref=e36]:
        - /placeholder: +49 123 456789
    - generic [ref=e38]:
      - generic [ref=e42] [cursor=pointer]: Website
