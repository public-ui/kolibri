...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 186px, received 500px by 198px. 4420 pixels (ratio 0.05 of all image pixels) are different.
    ...
    - generic [ref=e8]:
      ...
      - generic [ref=e14]:
        ...
        - generic [ref=e19]:
          ...
          - generic [ref=e25]: 
    - generic [ref=e27]:
      - generic [ref=e31]: Disabled input with button and icons
      - generic [ref=e33]:
        - generic [ref=e35]: 
        - textbox "Disabled input with button and icons" [disabled] [ref=e37]
        - generic [ref=e38]:
          - button "Disabled Button" [disabled] [ref=e40]:
            - generic [ref=e43]: 
          - generic [ref=e44]: 
```
