...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 354px, received 800px by 378px. 13948 pixels (ratio 0.05 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    ...
    - strong [ref=e21]:
      - button "Heading Accordion Tab 2" [ref=e23] [cursor=pointer]:
        - generic [ref=e25]:
          - generic [ref=e26]: 
          - generic [ref=e27]: Heading Accordion Tab 2
    - strong [ref=e30]:
      - button "Heading Accordion Tab 3 (deactivated)" [disabled] [ref=e32]:
        - generic [ref=e34]:
          - generic [ref=e35]: 
          - generic [ref=e36]: Heading Accordion Tab 3 (deactivated)
    - generic [ref=e38]:
      - strong [ref=e39]:
        - button "Heading Accordion Tab 4 (disabled and open)" [disabled] [expanded] [ref=e41]:
          - generic [ref=e43]:
            - generic [ref=e44]: 
            - generic [ref=e45]: Heading Accordion Tab 4 (disabled and open)
      - region "Heading Accordion Tab 4 (disabled and open)" [ref=e48]:
