import{o as e,p as t,r as n,s as r}from"./index-BdBzjSTb.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import"./_Uint8Array-kJHDjtoP-CTkgs_0o.js";import{n as i}from"./normalizers-B5NKuJgN-DsoPI_Ct.js";import{t as a}from"./label-BT-6lb8r-BaiOIA1m.js";import{t as o}from"./base-web-component-CArCAUxk-bSuFOAaU.js";import{t as s}from"./base-controller-CXhqh4cR-BNzx0WwK.js";import{t as c}from"./i18n-CFuSxM6N-QUi2-B8e.js";import{t as l}from"./contrast-D1msrkD4-DO16eHCZ.js";import{t as u}from"./src-DH5c0A9H-CBTd3gDW.js";var d=/^#((\d|[a-f]){8}|(\d|[a-f]){6}|(\d|[a-f]){3,4})$/i;function f(e){return d.test(e)}function p(e){if(typeof e==`string`&&f(e)){let t=l(e);return{backgroundColor:t.background,foregroundColor:t.foreground}}else if(typeof e==`object`&&e){let t=e;if(typeof t.backgroundColor==`string`&&typeof t.foregroundColor==`string`&&f(t.backgroundColor)&&f(t.foregroundColor)){let e=l({background:t.backgroundColor,foreground:t.foregroundColor});return{backgroundColor:e.background,foregroundColor:e.foreground}}}throw Error(`Invalid color ${e}`)}function m(e){return f(e.foregroundColor)&&f(e.backgroundColor)}var h=i(`color`,{backgroundColor:`#d3d3d3`,foregroundColor:`#3f3f3f`},p,m),g=`kol-avatar`,_=t(g,`image`),v=t(g,`initials`),y=t=>{let{color:n,initials:r,label:i,src:a}=t;return e(`div`,{"aria-label":c(`kol-avatar-alt`,{placeholders:{name:i}}),class:`kol-avatar`,role:`img`,style:{backgroundColor:n.backgroundColor,color:n.foregroundColor}},a?e(`img`,{alt:``,"aria-hidden":`true`,class:_,src:a}):e(`span`,{"aria-hidden":`true`,class:v},r))},b={optional:[h,u],required:[a]},x=e=>e.length===0?``:e[0].toUpperCase(),S=e=>{let t=e.trim().split(/\s+/),n=t[0],r=t[t.length-1];return t.length>=2&&n&&r?`${x(n)}${x(r)}`:x(e)},C=class extends s{constructor(e){super(e,b)}componentWillLoad(e){let{color:t,label:n,src:r}=e;this.watchColor(t),this.watchLabel(n),this.watchSrc(r)}watchColor(e){h.apply(e,e=>{this.setRenderProp(`color`,e)})}watchLabel(e){a.apply(e,e=>{this.setRenderProp(`label`,e),this.setState(`initials`,S(e))})}watchSrc(e){u.apply(e,e=>{this.setRenderProp(`src`,e)})}},w=`/* forward the rem function */
/*
