import{B as e,a as t,c as n,d as r,o as i,s as a,u as o}from"./index-d8HcVNlJ.js";import{i as s,n as c}from"./dev.utils-BLwpXbb2-DtCEdZwW.js";import{n as l,t as u}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as d}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{t as f}from"./clsx-COFh-Vc8-DWAop4cA.js";import"./label-C0rxk5dd-Dpp9hj8Z.js";import{n as p,r as m,t as h}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import"./normalizers-bmigMYOh-DIqUyazK.js";import{t as g}from"./i18n-6Ww8y2f3-J_8eYBFb.js";import"./label-0amhC2jU-BLLQcrHC.js";import"./variant-quote-Ch1VGFiN-Dv1dmPUM.js";import{n as _}from"./component-DSERKzTV-CUUwQ5hv.js";import"./variant-class-name-CJmwIdCX-BoE5XPvf.js";import"./component-ASKmbxEX-62GdFEbe.js";import"./component-B7DNhbVq-Cf1jrwWj.js";import{t as v}from"./component-BPFxbaa6-dz1-aPm_.js";import"./align-66zR6LwD-Cmfkp59_.js";import{i as y,t as b}from"./behavior-BAuOL8Z9-ylmfcLYh.js";import{t as x}from"./label-with-expert-slot-vheHAMen-CxRP2pQg.js";import{a as S,c as C,d as w,f as T,l as E,m as D,o as O,p as k,r as A,s as j,t as M,u as N}from"./variant-DIChpbq4-B6daS21D.js";import{t as P}from"./name-C4xBDY63-jYeXzdrH.js";import{a as F,n as I,r as L,t as R}from"./api-9-uP3TFJ-Mb9AnUeT.js";import"./controller-pH1qWcyw-CnM4gaAM.js";import"./aria-details-BejeJE6g-DpwaG8CK.js";import"./associated.controller-B8Mhrwd2-7uKUSBFp.js";import{t as z}from"./base-B-klenaB-B5jAigMd.js";import{n as B,r as V,t as H}from"./controller-BXUpdggx-C-E5ANML.js";var U={required:[x],optional:[M,A,R,I,L,F,S,O,j,y,C,x,E,P,V,N,w,T,k,D]},W=t=>{let r=new B,i=new b(u.stateLess),a=h(),d,f=l(U);delete f.tabIndex;let p=e=>{O.apply(e,e=>{f.disabled=e})};p(t.disabled),j.apply(t.hideLabel,e=>{f.hideLabel=e}),w.apply(t.icons,e=>{f.icons=e}),C.apply(!1,e=>{f.inline=e}),k.apply(`top`,e=>{f.tooltipAlign=e}),F.apply(`button`,e=>{f.type=e}),x.apply(t.label,e=>{f.label=e}),V.apply(t.popoverAlign,e=>{f.popoverAlign=e,r.setAlign(e)}),D.apply(e(`buttonVariantDefault`,t.getFlagHost())??`normal`,e=>{f.variant=e}),f.ariaDescriptionId=s(),f.popoverId=c(`popover`);let m=e=>{let n=t.getEventTarget();n&&o(n,e)},g=e=>{t.setOpen(e.newState===`open`)};return f.handleClick=e=>{e.stopPropagation(),i.hideTooltip(),r.setShow(!t.getOpen()),m(n.click)},f.handleMouseDown=()=>m(n.mousedown),f.handleFocus=()=>m(n.focus),f.handleBlur=()=>m(n.blur),f.refButton=e=>{a(e),r.setTriggerElement(e)},f.refPopover=e=>{d=e,r.setPopoverElementRef(e)},f.refTooltip=i.setTooltipElementRef,i.componentWillLoad({label:f.label,align:f.tooltipAlign}),{getFcProps:()=>Object.assign(Object.assign({},f),{popoverOpen:t.getOpen()}),hide:()=>r.setShow(!1),setDisabled:p,syncListeners:()=>{a.el&&i.syncListeners(void 0,a.el,!0),d?.addEventListener(`toggle`,g)},destroy:()=>{i.destroy(),d&&=(d.removeEventListener(`toggle`,g),void 0),r.destroy()}}},G=r.forBlock(`kol-split-button`),K=G(`button`),q=G(`horizontal-line`),J=G(`root`),Y=G(`secondary-button`),X=e=>{let{buttonProps:t,buttonWrapperClass:n,class:r,dropdownProps:a,refDropdown:o}=e;return i(_,{block:`kol-split-button`,class:r},i(`div`,{class:J},i(`div`,{class:f(K,n)},i(v,Object.assign({},t))),i(`div`,{class:q}),i(`div`,{class:Y,ref:o},i(H,Object.assign({},a)))))},Z=`@charset "UTF-8";
