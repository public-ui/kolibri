import{St as e,U as t,_t as n,a as r,c as i,d as a,o,r as s,s as c,u as l}from"./index-BkgQ29UN.js";import{i as u}from"./dev.utils-3xMYti16-5eMkcG4R.js";import{n as d,t as f}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as p}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./label-DxrksC9L-CVmVM18T.js";import{r as m,t as h}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{i as g,n as _}from"./normalizers-DEevvNbZ-DgUxvZI3.js";import"./i18n-DuzgYBgD-CODha9pQ.js";import"./component-CmFzOwYm-BcKeIWLC.js";import"./label-De6GKT_4-CZyL64YU.js";import"./variant-quote-JfuelQ4I-BLpgbuGn.js";import{t as v}from"./label-with-expert-slot-pcKVBAqt-BnjKnFyT.js";import"./align-DglmQnOH-DPYacqbh.js";import{a as y,c as b,f as x,h as S,i as C,l as w,m as T,p as E,r as D,u as O}from"./component-CE7IQwDa-voITi_D5.js";import"./variant-class-name-BFZvmFM_-BHfFSrlB.js";import"./component-vqRjEo0A-DEgBaxRP.js";import"./component-CU4HB3cl-CKdSJReC.js";import"./align-floating-elements-D6Kc-f8P-DWq8RD3k.js";import{t as k}from"./behavior-opTsLlOg-D9HOjkxU.js";import{t as A}from"./href-3Ej9WI_E-BBF159kb.js";import{t as j}from"./link-target-LVTiYY9w-CZV2eO0P.js";import{a as M,i as N,n as P,o as F,t as I}from"./api-CQwmSbAf-DA-N40ja.js";import{t as L}from"./access-and-short-key-ijzCZfHm-Dx5Q-CAn.js";import{n as R,t as z}from"./unique-nav-labels-DdDotOG6-6vJ9YvCD.js";var B=_(`links`,[],e=>g(e),e=>e.every(e=>typeof e==`object`&&(typeof e._href==`string`||typeof e._label==`string`)),{hints:(t,n)=>e(`KolSkipNav`,n.length)}),V={required:[B,v]},H=a.forBlock(`kol-skip-nav`),U=H(),W=H(`list`),G=H(`list-item`),K=({label:e,linkItems:t})=>o(`nav`,{class:U,"aria-label":e},o(`ul`,{class:W},t.map((e,t)=>o(`li`,{class:G,key:t},o(I,Object.assign({},e.fcProps)))))),q=(e,t)=>{let r=new k(f.stateLess),a=h(),o=d(F);delete o.tabIndex;let s=(e,t)=>e.apply(t,t=>{o[e.propName]=t});s(D,e._accessKey),s(C,e._ariaControls),s(P,e._ariaCurrentValue),s(y,e._ariaDescription),s(b,e._disabled),s(N,e._download),s(w,e._hideLabel),s(A,e._href),s(E,e._icons),s(O,e._inline??!0),s(v,e._label),s(M,e._on),s(x,e._shortKey),typeof e._tabIndex==`number`&&s(T,e._tabIndex),s(j,e._target),s(S,e._tooltipAlign),L(e._accessKey,e._shortKey),r.componentWillLoad({label:(()=>{let e=o.label;if(typeof e==`string`&&e.length>0)return e;let t=o.href;return typeof t==`string`?t:``})(),align:o.tooltipAlign}),o.ariaCurrent=``,o.ariaDescriptionId=u(),o.expertSlot=e._label===``;let c=()=>typeof o.href==`string`?o.href:``;return o.handleAnchorClick=e=>{if(r.hideTooltip(),o.disabled===!0){e.preventDefault();return}let s=c(),u=o.on;typeof u?.onClick==`function`&&(n(e,a.el),u.onClick(e,s));let d=t();d&&l(d,i.click,s)},o.refAnchor=e=>{a(e)},o.refTooltip=r.setTooltipElementRef,{fcProps:o,getAnchor:()=>a.el,syncTooltipListeners:()=>{a.el&&r.syncListeners(void 0,a.el,!0)},destroy:()=>{r.destroy()}}},J=`@charset "UTF-8";
