import{St as e,U as t,_t as n,a as r,c as i,d as a,o,r as s,s as c,u as l}from"./index-ABmTotcE.js";import{i as u}from"./dev.utils-3xMYti16-PNbjtEnD.js";import{n as d,t as f}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as p}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./label-DxrksC9L-Cz88aRO6.js";import{r as m,t as h}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{i as g,n as _}from"./normalizers-DEevvNbZ-BYAt2OlA.js";import"./i18n-DuzgYBgD-BVE5UPTU.js";import"./component-CmFzOwYm-C9Pvmfjm.js";import"./label-De6GKT_4-B4EYLzD1.js";import"./variant-quote-JfuelQ4I-DOKo2CPl.js";import{t as v}from"./label-with-expert-slot-pcKVBAqt-D6oMtyzP.js";import"./align-DglmQnOH-C5tdRjqX.js";import{a as y,c as b,f as x,h as S,i as C,l as w,m as T,p as E,r as D,u as O}from"./component-CE7IQwDa-guyxXOH3.js";import"./variant-class-name-BFZvmFM_-CNtGDtP9.js";import"./component-vqRjEo0A-Bu7vDX5g.js";import"./component-CU4HB3cl-ZaUUkABF.js";import"./align-floating-elements-D6Kc-f8P-CW0PMmfZ.js";import{t as k}from"./behavior-opTsLlOg-N4ogJ_I7.js";import{t as A}from"./href-3Ej9WI_E-CQOH7aeo.js";import{t as j}from"./link-target-LVTiYY9w-Cn0RbpLU.js";import{a as M,i as N,n as P,o as F,t as I}from"./api-CQwmSbAf-Bl3OuC3w.js";import{t as L}from"./access-and-short-key-ijzCZfHm-Dx5Q-CAn.js";import{n as R,t as z}from"./unique-nav-labels-DdDotOG6-Hh7lcVCJ.js";var B=_(`links`,[],e=>g(e),e=>e.every(e=>typeof e==`object`&&(typeof e._href==`string`||typeof e._label==`string`)),{hints:(t,n)=>e(`KolSkipNav`,n.length)}),V={required:[B,v]},H=a.forBlock(`kol-skip-nav`),U=H(),W=H(`list`),G=H(`list-item`),K=({label:e,linkItems:t})=>o(`nav`,{class:U,"aria-label":e},o(`ul`,{class:W},t.map((e,t)=>o(`li`,{class:G,key:t},o(I,Object.assign({},e.fcProps)))))),q=(e,t)=>{let r=new k(f.stateLess),a=h(),o=d(F);delete o.tabIndex;let s=(e,t)=>e.apply(t,t=>{o[e.propName]=t});s(D,e._accessKey),s(C,e._ariaControls),s(P,e._ariaCurrentValue),s(y,e._ariaDescription),s(b,e._disabled),s(N,e._download),s(w,e._hideLabel),s(A,e._href),s(E,e._icons),s(O,e._inline??!0),s(v,e._label),s(M,e._on),s(x,e._shortKey),typeof e._tabIndex==`number`&&s(T,e._tabIndex),s(j,e._target),s(S,e._tooltipAlign),L(e._accessKey,e._shortKey),r.componentWillLoad({label:(()=>{let e=o.label;if(typeof e==`string`&&e.length>0)return e;let t=o.href;return typeof t==`string`?t:``})(),align:o.tooltipAlign}),o.ariaCurrent=``,o.ariaDescriptionId=u(),o.expertSlot=e._label===``;let c=()=>typeof o.href==`string`?o.href:``;return o.handleAnchorClick=e=>{if(r.hideTooltip(),o.disabled===!0){e.preventDefault();return}let s=c(),u=o.on;typeof u?.onClick==`function`&&(n(e,a.el),u.onClick(e,s));let d=t();d&&l(d,i.click,s)},o.refAnchor=e=>{a(e)},o.refTooltip=r.setTooltipElementRef,{fcProps:o,getAnchor:()=>a.el,syncTooltipListeners:()=>{a.el&&r.syncListeners(void 0,a.el,!0)},destroy:()=>{r.destroy()}}},J=`@charset "UTF-8";
