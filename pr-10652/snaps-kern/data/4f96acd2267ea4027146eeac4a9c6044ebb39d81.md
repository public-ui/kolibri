...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 88px, received 800px by 64px. 1554 pixels (ratio 0.03 of all image pixels) are different.
  ...
  - generic [ref=e5]:
    ...
    - generic [active] [ref=e7]:
      - navigation "Hidden navigation":
        - list:
          - listitem:
            - link "To the top" [ref=e10] [cursor=pointer]:
              - /url: "#/back-page"
              - generic [ref=e13]: To the top
          - listitem:
            - link "To the form" [ref=e16] [cursor=pointer]:
              - /url: "#/back-page"
              - generic [ref=e19]: To the form
          - listitem:
            - link "To the end" [ref=e22] [cursor=pointer]:
              - /url: "#/back-page"
              - generic [ref=e25]: To the end
```
