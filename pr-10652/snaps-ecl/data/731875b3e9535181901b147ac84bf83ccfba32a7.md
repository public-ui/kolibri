...
Locator: locator('[data-visual-block="target"]')
  Expected an image 768px by 71px, received 768px by 44px. 2053 pixels (ratio 0.04 of all image pixels) are different.

  Snapshot: link-button-target--target.png

Call log:
  - Expect "toHaveScreenshot(link-button-target--target.png)" with timeout 10000ms
    - verifying given screenshot expectation
  - waiting for locator('[data-visual-block="target"]')
    - locator resolved to <div data-visual-block="target" class="flex flex-wrap gap-2">…</div>
...
- main [ref=e4]:
  ...
  - generic [ref=e7]:
    - link "Link Button Target default" [ref=e11] [cursor=pointer]:
      - /url: "#/back-page"
      - generic [ref=e14]: Link Button Target default
    - link "Link Button Target _self Opens in new tab." [ref=e18] [cursor=pointer]:
      - /url: "#/back-page"
      - generic [ref=e21]: Link Button Target _self
      - img "Opens in new tab." [ref=e22]: 
    - link "Link Button Target _blank Opens in new tab." [ref=e26] [cursor=pointer]:
      - /url: "#/back-page"
      - generic [ref=e29]: Link Button Target _blank
