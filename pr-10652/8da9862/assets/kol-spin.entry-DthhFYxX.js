import{o as e,r as t,s as n}from"./index-DaOCWC1Z.js";import{t as r}from"./base-web-component-Yd2xtcRx-DLjfgSf5.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import"./_Uint8Array-kJHDjtoP-CTkgs_0o.js";import{n as i,r as a,s as o}from"./normalizers-DwKzbMGB-DNgjZcl0.js";import"./i18n-Cmhkz-MX-ysVgrSFN.js";import{t as s}from"./label-D4pl6qKU-Csovemtv.js";import"./variant-quote-Dm5uxeVx-DeQqJbPP.js";import{t as c}from"./component-0vk1klt--BcDr-mXW.js";var l=i(`show`,!1,a),u=[`dot`,`cycle`,`none`],d=i(`variant`,`dot`,e=>{let t=o(e);if(u.includes(t))return t;throw Error(`Invalid spin variant: ${t}`)},()=>!0),f={optional:[s,l,d]},p=`@charset "UTF-8";
...
}`,m=class extends r{constructor(e){super(),n(this,e),this.showToggled=!1}watchShow(e){this.applyShow(e)}watchLabel(e){s.apply(e,e=>this.setRenderProp(`label`,e))}watchVariant(e){d.apply(e,e=>this.setRenderProp(`variant`,e))}componentWillLoad(){this.initRenderProps(f),this.applyShow(this._show),s.apply(this._label,e=>this.setRenderProp(`label`,e)),d.apply(this._variant,e=>this.setRenderProp(`variant`,e))}applyShow(e){l.apply(e,e=>{let t=this.getRenderProp(`show`);this.setRenderProp(`show`,e),this.setState(`showToggled`,t===!0&&e===!1)})}render(){return e(t,{key:`d5b9ed83d680d3fad1e95c20903d02d51155895e`},e(c,{key:`c7f67efcf062427241113a9251f00f28d18fef37`,show:this.getRenderProp(`show`),label:this.getRenderProp(`label`),variant:this.getRenderProp(`variant`),showToggled:this.showToggled}))}static get watchers(){return{_show:[`watchShow`],_label:[`watchLabel`],_variant:[`watchVariant`]}}};m.style={default:p};export{m as kol_spin};