import{n as e,o as t,r as n,s as r}from"./index-BSrSGxVB.js";import{t as i}from"./base-web-component-Yd2xtcRx-DLjfgSf5.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import"./_Uint8Array-kJHDjtoP-CTkgs_0o.js";import{n as a,r as o,s}from"./normalizers-aZN4lreB-CqpVamTR.js";import{t as c}from"./i18n-DSbQzWoo-DJShdSOL.js";import{t as l}from"./label-D-HX3Y2A-DFRIWL9M.js";import"./variant-quote-Jd3iIIas-iPZGx_Oq.js";var u=a(`show`,!1,o),d=[`dot`,`cycle`,`none`],f=a(`variant`,`dot`,e=>{let t=s(e);if(d.includes(t))return t;throw Error(`Invalid spin variant: ${t}`)},()=>!0),p={optional:[l,u,f]};function m(n){switch(n){case`cycle`:return t(`span`,{class:`kol-spin__loader kol-spin__spinner--${n}__element`});case`none`:return t(`slot`,{name:`expert`});default:return t(e,null,t(`span`,{class:`kol-spin__spinner-element 
							...
							kol-spin__spinner--${n}__element 
							kol-spin__spinner--${n}__element--4`}))}}var h=n=>{let{show:r,label:i,variant:a,showToggled:o}=n;return t(e,null,r?t(e,null,t(`span`,{class:`kol-spin__spinner kol-spin__spinner--${a}`},m(a)),t(`span`,{"aria-busy":`true`,class:`visually-hidden`,role:`alert`},i||c(`kol-action-running`))):o&&t(`span`,{"aria-busy":`false`,class:`visually-hidden`,role:`alert`},i||c(`kol-action-done`)))},g=`@charset "UTF-8";
...
}`,_=class extends i{constructor(e){super(),r(this,e),this.showToggled=!1}watchShow(e){this.applyShow(e)}watchLabel(e){l.apply(e,e=>this.setRenderProp(`label`,e))}watchVariant(e){f.apply(e,e=>this.setRenderProp(`variant`,e))}componentWillLoad(){this.initRenderProps(p),this.applyShow(this._show),l.apply(this._label,e=>this.setRenderProp(`label`,e)),f.apply(this._variant,e=>this.setRenderProp(`variant`,e))}applyShow(e){u.apply(e,e=>{let t=this.getRenderProp(`show`);this.setRenderProp(`show`,e),this.setState(`showToggled`,t===!0&&e===!1)})}render(){return t(n,{key:`3e30085cead3291cf62e11795fd3b01505556612`},t(h,{key:`4f1e1eeaefd44701ac9726e4578fb87cd74c84ff`,show:this.getRenderProp(`show`),label:this.getRenderProp(`label`),variant:this.getRenderProp(`variant`),showToggled:this.showToggled}))}static get watchers(){return{_show:[`watchShow`],_label:[`watchLabel`],_variant:[`watchVariant`]}}};_.style={default:g};export{_ as kol_spin};