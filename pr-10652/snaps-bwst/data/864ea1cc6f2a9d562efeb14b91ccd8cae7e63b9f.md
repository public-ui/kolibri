...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  9164 pixels (ratio 0.04 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    ...
    - toolbar "Toolbar" [ref=e10]:
      ...
      - link "Simple Link 3" [ref=e29] [cursor=pointer]:
        - /url: "#/back-page"
        - generic [ref=e32]: Simple Link 3
      - button "Bold" [ref=e34] [cursor=pointer]:
        - generic [ref=e37]: Bold
    ...
    - toolbar "Toolbar" [ref=e47]:
      ...
      - link "Simple Link 3" [ref=e66] [cursor=pointer]:
        - /url: "#/back-page"
        - generic [ref=e69]: Simple Link 3
      - button "Bold" [ref=e71] [cursor=pointer]:
        - generic [ref=e74]: Bold
