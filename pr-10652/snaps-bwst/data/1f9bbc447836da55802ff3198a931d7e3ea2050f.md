...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  2834 pixels (ratio 0.13 of all image pixels) are different.

  Snapshot: scenarios-focus-elements-component-linkButton.png

Call log:
  - Expect "toHaveScreenshot(scenarios-focus-elements-component-linkButton.png)" with timeout 10000ms
