...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Snapshot: skip-nav-basic.png

Call log:
  - Expect "toHaveScreenshot(skip-nav-basic.png)" with timeout 10000ms
    ...
    - generic [active] [ref=e7]:
      - navigation "Hidden navigation":
        - list:
          ...
          - listitem:
            - link "To the form" [ref=e15] [cursor=pointer]:
              - /url: "#/back-page"
              - generic [ref=e18]: To the form
          - listitem:
            - link "To the end" [ref=e20] [cursor=pointer]:
              - /url: "#/back-page"
              - generic [ref=e23]: To the end
```
