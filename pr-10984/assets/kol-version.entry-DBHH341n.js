import{o as e,r as t,s as n}from"./index-CboskrIm.js";import{t as r}from"./base-web-component--IgFgz37-CZuvR3uB.js";import"./_Uint8Array-kJnEuTzT-BYXN1zbF.js";import"./factory-DVePsLAQ-D6i81khj.js";import"./label-BJf95S0B-BpNCSI_H.js";import{t as i}from"./label-CnOLrr0w-BM-UImKz.js";import"./variant-quote-7bJL1WOX-D7tVh6DU.js";import"./block-bem-7gjd36jd-BeZLCyPU.js";import"./component-DdAp6OUz-D8icN5KO.js";import"./component-BdFrEcaV-DLOGT0xP.js";import{t as a}from"./i18n-B_vSiQA9-D2rqnZ6v.js";import{n as o}from"./component-Dxb12TYY-BdGwUGgu.js";import"./variant-class-name-2os1V9lQ-B9g7OQWw.js";import"./component-BcrPTqDX-DEkuFZkr.js";import"./component-Ca8xWJ9s-DyLQu-l8.js";import"./index-C9FLIdC6-W2JSDNhA.js";import{t as s}from"./contrast-CQ30AQB5-XmEg9SQt.js";import{t as c}from"./component-DynhhJ4l-CCPDz8AO.js";var l={required:[i]},u=({class:t,color:n,icons:r,label:i})=>e(o,{block:`kol-version`,class:t},e(c,{color:n,icons:r,label:i})),d=`@charset "UTF-8";
/*
 ...
 */
@layer kol-component {
  /* The version renders \`BadgeFC\` inline, so the badge box has to live in this shadow root too. */
  .kol-icon {
    color: inherit;
...
}`,f=s(`#bec5c9`),p={backgroundColor:f.background,foregroundColor:f.foreground},m={left:{icon:`kolicon-version`,label:a(`kol-version`)}},h=class extends r{constructor(e){super(),n(this,e)}watchLabel(e){i.apply(e,e=>this.setRenderProp(`label`,e))}componentWillLoad(){this.initRenderProps(l),i.apply(this._label,e=>this.setRenderProp(`label`,e))}render(){return e(t,{key:`d968693e27411d17466250e02f0a55150f00b02b`},e(u,{key:`e2cd9b8cdae332c5dc7b880a7d0a92ad96d2edf3`,color:p,icons:m,label:this.getRenderProp(`label`)}))}static get watchers(){return{_label:[`watchLabel`]}}};h.style={default:d};export{h as kol_version};