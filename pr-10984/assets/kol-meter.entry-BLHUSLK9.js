import{o as e,r as t,s as n}from"./index-CjbwesRT.js";import{t as r}from"./base-web-component--IgFgz37-CZuvR3uB.js";import"./_Uint8Array-kJnEuTzT-BYXN1zbF.js";import{l as i,r as a}from"./factory-DVePsLAQ--UPRBviO.js";import"./label-BJf95S0B-Id0KK_W4.js";import{t as o}from"./label-CnOLrr0w-ld5jnlm8.js";import"./variant-quote-7bJL1WOX-DIuW1M7x.js";import{t as s}from"./i18n-B_vSiQA9-BGf8OXTH.js";import{n as c,r as l,t as u}from"./value-number-clamped-DTpBaApx-Dbd-b5UM.js";import{t as d}from"./orientation-uFzZAOc6-BNKEaJ7D.js";var f=a(`high`,0,i),p=a(`low`,0,i),m=a(`min`,0,i),h=a(`optimum`,0,i),g=a(`value`,0,i,e=>e>=0),_={optional:[m,d,l],required:[o,c,g]};function v(e,t,n,r,i,a){let o=r??t,s=i??n;if(a===void 0)return e>=o&&e<=s?`optimum`:`suboptimal`;let c=e<o,l=e>s,u=!c&&!l;return a<o?c?`optimum`:u?`suboptimal`:`critical`:a>s?l?`optimum`:u?`suboptimal`:`critical`:u?`optimum`:`suboptimal`}var y=t=>{let{high:n,label:r,low:i,max:a,min:o,optimum:c,orientation:l,unit:u,value:d}=t,f=l===`vertical`,p=u===`%`,m=p?Math.round((d-o)/(a-o)*100):d,h=v(d,o,a,i,n,c),g=i!==void 0||n!==void 0,_=``;g&&(_=s(h===`critical`?`kol-meter-state-critical`:h===`optimum`?`kol-meter-state-optimum`:`kol-meter-state-suboptimal`));let y=p?s(`kol-live-value`,{placeholders:{value:String(m),unit:u}}):s(`kol-live-value-bounded`,{placeholders:{value:String(m),max:String(a),unit:u}}),b=g?`${y} – ${_}`:y,x=a.toString().length>o.toString().length?a.toString().length+`ch`:o.toString().length+`ch`;return e(`div`,{class:{"kol-meter":!0,"kol-meter--vertical":f}},e(`div`,{class:`kol-meter__bar`},e(`div`,{class:`kol-meter__bar-label`},r,g&&e(`span`,{class:`kol-meter__bar-state kol-meter__bar-state--${h}`},` – `,_)),e(`div`,{class:`kol-meter__bar-track`},e(`meter`,{"aria-label":r,"aria-valuetext":b,high:n,low:i,max:a,min:o,optimum:c,value:d})),e(`span`,{class:`kol-meter__value-unit`},e(`span`,{class:`kol-meter__value`,style:{"min-width":x}},m),e(`span`,{class:`kol-meter__unit`},u))))},b=`@charset "UTF-8";
