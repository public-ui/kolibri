import{B as e,a as t,c as n,d as r,o as i,s as a,u as o}from"./index-CboskrIm.js";import{i as s,n as c}from"./dev.utils-DEzQ6pd0-CQON772e.js";import{n as l,t as u}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as d}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./_Uint8Array-kJnEuTzT-BYXN1zbF.js";import"./factory-DVePsLAQ-D6i81khj.js";import{t as f}from"./disabled-CTTZKNPl-Cn2RlmzU.js";import"./label-BJf95S0B-BpNCSI_H.js";import"./label-CnOLrr0w-BM-UImKz.js";import"./variant-quote-7bJL1WOX-D7tVh6DU.js";import{t as p}from"./clsx-COFh-Vc8-DWAop4cA.js";import{n as m,r as h,t as g}from"./element-interaction-DORv36BQ-BSHBQDXV.js";import"./block-bem-7gjd36jd-BeZLCyPU.js";import"./component-DdAp6OUz-D8icN5KO.js";import"./component-BdFrEcaV-DLOGT0xP.js";import{t as _}from"./i18n-B_vSiQA9-D2rqnZ6v.js";import{n as v}from"./component-Dxb12TYY-BdGwUGgu.js";import"./variant-class-name-2os1V9lQ-B9g7OQWw.js";import"./component-BcrPTqDX-DEkuFZkr.js";import{t as y}from"./component-Ca8xWJ9s-DyLQu-l8.js";import"./align-Dm5aJHmk-wHtwd2H4.js";import{i as b,t as x}from"./behavior-Cxx5cP6o-CZdBAMai.js";import{t as S}from"./label-with-expert-slot-Dh4zRZEb-7prlcNKC.js";import{a as C,c as w,d as T,f as E,l as D,o as O,p as k,r as A,s as j,t as M,u as N}from"./variant-BBnlDNla-DWMK4cDW.js";import{t as P}from"./name-CeY6Ud0E-DcbsuDGj.js";import{a as F,n as I,r as L,t as R}from"./api-BdaEnkJl-v7Fs24Re.js";import"./controller-BDOsSDm9-BbpA1IAd.js";import"./aria-details-ChvorFzb-BPmapOg-.js";import"./associated.controller-ExNQqx6z-Dqp3_-8I.js";import{t as z}from"./base-BMm49PnG-eFqrxwwM.js";import{n as B,r as V,t as H}from"./controller-C_ksnS1D-DW2xMz8I.js";var U={required:[S],optional:[M,A,R,I,L,F,C,f,O,b,j,S,w,P,V,D,N,T,E,k]},W=t=>{let r=new B,i=new x(u.stateLess),a=g(),d,p=l(U);delete p.tabIndex;let m=e=>{f.apply(e,e=>{p.disabled=e})};m(t.disabled),O.apply(t.hideLabel,e=>{p.hideLabel=e}),N.apply(t.icons,e=>{p.icons=e}),j.apply(!1,e=>{p.inline=e}),E.apply(`top`,e=>{p.tooltipAlign=e}),F.apply(`button`,e=>{p.type=e}),S.apply(t.label,e=>{p.label=e}),V.apply(t.popoverAlign,e=>{p.popoverAlign=e,r.setAlign(e)}),k.apply(e(`buttonVariantDefault`,t.getFlagHost())??`normal`,e=>{p.variant=e}),p.ariaDescriptionId=s(),p.popoverId=c(`popover`);let h=e=>{let n=t.getEventTarget();n&&o(n,e)},_=e=>{t.setOpen(e.newState===`open`)};return p.handleClick=e=>{e.stopPropagation(),i.hideTooltip(),r.setShow(!t.getOpen()),h(n.click)},p.handleMouseDown=()=>h(n.mousedown),p.handleFocus=()=>h(n.focus),p.handleBlur=()=>h(n.blur),p.refButton=e=>{a(e),r.setTriggerElement(e)},p.refPopover=e=>{d=e,r.setPopoverElementRef(e)},p.refTooltip=i.setTooltipElementRef,i.componentWillLoad({label:p.label,align:p.tooltipAlign}),{getFcProps:()=>Object.assign(Object.assign({},p),{popoverOpen:t.getOpen()}),hide:()=>r.setShow(!1),setDisabled:m,syncListeners:()=>{a.el&&i.syncListeners(void 0,a.el,!0),d?.addEventListener(`toggle`,_)},destroy:()=>{i.destroy(),d&&=(d.removeEventListener(`toggle`,_),void 0),r.destroy()}}},G=r.forBlock(`kol-split-button`),K=G(`button`),q=G(`horizontal-line`),J=G(`root`),Y=G(`secondary-button`),X=e=>{let{buttonProps:t,buttonWrapperClass:n,class:r,dropdownProps:a,refDropdown:o}=e;return i(v,{block:`kol-split-button`,class:r},i(`div`,{class:J},i(`div`,{class:p(K,n)},i(y,Object.assign({},t))),i(`div`,{class:q}),i(`div`,{class:Y,ref:o},i(H,Object.assign({},a)))))},Z=`@charset "UTF-8";
