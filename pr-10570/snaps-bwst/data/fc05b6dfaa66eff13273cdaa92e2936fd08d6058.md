...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 448px, received 127px by 3544px. 26760 pixels (ratio 0.01 of all image pixels) are different.
