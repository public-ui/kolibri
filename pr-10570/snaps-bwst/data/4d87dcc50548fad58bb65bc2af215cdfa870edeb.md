...
- Name: theme-snapshots.spec.js >> snapshot for popover-button/inline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 181px, received 140px by 1207px. 10568 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: snapshot-for-popover-button-inline.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-popover-button-inline.png)" with timeout 10000ms
...
```yaml
- main [ref=e1]:
  - heading "popover-button inline" [level=1] [ref=e2]
  - generic:
    - paragraph:
      - text: Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur aut dolore dolores itaque praesentium reprehenderit sed voluptatum! Exercitationem ipsa magni maiores modi, placeat quas quos reprehenderit rerum sit veniam vitae.
