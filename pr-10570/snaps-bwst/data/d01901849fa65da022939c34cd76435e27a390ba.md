...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 1196px, received 476px by 3374px. 469421 pixels (ratio 0.18 of all image pixels) are different.
