...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 495px, received 232px by 2959px. 23493 pixels (ratio 0.01 of all image pixels) are different.
...
- main [ref=e1]:
  ...
  - figure [ref=e3]:
    - generic: Avian carriers can provide high delay.
```
