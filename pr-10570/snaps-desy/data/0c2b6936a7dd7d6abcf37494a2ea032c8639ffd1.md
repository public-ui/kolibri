...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 246px, received 56px by 1788px. 6358 pixels (ratio 0.01 of all image pixels) are different.
...
- main [ref=e1]:
  ...
  - generic:
    - generic:
      - tablist "Regular tabs":
        - tab "First tab" [selected] [ref=e4] [cursor=pointer]
        - tab "Second Tab" [ref=e9] [cursor=pointer]
        - tab "Disabled Tab" [disabled] [ref=e14]
        - tab "Last tab" [ref=e19] [cursor=pointer]
      - generic:
        - tabpanel "First tab":
          - generic: Contents of Tab 1
  - generic:
    - generic:
      - tablist "Tabs with icons":
        - tab "First tab" [selected] [ref=e24] [cursor=pointer]:
          - generic [ref=e26]:
            - generic [ref=e27]: 
            - generic [ref=e28]: First tab
        - tab "Second Tab" [ref=e30] [cursor=pointer]:
          - generic [ref=e32]:
            - generic [ref=e33]: 
            - generic [ref=e34]: Second Tab
        - tab "Disabled Tab" [disabled] [ref=e36]:
          - generic [ref=e38]:
            - generic [ref=e39]: 
            - generic [ref=e40]: Disabled Tab
        - tab "Last tab" [ref=e42] [cursor=pointer]:
          - generic [ref=e44]:
            - generic [ref=e45]: 
            - generic [ref=e46]: Last tab
      - generic:
        - tabpanel "First tab":
          - generic: Contents of Tab 1
```
