...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 1240px, received 483px by 3832px. 480800 pixels (ratio 0.16 of all image pixels) are different.
