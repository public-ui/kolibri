...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 264px, received 97px by 1574px. 47062 pixels (ratio 0.04 of all image pixels) are different.

  Snapshot: snapshot-for-button-variants.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-button-variants.png)" with timeout 10000ms
...
```yaml
- main [ref=e1]:
  - heading "button variants" [level=1] [ref=e2]
  - generic [ref=e3]:
    - heading "All theme exclusive button variants" [level=2] [ref=e5]
    - generic [ref=e6]:
      - button "primary" [ref=e9] [cursor=pointer]:
        - generic [ref=e11]:
          - generic [ref=e12]: 
      ...
      - button "tertiary" [ref=e23] [cursor=pointer]:
        - generic [ref=e25]:
          - generic [ref=e26]: 
          - generic [ref=e27]: tertiary
      - button "primary x-small" [ref=e30] [cursor=pointer]:
        - generic [ref=e32]:
          - generic [ref=e33]: 
          - generic [ref=e34]: primary x-small
      - button "secondary x-small" [ref=e37] [cursor=pointer]:
        - generic [ref=e39]:
          - generic [ref=e40]: 
          - generic [ref=e41]: secondary x-small
      - button "tertiary x-small" [ref=e44] [cursor=pointer]:
        - generic [ref=e46]:
          - generic [ref=e47]: 
          - generic [ref=e48]: tertiary x-small
    - generic [ref=e49]:
      - button "primary" [ref=e52] [cursor=pointer]:
        - generic [ref=e53]: 
      - button "secondary" [ref=e58] [cursor=pointer]:
        - generic [ref=e59]: 
      - button "tertiary" [ref=e64] [cursor=pointer]:
        - generic [ref=e65]: 
      - button "primary x-small" [ref=e70] [cursor=pointer]:
        - generic [ref=e71]: 
      - button "secondary x-small" [ref=e76] [cursor=pointer]:
        - generic [ref=e77]: 
      - button "tertiary x-small" [ref=e82] [cursor=pointer]:
        - generic [ref=e83]: 
```
