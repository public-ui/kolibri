...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 272px, received 128px by 2648px. 21470 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: snapshot-for-quote-basic-zoom.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-quote-basic-zoom.png)" with timeout 10000ms
...
```yaml
- main [ref=e1]:
  - heading "quote basic" [level=1] [ref=e2]
  - figure [ref=e3]:
    - generic [ref=e4]: Avian carriers can provide high delay.
```
