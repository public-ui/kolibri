...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 351px, received 60px by 9635px. 34706 pixels (ratio 0.01 of all image pixels) are different.
  ...
  - generic:
    - generic:
      ...
      - generic:
        - generic:
          - generic:
            - generic [ref=e4] [cursor=pointer]: Text input (auto grow)
