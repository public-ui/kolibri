import{c as e,r as t,s as n}from"./index-DcDxiC7I-BazlblmZ.js";import{g as r,i}from"./index-CJBrRNUE.js";import{t as a}from"./base-web-component--IgFgz37-CZuvR3uB.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{h as o,p as s,r as c}from"./variant-quote-DeZzWGZI-JlEh0XD9.js";import"./label-BDgaSpkn-ZFrSsPvw.js";import{t as l}from"./label-C-mcs1F6-WrxA0zwP.js";import{t as u}from"./href-D5Num3co-B_6eZD0e.js";var d=c(`quote`,``,s),f={optional:[l,o],required:[u,d]},p=i.forBlock(`kol-quote`),m=p(`blockquote`),h=p(`cite`),g=p(`figcaption`),_=p(`quote`),v=e=>{let{href:t,label:i,quote:a,variant:o}=e,s=a===``,c=p({[o]:!0});return n(`figure`,{class:c},o===`block`?n(`blockquote`,{class:m,cite:t},a,n(`span`,{"aria-hidden":s?void 0:`true`,hidden:!s},n(`slot`,{name:`expert`}))):n(`q`,{class:_,cite:t},a,n(`span`,{"aria-hidden":s?void 0:`true`,hidden:!s},n(`slot`,{name:`expert`}))),typeof i==`string`&&i.length>0&&n(`figcaption`,{class:g},n(`cite`,{class:h},n(r,{_href:t,_label:i,_target:`_blank`}))))},y=`@charset "UTF-8";
