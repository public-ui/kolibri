import{R as e,a as t,c as n,d as r,o as i,s as a,u as o}from"./index-CBow2j3g.js";import{i as s,n as c}from"./dev.utils-DEzQ6pd0-DzMDnI4-.js";import{n as l,t as u}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as d}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./_Uint8Array-kJnEuTzT-BYXN1zbF.js";import"./factory-CKsVyhxp-BBGA2HaT.js";import{t as f}from"./disabled-BP9IEDNp-CpGo45a5.js";import"./label-BJf95S0B-CcGbjiab.js";import"./label-D4UOJ7Gl-BEZz5O8X.js";import"./variant-quote-BuuHXxAx-Bz7bILRn.js";import{t as p}from"./clsx-COFh-Vc8-DWAop4cA.js";import{n as m,r as h,t as g}from"./element-interaction-DkGO5I_0-CYEJb_Yf.js";import"./block-bem-Cc5GQw76-viWRxd26.js";import"./component-Dib1yv-s-D9UbBs6B.js";import"./component-BrwWvnCR-BLJXmVkD.js";import{t as _}from"./i18n-B_vSiQA9-CuLme5ym.js";import{n as v}from"./component-CBf61K-R-C0BGN8J6.js";import"./variant-class-name-2os1V9lQ-BTSBTayQ.js";import"./component-CehFKwpO-Cof7m2OM.js";import{t as y}from"./component-BL3mU5LI-Dg9qkCyG.js";import"./align-Dm5aJHmk-HHjzn1u0.js";import{i as b,t as x}from"./behavior-GAvSQtAH-CpKF8AMw.js";import{t as S}from"./label-with-expert-slot-vOy1wI53-DjTYv8yI.js";import{a as C,c as w,d as T,f as E,l as D,o as O,p as k,r as A,s as j,t as M,u as N}from"./variant-BaK6DDl2-DqNL-4UJ.js";import{t as P}from"./name-CCoa6nld-DMV8X6MZ.js";import{a as F,n as I,r as L,t as R}from"./api-cgs7rKZj-Dc3DITij.js";import"./controller-CoYxGNMm-D1gHFsqF.js";import"./aria-details-ChvorFzb-CxeaWR2b.js";import"./associated.controller-D13xvviF-D7fJjL3A.js";import{t as z}from"./base-DreiVPs6-C7zjmO_L.js";import{n as B,r as V,t as H}from"./controller-B2XPsjyl-B7cj23Mk.js";var U={required:[S],optional:[M,A,R,I,L,F,C,f,O,b,j,S,w,P,V,D,N,T,E,k]},W=t=>{let r=new B,i=new x(u.stateLess),a=g(),d,p=l(U);delete p.tabIndex;let m=e=>{f.apply(e,e=>{p.disabled=e})};m(t.disabled),O.apply(t.hideLabel,e=>{p.hideLabel=e}),N.apply(t.icons,e=>{p.icons=e}),j.apply(!1,e=>{p.inline=e}),E.apply(`top`,e=>{p.tooltipAlign=e}),F.apply(`button`,e=>{p.type=e}),S.apply(t.label,e=>{p.label=e}),V.apply(t.popoverAlign,e=>{p.popoverAlign=e,r.setAlign(e)}),k.apply(e(`buttonVariantDefault`,t.getFlagHost())??`normal`,e=>{p.variant=e}),p.ariaDescriptionId=s(),p.popoverId=c(`popover`);let h=e=>{let n=t.getEventTarget();n&&o(n,e)},_=e=>{t.setOpen(e.newState===`open`)};return p.handleClick=e=>{e.stopPropagation(),i.hideTooltip(),r.setShow(!t.getOpen()),h(n.click)},p.handleMouseDown=()=>h(n.mousedown),p.handleFocus=()=>h(n.focus),p.handleBlur=()=>h(n.blur),p.refButton=e=>{a(e),r.setTriggerElement(e)},p.refPopover=e=>{d=e,r.setPopoverElementRef(e)},p.refTooltip=i.setTooltipElementRef,i.componentWillLoad({label:p.label,align:p.tooltipAlign}),{getFcProps:()=>Object.assign(Object.assign({},p),{popoverOpen:t.getOpen()}),hide:()=>r.setShow(!1),setDisabled:m,syncListeners:()=>{a.el&&i.syncListeners(void 0,a.el,!0),d?.addEventListener(`toggle`,_)},destroy:()=>{i.destroy(),d&&=(d.removeEventListener(`toggle`,_),void 0),r.destroy()}}},G=r.forBlock(`kol-split-button`),K=G(`button`),q=G(`horizontal-line`),J=G(`root`),Y=G(`secondary-button`),X=e=>{let{buttonProps:t,buttonWrapperClass:n,class:r,dropdownProps:a,refDropdown:o}=e;return i(v,{block:`kol-split-button`,class:r},i(`div`,{class:J},i(`div`,{class:p(K,n)},i(y,Object.assign({},t))),i(`div`,{class:q}),i(`div`,{class:Y,ref:o},i(H,Object.assign({},a)))))},Z=`@charset "UTF-8";
