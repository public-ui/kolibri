import{V as e,a as t,bt as n,c as r,d as i,ht as a,o,r as s,s as c,u as l}from"./index-BNq4MTZg.js";import{i as u}from"./dev.utils-DEzQ6pd0-Dzk96LBl.js";import{n as d,t as f}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as p}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./_Uint8Array-kJnEuTzT-BYXN1zbF.js";import{a as m,r as h}from"./factory-CKsVyhxp-CJlRfgmB.js";import{t as g}from"./disabled-BP9IEDNp--9pDZrkd.js";import"./label-BJf95S0B-4kcjkn5K.js";import"./label-D4UOJ7Gl-CfvAs-an.js";import"./variant-quote-BuuHXxAx-C-_7CeVL.js";import{r as _,t as v}from"./element-interaction-DkGO5I_0-CYEJb_Yf.js";import"./block-bem-Cc5GQw76-Dpf73xsZ.js";import"./component-Dib1yv-s-qGeACS7_.js";import"./component-BrwWvnCR-DsVzIrz2.js";import"./i18n-B_vSiQA9-e7ti2r4-.js";import"./component-CBf61K-R-DoLdKQpU.js";import"./variant-class-name-2os1V9lQ-DB0EG9h0.js";import"./component-CehFKwpO-dpra0_oQ.js";import"./align-Dm5aJHmk-DF0wg9r0.js";import{t as y}from"./behavior-GAvSQtAH-BjndT_Fa.js";import{t as b}from"./label-with-expert-slot-vOy1wI53-Dbzof-UO.js";import{d as x,f as S,l as C,n as w,o as T,r as E,s as D,t as O,u as k}from"./variant-BaK6DDl2-B2jxhn8k.js";import{t as A}from"./href-bww1hpGS-8BlhMkbU.js";import{t as j}from"./link-target-BoGygasH-uKr5K-Hz.js";import{a as M,i as N,n as P,o as F,t as I}from"./api-CSxdqdSs-g2eNuD4c.js";import{t as L}from"./access-and-short-key-ijzCZfHm-Dx5Q-CAn.js";import{n as R,t as z}from"./unique-nav-labels-DWO8JUzQ-BKVkUg0S.js";var B=h(`links`,[],e=>m(e),e=>e.every(e=>typeof e==`object`&&(typeof e._href==`string`||typeof e._label==`string`)),{hints:(e,t)=>n(`KolSkipNav`,t.length)}),V={required:[B,b]},H=i.forBlock(`kol-skip-nav`),U=H(),W=H(`list`),G=H(`list-item`),K=({label:e,linkItems:t})=>o(`nav`,{class:U,"aria-label":e},o(`ul`,{class:W},t.map((e,t)=>o(`li`,{class:G,key:t},o(I,Object.assign({},e.fcProps)))))),q=(e,t)=>{let n=new y(f.stateLess),i=v(),o=d(F);delete o.tabIndex;let s=(e,t)=>e.apply(t,t=>{o[e.propName]=t});s(O,e._accessKey),s(w,e._ariaControls),s(P,e._ariaCurrentValue),s(E,e._ariaDescription),s(g,e._disabled),s(N,e._download),s(T,e._hideLabel),s(A,e._href),s(k,e._icons),s(D,e._inline??!0),s(b,e._label),s(M,e._on),s(C,e._shortKey),typeof e._tabIndex==`number`&&s(x,e._tabIndex),s(j,e._target),s(S,e._tooltipAlign),L(e._accessKey,e._shortKey),n.componentWillLoad({label:(()=>{let e=o.label;if(typeof e==`string`&&e.length>0)return e;let t=o.href;return typeof t==`string`?t:``})(),align:o.tooltipAlign}),o.ariaCurrent=``,o.ariaDescriptionId=u(),o.expertSlot=e._label===``;let c=()=>typeof o.href==`string`?o.href:``;return o.handleAnchorClick=e=>{if(n.hideTooltip(),o.disabled===!0){e.preventDefault();return}let s=c(),u=o.on;typeof u?.onClick==`function`&&(a(e,i.el),u.onClick(e,s));let d=t();d&&l(d,r.click,s)},o.refAnchor=e=>{i(e)},o.refTooltip=n.setTooltipElementRef,{fcProps:o,getAnchor:()=>i.el,syncTooltipListeners:()=>{i.el&&n.syncListeners(void 0,i.el,!0)},destroy:()=>{n.destroy()}}},J=`@charset "UTF-8";
