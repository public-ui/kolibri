import{a as e,c as t,d as n,ht as r,o as i,r as a,s as o,u as s}from"./index-BNq4MTZg.js";import{i as c,n as l}from"./dev.utils-DEzQ6pd0-Dzk96LBl.js";import{n as u,t as d}from"./base-web-component--IgFgz37-CZuvR3uB.js";import"./_Uint8Array-kJnEuTzT-BYXN1zbF.js";import{a as f,r as p}from"./factory-CKsVyhxp-CJlRfgmB.js";import"./disabled-BP9IEDNp--9pDZrkd.js";import"./variant-quote-BuuHXxAx-C-_7CeVL.js";import"./Heading-BStLDIxc-B76qSUDo.js";import"./block-bem-Cc5GQw76-Dpf73xsZ.js";import"./component-Dib1yv-s-qGeACS7_.js";import"./component-BrwWvnCR-DsVzIrz2.js";import{t as m}from"./i18n-B_vSiQA9-e7ti2r4-.js";import"./component-CBf61K-R-DoLdKQpU.js";import"./variant-class-name-2os1V9lQ-DB0EG9h0.js";import"./component-CehFKwpO-dpra0_oQ.js";import"./component-BL3mU5LI-DXEZ17uD.js";import{t as h}from"./component-DypIgFjc-C6ZegqB9.js";import"./align-Dm5aJHmk-DF0wg9r0.js";import{t as g}from"./label-with-expert-slot-vOy1wI53-Dbzof-UO.js";import"./variant-BaK6DDl2-B2jxhn8k.js";import{t as _}from"./href-bww1hpGS-8BlhMkbU.js";import"./link-target-BoGygasH-uKr5K-Hz.js";import{a as v,o as y,t as b}from"./api-CSxdqdSs-g2eNuD4c.js";function x(e){if(typeof e!=`object`||!e)return!1;let{message:t,selector:n}=e;return typeof t==`string`&&(typeof n==`string`||typeof n==`function`)}var S=p(`errorList`,[],e=>f(e),e=>e.every(x));function C(e){if(typeof e==`object`&&e)return e;throw Error(`Invalid on callbacks: expected object, got ${typeof e}`)}var w=p(`on`,{},C);function T(e){if(typeof e==`boolean`||typeof e==`string`)return e;throw Error(`Invalid requiredText: expected boolean or string, got ${typeof e}`)}var E=p(`requiredText`,!0,T),D={optional:[S,w,E]},O=n.forBlock(`kol-form`),k=O(),A=O(`mandatory-fields-hint`),j=({handleReset:e,handleSubmit:t,requiredText:n})=>{let r=n===!0?m(`kol-form-description`):typeof n==`string`&&n.length>0?n:``;return i(`form`,{class:k,method:`post`,onSubmit:t,onReset:e,noValidate:!0},r.length>0&&i(`p`,{class:A},r),i(`slot`,null))},M=(e,t)=>{let n=u(y),i;return n.tabIndex=void 0,_.apply(``,e=>n.href=e),g.apply(e.message,e=>n.label=e),v.apply({onClick:typeof e.selector==`string`?()=>t(String(e.selector),e.options):e.selector},e=>n.on=e),n.ariaCurrent=``,n.ariaDescriptionId=c(),n.expertSlot=e.message===``,n.handleAnchorClick=e=>{let t=n.on?.onClick;typeof t==`function`&&(r(e,i),t(e,n.href))},n.refAnchor=e=>{i=e},n.refTooltip=()=>void 0,{fcProps:n,focus:e=>i?.focus(e)}},N=n.forBlock(`kol-form`),P=N(`alert`),F=N(`link`),I=({alertHeadingId:e,closerAriaDescriptionId:t,errorLinkItems:n})=>i(h,{alert:!1,class:P,closerAriaDescriptionId:t,handleCloserClick:()=>void 0,hasCloser:!1,headingId:e,label:m(`kol-error-list-message`),level:0,refCloserButton:()=>void 0,refCloserTooltip:()=>void 0,type:`error`,variant:`card`},i(`nav`,{"aria-label":m(`kol-error-list`)},i(`ul`,null,n.map((e,t)=>i(`li`,{key:t},i(`span`,{class:F},i(b,Object.assign({},e.fcProps)))))))),L=`@charset "UTF-8";
...
}`,R={behavior:`smooth`,block:`nearest`},z=250,B=class extends d{constructor(e){super(),o(this,e),this.alertHeadingId=l(`alert-heading`),this.closerAriaDescriptionId=c(),this.handleSubmit=e=>{e.preventDefault();let n=this.getRenderProp(`on`).onSubmit;typeof n==`function`&&n(e),this.host&&s(this.host,t.submit)},this.handleReset=e=>{e.preventDefault();let n=this.getRenderProp(`on`).onReset;typeof n==`function`&&n(e),this.host&&s(this.host,t.reset)},this.focusErrorTarget=(e,t)=>{let n=document.querySelector(e);n&&typeof n.focus==`function`&&n.focus(t??R)},this.errorLinkItems=[],this._requiredText=!0}componentWillLoad(){this.initRenderProps(D),this.watchErrorList(this._errorList),this.watchOn(this._on),this.watchRequiredText(this._requiredText)}async focusErrorList(e){setTimeout(()=>{var t;(t=this.errorLinkItems[0])==null||t.focus(e??R)},z)}render(){return i(a,{key:`1b5b3a897de76ee2e31e723ed266b4e221b02a2b`},this.errorLinkItems.length>0&&i(I,{key:`5a2e23fea9ca7d2d148b5212d8f43f518bf5e957`,alertHeadingId:this.alertHeadingId,closerAriaDescriptionId:this.closerAriaDescriptionId,errorLinkItems:this.errorLinkItems}),i(j,{key:`4a9735763e1f30c6104d61cffa5c8b5fe230ea6a`,errorList:this.getRenderProp(`errorList`),errorLinkItems:this.errorLinkItems,handleReset:this.handleReset,handleSubmit:this.handleSubmit,on:this.getRenderProp(`on`),requiredText:this.getRenderProp(`requiredText`)}))}watchErrorList(e){S.apply(e,e=>{this.setRenderProp(`errorList`,e),this.errorLinkItems=e.map(e=>M(e,this.focusErrorTarget))})}watchOn(e){w.apply(e,e=>this.setRenderProp(`on`,e))}watchRequiredText(e){E.apply(e,e=>this.setRenderProp(`requiredText`,e))}get host(){return e(this)}static get watchers(){return{_errorList:[`watchErrorList`],_on:[`watchOn`],_requiredText:[`watchRequiredText`]}}};B.style={default:L};export{B as kol_form};