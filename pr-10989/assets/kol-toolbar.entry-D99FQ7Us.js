import{G as e,R as t,T as n,_t as r,a as i,ct as a,o,s,ut as c,v as l}from"./index-B8CLGIlf.js";import{n as u}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{r as d}from"./label-BJf95S0B-Bty9-ygs.js";import{n as f,t as p}from"./element-focus-Cp994Rrk-BCxGGpIg.js";import{n as m,t as h}from"./element-click-CCljCb-a-Bw1_18r4.js";import{t as g}from"./orientation-CvnPk_j_-De0Bix5X.js";import{n as _}from"./keyboard-DNd73LVa-BCj4IeP3.js";var v=(t,n)=>{e(n,()=>{a(n,()=>{n===void 0&&(n=[]);try{n=c(n)}catch{}Array.isArray(n)&&n.every(e=>typeof e==`object`&&!!e)&&r(t,`_items`,n)})})},y=`@charset "UTF-8";
...
}`,b=class{constructor(e){s(this,e),this.state={_label:``,_items:[]},this.currentIndex=0,this.indexToElement=new Map,this.renderItem=(e,r)=>{let i=this.normalizeItem(e),a={key:r,class:`kol-toolbar__item`,_tabIndex:r===this.currentIndex&&!i?._disabled?0:-1,_inline:!1,_variant:t(`buttonVariantDefault`,this.host)??`normal`},s=e=>{e&&this.indexToElement.set(r,e)};return i.type===`link`?o(n,Object.assign({},a,i,{ref:s})):o(l,Object.assign({},a,i,{ref:s}))}}async focus(e){if(this.isCurrentItemDisabled())return;let t=this.indexToElement.get(this.currentIndex);if(t)return p(this.host,()=>f(t,e))}async click(){if(this.isCurrentItemDisabled())return;let e=this.indexToElement.get(this.currentIndex);if(e)return h(this.host,async()=>m(e))}isCurrentItemDisabled(){return this.state._items?.[this.currentIndex]?._disabled===!0}normalizeItem(e){let{_icons:t,_disabled:n}=e,r=u(e,[`_icons`,`_disabled`]);return Object.assign(Object.assign({},r),{_icons:t,_disabled:n})}render(){return o(`div`,{key:`703576042fc4fb3489b357383ef96b54a54db743`,class:`kol-toolbar kol-toolbar--orientation-${this.state._orientation}`,role:`toolbar`,"aria-label":this.state._label},this.state._items.map(this.renderItem))}validateLabel(e){d(this,e)}validateItems(e){v(this,e),this.indexToElement.clear(),this.setFirstEnabledItemIndex()}validateOrientation(e){g(this,e)}getCurrentToolbarItem(e){return typeof e==`number`?this.indexToElement.get(e):void 0}setFirstEnabledItemIndex(){this.currentIndex=this.state._items?.findIndex(e=>!e._disabled)}findNextEnabledItemIndex(e,t,n){let r=n+1;for(let n=1;n<=r;n++){let i=((e+t*n)%r+r)%r;if(!this.state._items?.[i]?._disabled)return i}}handleKeyDown(e){let t=e.code;if(![_.ArrowUp,_.ArrowDown,_.ArrowRight,_.ArrowLeft].includes(t))return;e.preventDefault();let n=(this._items?.length??0)-1;if(n<0)return;let r=this.currentIndex,i=t===_.ArrowUp||t===_.ArrowLeft?-1:1,a=this.findNextEnabledItemIndex(r,i,n);if(a===void 0||r===a)return;this.currentIndex=a;let o=this.getCurrentToolbarItem(a);this.host&&o?.focus()}handleFocusout(e){e.target===this.host&&this.setFirstEnabledItemIndex()}componentWillLoad(){this.validateLabel(this._label),this.validateItems(this._items),this.validateOrientation(this._orientation),this.setFirstEnabledItemIndex()}get host(){return i(this)}static get watchers(){return{_label:[`validateLabel`],_items:[`validateItems`],_orientation:[`validateOrientation`]}}};b.style={default:y};export{b as kol_toolbar};