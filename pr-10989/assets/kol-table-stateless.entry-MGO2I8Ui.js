import{c as e,o as t,s as n}from"./index-DcDxiC7I-MecBFiw5.js";import{S as r}from"./index-CMuSuLHh.js";import{t as i}from"./aria-labelledby-6-ki3akM-C6lJ0lQF.js";import{t as a}from"./aria-labelledby-D8sZtnnh-CN8eW6CS.js";var o=`@charset "UTF-8";
/*
...
}`,s=class{constructor(t){e(this,t),this.resolvedElements=[]}validateAriaLabelledby(e){this.syncExternalLabel(e)}syncExternalLabel(e){this.resolvedElements=a(this,this.host,this.internals,e)}componentWillLoad(){this.internals=i(this.host),this.syncExternalLabel(this._ariaLabelledby)}componentDidLoad(){this.resolvedElements.length||this.syncExternalLabel(this._ariaLabelledby)}render(){return n(r,{key:`fc7fdf9227713a84e7dd9d1fe84a173ea644948f`,externalLabelElements:this.resolvedElements,_data:this._data,_dataFoot:this._dataFoot,_fixedCols:this._fixedCols,_headers:this._headers?this._headers:this._headerCells,_label:this._label,_loading:this._loading,_on:this._on,_selection:this._selection,_hasSettingsMenu:this._hasSettingsMenu,_variant:this._variant})}get host(){return t(this)}static get watchers(){return{_ariaLabelledby:[`validateAriaLabelledby`]}}};s.style={default:o};export{s as kol_table_stateless};