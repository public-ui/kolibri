import{N as e,R as t,V as n,a as r,bt as i,c as a,d as o,ht as s,n as c,o as l,r as u,s as d,u as f}from"./index-KSMp7b7C.js";import{i as p}from"./dev.utils-DEzQ6pd0-KvwsFlMM.js";import{n as m,t as h}from"./base-web-component--IgFgz37-CZuvR3uB.js";import"./_Uint8Array-kJnEuTzT-BYXN1zbF.js";import{a as g,r as ee}from"./factory-CKsVyhxp--ZveyAAo.js";import{t as _}from"./disabled-BP9IEDNp-CgiStoNM.js";import"./label-BJf95S0B-DNSn6TOj.js";import"./label-D4UOJ7Gl-DWatNPeQ.js";import"./variant-quote-BuuHXxAx-WW76IvHI.js";import{t as v}from"./element-interaction-DkGO5I_0-CYEJb_Yf.js";import"./block-bem-Cc5GQw76-CZuvrOqj.js";import{t as y}from"./component-Dib1yv-s-DyWyWCyf.js";import"./component-BrwWvnCR-BTk5rAZb.js";import"./i18n-B_vSiQA9-D3LI81_Q.js";import"./component-CBf61K-R-CD42j7Gx.js";import"./variant-class-name-2os1V9lQ-DcwVvaPr.js";import"./component-CehFKwpO-BErTC8yn.js";import"./align-Dm5aJHmk-CdOWSPAK.js";import{t as b}from"./behavior-GAvSQtAH-DeSGy6zC.js";import{t as x}from"./label-with-expert-slot-vOy1wI53-Fw4RsW5u.js";import{d as S,f as C,l as w,n as T,o as E,r as D,s as O,t as k,u as A}from"./variant-BaK6DDl2-DkkPFcyE.js";import{t as j}from"./href-bww1hpGS-Dqzt4tGp.js";import{t as M}from"./link-target-BoGygasH-D3kxmWzf.js";import{a as N,i as P,n as F,o as I,t as te}from"./api-CSxdqdSs-BjjnV6us.js";import{t as L}from"./access-and-short-key-ijzCZfHm-Dx5Q-CAn.js";import{n as R,t as z}from"./unique-nav-labels-DWO8JUzQ-Dm_JY1Gb.js";var B=ee(`links`,[],e=>g(e),e=>e.every(e=>typeof e==`object`&&(typeof e._href==`string`||typeof e._label==`string`)),{hints:(e,t)=>i(`KolBreadcrumb`,t.length)}),V={required:[B,x]},H=o.forBlock(`kol-breadcrumb`),U=H(),W=H(`icon`),G=H(`link`),K=H(`list`),q=H(`list-element`),J=H(`list-element-span`),Y=H(`separator`),X=`kol-breadcrumb_icon`,Z=(e,t,n,r)=>{let i=r?t!==n:t<n-1;if(t===n&&!r)return l(c,null);let{link:a}=e;return l(`li`,{class:q,key:t},t===n?l(`span`,{class:J,"aria-current":`page`},a._hideLabel?l(y,{class:W,icons:typeof a._icons==`string`?a._icons:`kolicon-link`,label:a._label}):l(c,null,a._label)):l(`div`,{class:G},l(te,Object.assign({},e.fcProps))),i&&l(y,{class:Y,icons:`kolicon-chevron-right`,label:``}))},Q=({label:e,linkItems:t,showCurrentPage:n})=>{let r=t.length-1;return l(`nav`,{class:U,"aria-label":e},l(`ul`,{class:K},t.length===0&&l(`li`,null,l(y,{class:X,icons:`kolicon-house`,label:``}),`…`),t.map((e,t)=>Z(e,t,r,n))))},ne=(e,t)=>{let n=new b(h.stateLess),r=v(),i=m(I);delete i.tabIndex;let o=(e,t)=>e.apply(t,t=>{i[e.propName]=t});o(k,e._accessKey),o(T,e._ariaControls),o(F,e._ariaCurrentValue),o(D,e._ariaDescription),o(_,e._disabled),o(P,e._download),o(E,e._hideLabel),o(j,e._href),o(A,e._icons),o(O,e._inline??!1),o(x,e._label),o(N,e._on),o(w,e._shortKey),typeof e._tabIndex==`number`&&o(S,e._tabIndex),o(M,e._target),o(C,e._tooltipAlign),L(e._accessKey,e._shortKey),n.componentWillLoad({label:(()=>{let e=i.label;if(typeof e==`string`&&e.length>0)return e;let t=i.href;return typeof t==`string`?t:``})(),align:i.tooltipAlign}),i.ariaCurrent=``,i.ariaDescriptionId=p(),i.expertSlot=e._label===``;let c=()=>typeof i.href==`string`?i.href:``;return i.handleAnchorClick=e=>{if(n.hideTooltip(),i.disabled===!0){e.preventDefault();return}let o=c(),l=i.on;typeof l?.onClick==`function`&&(s(e,r.el),l.onClick(e,o));let u=t();u&&f(u,a.click,o)},i.refAnchor=e=>{r(e)},i.refTooltip=n.setTooltipElementRef,{link:e,fcProps:i,syncTooltipListeners:()=>{r.el&&n.syncListeners(void 0,r.el,!0)},destroy:()=>{n.destroy()}}},re=`@charset "UTF-8";
/*
