import{Ct as e,Dt as t,Et as n,T as r,a as i,c as a,o,r as s,s as c,u as l}from"./index-D3Xw80oJ.js";import{n as u}from"./dev.utils-CNUPRHqD-DPsqyNaK.js";import"./Heading-Cdhxan2n-1ZG-sjs-.js";import{t as d}from"./i18n-BQHGsG9x-DHCKQ0L9.js";import"./component-Bd9wr9Ey-boSnQs71.js";import"./component-_umTbs5q-Cc1_j_vZ.js";import{t as f}from"./component-GoSJntEy-CY4Eg0Jg.js";var p=(e,n)=>{t(e,`errorList`,e=>Array.isArray(e)&&e.find(e=>typeof e!=`string`&&typeof e!=`function`)===void 0,new Set([`string`,`function`]),n)},m=`@charset "UTF-8";
...
}`,h=class{constructor(e){c(this,e),this.scrollOptionsFallback={behavior:`smooth`,block:`nearest`},this.translateErrorListMessage=d(`kol-error-list-message`),this.translateErrorList=d(`kol-error-list`),this.translateFormDescription=d(`kol-form-description`),this.alertHeadingId=u(`alert-heading`),this.onSubmit=e=>{var t;e.preventDefault(),typeof this.state._on?.onSubmit==`function`&&((t=this.state._on)==null||t.onSubmit(e)),this.host&&l(this.host,a.submit)},this.onReset=e=>{var t;e.preventDefault(),typeof this.state._on?.onReset==`function`&&((t=this.state._on)==null||t.onReset(e)),this.host&&l(this.host,a.reset)},this.handleLinkClick=(e,t)=>{let n=document.querySelector(e);n&&typeof n.focus==`function`&&n.focus(t||this.scrollOptionsFallback)},this.setBlockElement=e=>this.errorListBlock=e,this.setFirstLinkElement=e=>this.errorListFirstLink=e,this._requiredText=!0,this.state={}}renderErrorList(e){return o(f,{alert:!1,class:`kol-form__alert`,handleCloserClick:()=>void 0,hasCloser:!1,headingId:this.alertHeadingId,label:this.translateErrorListMessage,level:0,ref:this.setBlockElement,type:`error`,variant:`card`},o(`nav`,{"aria-label":this.translateErrorList},o(`ul`,null,e?.map((e,t)=>o(`li`,{key:t},o(r,{class:`kol-form__link`,_href:``,_label:e.message,_on:{onClick:typeof e.selector==`string`?()=>this.handleLinkClick(String(e.selector),e.options):e.selector},ref:t===0?this.setFirstLinkElement:void 0}))))))}renderFormElement(){return o(`form`,{class:`kol-form`,method:`post`,onSubmit:this.onSubmit,onReset:this.onReset,noValidate:!0},this.state._requiredText===!0?o(`p`,{class:`kol-form__mandatory-fields-hint`},this.translateFormDescription):typeof this.state._requiredText==`string`&&this.state._requiredText.length>0?o(`p`,{class:`kol-form__mandatory-fields-hint`},this.state._requiredText):null,o(`slot`,null))}render(){let e=Array.isArray(this._errorList)&&this._errorList.length>0;return o(s,{key:`8974f7707bb34df6b54ee0d22a1a16bb2fa0c797`},e&&this.renderErrorList(this._errorList),this.renderFormElement())}scrollToErrorList(e){setTimeout(()=>{var t;(t=this.errorListFirstLink?.querySelector(`a`))==null||t.focus(e||this.scrollOptionsFallback)},250)}async focusErrorList(e){return this.scrollToErrorList(e),Promise.resolve()}validateOn(e){typeof e==`object`&&e&&(this.state=Object.assign(Object.assign({},this.state),{_on:e}))}validateRequiredText(t){typeof t==`boolean`?e(this,`_requiredText`,t):n(this,`_requiredText`,t)}validateErrorList(e){p(this,e)}componentWillLoad(){this.validateOn(this._on),this.validateRequiredText(this._requiredText),this.validateErrorList(this._errorList)}get host(){return i(this)}static get watchers(){return{_on:[`validateOn`],_requiredText:[`validateRequiredText`],_errorList:[`validateErrorList`]}}};h.style={default:m};export{h as kol_form};