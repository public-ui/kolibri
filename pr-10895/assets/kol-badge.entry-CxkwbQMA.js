import{B as e,J as t,_t as n,a as r,c as i,d as a,ft as o,o as s,r as c,s as l,u,ut as d}from"./index-Cxg43Fjy.js";import{i as f,n as p}from"./dev.utils-3xMYti16-DCCbv64J.js";import{n as m,t as h}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as g}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./label-DxrksC9L-BxFBugjB.js";import{r as _,t as v}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import"./_Uint8Array-kJHDjtoP-CTkgs_0o.js";import{n as y}from"./normalizers-BTuLU0xQ-CSzw3-PG.js";import"./label-BRtDUcg7-CLhkMVI-.js";import"./variant-quote-BgjHx4jL-BU53Yukf.js";import"./component-BaNPpdT4-DlT1u5ws.js";import"./variant-class-name-BFZvmFM_-BdmQuO1X.js";import"./component-BypIj6e1-B56U-ZhM.js";import{t as b}from"./component-DKkAwtJX-WeJrUVWw.js";import{t as x}from"./component-C44Zom-Q-yGxEHfwH.js";import"./align-floating-elements-D6Kc-f8P-bt9etlX6.js";import"./align-DglmQnOH-DM2BsrUi.js";import{n as S,t as ee}from"./behavior-CvJgV1Qn-kUyUDODt.js";import"./index-YF9sPUm--DeVpi63v.js";import{t as C}from"./color-D4YNuNPn-BMj5cz9u.js";import{t as w}from"./label-with-expert-slot-CQKOFO6E-CrwgHPJZ.js";import{a as T,c as E,d as D,f as O,i as k,l as A,m as j,n as M,o as N,p as P,r as F,s as I,t as L,u as R}from"./variant-BPc0tEN8-CTdZnBHc.js";import{t as z}from"./name-D2Tq7xMg-X4ZA_WOw.js";import{a as B,i as V,n as H,r as U}from"./api-DAf210q8-BzUT04it.js";function W(e){let t=typeof e==`string`?o(e):e;if(typeof t==`object`&&t)return t;throw Error(`Invalid smart button: ${typeof e}`)}var G=y(`smartButton`,{_label:``},W),K={required:[w],optional:[C,G,D]},q=a.forBlock(`kol-badge`),J=q(`label`),Y=q(`smart-button`),X=e=>{let{ariaDescriptionId:t,color:n,handleBlur:r,handleClick:i,handleFocus:a,handleMouseDown:o,icons:c,label:l,labelId:u,refSmartButton:d,refTooltip:f,smartButton:p,smartButtonProps:m}=e,h=typeof p==`object`&&!!p&&m!==void 0;return s(`div`,{class:q({"has-smart-button":h}),style:{backgroundColor:n.backgroundColor,color:n.foregroundColor}},s(b,{class:J,id:h?u:void 0,allowMarkdown:!0,icons:c,label:l}),h&&s(x,Object.assign({},m,{class:Y,ariaDescriptionId:t,handleBlur:r,handleClick:i,handleFocus:a,handleMouseDown:o,refButton:d,refTooltip:f})),s(`br`,null))},Z={disabled:!1,hideLabel:!1,inline:!1,tooltipAlign:`top`,type:`button`};function Q(t,n){let r=m(V),i=e=>t=>{r[e]=t};return w.apply(t._label,i(`label`)),L.apply(t._accessKey,i(`accessKey`)),M.apply(t._ariaControls,i(`ariaControls`)),F.apply(t._ariaDescription,i(`ariaDescription`)),k.apply(t._ariaExpanded,i(`ariaExpanded`)),H.apply(t._ariaSelected,i(`ariaSelected`)),U.apply(t._on,i(`on`)),B.apply(t._type??Z.type,i(`type`)),T.apply(t._customClass,i(`customClass`)),N.apply(t._disabled??Z.disabled,i(`disabled`)),I.apply(t._hideLabel??Z.hideLabel,i(`hideLabel`)),S.apply(t._id,i(`id`)),E.apply(t._inline??Z.inline,i(`inline`)),A.apply(t._role,i(`role`)),z.apply(t._name,i(`name`)),R.apply(t._shortKey,i(`shortKey`)),D.apply(t._icons,i(`icons`)),P.apply(t._tooltipAlign??Z.tooltipAlign,i(`tooltipAlign`)),typeof t._tabIndex==`number`?O.apply(t._tabIndex,i(`tabIndex`)):r.tabIndex=void 0,j.apply(t._variant??e(`buttonVariantDefault`,n)??`normal`,i(`variant`)),r}var te=`@charset "UTF-8";
