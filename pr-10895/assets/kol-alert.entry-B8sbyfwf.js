import{a as e,c as t,o as n,r,s as i,u as a}from"./index-ru7ZL5be.js";import{n as o}from"./dev.utils-CNUPRHqD-Decch7Xr.js";import{t as s}from"./base-web-component--IgFgz37-CZuvR3uB.js";import"./Heading-Cdhxan2n-DqpqXcXY.js";import"./label-BIbocgr4-Dm8-9sm-.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import"./_Uint8Array-kJHDjtoP-CTkgs_0o.js";import"./normalizers-hh3gIHIc-Bv8F7zRE.js";import{n as c}from"./level-D4HxwTOD-DJROtlim.js";import{t as l}from"./label-Bv1uvWne-CmWR9785.js";import"./variant-quote-CuMVeQCf-Bq5I3Itq.js";import{a as u,i as d,n as f,r as p,t as m}from"./api-C0bl8R2r-cu_NoDKu.js";import"./i18n-BQHGsG9x-DyrsdCkN.js";import"./component-Bd9wr9Ey-DYzUlF-7.js";import"./component-_umTbs5q-CUT672N7.js";import{t as h}from"./component-GoSJntEy-BfNEpPPL.js";var g=`@charset "UTF-8";
/*
...
}`,_=class extends s{constructor(e){super(),i(this,e),this.handleAlertTimeout=()=>{this.watchAlert(!1)},this.handleCloserClick=()=>{var e,n;(n=(e=this._on)?.onClose)==null||n.call(e,new Event(`Close`)),this.host&&a(this.host,t.close)},this.headingId=o(`alert-heading`),this._alert=!1,this._hasCloser=!1,this._level=0,this._type=`default`,this._variant=`msg`}componentWillLoad(){this.initRenderProps(f),this.watchAlert(this._alert),this.watchHasCloser(this._hasCloser),this.watchLabel(this._label),this.watchLevel(this._level),this.watchType(this._type),this.watchVariant(this._variant)}disconnectedCallback(){this.syncAlertEffects(!1)}render(){return n(r,{key:`a5804ddbba5a9cf21156e22662701967e275ac9d`},n(h,{key:`075bef5f014b6c44588809c2d22cddedddae5f88`,alert:this.getRenderProp(`alert`),handleCloserClick:this.handleCloserClick,hasCloser:this.getRenderProp(`hasCloser`),headingId:this.headingId,label:this.getRenderProp(`label`),level:this.getRenderProp(`level`),type:this.getRenderProp(`type`),variant:this.getRenderProp(`variant`)},n(`slot`,{key:`99f17f6bc8504f60a462706e08713504145ea28c`})))}watchAlert(e){m.apply(e,e=>{this.setRenderProp(`alert`,e),this.syncAlertEffects(e)})}watchHasCloser(e){u.apply(e,e=>this.setRenderProp(`hasCloser`,e))}watchLabel(e){l.apply(e,e=>this.setRenderProp(`label`,e))}watchLevel(e){c.apply(e,e=>this.setRenderProp(`level`,e))}watchType(e){p.apply(e,e=>this.setRenderProp(`type`,e))}watchVariant(e){d.apply(e,e=>this.setRenderProp(`variant`,e))}syncAlertEffects(e){if(clearTimeout(this.alertTimeout),e){if(typeof navigator<`u`&&typeof navigator.vibrate==`function`){let e=navigator.userActivation;if((e?.isActive||e?.hasBeenActive)&&matchMedia(`(any-pointer: coarse)`).matches)try{navigator.vibrate([100,75,100,75,100])}catch{}}this.alertTimeout=setTimeout(()=>this.handleAlertTimeout(),1e4)}}get host(){return e(this)}static get watchers(){return{_alert:[`watchAlert`],_hasCloser:[`watchHasCloser`],_label:[`watchLabel`],_level:[`watchLevel`],_type:[`watchType`],_variant:[`watchVariant`]}}};_.style={default:g};export{_ as kol_alert};