import{Dt as e,Tt as t,_ as n,a as r,kt as i,o as a,s as o}from"./index-Dbc2-hox.js";import{n as s}from"./dev.utils-VBoUDs60-CnWzMFKT.js";import"./base-web-component-BT6jbe_v-Vp21XLG3.js";import{t as c}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{t as l}from"./clsx-COFh-Vc8-DWAop4cA.js";import"./Heading-RSuzeiY3-B27mow6Z.js";import"./disabled-tmA090zy-B-1KLu8n.js";import"./label-43VWIjgW-B2-1fh8q.js";import{r as u,t as d}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import"./_Uint8Array-kJHDjtoP-CTkgs_0o.js";import"./normalizers-DwZ6RXph-DUeo9xCN.js";import{t as f}from"./i18n-DppON4Nc-Cu0lZrB5.js";import{t as p}from"./component-Cbqr3hDZ-BAc4G0Xf.js";import"./Alert-BrThwIQc-ButUCgLr.js";import"./label-B4jhdB3Q-DcWWbTzX.js";import"./variant-quote-B7A0-G7t-CrgrTlOZ.js";import"./component-C2H99wHM-CmvB-bzH.js";import"./icons-CxQkiQI9-CO-FtcZX.js";import"./access-and-short-key-BVBIy6Bf-C7UHyYNW.js";import"./hide-label-Dqs_owkY-B8FquU-Q.js";import"./align-CMg-YzqB-O4XxzDL2.js";import"./tooltip-align-BCIioKJU-CvMZa66-.js";import"./variant-class-name-9vl8S3-X-CLm8c3zu.js";import"./component-CJNiKkbd-Eh6q6Okb.js";import"./align-floating-elements-DjivLyM2-DmHOKVGP.js";import"./controller-CpsgJ1zD-kb0k98zr.js";import"./aria-details-Bm1c0NRK-D9Jnqk5d.js";import"./associated.controller-B22ATw25-ClD9y-n8.js";import{s as m,t as h}from"./FormFieldStateWrapper-B42l6zXe-Daqrld14.js";import{n as g,t as _}from"./controller-icon-2XQ_1N28-BGRtUhs7.js";import"./Input-i4ObCLuq-D2EJOAhB.js";import{t as v}from"./InputStateWrapper-bwkYJ-Z5-jF4UqGMb.js";import{n as y,t as b}from"./CustomSuggestionsOptionsGroup-BOmzHi-1-DENpLzby.js";import{t as x}from"./placeholder-S0DMyipR-D8w9JLC5.js";import{t as S}from"./required-16oQLXa0-Ceqya8Wr.js";import"./orientation-HCX-2i6Q-COoPmoHH.js";import{i as C,r as w}from"./controller-CL0cL-eC-DTdMOnLH.js";var T=class extends g{constructor(e,t,n){super(e,t,n),this.keyOptionMap=new Map,this.afterPatchOptions=(e,t,n,r)=>{r===`_value`&&this.setFormAssociatedValue(e)},this.beforePatchOptions=(e,t)=>{let n=t.has(`_options`)?t.get(`_options`):this.component.state._options;Array.isArray(n)&&n.length>0&&(this.keyOptionMap.clear(),w(this.keyOptionMap,n))},this.component=e}validateOptions(e){C(this.component,e,{hooks:{afterPatch:this.afterPatchOptions,beforePatch:this.beforePatchOptions}})}validateRequired(e){S(this.component,e)}validateValue(e){i(this.component,`_value`,e=>e!==void 0,new Set([`StencilUnknown`]),e)}validatePlaceholder(e){x(this.component,e)}validateHasClearButton(e){t(this.component,`_hasClearButton`,e)}validateRows(t){e(this.component,`_rows`,t)}componentWillLoad(){super.componentWillLoad(),this.validateOptions(this.component._options),this.validateRequired(this.component._required),this.validateValue(this.component._value),this.validatePlaceholder(this.component._placeholder),this.validateHasClearButton(this.component._hasClearButton),this.validateRows(this.component._rows)}},E=`@charset "UTF-8";
/*
