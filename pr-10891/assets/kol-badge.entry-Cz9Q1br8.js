import{B as e,J as t,_t as n,a as r,c as i,d as a,ft as o,o as s,r as c,s as l,u,ut as d}from"./index-BhpN9IG1.js";import{i as f,n as p}from"./dev.utils-vg27Ig_f-CCUts3LL.js";import{n as m,t as h}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as g}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{r as _}from"./factory-B7al9c0P-ZJeL_U3f.js";import{n as v}from"./component-IRt2Zci8-Db7na7uL.js";import"./label-DQP9fH5r-CFMv1Fal.js";import"./label-DikRjObP-RC3h36YB.js";import"./variant-quote-Xi3QThkZ-CqhHY41e.js";import{r as y,t as b}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./component-CdtnrvwM-CHJHuMWK.js";import"./index-BSUMLd4d-0_VKqz1f.js";import{t as x}from"./color-3J1i6Qh_-BVHgrQVV.js";import{t as S}from"./label-with-expert-slot-yLJ9lNSE-DDfyKW3r.js";import"./align-lbYx-vvu-BGxzFa2J.js";import{a as ee,c as C,d as w,f as T,i as E,l as D,m as O,n as k,o as A,p as j,r as M,s as N,u as P}from"./component-edKOcQE6-DKd3EQbr.js";import"./variant-class-name-BG-fhwg4-BSvyT2Tk.js";import{t as F}from"./component-Dc39clZd-CR9Ktf8X.js";import"./component-B7e4Ihjz-6dgd5i67.js";import"./align-floating-elements-BG_1SL89-MXQipuB-.js";import{n as I,t as L}from"./behavior-Ddi5tHOA-Bh7cXYlm.js";import{t as R}from"./name-BGYUJ2mn-Ka6dGxFY.js";import{a as z,i as B,o as V,r as H,t as U}from"./api-VG-DKpeK-Cw_H0TIZ.js";function W(e){let t=typeof e==`string`?o(e):e;if(typeof t==`object`&&t)return t;throw Error(`Invalid smart button: ${typeof e}`)}var G=_(`smartButton`,{_label:``},W),K={required:[S],optional:[x,G,w]},q=a.forBlock(`kol-badge`),J=q(`label`),Y=q(`smart-button`),X=e=>{let{ariaDescriptionId:t,color:n,handleBlur:r,handleClick:i,handleFocus:a,handleMouseDown:o,icons:c,label:l,labelId:u,refSmartButton:d,refTooltip:f,smartButton:p,smartButtonProps:m}=e,h=typeof p==`object`&&!!p&&m!==void 0;return s(`div`,{class:q({"has-smart-button":h}),style:{backgroundColor:n.backgroundColor,color:n.foregroundColor}},s(F,{class:J,id:h?u:void 0,allowMarkdown:!0,icons:c,label:l}),h&&s(U,Object.assign({},m,{class:Y,ariaDescriptionId:t,handleBlur:r,handleClick:i,handleFocus:a,handleMouseDown:o,refButton:d,refTooltip:f})),s(`br`,null))},Z={disabled:!1,hideLabel:!1,inline:!1,tooltipAlign:`top`,type:`button`};function Q(t,n){let r=m(z),i=e=>t=>{r[e]=t};return S.apply(t._label,i(`label`)),k.apply(t._accessKey,i(`accessKey`)),M.apply(t._ariaControls,i(`ariaControls`)),E.apply(t._ariaDescription,i(`ariaDescription`)),ee.apply(t._ariaExpanded,i(`ariaExpanded`)),H.apply(t._ariaSelected,i(`ariaSelected`)),B.apply(t._on,i(`on`)),V.apply(t._type??Z.type,i(`type`)),A.apply(t._customClass,i(`customClass`)),v.apply(t._disabled??Z.disabled,i(`disabled`)),N.apply(t._hideLabel??Z.hideLabel,i(`hideLabel`)),I.apply(t._id,i(`id`)),C.apply(t._inline??Z.inline,i(`inline`)),D.apply(t._role,i(`role`)),R.apply(t._name,i(`name`)),P.apply(t._shortKey,i(`shortKey`)),w.apply(t._icons,i(`icons`)),j.apply(t._tooltipAlign??Z.tooltipAlign,i(`tooltipAlign`)),typeof t._tabIndex==`number`?T.apply(t._tabIndex,i(`tabIndex`)):r.tabIndex=void 0,O.apply(t._variant??e(`buttonVariantDefault`,n)??`normal`,i(`variant`)),r}var te=`@charset "UTF-8";
