import{a as e,o as t,r as n,s as r}from"./index-BX76haOZ.js";import{n as i,t as a}from"./dev.utils-Cy5tSBQV-BC24Hsp1.js";import{t as o}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as s}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import"./_Uint8Array-kJHDjtoP-CTkgs_0o.js";import"./normalizers-B13uuknd-BD8gJPcr.js";import{n as c}from"./level-C0LQ3ZGO-DISB74et.js";import{n as l}from"./component-CB6lm1k9-NjCsFebh.js";import"./label-C7_p2_ej-D7ua4k0C.js";import{t as u}from"./label-ByXXlNQU-B39URLn-.js";import"./variant-quote-ChP9Iq6P-Ca2Tgx_c.js";import"./Heading-Bo-BUYpa-DFm7BONK.js";import{a as d,i as f,n as p,r as m,t as h}from"./toggle-BNtYcS7E-BuJes8QN.js";import{n as g,r as _,t as v}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";var y=`@charset "UTF-8";
...
}`,b=class extends o{constructor(e){super(),r(this,e),this.detailsId=i(`details`),this.ctaRef=v(),this.controlId=a(this.detailsId,`control`),this.headingId=a(this.detailsId,`heading`),this.handleToggle=f({getHost:()=>this.host,getOn:()=>this.getRenderProp(`on`),toggleOpen:()=>(this._open=!this._open,!!this._open)}),this._disabled=!1,this._level=0,this._open=!1}componentWillLoad(){this.initRenderProps(m),this.watchDisabled(this._disabled),this.watchLabel(this._label),this.watchLevel(this._level),this.watchOn(this._on),this.watchOpen(this._open)}async focus(e){}async click(){}render(){return t(n,{key:`962d623536764a18bb269a0c414330c8e321a9e6`},t(h,{key:`2d9b3d0f4389fd97f9ac459e4a694b46aed1ac7b`,block:`kol-details`,contentClass:`indented-text`,controlId:this.controlId,disabled:this.getRenderProp(`disabled`),handleToggle:this.handleToggle,headingId:this.headingId,icons:`kolicon-chevron-right`,label:this.getRenderProp(`label`),level:this.getRenderProp(`level`),on:this.getRenderProp(`on`),open:this.getRenderProp(`open`),refHeadingButton:this.ctaRef},t(`slot`,{key:`47937a774fc7d0054e0165308459c1220cf6c52a`})))}watchDisabled(e){l.apply(e,e=>this.setRenderProp(`disabled`,e))}watchLabel(e){u.apply(e,e=>this.setRenderProp(`label`,e))}watchLevel(e){c.apply(e,e=>this.setRenderProp(`level`,e))}watchOn(e){p.apply(e,e=>this.setRenderProp(`on`,e))}watchOpen(e){d.apply(e,e=>this.setRenderProp(`open`,e))}get host(){return e(this)}static get watchers(){return{_disabled:[`watchDisabled`],_label:[`watchLabel`],_level:[`watchLevel`],_on:[`watchOn`],_open:[`watchOpen`]}}};s([_(`ctaRef`)],b.prototype,`focus`,null),s([g(`ctaRef`)],b.prototype,`click`,null),b.style={default:y};export{b as kol_details};