import{t as e}from"./tooltip-open-tracking-D3tCiiGP-CEtn2Gu2.js";import{a as t,c as n,o as r,r as i,s as a,u as o,y as s,yt as c}from"./index-C9MBQi08.js";import{n as l}from"./dev.utils-Cy5tSBQV-BlUoBbsd.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import"./_Uint8Array-kJHDjtoP-CTkgs_0o.js";import"./normalizers-B13uuknd-BuiG5PSD.js";import"./level-C0LQ3ZGO-B-pFxp7R.js";import{t as u}from"./clsx-COFh-Vc8-DWAop4cA.js";import{r as d}from"./label-C7_p2_ej-Ct-_L413.js";import{t as f}from"./has-closer-hez_STQj-BG970uQW.js";import{t as p}from"./validation-C60EkMcS-CROisa8v.js";import{n as m}from"./align-DUWI6s56-Cj5RljsA.js";import{n as h,t as g}from"./scroll-lock-BWDLIEQu-CykNS5eN.js";import{t as _}from"./open-DKPLgHeT-DGPuWYPC.js";var v=`@charset "UTF-8";
/*
...
}`,y=class{constructor(t){a(this,t),this.cardHeadingId=l(`drawer-heading`),this.isModal=!0,this._cardOn={onClose:()=>void this.close()},this.getWrapperRef=e=>this.dialogWrapperElement=e,this.getRef=e=>{this.dialogElement=e,setTimeout(()=>{this.openOrCloseBasedOnState()})},this._hasCloser=!1,this._level=0,this.state={_label:``,_open:!1,_align:`left`},this.handleCancelEvent=t=>{var r,i;e(t),!t.defaultPrevented&&((i=(r=this.state._on)?.onCancel)==null||i.call(r,t),!t.defaultPrevented&&this.host&&!o(this.host,n.cancel)&&t.preventDefault())},this.handleClose=()=>{h(this),(async()=>{await this.close(),this.handleCloseDialog()})()},this.handleAnimationEnd=e=>{var t,n;e.animationName.includes(`slideOut`)&&((n=(t=this.dialogElement)?.close)==null||n.call(t))}}async show(e=!1){var t,r,i,a,s,c;this.dialogElement?.open||(this.isModal=e,this.state=Object.assign(Object.assign({},this.state),{_open:!0}),e?((r=(t=this.dialogElement)?.showModal)==null||r.call(t),this.dialogElement&&g(this)):(a=(i=this.dialogElement)?.show)==null||a.call(i),(c=(s=this._on)?.onToggle)==null||c.call(s,!0),this.host&&o(this.host,n.toggle))}showModal(){return this.show(!0)}open(){return this.show(!1)}async close(){var e,t;this.state=Object.assign(Object.assign({},this.state),{_open:!1});let n=this.dialogWrapperElement;n&&window.getComputedStyle(n).animationName===`none`&&((t=(e=this.dialogElement)?.close)==null||t.call(e))}renderDialogContent(){let e=this.state._align;return r(s,{ref:this.getWrapperRef,class:u(`kol-drawer__wrapper`,`kol-drawer__wrapper--${e}`,{"kol-drawer__wrapper--open":this.state._open,"kol-drawer__wrapper--is-closing":this.state._open===!1}),_hasCloser:this.state._hasCloser,_headingId:this.cardHeadingId,_label:this.state._label,_level:this._level,_on:this._cardOn},r(`div`,{class:`kol-drawer__content`},r(`slot`,null)))}render(){return r(i,{key:`a8eea7556c5c1c6c541b4269147ea2fd3884895a`,class:`kol-drawer`},r(`dialog`,{key:`83bd14f8d4616d252fe12fe1ea546b5fa4fc31da`,"aria-labelledby":this.cardHeadingId,"aria-modal":this.isModal?`true`:`false`,class:`kol-drawer__dialog`,onCancel:this.handleCancelEvent,ref:this.getRef},this.renderDialogContent()))}validateLabel(e){d(this,e,{required:!0})}validateAlign(e){m(this,e)}validateHasCloser(e){f(this,e)}validateLevel(e){p(this,e)}validateOpen(e){typeof e==`boolean`&&(_(this,e),this.dialogElement&&this.openOrCloseBasedOnState())}async openOrCloseBasedOnState(){this.state._open?await this.show(this.isModal):await this.close()}validateOn(e){if(typeof e==`object`&&e){let t={};typeof e.onCancel==`function`&&(t.onCancel=e.onCancel),typeof e.onClose==`function`&&(t.onClose=e.onClose),typeof e.onToggle==`function`&&(t.onToggle=e.onToggle),c(this,`_on`,t)}}handleCloseDialog(){var e,t,r,i;(t=(e=this._on)?.onClose)==null||t.call(e),(i=(r=this._on)?.onToggle)==null||i.call(r,!1),this.host&&(o(this.host,n.close),o(this.host,n.toggle))}componentDidLoad(){var e,t;(e=this.dialogElement)==null||e.addEventListener(`animationend`,this.handleAnimationEnd),(t=this.dialogElement)==null||t.addEventListener(`close`,this.handleClose)}disconnectedCallback(){var e,t;(e=this.dialogElement)==null||e.removeEventListener(`animationend`,this.handleAnimationEnd),(t=this.dialogElement)==null||t.removeEventListener(`close`,this.handleClose),h(this)}componentWillLoad(){this.validateAlign(this._align),this.validateHasCloser(this._hasCloser),this.validateLabel(this._label),this.validateOpen(this._open),this.validateLevel(this._level),this.validateOn(this._on)}get host(){return t(this)}static get watchers(){return{_label:[`validateLabel`],_align:[`validateAlign`],_hasCloser:[`validateHasCloser`],_level:[`validateLevel`],_open:[`validateOpen`],_on:[`validateOn`]}}};y.style={default:v};export{y as kol_drawer};