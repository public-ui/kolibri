import{B as e,J as t,_t as n,a as r,c as i,d as a,ft as o,o as s,r as c,s as l,u,ut as d}from"./index-BVUTw2ir.js";import{i as f,n as p}from"./dev.utils-3xMYti16-C2O_W8Wa.js";import{n as m,t as h}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as g}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./label-DxrksC9L-D7596nHv.js";import{r as _,t as v}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{n as y}from"./normalizers-DEevvNbZ-CuQqIapD.js";import"./component-BypIj6e1-Dtxr-WRF.js";import"./index-YF9sPUm--DDKmrf2A.js";import{t as b}from"./color-CeyCa7cR-DXqelCPJ.js";import"./label-De6GKT_4-2vKR-Y8Y.js";import"./variant-quote-JfuelQ4I-CrEjulJr.js";import{t as x}from"./label-with-expert-slot-pcKVBAqt-yxqPlFoz.js";import"./align-DglmQnOH-DutcgT1V.js";import{a as S,c as ee,d as C,f as w,g as T,h as E,i as D,l as O,m as k,o as A,p as j,r as M,s as N,u as P}from"./component-CY6SGsbj-ChulL5od.js";import"./variant-class-name-BFZvmFM_-k3geODn5.js";import{t as F}from"./component-DfYcdhVm-DOkcqE_T.js";import"./component-CCDgZC9S-BLKhkqBX.js";import"./align-floating-elements-D6Kc-f8P-b0h-ER3y.js";import{n as I,t as L}from"./behavior-opTsLlOg-Vvs9vEmm.js";import{t as R}from"./name-BOMzcWdF-C9UhCnW8.js";import{a as z,i as B,o as V,r as H,t as U}from"./api-DDoxU-Gp-rdMtTvdR.js";function W(e){let t=typeof e==`string`?o(e):e;if(typeof t==`object`&&t)return t;throw Error(`Invalid smart button: ${typeof e}`)}var G=y(`smartButton`,{_label:``},W),K={required:[x],optional:[b,G,j]},q=a.forBlock(`kol-badge`),J=q(`label`),Y=q(`smart-button`),X=e=>{let{ariaDescriptionId:t,color:n,handleBlur:r,handleClick:i,handleFocus:a,handleMouseDown:o,icons:c,label:l,labelId:u,refSmartButton:d,refTooltip:f,smartButton:p,smartButtonProps:m}=e,h=typeof p==`object`&&!!p&&m!==void 0;return s(`div`,{class:q({"has-smart-button":h}),style:{backgroundColor:n.backgroundColor,color:n.foregroundColor}},s(F,{class:J,id:h?u:void 0,allowMarkdown:!0,icons:c,label:l}),h&&s(U,Object.assign({},m,{class:Y,ariaDescriptionId:t,handleBlur:r,handleClick:i,handleFocus:a,handleMouseDown:o,refButton:d,refTooltip:f})),s(`br`,null))},Z={disabled:!1,hideLabel:!1,inline:!1,tooltipAlign:`top`,type:`button`};function Q(t,n){let r=m(z),i=e=>t=>{r[e]=t};return x.apply(t._label,i(`label`)),M.apply(t._accessKey,i(`accessKey`)),D.apply(t._ariaControls,i(`ariaControls`)),S.apply(t._ariaDescription,i(`ariaDescription`)),A.apply(t._ariaExpanded,i(`ariaExpanded`)),H.apply(t._ariaSelected,i(`ariaSelected`)),B.apply(t._on,i(`on`)),V.apply(t._type??Z.type,i(`type`)),N.apply(t._customClass,i(`customClass`)),ee.apply(t._disabled??Z.disabled,i(`disabled`)),O.apply(t._hideLabel??Z.hideLabel,i(`hideLabel`)),I.apply(t._id,i(`id`)),P.apply(t._inline??Z.inline,i(`inline`)),C.apply(t._role,i(`role`)),R.apply(t._name,i(`name`)),w.apply(t._shortKey,i(`shortKey`)),j.apply(t._icons,i(`icons`)),E.apply(t._tooltipAlign??Z.tooltipAlign,i(`tooltipAlign`)),typeof t._tabIndex==`number`?k.apply(t._tabIndex,i(`tabIndex`)):r.tabIndex=void 0,T.apply(t._variant??e(`buttonVariantDefault`,n)??`normal`,i(`variant`)),r}var te=`@charset "UTF-8";
