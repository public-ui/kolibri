import{o as e,r as t,s as n}from"./index-BeKetKBb.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import"./_Uint8Array-kJHDjtoP-CTkgs_0o.js";import{a as r,n as i,o as a}from"./normalizers-B5NKuJgN-K6YqfPgr.js";import{t as o}from"./label-BT-6lb8r-hXARrJlt.js";import{t as s}from"./base-web-component-CArCAUxk-Pm6ogzRJ.js";import{t as c}from"./base-controller-CXhqh4cR-BNzx0WwK.js";import{t as l}from"./i18n-CFuSxM6N-C4zopFdM.js";import{n as u,r as d,t as f}from"./value-number-clamped-eznLHU11-DCZHyAoq.js";var p=i(`high`,0,r),m=i(`low`,0,r),h=i(`min`,0,r),g=i(`optimum`,0,r),_=[`horizontal`,`vertical`],v=i(`orientation`,`horizontal`,e=>{let t=a(e);if(_.includes(t))return t;throw Error(`Invalid orientation: ${t}`)}),y=i(`value`,0,r,e=>e>=0);function b(e,t,n,r,i,a){let o=r??t,s=i??n;if(a===void 0)return e>=o&&e<=s?`optimum`:`suboptimal`;let c=e<o,l=e>s,u=!c&&!l;return a<o?c?`optimum`:u?`suboptimal`:`critical`:a>s?l?`optimum`:u?`suboptimal`:`critical`:u?`optimum`:`suboptimal`}var x=t=>{let{high:n,label:r,low:i,max:a,min:o,optimum:s,orientation:c,unit:u,value:d}=t,f=c===`vertical`,p=u===`%`?Math.round((d-o)/(a-o)*100):d,m=b(d,o,a,i,n,s),h=i!==void 0||n!==void 0,g=h?l(`kol-meter-state-${m}`):``,_=a.toString().length>o.toString().length?a.toString().length+`ch`:o.toString().length+`ch`;return e(`div`,{class:{"kol-meter":!0,"kol-meter--vertical":f}},e(`div`,{class:`kol-meter__bar`},e(`div`,{class:`kol-meter__bar-label`},r,h&&e(`span`,{class:`kol-meter__bar-state kol-meter__bar-state--${m}`},` – `,g)),e(`div`,{class:`kol-meter__bar-track`},e(`meter`,{"aria-label":r,high:n,low:i,max:a,min:o,optimum:s,value:d})),e(`span`,{class:`kol-meter__value-unit`},e(`span`,{class:`kol-meter__value`,style:{"min-width":_}},p),e(`span`,{class:`kol-meter__unit`},u))))},S={optional:[h,v,d],required:[o,u,y]},C=class extends c{constructor(e){super(e,S),this.meterData={high:void 0,low:void 0,optimum:void 0}}componentWillLoad(e){let{high:t,label:n,low:r,max:i,min:a,optimum:o,orientation:s,unit:c,value:l}=e;this.watchHigh(t),this.watchLabel(n),this.watchLow(r),this.watchMax(i),this.watchMin(a),this.watchOptimum(o),this.watchOrientation(s),this.watchUnit(c),this.watchValue(l)}getMeterData(){return this.meterData}watchHigh(e){e===void 0?this.meterData.high=void 0:p.apply(e,e=>{this.meterData.high=e})}watchLabel(e){o.apply(e,e=>{this.setRenderProp(`label`,e)})}watchLow(e){e===void 0?this.meterData.low=void 0:m.apply(e,e=>{this.meterData.low=e})}watchMax(e){u.apply(e,e=>{this.setRenderProp(`max`,e),this.watchValue(this.getRawProp(`value`))})}watchMin(e){h.apply(e,e=>{this.setRenderProp(`min`,e),this.watchValue(this.getRawProp(`value`))})}watchOptimum(e){e===void 0?this.meterData.optimum=void 0:g.apply(e,e=>{this.meterData.optimum=e})}watchOrientation(e){v.apply(e,e=>{this.setRenderProp(`orientation`,e)})}watchUnit(e){d.apply(e,e=>{this.setRenderProp(`unit`,e)})}watchValue(e){this.setRawProp(`value`,e),f.apply(e,e=>{this.setRenderProp(`value`,e)},{min:this.getRenderProp(`min`),max:this.getRenderProp(`max`)})}},w=`/* forward the rem function */
/*
...
//# sourceMappingURL=kol-meter.entry-rxR5sXW6.js.map