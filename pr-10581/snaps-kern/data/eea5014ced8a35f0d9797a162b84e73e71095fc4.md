...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    - generic [ref=e8]:
      - generic [ref=e9] [cursor=pointer]: Textarea with soft max length
    ...
    - generic [ref=e20]:
      - generic [ref=e21] [cursor=pointer]: Textarea with max length
      - textbox "Textarea with max length" [ref=e28]: Lorem Ipsum
      - generic [ref=e29]: You can enter up to 20 characters
    - generic [ref=e31]:
      - generic [ref=e32] [cursor=pointer]: Textarea with max length and counter
      - textbox "Textarea with max length and counter" [ref=e39]: Lorem Ipsum
      - generic [ref=e40]:
        - text: 11/20 characters
        - generic [ref=e41]: 11 of 20 characters
    - generic [ref=e43]:
      - generic [ref=e44] [cursor=pointer]: Textarea with counter
      - textbox "Textarea with counter" [ref=e51]: Lorem Ipsum
      - generic [ref=e52]:
        - text: 11 characters
        - generic [ref=e53]: 11 characters
```
