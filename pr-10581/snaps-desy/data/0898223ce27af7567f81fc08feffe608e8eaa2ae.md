...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 132px, received 32px by 80px. 14008 pixels (ratio 0.14 of all image pixels) are different.
...
- main [ref=e1]:
  ...
  - generic:
    ...
    - generic:
      - img "Avatar of Elke Mustermann"
    - generic:
      - img "Avatar of Marianne"
    - generic:
      - img "Avatar of Christian"
```
