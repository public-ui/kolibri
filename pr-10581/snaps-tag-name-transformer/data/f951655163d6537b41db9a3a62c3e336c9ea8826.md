...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 197px, received 76px by 8234px. 12948 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: snapshot-for-quote-block.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-quote-block.png)" with timeout 10000ms
