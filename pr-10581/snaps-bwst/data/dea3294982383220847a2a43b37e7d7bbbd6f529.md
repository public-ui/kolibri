...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 182px, received 39px by 171px. 22505 pixels (ratio 0.16 of all image pixels) are different.
...
```yaml
- main [ref=e1]:
  - heading "avatar size" [level=1] [ref=e2]
  - generic:
    - generic:
      - img "Avatar of Elke Mustermann"
    - img "Avatar of Marianne" [ref=e3]:
      - generic [ref=e4]: M
    - img "Avatar of Christian" [ref=e5]:
      - generic [ref=e6]: C
    - generic:
      - img "Avatar of Elke Mustermann"
    - generic:
