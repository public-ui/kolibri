...
<html lang="de" dir="ltr">
	<head>
		...
		<script type="module">
			import { register } from 'https://esm.sh/@public-ui/components@1.6.0-rc.0';
			import { defineCustomElements } from 'https://esm.sh/@public-ui/components@1.6.0-rc.0/dist/loader';
			import { ITZBund } from 'https://esm.sh/@public-ui/themes@1.6.0-rc.0';
	...
	"html.customData": ["https://esm.sh/@public-ui/components@1.6.0-rc.0/vscode-custom-data.json"]
}`
				.replace(/</g, '&#60;')
				.replace(/>/g, '&#62;')}</code>
		</pre>
