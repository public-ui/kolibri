...
| ------------------- | --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- | ----------- |
| `_abbr`             | `_abbr`   | <span style="color:red">**[DEPRECATED]**</span> Verwende stattdessen das Property \_org.<br/><br/>Deprecated: Gibt die Abkürzung eines Ministeriums, eines Amts oder einer Bundesanstalt an. | `Bundesamt \| Bundesanstalt \| Bundesministerium \| undefined` | `undefined` |
