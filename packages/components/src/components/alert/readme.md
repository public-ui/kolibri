...
Bei der Nutzung eines Screenreaders wird beim Lesen des Icons zusätzlich der Titel mitgelesen.
...
<br>
Falsch: Label = "Fehler: Füllen Sie das Feld aus." -> Ausgabe: Fehler - Fehler: Füllen ie das Feld aus
