...
| `_type`               | `_type`    | <span style="color:red">**[DEPRECATED]**</span> will be removed in v2, use \_variant<br/><br/>Defines which variant should be used for presentation. | `"bar" \| "cycle" \| "cycle-label-value" \| "cycle-value-label" \| undefined` | `undefined` |
