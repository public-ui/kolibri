...
export class KolTableStateless implements TableStatelessAPI {
	...
	private getTableMinWidth(): string {
		const primaryHeaders = this.getPrimaryHeaders(this.state._headerCells).filter((cell) => cell.visible !== false);

		// Calculate width from vertical headers (first cell of each column)
