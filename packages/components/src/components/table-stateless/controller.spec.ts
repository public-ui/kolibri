...
describe('parseColumnWidth', () => {
	...
	describe('strings with units (parseInt extracts leading number)', () => {
		it('should parse "15ch" as 15 (parseInt extracts leading digits)', () => {
		...
		it('should parse "1.5rem" as 1 (parseInt truncates at decimal)', () => {
			expect(parseColumnWidth('1.5rem')).toBe(1);
		});
