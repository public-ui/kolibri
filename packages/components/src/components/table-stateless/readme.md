...
| `_minWidth`                 | `_min-width`    | <span style="color:red">**[DEPRECATED]**</span> This property is deprecated and will be removed in the next major release.<br/><br/>Defines the table min-width. | `string \| undefined`                                                                                                                                                                             | `undefined` |
