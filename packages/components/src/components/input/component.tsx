	...
	public render(): JSX.Element {
		...
		return (
			...
			>
				...
				>
					{this._icon?.left ? <kol-icon class="left-icon" _ariaLabel="" _icon={(this._icon.left as KoliBriCustomIcon).icon}></kol-icon> : <i />}
					...
					{this._icon?.right ? <kol-icon class="right-icon" _ariaLabel="" _icon={(this._icon.right as KoliBriCustomIcon).icon}></kol-icon> : <i />}
				</div>
				{hasError && (
