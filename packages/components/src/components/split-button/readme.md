...
| `_showDropdown`       | `_show-dropdown` | <span style="color:red">**[DEPRECATED]**</span> use \_show instead<br/><br/>Deprecated: Defines whether to show the dropdown menu.                                               | `boolean \| undefined`                                                                                                                                 | `false`     |
