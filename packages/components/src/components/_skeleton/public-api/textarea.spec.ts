...
/**
 * Pinned public API of `kol-textarea` (28 props, 3 methods),
 ...
 */
const KOL_TEXTAREA_PUBLIC_API: PublicApiContract = {
	click: {
		kind: 'method',
		type: '',
		required: false,
	...
	_adjustHeight: {
		...
		required: false,
		default: 'false',
		doc: 'Adjusts the height of the element to its content. @TODO: change back to AdjustHeightPropType after stencil #4663 has been resolved',
	},
	_ariaDetails: {
		kind: 'prop',
		type: 'AriaDetailsPropType',
		required: false,
		doc: 'References an external element by ID that provides accessible details for this textarea.',
	},
	_disabled: {
		kind: 'prop',
		type: 'boolean',
	...
	_resize: {
		...
		required: false,
		default: "'vertical'",
		doc: 'Defines whether and in which direction the size of the input can be changed by the user. (https://developer.mozilla.org/de/docs/Web/CSS/resize) In version 3 (v3), horizontal resizing is abolished. The corresponding property is then reduced to the properties `vertical` (default) and `none`.',
	},
	_rows: {
		kind: 'prop',
		type: 'RowsPropType',
