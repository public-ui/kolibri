...
/**
 * Pinned public API of `kol-combobox` (22 props, 3 methods),
 ...
 */
const KOL_COMBOBOX_PUBLIC_API: PublicApiContract = {
	click: {
		kind: 'method',
		type: '',
		required: false,
	...
	_ariaDetails: {
		...
		required: false,
		doc: 'References an external element by ID that provides accessible details for this combobox.',
	},
	_disabled: {
		kind: 'prop',
		type: 'boolean',
