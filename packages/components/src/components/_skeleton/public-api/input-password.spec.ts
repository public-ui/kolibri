...
/**
 * Pinned public API of `kol-input-password` (28 props, 3 methods),
 ...
 */
const KOL_INPUT_PASSWORD_PUBLIC_API: PublicApiContract = {
	click: {
		kind: 'method',
		type: '',
		required: false,
	...
	_visibilityToggle: {
		kind: 'prop',
		type: 'VisibilityTogglePropType',
		required: false,
		default: 'false',
		doc: 'Activates the show password button',
	},
};
