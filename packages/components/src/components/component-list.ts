...
import { KolButtonLinkTextSwitchWc } from './button-link-text-switch/component';
...
import { KolInputAdapterLeanup } from './input-adapter-leanup/shadow';
...
import { KolInputRadioGroup } from './input-radio-group/shadow';
...
import { KolToast } from './toast/shadow';
