...
| `_disabled`          | `_disabled`           | <span style="color:red">**[DEPRECATED]**</span> will be removed in v2<br/><br/>Deaktiviert das interaktive Element in der Komponente und erlaubt keine Interaktion mehr damit.                              | `boolean \| undefined`                                                              | `false`                                        |
