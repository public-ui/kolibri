...
import { KolSpanWc } from '../../core/component-names';
			...
			<Host>
				{this.state._label !== '' && (
					<div class="tooltip-floating" ref={this.catchTooltipElement}>
						...
						<KolSpanWc class="tooltip-area tooltip-content" id={this.state._id} _accessKey={this._accessKey} _label={this.state._label}></KolSpanWc>
					</div>
				)}
			</Host>
		);
