...
| `_hasCounter`         | `_has-counter`   | Shows the character count on the lower border of the input. TODO: Change type back to `HasCounterPropType` after Stencil#4663 has been resolved      | `boolean \| undefined`                                                                   | `undefined`  |
