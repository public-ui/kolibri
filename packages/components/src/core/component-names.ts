...
export let KolButtonLinkTextSwitchWcTag = 'kol-button-link-text-switch-wc' as const;
...
export let KolInputWcTag = 'kol-input-wc' as const;
...
export let KolToastTag = 'kol-toast' as const;
...
export const setCustomTagNames = (transformTagName: (tagName: string) => string) => {
	...
	KolButtonLinkTextSwitchWcTag = transformTagName(KolButtonLinkTextSwitchWcTag as string) as 'kol-button-link-text-switch-wc';
	...
	KolInputWcTag = transformTagName(KolInputWcTag as string) as 'kol-input-wc';
	...
	KolToastTag = transformTagName(KolToastTag as string) as 'kol-toast';
