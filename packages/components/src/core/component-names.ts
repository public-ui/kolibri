...
export let KolButtonLinkTextSwitchTag = 'kol-button-link-text-switch' as const;
...
export let KolSymbolTag = 'kol-symbol-wc' as const;
...
export const setCustomTagNames = (transformTagName: (tagName: string) => string) => {
	...
	KolButtonLinkTextSwitchTag = transformTagName(KolButtonLinkTextSwitchTag as string) as 'kol-button-link-text-switch';
	...
	KolSymbolTag = transformTagName(KolSymbolTag as string) as 'kol-symbol-wc';
