...
export namespace Components {
	...
	interface KolLink {
		...
		/**
		 * Setzt die sichtbare oder semantische Beschriftung der Komponente (z.B. Aria-Label, Label, Headline, Caption, Summary usw.).
		 * @deprecated @deprecated use _label instead
		 */
		_ariaLabel?: string;
		/**
		 * Gibt an, ob interaktive Element in der Komponente ausgewählt ist (z.B. role=tab). (https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Attributes/aria-selected)
...
export interface KolNavCustomEvent<T> extends CustomEvent<T> {
	detail: T;
	target: HTMLKolNavElement;
}
declare global {
...
declare namespace LocalJSX {
	...
	interface KolNav {
		 ...
		 */
		_variant?: KoliBriNavVariant;
		'onAria-current'?: (event: KolNavCustomEvent<unknown>) => void;
	}
	interface KolPagination {
		/**
		 * Gibt an, wie viele Seiten neben den am Rand liegenden Pfeil-Schaltern angezeigt werden sollen.
