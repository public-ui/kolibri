...
import type { PropAlternativeButtonLinkRole, PropButtonVariant, PropInline } from '../props';
...
type OptionalProps = Omit<OptionalButtonProps, keyof PropAlternativeButtonLinkRole | keyof PropButtonVariant> & PropInline; // _role is fixed to "link"
