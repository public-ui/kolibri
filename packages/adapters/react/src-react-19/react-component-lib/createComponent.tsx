...
import { attachProps, camelToDashCase, createForwardRef, dashToPascalCase, isCoveredByReact, mergeRefs, tagNameTransformer } from './utils';
...
export const createReactComponent = <PropType, ElementType extends HTMLStencilElement, ContextStateType = {}, ExpandedPropsTypes = {}>(
	...
	const ReactComponent = class extends Component<StencilReactInternalProps<ElementType>> {
