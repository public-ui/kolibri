...
export const BPA = KoliBri.createTheme('bpa', {
	GLOBAL:
		':host {--kolibri-border-color: unset;--kolibri-border-radius: unset;--kolibri-border-width: unset;--kolibri-color-error: unset;--kolibri-color-info: unset;--kolibri-color-success: unset;--kolibri-color-warning: unset;--kolibri-color-primary: unset;--kolibri-color-secondary: unset;--kolibri-color-normal: unset;--kolibri-color-danger: unset;--kolibri-color-ghost: unset;--kolibri-color-disabled: unset;--kolibri-color-text: unset;--kolibri-color-visited: unset;--kolibri-font-family: unset;--kolibri-font-size: unset;--kolibri-spacing: unset;}:host {--font-family-sans: "BundesSans Web, Arial, Helvetica, sans-serif";--font-family-serif: "BundesSerif Web, var(--kolibri-font-family-sans)";--font-family: "var(--kolibri-font-family-sans), Helvetica, sans-serif";--font-weight: 400;--font-weight-bold: bold;--color-white: #fff;--color-black: #111314;--color-blue: #0077b6;--color-darkblue: #004b76;--color-darkgray: #576164;}@keyframes blinker {50% {opacity: 0.25;}}:host {color: var(--color-black);}p {font-size: 1.5rem;}',
	'KOL-BUTTON':
		'a,:is(a, button) > kol-span-wc {padding: 0.625rem 1.125rem;font-family: var(--font);font-size: 1rem;line-height: 1.125rem;border: 1px solid var(--color-darkgray);border-radius: 0.125rem;transition: background-color 0.3s ease, border 0.3s ease, color 0.3s ease;}:is(a, button).ghost > kol-span-wc {border: none;}:is(a, button) > kol-span-wc > span {gap: 0.625rem;}:is(a, button) > kol-span-wc {background-color: var(--color-white);color: var(--color-black);}button > kol-span-wc kol-icon {color: var(--color-blue);}button:is(:hover, :focus) > kol-span-wc kol-icon {color: var(--color-white);}kol-link-wc > a:is(:hover, :focus) > kol-span-wc,button:is(:hover, :focus) > kol-span-wc {cursor: pointer;background-color: var(--color-blue);color: var(--color-white);}kol-link-wc > a:focus > kol-span-wc,button:focus > kol-span-wc {outline: 1px dotted var(--color-black);border: none;}kol-link-wc > a:focus,button:focus {outline: none;}',
	'KOL-INPUT-TEXT': '',
	'KOL-INPUT-PASSWORD': '',
	'KOL-INPUT-NUMBER': '',
	'KOL-INPUT-EMAIL': '',
