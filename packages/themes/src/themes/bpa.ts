...
export const BPA = KoliBri.createTheme('bpa', {
	...
	'KOL-INPUT-CHECKBOX':
		'kol-input {gap: 0.1rem 0.75rem;font-size: 1.375rem;}input[type="checkbox"]:focus {outline: var(--color-black) dotted 1px;outline-offset: 0.15rem;}.hint {font-size: 1.125rem;line-height: 1.125em;}.checkbox input[type="checkbox"] {border-width: 1px;padding: 0.125rem;width: 1.375rem;height: 1.375rem;}.checkbox input[type="checkbox"]:checked {background-color: var(--color-blue);border-color: var(--color-blue);padding: 0;}.checkbox input[type="checkbox"]:checked:before {left: 0.35rem;top: 45%;height: 0.6rem;width: 0.25rem;transform: rotate(45deg) translate(-50%, -50%);border-width: 0px 2px 2px 0px;}.checkbox input[type="checkbox"]:indeterminate:before {background-color: var(--color-blue);top: 0;left: 0;width: 100%;height: 100%;}kol-input > kol-alert {order: 3;}.switch input[type="checkbox"] {border-width: 1px;}.switch input[type="checkbox"]:before {background-color: var(--color-blue);height: 1.3em;width: 1.3em;}.button span[data-role="button"] {font-family: var(----font-family);font-size: 1rem;line-height: 1.125rem;padding: 0.625rem 1.125rem;border: 1px solid var(--color-darkgray);border-radius: 0.125rem;transition: background-color 0.3s ease, border 0.3s ease, color 0.3s ease;gap: 0.625rem;}.button span[data-role="button"] {background-color: var(--color-white);color: var(--color-black);}.button span[data-role="button"] kol-icon {color: var(--color-blue);}.button span[data-role="button"]:is(:hover, :focus) kol-icon {color: var(--color-white);}.button span[data-role="button"]:is(:hover, :focus) {cursor: pointer;background-color: var(--color-blue);color: var(--color-white);}.button span[data-role="button"]:is(:hover, :focus) {outline: 1px dotted var(--color-black);border: 1px solid var(--color-blue);}',
	'KOL-INPUT-RADIO': '',
	'KOL-LINK-GROUP': '',
	'KOL-TOAST': '',
