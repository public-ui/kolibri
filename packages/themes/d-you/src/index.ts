...
/*
 * The theme identifier is `dyou`, not `d-you`: KoliBri validates it against
 * /^[a-z][a-z0-9]{1,}(-[a-z0-9]+)?$/, which requires at least two characters before the hyphen.
 * The package name and the export keep the product spelling.
 */
export const D_YOU = KoliBri.createTheme(
	'dyou',
	{
		GLOBAL: globalCss,
		'KOL-ABBR': abbrCss,
