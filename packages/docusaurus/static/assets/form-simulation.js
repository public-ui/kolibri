...
function domReady() {
	...
	document.querySelector('#ansprache')._options = ANREDE_ANSPRACHE_OPTIONS;
	...
	document.querySelector('#new-input-radio-group')._control = ANREDE_ANSPRACHE_INPUT;
	document.querySelectorAll('kol-input-radio-group').forEach((input) => {
	...
	document.querySelector('#new-input-password')._control = ANREDE_NACHNAME_INPUT;
	...
	document.querySelector('#new-select')._control = STATUS_INPUT;
	document.querySelectorAll('kol-select').forEach((input) => {
		input._list = STATUS_OPTIONS;
	});
	document.querySelectorAll('kol-select_milti').forEach((input) => {
		input._list = STATUS_OPTIONS;
	});

	document.querySelector('#new-input-date')._control = DATUM_INPUT;

	document.querySelector('#datenschutz-switch')._control = DATENSCHUTZ_INPUT;

	document.querySelector('#password')._control = PASSWORD_INPUT;
	document.querySelector('#datum')._control = DATUM_INPUT;
