...
<html lang="de" dir="ltr">
	<head>
		...
		<script type="module">
			...
			import { defineCustomElements } from 'https://esm.sh/@public-ui/components@1.3.0/dist/loader';
			import { MAPZ } from 'https://esm.sh/@public-ui/themes@1.3.0';
	...
	<link href="https://use.fontawesome.com/releases/v6.2.1/css/all.css" rel="stylesheet">
			...
			<pre>
				<code class="language-html">${`<head>
	<script type="module">
		import { register } from 'https://esm.sh/@public-ui/core@1.3.0';
		import { defineCustomElements } from 'https://esm.sh/@public-ui/components@1.3.0/dist/loader';
		import { MAPZ } from 'https://esm.sh/@public-ui/themes@1.3.0';
		register([MAPZ], [defineCustomElements])
			.then(() => {})
