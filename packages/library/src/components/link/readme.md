...
| `_on`                | --                    | Gibt die EventCallback-Funktionen für den Link an.                                                                                               | `undefined \| { onClick?: EventCallback<Event> \| undefined; }`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | `undefined`                                    |
...
| `_showAs`            | `_show-as`            | Gibt an, ob der Link als Link oder Button dargestellt werden soll.                                                                               | `"button" \| "link" \| undefined`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | `'link'`                                       |
