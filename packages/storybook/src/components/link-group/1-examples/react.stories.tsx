...
export const Icons = (args: any) => (
	<div>
		<KolLinkGroup
			...
			_links="[{'_label':'Link nur Text','_href':'https://www.w3.org'},{'_label':'Link mit Icon','_href':'https://www.w3.org','_icon':'icofont-home'},{'_label':'Link nur Icon','_href':'https://www.w3.org','_icon':'icofont-home','_hideLabel':'true'},{'_label':'Link ohne Unterstrich','_href':'https://www.w3.org','_underline':'false'}]"
		></KolLinkGroup>
	</div>
);
Icons.args = {
