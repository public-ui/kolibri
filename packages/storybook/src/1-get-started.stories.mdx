...
<head>
	<script type="module">
		...
		import { defineCustomElements } from 'https://unpkg.com/@public-ui/components@1.7.12/dist/loader/index.js';
		import { ITZBund } from 'https://unpkg.com/@public-ui/themes@1.7.12/dist/index.mjs';
