...
<head>
	<script type="module">
		import { register } from 'https://unpkg.com/@public-ui/components@2.0.0-rc.5/dist/esm/index.js';
		import { defineCustomElements } from 'https://unpkg.com/@public-ui/components@2.0.0-rc.5/dist/loader/index.js';
		import { ITZBund } from 'https://unpkg.com/@public-ui/themes@2.0.0-rc.5/dist/index.mjs';
