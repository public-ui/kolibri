...
<head>
	<script type="module">
		...
		import { defineCustomElements } from 'https://unpkg.com/@public-ui/components@2.0.12/dist/loader/index.js';
		import { ITZBund } from 'https://unpkg.com/@public-ui/themes@2.0.12/dist/index.mjs';
