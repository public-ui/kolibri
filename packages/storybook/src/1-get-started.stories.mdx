...
<head>
	<script type="module">
		import { register } from 'https://unpkg.com/@public-ui/components@1.6.2/dist/esm/index.js';
		import { defineCustomElements } from 'https://unpkg.com/@public-ui/components@1.6.2/dist/loader/index.js';
		import { ITZBund } from 'https://unpkg.com/@public-ui/themes@1.6.2/dist/index.mjs';
