...
<head>
	<script type="module">
		import { register } from 'https://esm.sh/@public-ui/core@1.6.0-rc.6';
		import { defineCustomElements } from 'https://esm.sh/@public-ui/components@1.6.0-rc.6/dist/loader';
		import { ITZBund } from 'https://esm.sh/@public-ui/themes@1.6.0-rc.6';
