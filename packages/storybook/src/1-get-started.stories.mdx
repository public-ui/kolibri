...
<head>
	<script type="module">
		import { register } from 'https://esm.sh/@public-ui/core@1.1.10-rc.6';
		import { defineCustomElements } from 'https://esm.sh/@public-ui/components@1.1.10-rc.6/dist/loader';
		import { BMF } from 'https://esm.sh/@public-ui/themes@1.1.10-rc.6';
