...
<head>
	<script type="module">
		import { register } from 'https://unpkg.com/@public-ui/core@1.1.8';
		import { defineCustomElements } from 'https://unpkg.com/@public-ui/components@1.1.8/dist/loader';
		import { BMF } from 'https://unpkg.com/@public-ui/themes@1.1.8';
