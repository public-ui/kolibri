...
<head>
	<script type="module">
		import { register } from 'https://unpkg.com/@public-ui/core@1.6.0-rc.24';
		import { defineCustomElements } from 'https://unpkg.com/@public-ui/components@1.6.0-rc.24/dist/loader';
		import { ITZBund } from 'https://unpkg.com/@public-ui/themes@1.6.0-rc.24';
