...
<p>
	...
	Design-Tokens definiert werden. Damit das eigene Theme über Projekte hinweg geteilt werden kann, wird das Theme in ein NPM-Paket paketiert und bereitgestellt. 
	Das Paket kann über die öffentliche{' '}
	<KolLink _href="https://www.npmjs.com" _target="npmjs">
		NPM-Registry
	</KolLink>{' '}
	für alle Verfügbar gemacht werden aber genauso über interne Registries nur für den internen Gebrauch zur Verfügung gestellt werden.
</p>
<p>
	<KolDetails _summary="Design-Tokens">
		...
		den Webcomponents und dem Theme in der Webseite anzuwenden.
	</KolDetails>
</p>
<p>
