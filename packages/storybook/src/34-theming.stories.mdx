...
<kol-alert _type="info">
	<img width="100%" src={ThemeSwitch} alt="Zeigt wo der Schalter zum Umschalten des Themes im Toolbar ist" />
	<p>
...
<p>
	...
	beliebige Registry bereitgestellt werden.
</p>
<p>
...
<KolAlert _heading="KoliBri-Factory" _type="info" _variant="card">
	<p>
		...
		<KolLink _href="https://public-ui.github.io/docs/concepts/architecture#erweitert" _target="github">
			Modularisierung
		</KolLink>
		).
	</p>
