...
/* Focus tests */
ROUTES.set('scenarios/focus-elements?component=inputCheckbox', { waitForTimeout: 500 });
ROUTES.set('scenarios/focus-elements?component=inputColor', { waitForTimeout: 500 });
ROUTES.set('scenarios/focus-elements?component=inputDate', { waitForTimeout: 500 });
ROUTES.set('scenarios/focus-elements?component=inputEmail', { waitForTimeout: 500 });
ROUTES.set('scenarios/focus-elements?component=inputFile', { waitForTimeout: 500 });
ROUTES.set('scenarios/focus-elements?component=inputFileMultiple', { waitForTimeout: 500 });
ROUTES.set('scenarios/focus-elements?component=inputNumber', { waitForTimeout: 500 });
ROUTES.set('scenarios/focus-elements?component=inputPassword', { waitForTimeout: 500 });
ROUTES.set('scenarios/focus-elements?component=inputRadio', { waitForTimeout: 500 });
ROUTES.set('scenarios/focus-elements?component=inputRange', { waitForTimeout: 500 });
ROUTES.set('scenarios/focus-elements?component=inputText', { waitForTimeout: 500 });
ROUTES.set('scenarios/focus-elements?component=select', { waitForTimeout: 500 });
ROUTES.set('scenarios/focus-elements?component=selectMultiple', { waitForTimeout: 500 });
ROUTES.set('scenarios/focus-elements?component=textarea', { waitForTimeout: 500 });
ROUTES.set('scenarios/focus-elements?component=accordion', { waitForTimeout: 500 });
ROUTES.set('scenarios/focus-elements?component=button', { waitForTimeout: 500 });
ROUTES.set('scenarios/focus-elements?component=buttonLink', { waitForTimeout: 500 });
ROUTES.set('scenarios/focus-elements?component=details', { waitForTimeout: 500 });
ROUTES.set('scenarios/focus-elements?component=link', { waitForTimeout: 500 });
ROUTES.set('scenarios/focus-elements?component=linkButton', { waitForTimeout: 500 });
