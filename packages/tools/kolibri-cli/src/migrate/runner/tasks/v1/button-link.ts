...
export const ButtonLinkRemovePropertyAccessKey = RemovePropertyNameTask.getInstance('kol-button-link', '_access-key', '^1');
...
export const ButtonLinkRenamePropertyIconToIcons = RenamePropertyNameTask.getInstance('kol-button-link', '_icon', '_icons', '^1');
