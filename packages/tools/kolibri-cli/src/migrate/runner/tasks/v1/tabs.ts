...
export const TabsRenamePropertyIconToIcons = RenamePropertyNameTask.getInstance('kol-tabs', '_icon', '_icons', '^1');
export const TabsRenamePropertyIconOnlyToHideLabel = RenamePropertyNameTask.getInstance('kol-tabs', '_icon-only', '_hide-label', '^1');
