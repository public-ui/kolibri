...
async function prebuildSampleIndex() {
	try {
		...
		// 3. As JavaScript module for direct import
		const jsContent = `// Auto-generated sample index data
// This file is generated by the prebuild script

export const SAMPLE_INDEX_DATA = ${JSON.stringify(indexData, null, 2)};
`;
