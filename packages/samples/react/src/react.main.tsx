...
import { BAMF, BMF, BZSt, BZStv1, DEFAULT, DESYv1, DESYv2, ECL_EC, ECL_EU, ITZBund, MAPZ, ZOLLv2, ZOLLv3 } from '@public-ui/themes';
...
void (async () => {
	if (process.env.THEME_MODULE) {
		...
		try {
			await register([BAMF, BMF, DEFAULT, BZSt, BZStv1, DESYv1, DESYv2, ECL_EC, ECL_EU, ITZBund, MAPZ, ZOLLv2, ZOLLv3, TH], defineCustomElements, {
				theme: {
					detect: 'auto',
				},
			});
