			...
			<KolTree>
				...
				<KolTreeItem _label="2 About (open initially)" _href={href} _open>
					<KolTreeItem _label="2.1 Team" _href={href}>
						...
						<KolTreeItem _label="2.2 Locations" _href={href}>
							{showEurope && (
								<KolTreeItem _label="2.2.1 Europe" _href={href}>
									<KolTreeItem _label="2.2.1.1 Denmark" _href={href} />
									<KolTreeItem _label="2.2.1.2 Netherlands" _href={href} />
								</KolTreeItem>
							)}
						</KolTreeItem>
					</KolTreeItem>
