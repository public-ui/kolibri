...
export const LinkBasic: FC = () => (
	<div className="grid gap-4">
		<KolLink _href="#/sample-page" _label="Simple Link" />
		<p>
		...
		<p>
			...
			<KolLink class="d-inline-block" _href="#/sample-page" _label="Simple Link" />. Damit kann man mir per CSS-Styles eine Breite, eine Höhe und andere
