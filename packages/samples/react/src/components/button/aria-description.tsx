...
export const ButtonAriaDescription: FC = () => (
	<>
		<SampleDescription>
			<p>
				This sample shows KolButton with aria-description
		...
		<div className="flex flex-wrap gap-4">
			...
			<KolButton _label="Sehr kleines s" _accessKey="s" _ariaDescription="Beschreibung für Sehr kleines s"></KolButton>
