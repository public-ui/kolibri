...
export const InputTextMessageTypes: FC = () => (
	<>
		...
		<div className="grid gap-4">
			<KolInputText _label="Info message" _value="Some value" _msg={{ _type: 'info', _description: 'This is an informational message' }} />
			<KolInputText _label="Error message" _value="Invalid value" _msg={{ _type: 'error', _description: 'This is an error message' }} _touched />
			<KolInputText _label="Warning message" _value="Potentially problematic value" _msg={{ _type: 'warning', _description: 'This is a warning message' }} />
