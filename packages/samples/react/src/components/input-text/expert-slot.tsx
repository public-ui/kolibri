	...
	return (
		<>
			...
			<div className="grid gap-4">
				<KolInputText _label="Expert slot with simple text" _type="text">
					<span slot="expert">I am more than just a input field</span>
				</KolInputText>

				<KolInputText _label="Expert slot with badge and icon" _type="text" _value="Complex example">
				...
				<KolInputText _label="Expert slot with styled content" _type="text" _placeholder="Enter your email">
