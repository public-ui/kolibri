		...
		<section className="w-full flex flex-col">
			...
			<KolTableStateful
				...
				_headers={{
					horizontal: [
						[
							{ label: 'left', key: 'left', textAlign: 'left', minWidth: '150px' },
							{ label: 'center', key: 'center', textAlign: 'center', minWidth: '150px' },
							{ label: 'right', key: 'right', textAlign: 'right', minWidth: '150px' },
						],
					],
				}}
				_data={DATA}
			...
			<KolTableStateful
				...
				_headers={{
					horizontal: [
						[
							{ label: 'left', key: 'left', textAlign: 'left', compareFn: genericNonSorter, minWidth: '150px' },
							{ label: 'center', key: 'center', textAlign: 'center', compareFn: genericNonSorter, minWidth: '150px' },
							{ label: 'right', key: 'right', textAlign: 'right', compareFn: genericNonSorter, minWidth: '150px' },
						],
					],
				}}
				_data={DATA}
			...
			<KolTableStateful
				...
				_headers={{
					...
					vertical: [[{ label: 'Vertical', minWidth: '100px' }]],
				}}
				_data={DATA}
				className="block"
				style={{ maxWidth: '600px' }}
