...
export const TableStickyCol: FC = () => (
	<>
		<SampleDescription>
			<p>
				This sample shows KolTableStateful with the first and last columns sticky. It should be focusable and scrollable with the keyboard. The table headline
				should be sticky at the top of the table. The data lists animal species with conservation-focused details.
			</p>
		</SampleDescription>
