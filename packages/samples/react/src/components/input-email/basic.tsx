	...
	<>
		...
		<div className="grid gap-4">
			<div className="black-background">
				<KolInputEmail _required _value="test@mail.de" _msg={{ _type: 'error', _description: ERROR_MSG }} _label="E-Mail (Black background test)" />
			</div>
			<KolInputEmail
				_accessKey="M"
			...
			/>
			<KolInputEmail _msg={{ _type: 'info', _description: 'Just a hint' }} _label="E-Mail" />
			<KolInputEmail _msg={{ _type: 'warning', _description: 'Small warning' }} _label="E-Mail" />
			<KolInputEmail _msg={{ _type: 'success', _description: 'Success message' }} _label="E-Mail" />
			...
			<KolInputEmail _value="test@mail.de" _label="With access key" _accessKey="c" />
			<KolInputEmail _value="test@mail.de" _label="With short key" _shortKey="s" />
		</div>
	</>
);
