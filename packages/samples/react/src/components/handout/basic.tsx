			...
			<KolCard className="col-span-3" _heading="Button, LinkButton and Tab" _level={2}>
				<div slot="content" className="grid gap-2 p-2">
					<KolTabs _ariaLabel="" _selected={0} _tabs={[{ _label: 'Button' }, { _label: 'LinkButton' }, { _label: 'Disabled Tab', _disabled: true }]}>
						...
						<div className="grid gap-2 py-2">
							<div className="grid gap-2 grid-cols-[4fr_4fr_1fr] justify-items-center">
								<KolLinkButton _href="#/sample-page" _icons={{ left: 'codicon codicon-arrow-left' }} _label="primary" _variant="primary"></KolLinkButton>
								<KolLinkButton
									_href="#/sample-page"
									_disabled
									...
									_variant="primary"
								></KolLinkButton>
								<KolLinkButton _href="#/sample-page" _hideLabel _icons="codicon codicon-arrow-left" _label="primary" _variant="primary"></KolLinkButton>
							</div>
							<div className="grid gap-2 grid-cols-[4fr_4fr_1fr] justify-items-center">
								<KolLinkButton _href="#/sample-page" _icons={{ right: 'codicon codicon-arrow-right' }} _label="secondary" _variant="secondary"></KolLinkButton>
								<KolLinkButton
									_href="#/sample-page"
									_disabled
									...
									_variant="secondary"
								></KolLinkButton>
								<KolLinkButton _href="#/sample-page" _hideLabel _icons="codicon codicon-arrow-right" _label="secondary" _variant="secondary"></KolLinkButton>
							</div>
							<div className="grid gap-2 grid-cols-[4fr_4fr_1fr] justify-items-center">
								<KolLinkButton _href="#/sample-page" _icons={{ top: 'codicon codicon-arrow-up' }} _label="danger" _variant="danger"></KolLinkButton>
								<KolLinkButton _href="#/sample-page" _disabled _icons={{ top: 'codicon codicon-arrow-up' }} _label="danger" _variant="danger"></KolLinkButton>
								<KolLinkButton _href="#/sample-page" _hideLabel _icons="codicon codicon-arrow-up" _label="danger" _variant="danger"></KolLinkButton>
							</div>
							<div className="grid gap-2 grid-cols-[4fr_4fr_1fr] justify-items-center">
								<KolLinkButton _href="#/sample-page" _icons={{ bottom: 'codicon codicon-arrow-down' }} _label="normal" _variant="normal"></KolLinkButton>
								<KolLinkButton
									_href="#/sample-page"
									_disabled
									...
									_variant="normal"
								></KolLinkButton>
								<KolLinkButton _href="#/sample-page" _hideLabel _icons="codicon codicon-arrow-down" _label="normal" _variant="normal"></KolLinkButton>
							</div>
							<div className="grid gap-2 grid-cols-[4fr_4fr_1fr] justify-items-center">
								<KolLinkButton _href="#/sample-page" _label="ghost" _variant="ghost"></KolLinkButton>
								<KolLinkButton _href="#/sample-page" _disabled _label="ghost" _variant="ghost"></KolLinkButton>
								<KolLinkButton _href="#/sample-page" _icons="codicon codicon-home" _hideLabel _label="ghost" _variant="ghost"></KolLinkButton>
							</div>
						</div>
					</KolTabs>
				</div>
				...
				<div slot="content" className="grid gap-2 p-2">
					<KolAccordion _heading="Links" _level={3} _open>
						<div className="grid gap-2" slot="content">
							<KolLink _href="#/sample-page" _label="Linktext"></KolLink>
							<KolLink _href="#/sample-page" _icons="codicon codicon-home" _label="Linktext mit Icon"></KolLink>
							<KolLink _href="#/sample-page" _icons="codicon codicon-home" _hideLabel _label="Linktext nur mit Icon"></KolLink>
							<KolLink _href="/" _label="Besuchter Link"></KolLink>
							<p>
								Ich bin ein <KolLink _href="#/sample-page" _label="externer Link" _target="w3c"></KolLink> im Fließtext.
							</p>
							<KolLink _ariaLabel="Zurück zur Startseite" _href="#/sample-page" _label="">
									...
									_children: [
										...
										},
										{
											...
											_children: [
												...
												{ _label: '3.3.2 Navigation point', _icons: 'codicon codicon-home', _href: '#/sample-page' },
											],
										},
									],
								},
								{ _label: '3 Navigation point', _icons: 'codicon codicon-home', _href: '#/sample-page' },
							]}
							_hasCompactButton
						/>
					</div>
