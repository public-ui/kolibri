		...
		<>
			<SampleDescription>
				...
				<p>
					...
					field directly in the browser. Access keys must be unique per page – this example therefore uses a different access key for each rendered field.
					The <code>_shortKey</code> property only renders a visual hint and sets <code>aria-keyshortcuts</code>; it is not bound to the native browser
					shortcut and must be wired up by the host application.
				</p>
			</SampleDescription>
