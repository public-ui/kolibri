import{a as e,c as t,o as n,r,s as i,u as a}from"./index-B33ongT1.js";import{n as o,t as s}from"./dev.utils-ECC8EZa5-D5DcddXW.js";import{t as c}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as l}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{n as u,s as d}from"./normalizers-BKn5MMMa-D6rFsmGq.js";import{n as f}from"./level-BoUK1uwO-B-dgIMl-.js";import{n as p}from"./component-Bp59IjLO-4IjOiLpz.js";import"./label-C0M7juqN-CblioTLL.js";import{t as m}from"./label-DYQJC4WL-SCvXSbOP.js";import"./variant-quote-CPhOA1Br-DmpbAYG2.js";import"./Heading-0nLgAxIn-DeCLsoQf.js";import{n as h,t as g}from"./component-tSLQ7OXy-gSLskCEo.js";import{n as _,r as v,t as y}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";var b=u(`on`,{},e=>d(e)),x={optional:[b,p,f,h],required:[m]},S=({controlId:e,disabled:t,handleToggle:r,headingId:i,label:a,level:o,open:s,refHeadingButton:c},l)=>n(g,{block:`kol-details`,contentClass:`indented-text`,controlId:e,disabled:t,handleToggle:r,headingId:i,icon:`kolicon-chevron-right`,label:a,level:o,open:s,refHeadingButton:c},l),C=`@charset "UTF-8";
...
}`,w=class extends c{constructor(e){super(),i(this,e),this.detailsId=o(`details`),this.ctaRef=y(),this.controlId=s(this.detailsId,`control`),this.headingId=s(this.detailsId,`heading`),this.handleToggle=e=>{this._open=!this._open,clearTimeout(this.toggleTimeout),this.toggleTimeout=setTimeout(()=>{var n,r;this.host&&a(this.host,t.toggle,!!this._open),(r=(n=this.getRenderProp(`on`)).onToggle)==null||r.call(n,e,!!this._open)},25)},this._disabled=!1,this._level=0,this._open=!1}componentWillLoad(){this.initRenderProps(x),this.watchDisabled(this._disabled),this.watchLabel(this._label),this.watchLevel(this._level),this.watchOn(this._on),this.watchOpen(this._open)}async focus(e){}async click(){}render(){return n(r,{key:`5140f54ebb7219a33bdcbbbda0e04b0712919c81`},n(S,{key:`71b3676d378060f61dcceff56c29dd8254f1c1dd`,controlId:this.controlId,disabled:this.getRenderProp(`disabled`),handleToggle:this.handleToggle,headingId:this.headingId,label:this.getRenderProp(`label`),level:this.getRenderProp(`level`),on:this.getRenderProp(`on`),open:this.getRenderProp(`open`),refHeadingButton:this.ctaRef},n(`slot`,{key:`7bc2780a451f275589fd84fe5575be5579d100d3`})))}watchDisabled(e){p.apply(e,e=>this.setRenderProp(`disabled`,e))}watchLabel(e){m.apply(e,e=>this.setRenderProp(`label`,e))}watchLevel(e){f.apply(e,e=>this.setRenderProp(`level`,e))}watchOn(e){b.apply(e,e=>this.setRenderProp(`on`,e))}watchOpen(e){h.apply(e,e=>this.setRenderProp(`open`,e))}get host(){return e(this)}static get watchers(){return{_disabled:[`watchDisabled`],_label:[`watchLabel`],_level:[`watchLevel`],_on:[`watchOn`],_open:[`watchOpen`]}}};l([v(`ctaRef`)],w.prototype,`focus`,null),l([_(`ctaRef`)],w.prototype,`click`,null),w.style={default:C};export{w as kol_details};