import{Dt as e,a as t,c as n,o as r,s as i,u as a,v as o}from"./index-Mtm02T-M.js";import{n as s,t as c}from"./dev.utils-Cy5tSBQV-D0f-KB3V.js";import{n as l,t as u}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import"./_Uint8Array-kJHDjtoP-CTkgs_0o.js";import"./normalizers-DeSF4l8V-C87YG_Ao.js";import"./level-CRij748Y-D6M5eiG2.js";import{t as d}from"./clsx-COFh-Vc8-DWAop4cA.js";import{r as f}from"./label-C7_p2_ej-DxRIvXL9.js";import{t as p}from"./Heading-Bo-BUYpa-CnKniaMO.js";import{n as m,r as h,t as g}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import{t as _}from"./validation-CcA_kdEh-CSZTxkjR.js";import{t as v}from"./disabled-BwXO0p32-CcSZEGNu.js";import{t as y}from"./open-DKPLgHeT-DO7IJSuZ.js";var b=(t,n)=>{e(t,`_on`,e=>typeof e==`object`&&!!e,new Set([`DetailsCallbacksPropType {Events.onToggle}`]),n)},x=(e,t)=>{let{id:n,class:i,label:a,level:s=1,disabled:u,open:f,onClick:m,HeadingProps:h={},HeadingButtonProps:g={},ContentProps:_={}}=e,v=l(e,[`id`,`class`,`label`,`level`,`disabled`,`open`,`onClick`,`HeadingProps`,`HeadingButtonProps`,`ContentProps`]),y=f?`kolicon-chevron-down`:`kolicon-chevron-right`,b=c(n,`heading`),x=c(n,`control`);return r(`div`,Object.assign({id:n,class:d(`collapsible`,{"collapsible--disabled":u===!0,"collapsible--open":f===!0},i)},v),r(p,{ref:h?.ref,level:s,class:d(`collapsible__heading`,h?.class)},r(o,{class:d(`collapsible__heading-button`,g?.class),ref:g?.ref,slot:`expert`,id:b,_ariaControls:x,_ariaExpanded:f,_disabled:u,_icons:g?._icons||`${y}`,_label:a,_on:{onClick:m}})),r(`div`,{class:d(`collapsible__wrapper`,_?.wrapperClass)},r(`div`,{class:d(`collapsible__wrapper-animation`,_?.animationClass)},r(`div`,{"aria-hidden":f===!1?`true`:void 0,"aria-labelledby":b,role:`region`,class:d(`collapsible__content`,_?.class),id:x},t))))},S=`@charset "UTF-8";
...
}`,C=class{constructor(e){i(this,e),this.id=s(`details`),this.ctaRef=g(),this.handleOnClick=e=>{this._open=!this._open,clearTimeout(this.toggleTimeout),this.toggleTimeout=setTimeout(()=>{var t,r;this.host&&a(this.host,n.toggle,!!this._open),(r=(t=this.state._on)?.onToggle)==null||r.call(t,e,!!this._open)},25)},this._disabled=!1,this._level=0,this._open=!1,this.state={_label:``,_level:0,_on:{}}}async focus(e){}async click(){}render(){let{_open:e,_label:t,_disabled:n,_level:i}=this.state,a=`kol-details`,o={id:this.id,label:t,open:e,disabled:n,level:i,onClick:this.handleOnClick,class:a,HeadingProps:{class:`${a}__heading`},HeadingButtonProps:{ref:this.ctaRef,class:`${a}__heading-button`,_icons:`kolicon-chevron-right`},ContentProps:{class:`${a}__content indented-text`,wrapperClass:`${a}__wrapper`,animationClass:`${a}__wrapper-animation`}};return r(x,Object.assign({key:`f9f5dfb0e9c1f9c44d2e0ade3137e47248c39a21`},o),r(`slot`,{key:`f8fdc0d5e228865d006b47ea92dde05012e2e800`}))}validateDisabled(e){v(this,e)}validateLabel(e){f(this,e,{required:!0})}validateLevel(e){_(this,e)}validateOn(e){b(this,e)}validateOpen(e){y(this,e)}componentWillLoad(){this.validateDisabled(this._disabled),this.validateLabel(this._label),this.validateLevel(this._level),this.validateOn(this._on),this.validateOpen(this._open)}get host(){return t(this)}static get watchers(){return{_disabled:[`validateDisabled`],_label:[`validateLabel`],_level:[`validateLevel`],_on:[`validateOn`],_open:[`validateOpen`]}}};u([h(`ctaRef`)],C.prototype,`focus`,null),u([m(`ctaRef`)],C.prototype,`click`,null),C.style={default:S};export{C as kol_details};