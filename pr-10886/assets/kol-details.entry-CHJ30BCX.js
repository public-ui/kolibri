...
}`,k=class extends u{constructor(e){super(),a(this,e),this.detailsId=c(`details`),this.ctaRef=S(),this.controlId=l(this.detailsId,`control`),this.headingId=l(this.detailsId,`heading`),this.handleToggle=e=>{this._open=!this._open,clearTimeout(this.toggleTimeout),this.toggleTimeout=setTimeout(()=>{var n,r;this.host&&o(this.host,t.toggle,!!this._open),(r=(n=this.getRenderProp(`on`)).onToggle)==null||r.call(n,e,!!this._open)},25)},this._disabled=!1,this._level=0,this._open=!1}componentWillLoad(){this.initRenderProps(T),this.watchDisabled(this._disabled),this.watchLabel(this._label),this.watchLevel(this._level),this.watchOn(this._on),this.watchOpen(this._open)}async focus(e){}async click(){}render(){return r(i,{key:`bfe5fc2809765c22bbe1217798e4581c1240c9e3`},r(D,{key:`dd8a2a9f9c30fa1c740e3e2db34ba7ccf0e9a47d`,controlId:this.controlId,disabled:this.getRenderProp(`disabled`),handleToggle:this.handleToggle,headingId:this.headingId,label:this.getRenderProp(`label`),level:this.getRenderProp(`level`),on:this.getRenderProp(`on`),open:this.getRenderProp(`open`),refHeadingButton:this.ctaRef},r(`slot`,{key:`757078cee38752519bc8c99fe3dc2128384f76e4`})))}watchDisabled(e){h.apply(e,e=>this.setRenderProp(`disabled`,e))}watchLabel(e){_.apply(e,e=>this.setRenderProp(`label`,e))}watchLevel(e){p.apply(e,e=>this.setRenderProp(`level`,e))}watchOn(e){w.apply(e,e=>this.setRenderProp(`on`,e))}watchOpen(e){v.apply(e,e=>this.setRenderProp(`open`,e))}get host(){return e(this)}static get watchers(){return{_disabled:[`watchDisabled`],_label:[`watchLabel`],_level:[`watchLevel`],_on:[`watchOn`],_open:[`watchOpen`]}}};d([x(`ctaRef`)],k.prototype,`focus`,null),d([b(`ctaRef`)],k.prototype,`click`,null),k.style={default:O};export{k as kol_details};