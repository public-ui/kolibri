import{B as e,J as t,_t as n,a as r,c as i,d as a,ft as o,o as s,r as c,s as l,u,ut as d}from"./index-DpvBhAI-.js";import{i as f,n as p}from"./dev.utils-ECC8EZa5-CWYOCQ_9.js";import{n as m,t as h}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as g}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{n as _}from"./normalizers-BKn5MMMa-CxCgP2TC.js";import{n as v}from"./component-Bp59IjLO-B1qjam9o.js";import"./label-C0M7juqN-DRA9Qvd-.js";import"./label-DYQJC4WL-KjJAixdn.js";import"./variant-quote-CPhOA1Br-BOWjrPhS.js";import{r as y,t as b}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./component-wFfb-V2H-DCyc5DF4.js";import"./index-Dn4yuLb2-Ls5-nj5Q.js";import{t as x}from"./color-CHbJOyuG-DtepQTk-.js";import{t as S}from"./label-with-expert-slot-CVC4EYWd-BUCOHin1.js";import"./align-DTxBCGKI-BirdYjhJ.js";import{a as ee,c as C,d as w,f as T,i as E,l as D,m as O,n as k,o as A,p as j,r as M,s as N,u as P}from"./component-BdU4fpC--Bssu0IS9.js";import"./variant-class-name-CIkeqds3-IQIEYaQQ.js";import{t as F}from"./component-auMlmO1f-BmA3sqva.js";import"./component-C40gKAC--CM3Ln-nf.js";import"./align-floating-elements-CEOmKevE-eIz5DMQw.js";import{n as I,t as L}from"./behavior-CJkZBRZO-Dz4WQzYD.js";import{t as R}from"./name-6F-5kaDk-3yymil9X.js";import{a as z,i as B,o as V,r as H,t as U}from"./api-C-0p_ooN-xs0qmI6f.js";function W(e){let t=typeof e==`string`?o(e):e;if(typeof t==`object`&&t)return t;throw Error(`Invalid smart button: ${typeof e}`)}var G=_(`smartButton`,{_label:``},W),K={required:[S],optional:[x,G,w]},q=a.forBlock(`kol-badge`),J=q(`label`),Y=q(`smart-button`),X=e=>{let{ariaDescriptionId:t,color:n,handleBlur:r,handleClick:i,handleFocus:a,handleMouseDown:o,icons:c,label:l,labelId:u,refSmartButton:d,refTooltip:f,smartButton:p,smartButtonProps:m}=e,h=typeof p==`object`&&!!p&&m!==void 0;return s(`div`,{class:q({"has-smart-button":h}),style:{backgroundColor:n.backgroundColor,color:n.foregroundColor}},s(F,{class:J,id:h?u:void 0,allowMarkdown:!0,icons:c,label:l}),h&&s(U,Object.assign({},m,{class:Y,ariaDescriptionId:t,handleBlur:r,handleClick:i,handleFocus:a,handleMouseDown:o,refButton:d,refTooltip:f})),s(`br`,null))},Z={disabled:!1,hideLabel:!1,inline:!1,tooltipAlign:`top`,type:`button`};function Q(t,n){let r=m(z),i=e=>t=>{r[e]=t};return S.apply(t._label,i(`label`)),k.apply(t._accessKey,i(`accessKey`)),M.apply(t._ariaControls,i(`ariaControls`)),E.apply(t._ariaDescription,i(`ariaDescription`)),ee.apply(t._ariaExpanded,i(`ariaExpanded`)),H.apply(t._ariaSelected,i(`ariaSelected`)),B.apply(t._on,i(`on`)),V.apply(t._type??Z.type,i(`type`)),A.apply(t._customClass,i(`customClass`)),v.apply(t._disabled??Z.disabled,i(`disabled`)),N.apply(t._hideLabel??Z.hideLabel,i(`hideLabel`)),I.apply(t._id,i(`id`)),C.apply(t._inline??Z.inline,i(`inline`)),D.apply(t._role,i(`role`)),R.apply(t._name,i(`name`)),P.apply(t._shortKey,i(`shortKey`)),w.apply(t._icons,i(`icons`)),j.apply(t._tooltipAlign??Z.tooltipAlign,i(`tooltipAlign`)),typeof t._tabIndex==`number`?T.apply(t._tabIndex,i(`tabIndex`)):r.tabIndex=void 0,O.apply(t._variant??e(`buttonVariantDefault`,n)??`normal`,i(`variant`)),r}var te=`@charset "UTF-8";
