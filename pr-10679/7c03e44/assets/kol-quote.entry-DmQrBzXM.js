import{o as e,r as t,s as n,u as r,w as i}from"./index-aPvlshhp.js";import{t as a}from"./base-web-component-BT6jbe_v-Vp21XLG3.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import"./_Uint8Array-kJHDjtoP-CTkgs_0o.js";import{n as o,o as s}from"./normalizers-Cpy0t9-X-BmgdWTjM.js";import{t as c}from"./label-BGcJjCR_-Chizylcz.js";import{n as l}from"./variant-quote-CZ5CemUm-BD9VOlIL.js";import{t as u}from"./base-controller-CXhqh4cR-BNzx0WwK.js";var d=o(`href`,``,s,e=>typeof e==`string`),f=o(`quote`,``,s),p=r.forBlock(`kol-quote`),m=p(`blockquote`),h=p(`cite`),g=p(`figcaption`),_=p(`quote`),v=t=>{let{href:n,label:r,quote:a,variant:o}=t,s=a===``,c=p({[o]:!0});return e(`figure`,{class:c},o===`block`?e(`blockquote`,{class:m,cite:n},a,e(`span`,{"aria-hidden":s?void 0:`true`,hidden:!s},e(`slot`,{name:`expert`}))):e(`q`,{class:_,cite:n},a,e(`span`,{"aria-hidden":s?void 0:`true`,hidden:!s},e(`slot`,{name:`expert`}))),typeof r==`string`&&r.length>0&&e(`figcaption`,{class:g},e(`cite`,{class:h},e(i,{_href:n,_label:r,_target:`_blank`}))))},y={optional:[c,l],required:[d,f]},b=class extends u{constructor(e){super(e,y)}componentWillLoad(e){let{href:t,label:n,quote:r,variant:i}=e;this.watchHref(t),this.watchLabel(n),this.watchQuote(r),this.watchVariant(i)}watchHref(e){d.apply(e,e=>{this.setRenderProp(`href`,e)})}watchLabel(e){c.apply(e,e=>{this.setRenderProp(`label`,e)})}watchQuote(e){f.apply(e,e=>{this.setRenderProp(`quote`,e)})}watchVariant(e){l.apply(e,e=>{this.setRenderProp(`variant`,e)})}},x=`@charset "UTF-8";
