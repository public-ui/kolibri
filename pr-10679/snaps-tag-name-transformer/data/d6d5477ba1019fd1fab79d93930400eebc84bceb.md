...
```
Error: A snapshot doesn't exist at /home/runner/work/kolibri/kolibri/packages/test-tag-name-transformer/snapshots/theme-default/snapshot-for-scenarios-same-height-of-all-form-elements-with-label-firefox-linux.png, writing actual.
```
