import{A as e,Ct as t,Dt as n,E as r,G as i,a,c as o,ft as s,l as c,o as l,q as u,r as d,s as f,ut as p,yt as m}from"./index-B-nvejUS.js";import{r as h}from"./label-BIbocgr4-D49dwJ0X.js";import{t as g}from"./i18n-BQHGsG9x-DU4ukQA4.js";import{t as _}from"./aria-labelledby-6-ki3akM-C6lJ0lQF.js";import{t as v}from"./aria-labelledby-l_rLlvmD-CWi-Rv3n.js";import{a as y,i as b,n as x,o as S,s as C,t as w}from"./table-selection-BR8SUvH5-C48ehDTS.js";import{t as T}from"./keyboard-DNd73LVa-BCj4IeP3.js";var E=(e,n,r={})=>{t(e,`_allowMultiSort`,n,Object.assign({defaultValue:!1},r))},D=[`top`,`bottom`,`both`],O=(e,t)=>{n(e,`_paginationPosition`,e=>typeof e==`string`&&D.includes(e),new Set([`PaginationPositionPropType {${D.join(`, `)}`]),t,{defaultValue:`bottom`})},k=`@charset "UTF-8";
/*
...
@font-face {
  ...
  src: url("kolicons.eot?t=1788252983206"); /* IE9*/
  src: url("kolicons.eot?t=1788252983206#iefix") format("embedded-opentype"), url("kolicons.woff2?t=1788252983206") format("woff2"), url("kolicons.woff?t=1788252983206") format("woff"), url("kolicons.ttf?t=1788252983206") format("truetype"), url("kolicons.svg?t=1788252983206#kolicons") format("svg"); /* iOS 4.1- */
}
@layer kol-component {
 ...
 * \`kol-link\` renders \`<div class="kol-link"><a class="kol-link__anchor">\`, \`kol-button\` renders
 * \`<div class="kol-button"><button class="kol-button__button">\`. \`$interactive-element\` names that
 * inner element; \`null\` attaches the styles to the class carrier itself, for blocks whose DOM has
 * no inner interactive element.
 */
@layer kol-component {
...
@layer kol-component {
  ...
  .kol-popover-button--inline .kol-button .kol-button__button {
    min-width: 0;
    min-height: 1em;
  }
  .kol-popover {
  ...
  .kol-table__cell--actions .kol-button__button {
    display: flex;
    flex: 1;
    text-align: left;
    text-decoration-line: none;
  ...
  .kol-table__cell--actions .kol-button__button::before {
    content: "​";
  }
  ...
  .kol-table__cell--actions .kol-button--external-link .kol-button__button > .kolicon-link-external::before {
    content: none;
  }
  .kol-table__cell--actions .kol-icon {
    color: inherit;
  ...
  .kol-table__cell--actions .kol-link--standalone .kol-link__anchor {
    align-items: stretch;
  }
  ...
  .kol-table__cell--actions .kol-link__anchor {
    display: inline-flex;
    flex: 1;
  ...
  .kol-table__cell--actions .kol-link__anchor:focus:not([aria-disabled], [disabled]) .kol-span__label, .kol-table__cell--actions .kol-link__anchor:hover:not([aria-disabled], [disabled]) .kol-span__label {
  ...
  .kol-table__cell--actions .kol-link {
    /* Root-level hover/focus decoration: kept for blocks rendered without an inner interactive
       element, and harmless where one exists (the wrapper is hovered together with it). */
  }
