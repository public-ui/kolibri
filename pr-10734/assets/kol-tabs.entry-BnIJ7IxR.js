import{Ct as e,Dt as t,G as n,St as r,Tt as i,_ as a,a as o,c as s,l as c,o as l,s as u,st as d,wt as f,yt as p}from"./index-CKBmsJIL.js";import{n as m}from"./dev.utils-DIu7_VyB-DY4M_BBI.js";import{t as h}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{t as g}from"./clsx-COFh-Vc8-DWAop4cA.js";import{r as _}from"./label-BIbocgr4-VQnE-xpe.js";import{n as v,r as y,t as b}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import{t as x}from"./i18n-BQHGsG9x-BDnaLi82.js";import{n as S}from"./align-DnuTHmUs-CpAFS60b.js";import{n as C}from"./keyboard-DNd73LVa-BCj4IeP3.js";var w=[`select-automatic`,`select-manual`],T=(e,n)=>{t(e,`_behavior`,e=>typeof e==`string`&&w.includes(e),new Set([`KoliBriTabBehavior {${w.join(`, `)}`]),n)},E=(t,n)=>{e(t,`_hasCreateButton`,n)},D=`@charset "UTF-8";
...
@layer kol-component {
  ...
  .kol-button__button {
    ...
    display: block;
    border-width: medium;
    /* The UA pins \`text-align: center\` directly on every \`button\`, which would beat any
       alignment inherited from the wrapper (e.g. nav's \`text-align: left\`). Inheriting
       restores the old flow, where the alignment applied to the button element itself. */
    text-align: inherit;
  }
  .kol-tabs {
    display: var(--display);
  ...
  .kol-tabs__button-group .kol-button .kol-button__button {
