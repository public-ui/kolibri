import{E as e,a as t,o as n,s as r}from"./index-sVd_XErU.js";import{t as i}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{n as a,r as o,t as s}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";var c=`@charset "UTF-8";
/*
...
}`,l=class{constructor(e){r(this,e),this.ctaRef=s(),this._disabled=!1,this._hideLabel=!1,this._inline=!1,this._popoverAlign=`bottom`,this._tooltipAlign=`top`,this._type=`button`,this._variant=`normal`}async hidePopover(){var e;(e=this.ctaRef.el)==null||e.hidePopover()}async showPopover(){var e;(e=this.ctaRef.el)==null||e.showPopover()}async click(){}async focus(e){}render(){return n(e,{key:`64c469c66d115924a2797dd2701b6328f6f65669`,ref:this.ctaRef,_accessKey:this._accessKey,_ariaDescription:this._ariaDescription,_customClass:this._customClass,_disabled:this._disabled,_hideLabel:this._hideLabel,_icons:this._icons,_inline:this._inline,_label:this._label,_name:this._name,_popoverAlign:this._popoverAlign,_shortKey:this._shortKey,_syncValueBySelector:this._syncValueBySelector,_tabIndex:this._tabIndex,_tooltipAlign:this._tooltipAlign,_type:this._type,_value:this._value,_variant:this._variant},n(`slot`,{key:`735e62a1983a11aee47adc4bfb4825d6da3987d8`,name:`expert`,slot:`expert`}),n(`slot`,{key:`cc2e880fa4c2c8d25056f9c5af1a58180157f058`}))}get host(){return t(this)}};i([a(`ctaRef`)],l.prototype,`click`,null),i([o(`ctaRef`)],l.prototype,`focus`,null),l.style={default:c};export{l as kol_popover_button};