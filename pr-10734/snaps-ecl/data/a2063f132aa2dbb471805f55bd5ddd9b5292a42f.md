...
Locator: locator('[data-visual-block="icons-only"]')
  Expected an image 168px by 110px, received 168px by 146px. 1109 pixels (ratio 0.05 of all image pixels) are different.

  Snapshot: tabs-icons-only--icons-only.png

Call log:
  - Expect "toHaveScreenshot(tabs-icons-only--icons-only.png)" with timeout 10000ms
    - verifying given screenshot expectation
  - waiting for locator('[data-visual-block="icons-only"]')
    - locator resolved to <div class="grid gap-4" data-visual-block="icons-only">…</div>
