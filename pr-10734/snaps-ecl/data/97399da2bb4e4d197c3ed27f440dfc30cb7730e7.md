...
Locator: locator('[data-visual-block="left"]')
  Expected an image 253px by 24px, received 253px by 44px. 1497 pixels (ratio 0.14 of all image pixels) are different.

  Snapshot: button-link-icons--left.png

Call log:
  - Expect "toHaveScreenshot(button-link-icons--left.png)" with timeout 10000ms
    - verifying given screenshot expectation
  - waiting for locator('[data-visual-block="left"]')
    - locator resolved to <div class="grid gap-4" data-visual-block="left">…</div>
...
- main [ref=e4]:
  ...
  - button "I am a link with an icon on the left" [ref=e11] [cursor=pointer]:
    - generic [ref=e13]:
      - generic [ref=e14]: 
      - generic [ref=e15]: I am a link with an icon on the left
  - button "I am a link with an icon on the right" [ref=e21] [cursor=pointer]:
    - generic [ref=e23]:
      - generic [ref=e24]: I am a link with an icon on the right
      - generic [ref=e25]: 
  - button "I am a link with an icon at the top" [ref=e31] [cursor=pointer]:
    - generic [ref=e32]:
      - generic [ref=e33]: 
      - generic [ref=e35]: I am a link with an icon at the top
  - button "I am a link with icon below" [ref=e41] [cursor=pointer]:
    - generic [ref=e42]:
      - generic [ref=e44]: I am a link with icon below
      - generic [ref=e45]: 
  - button "I am a link with all icons" [ref=e51] [cursor=pointer]:
    - generic [ref=e52]:
      - generic [ref=e53]: 
      - generic [ref=e54]:
        - generic [ref=e55]: 
        - generic [ref=e56]: I am a link with all icons
        - generic [ref=e57]: 
      - generic [ref=e58]: 
  - button "I am a link with icon only" [ref=e64] [cursor=pointer]:
    - generic [ref=e67]: 
```
