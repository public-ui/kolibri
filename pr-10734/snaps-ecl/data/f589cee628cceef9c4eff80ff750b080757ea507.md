...
Locator: locator('[data-visual-block="info-popover"]')
  Expected an image 768px by 78px, received 768px by 96px. 3808 pixels (ratio 0.06 of all image pixels) are different.
...
- main [ref=e4]:
  - generic [ref=e5]:
    ...
    - generic [ref=e116]:
      - generic [ref=e120] [cursor=pointer]: Search
      - generic [ref=e122]:
        - searchbox "Search" [ref=e125]: test
