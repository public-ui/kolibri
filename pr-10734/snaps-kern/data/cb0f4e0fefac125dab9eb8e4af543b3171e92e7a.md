...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Snapshot: drawer-basic-align-left-closer-true.png

Call log:
  - Expect "toHaveScreenshot(drawer-basic-align-left-closer-true.png)" with timeout 10000ms
...
- main [ref=e4]:
  ...
  - generic [ref=e58]:
    ...
    - button "Open drawer" [ref=e85] [cursor=pointer]:
      - generic [ref=e88]: Open drawer
```
