...
Locator: locator('[data-visual-block="basic"]')
  Expected an image 768px by 418px, received 768px by 466px. 29237 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: details-basic--basic.png

Call log:
  - Expect "toHaveScreenshot(details-basic--basic.png)" with timeout 10000ms
...
- main [ref=e4]:
  ...
  - generic [ref=e7]:
    - strong [ref=e10]:
      - button "Closed initially" [ref=e13] [cursor=pointer]:
        - generic [ref=e15]:
          - generic [ref=e16]: 
          - generic [ref=e17]: Closed initially
    - generic [ref=e19]:
      - strong [ref=e20]:
        - button "Open initially (disabled)" [disabled] [expanded] [ref=e23]:
          - generic [ref=e25]:
            - generic [ref=e26]: 
            - generic [ref=e27]: Open initially (disabled)
      - region "Open initially (disabled)" [ref=e30]:
        - paragraph [ref=e31]: Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt.
    - generic [ref=e33]:
      - strong [ref=e34]:
        - button "Open initially" [expanded] [ref=e37] [cursor=pointer]:
          - generic [ref=e39]:
            - generic [ref=e40]: 
            - generic [ref=e41]: Open initially
      - region "Open initially" [ref=e44]:
