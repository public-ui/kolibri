...
Locator: locator('[data-visual-block="basic"]')
  Expected an image 768px by 474px, received 768px by 522px. 23197 pixels (ratio 0.06 of all image pixels) are different.

  Snapshot: accordion-basic--basic.png

Call log:
  - Expect "toHaveScreenshot(accordion-basic--basic.png)" with timeout 10000ms
...
- main [ref=e4]:
  ...
  - generic [ref=e7]:
    - generic [ref=e9]:
      - strong [ref=e10]:
        - button "Heading Accordion Tab 1 (open)" [expanded] [ref=e13] [cursor=pointer]:
          - generic [ref=e15]:
            - generic [ref=e16]: 
            - generic [ref=e17]: Heading Accordion Tab 1 (open)
      - region "Heading Accordion Tab 1 (open)" [ref=e20]:
        - paragraph [ref=e21]: Contents Accordion Tab 1
    - strong [ref=e24]:
      - button "Heading Accordion Tab 2" [ref=e27] [cursor=pointer]:
        - generic [ref=e29]:
          - generic [ref=e30]: 
          - generic [ref=e31]: Heading Accordion Tab 2
    - strong [ref=e34]:
      - button "Heading Accordion Tab 3 (deactivated)" [disabled] [ref=e37]:
        - generic [ref=e39]:
          - generic [ref=e40]: 
          - generic [ref=e41]: Heading Accordion Tab 3 (deactivated)
    - generic [ref=e43]:
      - strong [ref=e44]:
        - button "Heading Accordion Tab 4 (disabled and open)" [disabled] [expanded] [ref=e47]:
          - generic [ref=e49]:
            - generic [ref=e50]: 
            - generic [ref=e51]: Heading Accordion Tab 4 (disabled and open)
      - region "Heading Accordion Tab 4 (disabled and open)" [ref=e54]:
        - paragraph [ref=e55]: Contents Accordion Tab 4
```
