...
Locator: locator('[data-visual-block="buttons"]')
  54 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: icon-font--buttons.png

Call log:
  - Expect "toHaveScreenshot(icon-font--buttons.png)" with timeout 10000ms
    - verifying given screenshot expectation
  - waiting for locator('[data-visual-block="buttons"]')
    - locator resolved to <div data-visual-block="buttons" class="grid grid-cols-2 gap-8 p-8">…</div>
...
- main [ref=e4]:
  ...
  - generic [ref=e7]:
    - generic [ref=e8]:
      - img "icon icon-dark-mode" [ref=e10]: 
      - generic [ref=e11]: <KolIcon _icons='icon icon-dark-mode' _label="icon icon-dark-mode" />
    - generic [ref=e12]:
      - img "icon icon-light-mode" [ref=e14]: 
      - generic [ref=e15]: <KolIcon _icons='icon icon-light-mode' _label="icon icon-light-mode" />
    - generic [ref=e16]:
      - img "icon icon-brightness-medium" [ref=e18]: 
      - generic [ref=e19]: <KolIcon _icons='icon icon-brightness-medium' _label="icon icon-brightness-medium" />
    - generic [ref=e20]:
      - img "icon icon-warning" [ref=e22]: 
      - generic [ref=e23]: <KolIcon _icons='icon icon-warning' _label="icon icon-warning" />
  - generic [ref=e26]:
    - button "Button" [ref=e29] [cursor=pointer]:
      - generic [ref=e31]:
        - generic [ref=e32]: 
        - generic [ref=e33]: Button
    - generic [ref=e34]: <KolButton _icons='icon icon-settings' _label="Button" _variant="primary" />
  - generic [ref=e37]:
    - generic [ref=e39]:
    ...
    - generic [ref=e50]: <KolInputText _icons='icon icon-content-copy' _label="Input with Icon" />
```
