...
Locator: locator('[data-visual-block="variants"]')
  Expected an image 768px by 160px, received 768px by 172px. 7674 pixels (ratio 0.06 of all image pixels) are different.

  Snapshot: button-variants--variants.png

Call log:
  - Expect "toHaveScreenshot(button-variants--variants.png)" with timeout 10000ms
