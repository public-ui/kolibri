...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  2918 pixels (ratio 0.13 of all image pixels) are different.

  Snapshot: scenarios-focus-elements-component-splitButton.png

Call log:
  - Expect "toHaveScreenshot(scenarios-focus-elements-component-splitButton.png)" with timeout 10000ms
...
- main [ref=e4]:
  - generic [ref=e8]:
    - button "SplitButton here" [ref=e11] [cursor=pointer]:
      - generic [ref=e14]: SplitButton here
