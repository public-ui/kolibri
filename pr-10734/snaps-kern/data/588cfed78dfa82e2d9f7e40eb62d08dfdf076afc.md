...
Locator: locator('[data-visual-block="basic"]')
  Expected an image 187px by 44px, received 187px by 52px. 1002 pixels (ratio 0.11 of all image pixels) are different.

  Snapshot: button-link-basic--basic.png

Call log:
  - Expect "toHaveScreenshot(button-link-basic--basic.png)" with timeout 10000ms
    - verifying given screenshot expectation
  - waiting for locator('[data-visual-block="basic"]')
    - locator resolved to <div data-visual-block="basic" class="flex flex-col gap-2">…</div>
...
- main [ref=e4]:
  ...
  - paragraph [ref=e8]:
    ...
    - button "Simple Link" [ref=e12] [cursor=pointer]:
      - generic [ref=e15]: Simple Link
    - text: It is rendered by default as an
    - strong [ref=e16]: inline element
    - text: .
  - paragraph [ref=e17]:
    - text: In this paragraph, a link is inserted that is rendered as an inline-block element.
    - button "Simple Link" [ref=e21] [cursor=pointer]:
      - generic [ref=e24]: Simple Link
    ...
    - button "Simple Link" [ref=e28] [cursor=pointer]:
      - generic [ref=e31]: Simple Link
    - text: Therefore, I go over the entire width of the parent element to create a line break.
  - 'heading "Button-Link with _inline={false}" [level=2] [ref=e33]': "Button-Link with _inline={false}"
  - paragraph [ref=e34]: Use the boolean _inline property to render the link inline (default) or standalone.
  - button "Standalone ButtonLink" [ref=e40] [cursor=pointer]:
    - generic [ref=e43]: Standalone ButtonLink
  - button "Disabled ButtonLink" [disabled] [ref=e49]:
    - generic [ref=e52]: Disabled ButtonLink
  - button "With access key" [ref=e58] [cursor=pointer]:
    - generic [ref=e60]:
      - generic [ref=e61]: With access key
      - generic [ref=e62]: c
  - button "With short key" [ref=e68] [cursor=pointer]:
    - generic [ref=e70]:
      - generic [ref=e71]: With short key
      - generic [ref=e72]: s
  - button "Special Variant ButtonLink" [ref=e78] [cursor=pointer]:
    - generic [ref=e81]: Special Variant ButtonLink
```
