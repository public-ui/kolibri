...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  2889 pixels (ratio 0.13 of all image pixels) are different.

  Snapshot: scenarios-focus-elements-component-popoverButton.png

Call log:
  - Expect "toHaveScreenshot(scenarios-focus-elements-component-popoverButton.png)" with timeout 10000ms
...
```yaml
- main [ref=e4]:
  - button "PopoverButton here" [ref=e10] [cursor=pointer]:
    - generic [ref=e13]: PopoverButton here
```
