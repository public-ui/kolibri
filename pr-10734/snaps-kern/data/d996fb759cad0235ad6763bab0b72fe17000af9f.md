...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  1220 pixels (ratio 0.06 of all image pixels) are different.

  Snapshot: scenarios-focus-elements-component-toolbar.png

Call log:
  - Expect "toHaveScreenshot(scenarios-focus-elements-component-toolbar.png)" with timeout 10000ms
...
- main [ref=e4]:
  - toolbar "Toolbar here" [ref=e7]:
    - button "Action 1" [ref=e10] [cursor=pointer]:
      - generic [ref=e13]: Action 1
    - button "Action 2" [ref=e16] [cursor=pointer]:
      - generic [ref=e19]: Action 2
```
