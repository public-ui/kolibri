...
Locator: locator('[data-visual-block="smart-button"]')
  Expected an image 212px by 96px, received 216px by 109px. 6237 pixels (ratio 0.27 of all image pixels) are different.

  Snapshot: badge-basic--smart-button.png

Call log:
  - Expect "toHaveScreenshot(badge-basic--smart-button.png)" with timeout 10000ms
    - verifying given screenshot expectation
  - waiting for locator('[data-visual-block="smart-button"]')
    - locator resolved to <div class="flex flex-col gap-2" data-visual-block="smart-button">…</div>
        ...
        - generic [ref=e58]:
          ...
          - generic [ref=e63]:
            - button "Remove" [ref=e64] [cursor=pointer]:
              - generic [ref=e67]: 
            - generic [ref=e68]: blue
        - generic [ref=e70]:
          - generic [ref=e72]:
            - generic [ref=e73]: 
            - generic [ref=e74]: purple with icon
          - generic [ref=e76]:
            - button "Remove" [ref=e77] [cursor=pointer]:
              - generic [ref=e80]: 
            - generic [ref=e81]: purple with icon
    - generic [ref=e82]:
      - heading "Formatted Label" [level=2] [ref=e84]: Formatted Label
      - generic [ref=e85]:
        - generic [ref=e90]:
          - strong [ref=e91]: Bold
          - text: and
          - emphasis [ref=e92]: italic
          - text: Markdown label
        - generic [ref=e97]: This is strikethrough text
        - generic [ref=e102]:
          - text: Source code like
          - code [ref=e103]: y = mx + n
          - text: is possible
```
