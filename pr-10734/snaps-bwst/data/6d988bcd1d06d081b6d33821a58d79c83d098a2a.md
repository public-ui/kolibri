...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 77px, received 300px by 101px. 1791 pixels (ratio 0.06 of all image pixels) are different.

  Snapshot: scenarios-focus-elements-component-accordion.png

Call log:
  - Expect "toHaveScreenshot(scenarios-focus-elements-component-accordion.png)" with timeout 10000ms
...
- main [ref=e4]:
  - strong [ref=e8]:
    - button "Accordion here" [ref=e11] [cursor=pointer]:
      - generic [ref=e13]:
        - generic [ref=e14]: 
        - generic [ref=e15]: Accordion here
```
