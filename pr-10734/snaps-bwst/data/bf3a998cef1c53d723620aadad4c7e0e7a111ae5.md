...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 102px, received 300px by 104px. 1972 pixels (ratio 0.07 of all image pixels) are different.

  Snapshot: scenarios-focus-elements-component-inputFile.png

Call log:
  - Expect "toHaveScreenshot(scenarios-focus-elements-component-inputFile.png)" with timeout 10000ms
