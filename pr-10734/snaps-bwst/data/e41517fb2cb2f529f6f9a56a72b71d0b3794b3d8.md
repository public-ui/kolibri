...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  2274 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: scenarios-focus-elements-component-details.png

Call log:
  - Expect "toHaveScreenshot(scenarios-focus-elements-component-details.png)" with timeout 10000ms
...
- main [ref=e4]:
  - strong [ref=e8]:
    - button "Details here" [ref=e11] [cursor=pointer]:
      - generic [ref=e13]:
        - generic [ref=e14]: 
        - generic [ref=e15]: Details here
```
