...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 200px by 296px, received 200px by 324px. 3018 pixels (ratio 0.05 of all image pixels) are different.
  ...
  - generic [ref=e6]:
    ...
    - generic [ref=e34]:
      ...
      - region "With Table" [ref=e45]:
        - table "Table for demonstration purposes with different text align properties" [ref=e46]:
          - caption [ref=e47]: Table for demonstration purposes with different text align properties
          - rowgroup [ref=e48]:
            - row "left center right" [ref=e49]:
              - columnheader "left" [ref=e50]
              - columnheader "center" [ref=e51]
              - columnheader "right" [ref=e52]
          - rowgroup [ref=e53]:
            - alert [ref=e54]: Data in table Table for demonstration purposes with different text align properties got loaded.
