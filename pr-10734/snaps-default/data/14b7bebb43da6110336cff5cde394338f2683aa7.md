...
Locator: locator('[data-visual-block="variant"]')
  Expected an image 187px by 19px, received 187px by 44px. 1385 pixels (ratio 0.17 of all image pixels) are different.

  Snapshot: button-link-basic--variant.png

Call log:
  - Expect "toHaveScreenshot(button-link-basic--variant.png)" with timeout 10000ms
    - verifying given screenshot expectation
  - waiting for locator('[data-visual-block="variant"]')
    - locator resolved to <div data-visual-block="variant" class="flex flex-col gap-2">…</div>
