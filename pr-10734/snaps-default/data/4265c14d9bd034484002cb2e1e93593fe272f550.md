...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  1473 pixels (ratio 0.04 of all image pixels) are different.

  Snapshot: popover-button-basic.png

Call log:
  - Expect "toHaveScreenshot(popover-button-basic.png)" with timeout 10000ms
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    - generic [ref=e8]:
      - button "Actions" [expanded] [ref=e11] [cursor=pointer]:
        - generic [ref=e13]:
          - generic [ref=e14]: Actions
          - generic [ref=e15]: 
      - toolbar "Action toolbar" [ref=e18]:
        - button "Show" [ref=e21] [cursor=pointer]:
          - generic [ref=e23]:
            - generic [ref=e24]: 
            - generic [ref=e25]: Show
