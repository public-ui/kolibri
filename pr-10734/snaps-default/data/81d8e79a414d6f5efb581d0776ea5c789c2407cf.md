...
Locator: locator('[data-visual-block="inline"]')
  Expected an image 268px by 179px, received 268px by 203px. 2863 pixels (ratio 0.06 of all image pixels) are different.

  Snapshot: popover-button-inline--inline.png

Call log:
  - Expect "toHaveScreenshot(popover-button-inline--inline.png)" with timeout 10000ms
    - verifying given screenshot expectation
  - waiting for locator('[data-visual-block="inline"]')
    - locator resolved to <div data-visual-block="inline" class="flex flex-col gap-4">…</div>
