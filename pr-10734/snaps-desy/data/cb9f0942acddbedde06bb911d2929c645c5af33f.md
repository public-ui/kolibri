...
Locator: locator('[data-visual-block="top"]')
  Expected an image 235px by 44px, received 235px by 45px. 

  Snapshot: button-link-icons--top.png

Call log:
  - Expect "toHaveScreenshot(button-link-icons--top.png)" with timeout 10000ms
    - verifying given screenshot expectation
  - waiting for locator('[data-visual-block="top"]')
    - locator resolved to <div class="grid gap-4" data-visual-block="top">…</div>
