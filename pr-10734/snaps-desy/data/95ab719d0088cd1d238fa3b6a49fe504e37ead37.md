...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 54px, received 300px by 76px. 1887 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: scenarios-focus-elements-component-buttonLink.png

Call log:
  - Expect "toHaveScreenshot(scenarios-focus-elements-component-buttonLink.png)" with timeout 10000ms
...
```yaml
- main [ref=e4]:
  - button "ButtonLink here" [ref=e9] [cursor=pointer]:
    - generic [ref=e12]: ButtonLink here
```
