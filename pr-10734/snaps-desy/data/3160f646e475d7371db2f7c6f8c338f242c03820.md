...
Locator: locator('[data-visual-block="show-password"]')
  110 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: input-password-show-password-noColumns--show-password.png

Call log:
  - Expect "toHaveScreenshot(input-password-show-password-noColumns--show-password.png)" with timeout 10000ms
    - verifying given screenshot expectation
  - waiting for locator('[data-visual-block="show-password"]')
    - locator resolved to <div class="grid gap-4" data-visual-block="show-password">…</div>
  ...
  - generic [ref=e9]:
    ...
    - generic:
      ...
      - generic [ref=e46]:
        ...
        - generic [ref=e52]:
          - textbox "Password" [disabled] [ref=e54]:
