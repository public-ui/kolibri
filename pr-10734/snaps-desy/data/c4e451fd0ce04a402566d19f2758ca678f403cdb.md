...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  292 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: modal-basic-show-dialog-true.png

Call log:
  - Expect "toHaveScreenshot(modal-basic-show-dialog-true.png)" with timeout 10000ms
    - verifying given screenshot expectation
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - 641 pixels (ratio 0.01 of all image pixels) are different.
