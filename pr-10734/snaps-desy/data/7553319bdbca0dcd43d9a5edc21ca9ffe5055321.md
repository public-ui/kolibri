...
Locator: locator('[data-visual-block="enabled"]')
  32 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: input-text-smart-button-noColumns--enabled.png

Call log:
  - Expect "toHaveScreenshot(input-text-smart-button-noColumns--enabled.png)" with timeout 10000ms
    - verifying given screenshot expectation
  - waiting for locator('[data-visual-block="enabled"]')
    - locator resolved to <div class="grid gap-4" data-visual-block="enabled">…</div>
  ...
  - generic [ref=e5]:
    ...
    - generic [ref=e10]:
      ...
      - generic [ref=e16]:
        ...
        - generic [ref=e21]:
          - button "Open Toast" [ref=e24] [cursor=pointer]:
            - generic [ref=e27]: 
          - generic [ref=e28]: 
    - generic [ref=e32]:
      - generic [ref=e36]: Disabled input with button and icons
      - generic [ref=e38]:
        - generic [ref=e40]: 
        - textbox "Disabled input with button and icons" [disabled] [ref=e42]
        - generic [ref=e43]:
          - button "Disabled Button" [disabled] [ref=e46]:
            - generic [ref=e49]: 
          - generic [ref=e50]: 
```
