...
Locator: locator('[data-visual-block="search"]')
  37 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: input-text-basic-noColumns--search.png

Call log:
  - Expect "toHaveScreenshot(input-text-basic-noColumns--search.png)" with timeout 10000ms
    - verifying given screenshot expectation
  - waiting for locator('[data-visual-block="search"]')
    - locator resolved to <div class="grid gap-4" data-visual-block="search">…</div>
