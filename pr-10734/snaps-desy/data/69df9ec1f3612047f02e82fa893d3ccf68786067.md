...
Locator: locator('[data-visual-block="info-popover"]')
  Expected an image 768px by 63px, received 768px by 78px. 3728 pixels (ratio 0.07 of all image pixels) are different.

  Snapshot: input-text-basic-noColumns--info-popover.png

Call log:
  - Expect "toHaveScreenshot(input-text-basic-noColumns--info-popover.png)" with timeout 10000ms
    - verifying given screenshot expectation
  - waiting for locator('[data-visual-block="info-popover"]')
    - locator resolved to <div class="grid gap-4" data-visual-block="info-popover">…</div>
  ...
  - generic [ref=e5]:
    ...
    - generic [ref=e81]:
      - generic [ref=e82] [cursor=pointer]:
        ...
        - button "hint" [ref=e89]:
          - generic [ref=e92]: 
      - textbox "Name hint" [ref=e96]: Anderson-Clark
    - generic [ref=e100]:
      - generic [ref=e104] [cursor=pointer]: Name
      - generic [ref=e106]:
        - generic [ref=e108]: 
        - textbox "Name" [ref=e110]: Anderson-Clark
    - generic [ref=e114]:
      - generic [ref=e118] [cursor=pointer]: Search
      - generic [ref=e120]:
        - searchbox "Search" [ref=e122]: test
