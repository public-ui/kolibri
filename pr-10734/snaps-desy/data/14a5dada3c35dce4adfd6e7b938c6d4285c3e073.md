...
Locator: locator('[data-visual-block="create-button"]')
  Expected an image 262px by 117px, received 254px by 137px. 1529 pixels (ratio 0.05 of all image pixels) are different.

  Snapshot: tabs-create-button--create-button.png

Call log:
  - Expect "toHaveScreenshot(tabs-create-button--create-button.png)" with timeout 10000ms
    - verifying given screenshot expectation
  - waiting for locator('[data-visual-block="create-button"]')
    - locator resolved to <div class="grid gap-4" data-visual-block="create-button">…</div>
    ...
    - tablist "Tabs with create button" [ref=e10]:
      ...
      - button "New …" [ref=e25] [cursor=pointer]:
        - generic [ref=e27]:
          - generic [ref=e28]: 
          - generic [ref=e29]: New …
    - tabpanel "First tab" [ref=e31]:
      - generic [ref=e32]: Contents of First tab
```
