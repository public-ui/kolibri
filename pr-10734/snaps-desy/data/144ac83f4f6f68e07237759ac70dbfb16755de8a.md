...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 95px, received 300px by 99px. 2302 pixels (ratio 0.08 of all image pixels) are different.

  Snapshot: scenarios-focus-elements-component-inputFileMultiple.png

Call log:
  - Expect "toHaveScreenshot(scenarios-focus-elements-component-inputFileMultiple.png)" with timeout 10000ms
...
- main [ref=e4]:
  - generic [ref=e7]:
    ...
    - generic [ref=e14]:
      ...
      - button "Browse" [ref=e19] [cursor=pointer]:
