...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 112px, received 300px by 132px. 1376 pixels (ratio 0.04 of all image pixels) are different.

  Snapshot: scenarios-focus-elements-component-tabs.png

Call log:
  - Expect "toHaveScreenshot(scenarios-focus-elements-component-tabs.png)" with timeout 10000ms
  ...
  - generic [active] [ref=e6]:
    ...
    - generic [ref=e7]:
      - tablist "Tabs here" [ref=e8]:
        - tab "Tab 1" [selected] [ref=e11] [cursor=pointer]:
          - generic [ref=e14]: Tab 1
        - tab "Tab 2" [ref=e17] [cursor=pointer]:
          - generic [ref=e20]: Tab 2
        - tab "Tab 3" [ref=e23] [cursor=pointer]:
          - generic [ref=e26]: Tab 3
      - generic [ref=e27]:
        - tabpanel "Tab 1"
```
