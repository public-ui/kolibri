...
- Name: theme-snapshots.spec.js >> snapshot for abbr/basic
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 134px, received 800px by 83px. 534 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: snapshot-for-abbr-basic.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-abbr-basic.png)" with timeout 10000ms
...
```yaml
- main [ref=e4]:
  - heading "abbr basic" [level=1] [ref=e5]
  - paragraph [ref=e6]:
    - text: I am
    - generic [ref=e7]:
      - generic: e.g.
