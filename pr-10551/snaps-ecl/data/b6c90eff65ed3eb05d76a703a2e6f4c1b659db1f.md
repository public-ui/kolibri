...
- Name: theme-snapshots.spec.js >> snapshot for table/sticky-header
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1300px by 1032px, received 1300px by 1000px. 104736 pixels (ratio 0.08 of all image pixels) are different.

  Snapshot: snapshot-for-table-sticky-header.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-table-sticky-header.png)" with timeout 10000ms
