...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 250px by 330px, received 250px by 300px. 5401 pixels (ratio 0.07 of all image pixels) are different.

  Snapshot: snapshot-for-heading-basic.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-heading-basic.png)" with timeout 10000ms
