...
- Name: theme-snapshots.spec.js >> snapshot for spin/cycle
...
Timeout: 10000ms
  ...
  Snapshot: snapshot-for-spin-cycle.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-spin-cycle.png)" with timeout 10000ms
