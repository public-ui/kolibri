import{d as e,o as t,r as n,s as r,w as i}from"./index-ClXq-INa.js";import{t as a}from"./base-web-component--IgFgz37-CZuvR3uB.js";import"./_Uint8Array-kJnEuTzT-BYXN1zbF.js";import{d as o,r as s}from"./factory-DVePsLAQ-CSPXiENz.js";import"./label-BJf95S0B-CN3uiexX.js";import{t as c}from"./label-CnOLrr0w-X-BeQNJT.js";import{r as l}from"./variant-quote-7bJL1WOX-n6FveqKX.js";import{t as u}from"./href-C8BqY9-O-BvpvRdCu.js";var d=s(`quote`,``,o),f={optional:[c,l],required:[u,d]},p=e.forBlock(`kol-quote`),m=p(`blockquote`),h=p(`cite`),g=p(`figcaption`),_=p(`quote`),v=e=>{let{href:n,label:r,quote:a,variant:o}=e,s=a===``,c=p({[o]:!0});return t(`figure`,{class:c},o===`block`?t(`blockquote`,{class:m,cite:n},a,t(`span`,{"aria-hidden":s?void 0:`true`,hidden:!s},t(`slot`,{name:`expert`}))):t(`q`,{class:_,cite:n},a,t(`span`,{"aria-hidden":s?void 0:`true`,hidden:!s},t(`slot`,{name:`expert`}))),typeof r==`string`&&r.length>0&&t(`figcaption`,{class:g},t(`cite`,{class:h},t(i,{_href:n,_label:r,_target:`_blank`}))))},y=`@charset "UTF-8";
