import{t as e}from"./tooltip-open-tracking-D3tCiiGP-CEtn2Gu2.js";import{Ct as t,Dt as n,a as r,c as i,o as a,r as o,s,u as c,y as l,yt as u}from"./index-DEVIV0un.js";import{n as d}from"./dev.utils-DEzQ6pd0-sOvaBYCZ.js";import"./_Uint8Array-kJnEuTzT-BYXN1zbF.js";import"./factory-DVePsLAQ-CKczWQRi.js";import{t as f}from"./level-B1-aeVNt-B4xElwvX.js";import{r as p}from"./label-BJf95S0B-Bgr8zXaT.js";import{t as m}from"./clsx-COFh-Vc8-DWAop4cA.js";import{n as h}from"./align-Dm5aJHmk-DNSAFzRh.js";import{n as g,t as _}from"./scroll-lock-BWDLIEQu-CykNS5eN.js";import{t as v}from"./open-v80i9O0s-B-zxlMj3.js";var y=(e,n)=>{t(e,`_hasCloser`,n)},b=(e,t)=>{n(e,`_level`,e=>typeof e==`number`&&f.includes(e),new Set(f.map(String)),t,{defaultValue:1,required:!0})},x=`@charset "UTF-8";
/*
...
}`,S=class{constructor(t){s(this,t),this.cardHeadingId=d(`drawer-heading`),this.isModal=!0,this._cardOn={onClose:()=>void this.close()},this.getWrapperRef=e=>this.dialogWrapperElement=e,this.getRef=e=>{this.dialogElement=e,setTimeout(()=>{this.openOrCloseBasedOnState()})},this._hasCloser=!1,this._level=0,this.state={_label:``,_open:!1,_align:`left`},this.handleCancelEvent=t=>{var n,r;e(t),!t.defaultPrevented&&((r=(n=this.state._on)?.onCancel)==null||r.call(n,t),!t.defaultPrevented&&this.host&&!c(this.host,i.cancel)&&t.preventDefault())},this.handleClose=()=>{g(this),(async()=>{await this.close(),this.handleCloseDialog()})()},this.handleAnimationEnd=e=>{var t,n;e.animationName.includes(`slideOut`)&&((n=(t=this.dialogElement)?.close)==null||n.call(t))}}async show(e=!1){var t,n,r,a,o,s;this.dialogElement?.open||(this.isModal=e,this.state=Object.assign(Object.assign({},this.state),{_open:!0}),e?((n=(t=this.dialogElement)?.showModal)==null||n.call(t),this.dialogElement&&_(this)):(a=(r=this.dialogElement)?.show)==null||a.call(r),(s=(o=this._on)?.onToggle)==null||s.call(o,!0),this.host&&c(this.host,i.toggle))}showModal(){return this.show(!0)}open(){return this.show(!1)}async close(){var e,t;this.state=Object.assign(Object.assign({},this.state),{_open:!1});let n=this.dialogWrapperElement;n&&window.getComputedStyle(n).animationName===`none`&&((t=(e=this.dialogElement)?.close)==null||t.call(e))}renderDialogContent(){let e=this.state._align;return a(l,{ref:this.getWrapperRef,class:m(`kol-drawer__wrapper`,`kol-drawer__wrapper--${e}`,{"kol-drawer__wrapper--open":this.state._open,"kol-drawer__wrapper--is-closing":this.state._open===!1}),_hasCloser:this.state._hasCloser,_headingId:this.cardHeadingId,_label:this.state._label,_level:this._level,_on:this._cardOn},a(`div`,{class:`kol-drawer__content`},a(`slot`,null)))}render(){return a(o,{key:`f4713ff90c12db78f83491d96f62065e49c4281c`,class:`kol-drawer`},a(`dialog`,{key:`31171d6f6118eb0e5a4bb7996cb763ba3a34db7b`,"aria-labelledby":this.cardHeadingId,"aria-modal":this.isModal?`true`:`false`,class:`kol-drawer__dialog`,onCancel:this.handleCancelEvent,ref:this.getRef},this.renderDialogContent()))}validateLabel(e){p(this,e,{required:!0})}validateAlign(e){h(this,e)}validateHasCloser(e){y(this,e)}validateLevel(e){b(this,e)}validateOpen(e){typeof e==`boolean`&&(v(this,e),this.dialogElement&&this.openOrCloseBasedOnState())}async openOrCloseBasedOnState(){this.state._open?await this.show(this.isModal):await this.close()}validateOn(e){if(typeof e==`object`&&e){let t={};typeof e.onCancel==`function`&&(t.onCancel=e.onCancel),typeof e.onClose==`function`&&(t.onClose=e.onClose),typeof e.onToggle==`function`&&(t.onToggle=e.onToggle),u(this,`_on`,t)}}handleCloseDialog(){var e,t,n,r;(t=(e=this._on)?.onClose)==null||t.call(e),(r=(n=this._on)?.onToggle)==null||r.call(n,!1),this.host&&(c(this.host,i.close),c(this.host,i.toggle))}componentDidLoad(){var e,t;(e=this.dialogElement)==null||e.addEventListener(`animationend`,this.handleAnimationEnd),(t=this.dialogElement)==null||t.addEventListener(`close`,this.handleClose)}disconnectedCallback(){var e,t;(e=this.dialogElement)==null||e.removeEventListener(`animationend`,this.handleAnimationEnd),(t=this.dialogElement)==null||t.removeEventListener(`close`,this.handleClose),g(this)}componentWillLoad(){this.validateAlign(this._align),this.validateHasCloser(this._hasCloser),this.validateLabel(this._label),this.validateOpen(this._open),this.validateLevel(this._level),this.validateOn(this._on)}get host(){return r(this)}static get watchers(){return{_label:[`validateLabel`],_align:[`validateAlign`],_hasCloser:[`validateHasCloser`],_level:[`validateLevel`],_open:[`validateOpen`],_on:[`validateOn`]}}};S.style={default:x};export{S as kol_drawer};