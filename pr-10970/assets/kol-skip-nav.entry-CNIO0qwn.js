import{St as e,U as t,_t as n,a as r,c as i,d as a,o,r as s,s as c,u as l}from"./index-DzxTLKdn.js";import{i as u}from"./dev.utils-DEzQ6pd0-DVwSIawx.js";import{n as d,t as f}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as p}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./_Uint8Array-kJnEuTzT-BYXN1zbF.js";import{a as m,r as h}from"./factory-DVePsLAQ-BCQd6fBI.js";import{t as g}from"./disabled-CTTZKNPl-hEDmZmOt.js";import"./label-BJf95S0B-Bjer-hOf.js";import"./label-CnOLrr0w-Cw2vDdOT.js";import"./variant-quote-7bJL1WOX-DCUg1ZsB.js";import{r as _,t as v}from"./element-interaction-DORv36BQ-BSHBQDXV.js";import"./block-bem-BGMd0WJH-BehV--16.js";import"./component-BG05O9Id-D_Bi_WX1.js";import"./component-DIrul5pb-BfQ284_v.js";import"./i18n-B_vSiQA9-BIb9uLqz.js";import"./component-1zt0BWKC-BgF-jlKk.js";import"./variant-class-name-2os1V9lQ-CzNff1xf.js";import"./component-COEI4VoT-Bqek5t0q.js";import"./align-Dm5aJHmk-DtlcWPGq.js";import{t as y}from"./behavior-Cxx5cP6o-C_cLm7ai.js";import{t as b}from"./label-with-expert-slot-Dh4zRZEb-4ZK0-JuP.js";import{d as x,f as S,l as C,n as w,o as T,r as E,s as D,t as O,u as k}from"./variant-BBnlDNla-CJ96mBLf.js";import{t as A}from"./href-C8BqY9-O-DnBu8CxA.js";import{t as j}from"./link-target-Dn2nOGYR-22qrpxwh.js";import{a as M,i as N,n as P,o as F,t as I}from"./api-Cmxpq9Zo-zqpv0OE-.js";import{t as L}from"./access-and-short-key-ijzCZfHm-Dx5Q-CAn.js";import{n as R,t as z}from"./unique-nav-labels-DWO8JUzQ-Cmlj_fVE.js";var B=h(`links`,[],e=>m(e),e=>e.every(e=>typeof e==`object`&&(typeof e._href==`string`||typeof e._label==`string`)),{hints:(t,n)=>e(`KolSkipNav`,n.length)}),V={required:[B,b]},H=a.forBlock(`kol-skip-nav`),U=H(),W=H(`list`),G=H(`list-item`),K=({label:e,linkItems:t})=>o(`nav`,{class:U,"aria-label":e},o(`ul`,{class:W},t.map((e,t)=>o(`li`,{class:G,key:t},o(I,Object.assign({},e.fcProps)))))),q=(e,t)=>{let r=new y(f.stateLess),a=v(),o=d(F);delete o.tabIndex;let s=(e,t)=>e.apply(t,t=>{o[e.propName]=t});s(O,e._accessKey),s(w,e._ariaControls),s(P,e._ariaCurrentValue),s(E,e._ariaDescription),s(g,e._disabled),s(N,e._download),s(T,e._hideLabel),s(A,e._href),s(k,e._icons),s(D,e._inline??!0),s(b,e._label),s(M,e._on),s(C,e._shortKey),typeof e._tabIndex==`number`&&s(x,e._tabIndex),s(j,e._target),s(S,e._tooltipAlign),L(e._accessKey,e._shortKey),r.componentWillLoad({label:(()=>{let e=o.label;if(typeof e==`string`&&e.length>0)return e;let t=o.href;return typeof t==`string`?t:``})(),align:o.tooltipAlign}),o.ariaCurrent=``,o.ariaDescriptionId=u(),o.expertSlot=e._label===``;let c=()=>typeof o.href==`string`?o.href:``;return o.handleAnchorClick=e=>{if(r.hideTooltip(),o.disabled===!0){e.preventDefault();return}let s=c(),u=o.on;typeof u?.onClick==`function`&&(n(e,a.el),u.onClick(e,s));let d=t();d&&l(d,i.click,s)},o.refAnchor=e=>{a(e)},o.refTooltip=r.setTooltipElementRef,{fcProps:o,getAnchor:()=>a.el,syncTooltipListeners:()=>{a.el&&r.syncListeners(void 0,a.el,!0)},destroy:()=>{r.destroy()}}},J=`@charset "UTF-8";
