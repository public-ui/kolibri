import{Dt as e,Tt as t,_ as n,a as r,kt as i,o as a,s as o}from"./index-c4Gd8YY_.js";import{n as s}from"./dev.utils-VBoUDs60-Bkp6qvUC.js";import"./base-web-component-BT6jbe_v-Vp21XLG3.js";import{t as c}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{t as l}from"./clsx-COFh-Vc8-DWAop4cA.js";import"./Heading-RSuzeiY3-DHhkru63.js";import"./disabled-tmA090zy-iEtZdKv3.js";import"./label-43VWIjgW-CL8Rw8BQ.js";import{r as u,t as d}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import"./_Uint8Array-kJHDjtoP-CTkgs_0o.js";import"./normalizers-DwZ6RXph-BsYwiL8v.js";import{t as f}from"./i18n-DppON4Nc-CbULw0t3.js";import{t as p}from"./component-Cbqr3hDZ-BBUQVbe9.js";import"./Alert-BrThwIQc-Dk-c1Z2j.js";import"./label-B4jhdB3Q-05Ep4fjU.js";import"./variant-quote-B7A0-G7t-BMeEub5c.js";import"./component-C2H99wHM-DD6F-jvB.js";import"./icons-CxQkiQI9-DOg5aI_z.js";import"./access-and-short-key-BVBIy6Bf-CfxjHReT.js";import"./hide-label-Dqs_owkY-D1hqN_1B.js";import"./align-CMg-YzqB-VWKd98wK.js";import"./tooltip-align-BCIioKJU-DB2LYZaC.js";import"./variant-class-name-9vl8S3-X-CWxkXhtc.js";import"./component-CJNiKkbd-DcwUii-y.js";import"./align-floating-elements-DjivLyM2-PVHS6JnB.js";import"./controller-CpsgJ1zD-DSZw5Jq8.js";import"./aria-details-Bm1c0NRK-CSkBw-kh.js";import"./associated.controller-B22ATw25-CIKcr6QZ.js";import{s as m,t as h}from"./FormFieldStateWrapper-B42l6zXe-DfMQcOd2.js";import{n as g,t as _}from"./controller-icon-2XQ_1N28-BYUdIKO1.js";import"./Input-i4ObCLuq-D5o9ASnw.js";import{t as v}from"./InputStateWrapper-bwkYJ-Z5-BA7BuR6m.js";import{n as y,t as b}from"./CustomSuggestionsOptionsGroup-BOmzHi-1-pomop47K.js";import{t as x}from"./placeholder-S0DMyipR-CiWoF65T.js";import{t as S}from"./required-16oQLXa0-BWzXlEOH.js";import"./orientation-HCX-2i6Q-DSL3cqdi.js";import{i as C,r as w}from"./controller-CL0cL-eC-C-xinOJK.js";var T=class extends g{constructor(e,t,n){super(e,t,n),this.keyOptionMap=new Map,this.afterPatchOptions=(e,t,n,r)=>{r===`_value`&&this.setFormAssociatedValue(e)},this.beforePatchOptions=(e,t)=>{let n=t.has(`_options`)?t.get(`_options`):this.component.state._options;Array.isArray(n)&&n.length>0&&(this.keyOptionMap.clear(),w(this.keyOptionMap,n))},this.component=e}validateOptions(e){C(this.component,e,{hooks:{afterPatch:this.afterPatchOptions,beforePatch:this.beforePatchOptions}})}validateRequired(e){S(this.component,e)}validateValue(e){i(this.component,`_value`,e=>e!==void 0,new Set([`StencilUnknown`]),e)}validatePlaceholder(e){x(this.component,e)}validateHasClearButton(e){t(this.component,`_hasClearButton`,e)}validateRows(t){e(this.component,`_rows`,t)}componentWillLoad(){super.componentWillLoad(),this.validateOptions(this.component._options),this.validateRequired(this.component._required),this.validateValue(this.component._value),this.validatePlaceholder(this.component._placeholder),this.validateHasClearButton(this.component._hasClearButton),this.validateRows(this.component._rows)}},E=`@charset "UTF-8";
/*
