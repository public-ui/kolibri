import{$ as e,C as t,H as n,P as r,T as i,W as a,c as o,ct as s,it as c,o as l,r as u,s as d}from"./index-DcDxiC7I-CfHTAZqb.js";import{S as f,r as p,t as m,v as h}from"./index-fRrGFz2C.js";import{r as g}from"./label-BDgaSpkn-BLjQOrMY.js";import{t as _}from"./i18n-s5q4We3h-CxFHR29R.js";import{t as v}from"./aria-labelledby-6-ki3akM-C6lJ0lQF.js";import{t as y}from"./aria-labelledby-D8sZtnnh-DbQ0yCtm.js";import{t as b}from"./keyboard-DNd73LVa-BCj4IeP3.js";var x=(e,t,n={})=>{c(e,`_allowMultiSort`,t,Object.assign({defaultValue:!1},n))},S=(e,t)=>{c(e,`_hasSettingsMenu`,t)},C=[`top`,`bottom`,`both`],w=(e,t)=>{s(e,`_paginationPosition`,e=>typeof e==`string`&&C.includes(e),new Set([`PaginationPositionPropType {${C.join(`, `)}`]),t,{defaultValue:`bottom`})},T=(e,t)=>{s(e,`_on`,e=>typeof e==`object`&&!!e,new Set([`TableStatefulCallbacksPropType {Events.onSelectionChange}`]),t)},E=(t,r,o)=>{i(r,()=>{n(r,()=>{r===void 0&&(r=[]);try{r=a(r)}catch{}Array.isArray(r)&&r.every(e=>typeof e==`object`&&!!e)&&e(t,`_data`,r,o)})})},D=(t,r,o)=>{i(r,()=>{n(r,()=>{r===void 0&&(r=[]);try{r=a(r)}catch{}Array.isArray(r)&&r.every(e=>typeof e==`object`&&!!e)&&e(t,`_dataFoot`,r,o)})})},O=(e,t)=>{s(e,`_fixedCols`,e=>Array.isArray(e)&&e.length===2&&typeof e[0]==`number`&&typeof e[1]==`number`&&Number.isInteger(e[0])&&Number.isInteger(e[1])&&e[0]>=0&&e[1]>=0,new Set([`FixedColsPropType [leftFixed: number, rightFixed: number]`]),t)},k=(t,n)=>{(e=>e&&r(e)&&typeof e.label==`function`&&(!e.selectedKeys||Array.isArray(e.selectedKeys)))(typeof n==`string`?(()=>{try{return a(n)}catch{return}})():n)&&e(t,`_selection`,n)},A=`@charset "UTF-8";
/*
...
@layer kol-component {
  ...
  .kol-table__body:has(.kol-table__loader--shown) {
    position: relative;
    min-height: calc(var(--a11y-min-size) * 3);
  }
  .kol-table__cell--align-left {
    text-align: left;
  }
  .kol-table__cell--align-left .kol-table__sort-button .kol-button__text {
    align-items: start;
    text-align: start;
  }
  .kol-table__cell--align-left .kol-table__cell-actions {
    justify-content: flex-start;
  }
  .kol-table__cell--align-center {
    text-align: center;
  }
  .kol-table__cell--align-center .kol-table__sort-button .kol-button__text {
    align-items: center;
  }
  .kol-table__cell--align-right {
    text-align: right;
  }
  .kol-table__cell--align-right .kol-table__sort-button .kol-button__text {
    align-items: end;
    text-align: end;
  }
  .kol-table__cell--align-right .kol-table__cell-actions {
  ...
  .kol-table__cell--actions .kol-button__interactive-element {
    display: flex;
    flex: 1;
    text-align: left;
    text-decoration-line: none;
  ...
  .kol-table__cell--actions .kol-button__interactive-element::before {
    content: "​";
  }
  ...
  .kol-table__cell--actions .kol-button__tooltip {
    height: 0;
  }
  .kol-table__cell--actions .kol-button--external-link > .kolicon-link-external::before {
    content: none;
  }
  .kol-table__cell--actions .kol-button--external-link .kol-button__interactive-element > .kolicon-link-external::before {
    content: none;
  }
  .kol-table__cell--actions .kol-icon {
    color: inherit;
  ...
  .kol-table__cell--actions .kol-link--standalone .kol-link__interactive-element {
    align-items: stretch;
  }
  ...
  .kol-table__cell--actions .kol-link__interactive-element {
    display: inline-flex;
    flex: 1;
  ...
  .kol-table__cell--actions .kol-link__interactive-element:focus:not([aria-disabled], [disabled]) .kol-span__label, .kol-table__cell--actions .kol-link__interactive-element:hover:not([aria-disabled], [disabled]) .kol-span__label {
  ...
  .kol-table__selection-label {
    ...
    align-items: center;
    justify-content: center;
    /* The disabled modifier sits on the label, not on the selection wrapper: the former
       \`&--disabled\` one level up compiled to \`.kol-table__selection--disabled\`, which the
       component never renders, so the reset never applied. */
  }
  .kol-table__selection-label:not(.kol-table__selection-label--disabled) {
    cursor: pointer;
  }
...
}`,j=[10,20,50,100],M=e=>e===!0||e===``||typeof e==`object`&&!!e,N=class{constructor(t){o(this,t),this.resolvedElements=[],this.catchRef=e=>{this.tableWcRef=e},this.sortData=[],this.showPagination=!1,this.pageStartSlice=0,this.pageEndSlice=10,this.disableSort=!1,this._paginationPosition=`bottom`,this.state={_allowMultiSort:!1,_fixedCols:[0,0],_data:[],_dataFoot:[],_headers:{horizontal:[],vertical:[]},_label:``,_pagination:{_page:1,_pageSize:10,_max:0},_sortedData:[],_paginationPosition:`bottom`,_hasSettingsMenu:!1},this.handlePagination={onClick:(t,n)=>{typeof this.state._pagination._on?.onClick==`function`&&this.state._pagination._on.onClick(t,n),e(this,`_pagination`,Object.assign(Object.assign({},this.state._pagination),{_page:n}))},onChangePage:(t,n)=>{typeof this.state._pagination._on?.onChangePage==`function`&&this.state._pagination._on.onChangePage(t,n),e(this,`_pagination`,Object.assign(Object.assign({},this.state._pagination),{_page:n}))},onChangePageSize:(t,n)=>{typeof this.state._pagination._on?.onChangePageSize==`function`&&this.state._pagination._on.onChangePageSize(t,n),e(this,`_pagination`,Object.assign(Object.assign({},this.state._pagination),{_pageSize:n})),e(this,`_pageSize`,n)}},this.onSelectionChange=e=>{e.stopPropagation()},this.updateSortedData=()=>{if(this.disableSort){e(this,`_sortedData`,this.state._data);return}let t=[...this.state._data];this.sortData.length>0&&t.sort((e,t)=>{for(let n=0;n<this.sortData.length;n++){let r=this.sortData[n],i=r.compareFn(e,t,r.direction);if(i!==0)return r.direction===`ASC`?i:-i}return 0}),e(this,`_sortedData`,t)},this.handleChangeHeaderCells=e=>{this.adjustedHeaderCells=e}}validateAriaLabelledby(e){this.syncExternalLabel(e)}syncExternalLabel(e){this.resolvedElements=y(this,this.host,this.internals,e)}validateAllowMultiSort(e){x(this,e,{defaultValue:!1})}validateData(e){E(this,e,{afterPatch:()=>{setTimeout(this.updateSortedData)}})}validateDataFoot(e){D(this,e,{afterPatch:()=>{setTimeout(this.updateSortedData)}})}validateFixedCols(e){O(this,e)}validatePaginationPosition(e){w(this,e)}validateHasSettingsMenu(e){S(this,e)}changeCellSort(e){if(e.type===void 0||e.type==="default"){if(typeof e.compareFn!=`function`)return;!this.state._allowMultiSort&&e.key!==this.sortData[0]?.key&&(this.sortData=[]);let t=this.sortData.findIndex(t=>t.key===e.key);if(t>=0){let e=this.sortData[t];switch(e.direction){case`ASC`:e.direction=`DESC`;break;case`DESC`:this.sortData.splice(t,1);break;default:e.direction=`ASC`}}else e.key&&this.sortData.push({label:e.label,key:e.key,compareFn:e.compareFn,direction:`ASC`});this.updateSortedData()}}initializeSortFromHeaders(e){var n,r;let i=!1,a=e=>{this.sortData=[],e.forEach(e=>{if(e.type!==void 0&&e.type!=="default")return;if(typeof e.compareFn==`function`&&!e.key){t(`[KolTableStateful] A sortable column requires the 'key' property.`);return}let n=e.key;if(!n)return;let r=e.sortDirection;(r===`ASC`||r===`DESC`)&&typeof e.compareFn==`function`&&((this.state._allowMultiSort||this.sortData.length===0)&&this.sortData.push({label:e.label,key:n,compareFn:e.compareFn,direction:r}),i=!0)})};return(n=e.horizontal)==null||n.forEach(a),(r=e.vertical)==null||r.forEach(a),i}validateHeaders(e){i(e,()=>{n(e,()=>{try{e=a(e)}catch{}s(this,`_headers`,e=>typeof e==`object`&&!!e,new Set([`KoliBriTableHeaders`]),e,{hooks:{beforePatch:e=>{let n=e;this.headerKeysChanged(this.state._headers,n)&&(this.adjustedHeaderCells=void 0),this.initializeSortFromHeaders(n)&&setTimeout(()=>this.updateSortedData()),n.horizontal&&n.vertical&&n.horizontal?.length>0&&n.vertical?.length>0&&(this.disableSort=!0,t(`Table: You can not sort the table data, if horizontal and vertical headers are defined at the same time. (https://github.com/public-ui/kolibri/issues/2372)`))}}})})})}validateLabel(e){g(this,e,{required:!0})}validateSelection(e){k(this,e)}validateOn(e){T(this,e)}validatePagination(e){try{e=a(e)}catch{}this.showPagination=M(e),s(this,`_pagination`,M,new Set([`boolean`,`KoliBriTablePagination`]),e,{defaultValue:{_page:1,_pageSize:10,_max:0}})}componentDidLoad(){var e;(e=this.tableWcRef)==null||e.addEventListener(m.selectionChange,this.onSelectionChange),this.resolvedElements.length||this.syncExternalLabel(this._ariaLabelledby)}disconnectedCallback(){var e;(e=this.tableWcRef)==null||e.removeEventListener(m.selectionChange,this.onSelectionChange)}componentWillLoad(){this.internals=v(this.host),this.syncExternalLabel(this._ariaLabelledby),this.validateAllowMultiSort(this._allowMultiSort),this.validateData(this._data),this.validateDataFoot(this._dataFoot),this.validateFixedCols(this._fixedCols),this.validateHeaders(this._headers),this.validateLabel(this._label),this.validateOn(this._on),this.validatePagination(this._pagination),this.validatePaginationPosition(this._paginationPosition),this.validateSelection(this._selection),this.validateHasSettingsMenu(this._hasSettingsMenu)}selectDisplayedData(e,t,n){return typeof t==`number`&&t>0&&typeof n==`number`&&n>0?(this.pageStartSlice=t*(n-1),this.pageEndSlice=t*n>e.length?e.length:t*n,e.slice(this.pageStartSlice,this.pageEndSlice)):(this.pageStartSlice=0,this.pageEndSlice=e.length,e)}renderPagination(e){let t=_(e===`top`?`kol-pagination-position-top`:`kol-pagination-position-bottom`),n=_(`kol-table-pagination-label`,{placeholders:{label:`${this.state._label} (${t})`}});return d(`div`,{class:`kol-table-stateful__pagination kol-table-stateful__pagination--${this.state._paginationPosition}`},d(`div`,{class:`kol-table-stateful__pagination-wrapper`},d(h,{_boundaryCount:this.state._pagination._boundaryCount,_customClass:this.state._pagination._customClass,_hasButtons:this.state._pagination._hasButtons,_on:this.handlePagination,_page:this.state._pagination._page,_pageSize:this.state._pagination._pageSize,_pageSizeOptions:this.state._pagination._pageSizeOptions||j,_siblingCount:this.state._pagination._siblingCount,_tooltipAlign:`bottom`,_max:this.state._pagination._max||this.state._data.length,_label:n})))}getHeaderCellSortState(e){if((e.type===void 0||e.type==="default")&&!this.disableSort&&typeof e.compareFn==`function`){if(e.key){let t=this.sortData.find(t=>t.key===e.key);if(t?.direction)return t.direction}return`NOS`}}getHeaderCellSortOrder(e){if((e.type===void 0||e.type==="default")&&!this.disableSort&&this.state._allowMultiSort&&typeof e.compareFn==`function`&&e.key){let t=this.sortData.findIndex(t=>t.key===e.key);if(t>=0)return t+1}}handleSort({key:e}){let t=this.state._headers.horizontal??[],n=this.state._headers.vertical??[],r=[];for(let e of t)Array.isArray(e)&&r.push(...e);for(let e of n)Array.isArray(e)&&r.push(...e);let i=r.find(t=>t.key===e);i&&this.changeCellSort(i)}getSelectedData(e){let t=this.state._selection;if(t){let n=t.keyPropertyName??`id`,r=new Set(e.map(String)),i=this.state._sortedData.filter(e=>r.has(String(e[n])));if(n)return i}return null}handleSelectionChange(e,t){let n=this.state._selection;n&&(this.state=Object.assign(Object.assign({},this.state),{_selection:Object.assign(Object.assign({},n),{selectedKeys:t})}));let r=this.getSelectedData(t);typeof this.state._on?.[b.onSelectionChange]==`function`&&this.state._on[b.onSelectionChange](e,r),this.host&&p(this.host,m.selectionChange,r)}async getSelection(){let e=this.state._selection?.selectedKeys||[];return this.getSelectedData(e)}async resetSort(){this.initializeSortFromHeaders(this.state._headers),this.updateSortedData()}headerKeysChanged(e,t){let n=e=>[...e.horizontal?.flatMap(e=>e.map(e=>e?.key).filter(e=>!!e))??[],...e.vertical?.flatMap(e=>e.map(e=>e?.key).filter(e=>!!e))??[]],r=n(e),i=n(t);return r.length!==i.length||r.some((e,t)=>e!==i[t])}mergeAdjustedHeaderCells(e){var t;let n=new Map;return(t=this.state._headers.horizontal)==null||t.forEach(e=>e.forEach(e=>{e?.key&&n.set(e.key,e)})),e.map(e=>e.map(e=>{let t=e?.key?n.get(e.key):void 0;if(!t)return e;let r=Object.assign({},t);return e.visible!==void 0&&(r.visible=e.visible),e.width!==void 0&&(r.width=e.width),e.hidable!==void 0&&(r.hidable=e.hidable),e.sortable!==void 0&&(r.sortable=e.sortable),e.resizable!==void 0&&(r.resizable=e.resizable),r}))}buildHeaderCells(){let e=e=>e&&Object.assign(Object.assign({},e),{sortDirection:this.getHeaderCellSortState(e),sortOrder:this.getHeaderCellSortOrder(e)});return{horizontal:(this.adjustedHeaderCells?.horizontal?this.mergeAdjustedHeaderCells(this.adjustedHeaderCells.horizontal):this.state._headers.horizontal)?.map(t=>t.map(e))??[],vertical:this.state._headers.vertical?.map(t=>t.map(e))??[]}}render(){let e=this.selectDisplayedData(this.state._sortedData,this.showPagination?this.state._pagination?._pageSize??10:this.state._sortedData.length,this.state._pagination._page||1),t=this._paginationPosition===`top`||this._paginationPosition===`both`?this.renderPagination(`top`):null,n=this._paginationPosition===`bottom`||this._paginationPosition===`both`?this.renderPagination(`bottom`):null,r=this.buildHeaderCells();return d(u,{key:`9d06f7969aab93fa157f41afe46f2ce5f2cc6f67`,class:`kol-table-stateful`},this.pageEndSlice>0&&this.showPagination&&t,d(f,{key:`a3eac30ff7ad0df2079b9a8fb2649bcc00e88abc`,externalLabelElements:this.resolvedElements,ref:this.catchRef,_data:e,_fixedCols:this._fixedCols,_headers:r,_label:this.state._label,_loading:this._loading,_dataFoot:this.state._dataFoot,_on:{onSort:(e,t)=>{this.handleSort(t)},onSelectionChange:(e,t)=>{this.handleSelectionChange(e,t)},onChangeHeaderCells:(e,t)=>{this.handleChangeHeaderCells(t)}},_selection:this.state._selection,_hasSettingsMenu:this.state._hasSettingsMenu,_variant:this._variant}),this.pageEndSlice>0&&this.showPagination&&n)}get host(){return l(this)}static get watchers(){return{_ariaLabelledby:[`validateAriaLabelledby`],_allowMultiSort:[`validateAllowMultiSort`],_data:[`validateData`],_dataFoot:[`validateDataFoot`],_fixedCols:[`validateFixedCols`],_paginationPosition:[`validatePaginationPosition`],_hasSettingsMenu:[`validateHasSettingsMenu`],_headers:[`validateHeaders`],_label:[`validateLabel`],_selection:[`validateSelection`],_on:[`validateOn`],_pagination:[`validatePagination`]}}};N.style={default:A};export{N as kol_table_stateful};