import{n as e,o as t}from"./index-TMM2XLjh.js";import{t as n}from"./i18n-6Ww8y2f3-DkOh4NYz.js";function r(n){switch(n){case`cycle`:return t(`span`,{class:`kol-spin__loader kol-spin__spinner--${n}__element`});case`none`:return t(`slot`,{name:`expert`});default:return t(e,null,t(`span`,{class:`kol-spin__spinner-element
