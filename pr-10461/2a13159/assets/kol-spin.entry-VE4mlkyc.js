import{n as e,o as t,r as n,s as r}from"./index-BBuhFUe3.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import"./_Uint8Array-kJHDjtoP-CTkgs_0o.js";import{n as i,o as a,r as o}from"./normalizers-iLdS6AQE-Bjixhham.js";import{t as s}from"./label-BwPy2Jd4-CN0aQJ3x.js";import{t as c}from"./base-web-component-BCIMb9gN-CXhUOWoh.js";import{t as l}from"./base-controller-CXhqh4cR-BNzx0WwK.js";import{t as u}from"./i18n-Bs69aKfq-DCHSnydp.js";var d=i(`show`,!1,o),f=[`dot`,`cycle`,`none`],p=i(`variant`,`dot`,e=>{let t=a(e);if(f.includes(t))return t;throw Error(`Invalid spin variant: ${t}`)},()=>!0);function m(n){switch(n){case`cycle`:return t(`span`,{class:`kol-spin__loader kol-spin__spinner--${n}__element`});case`none`:return t(`slot`,{name:`expert`});default:return t(e,null,t(`span`,{class:`kol-spin__spinner-element 
