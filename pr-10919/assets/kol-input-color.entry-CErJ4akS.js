import{Et as e,a as t,o as n,s as r}from"./index-bA64inZQ.js";import{n as i,t as a}from"./dev.utils-3xMYti16-kL1VUQWA.js";import"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as o}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./Heading-SvkK2KW6-Dh-FcFLi.js";import"./disabled-DZzm72Jx-DdBTQvHR.js";import"./label-DxrksC9L-BReLqqxo.js";import{n as s,r as c,t as l}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import"./normalizers-DEevvNbZ-BE4EawTj.js";import"./i18n-DuzgYBgD-S1fI47eO.js";import"./component-BypIj6e1-B9_Jxhnx.js";import"./Alert-D4J4u9vt-ClUShCXt.js";import"./label-De6GKT_4-i8EdaBPQ.js";import"./variant-quote-JfuelQ4I-CiTd1MVE.js";import"./align-DglmQnOH-CodbEwR0.js";import"./variant-class-name-BFZvmFM_-_ipnSk5j.js";import"./component-DE2a2fD4-DcT0bXS0.js";import"./component-BL6pcz5a-Z0PN9dRP.js";import"./align-floating-elements-D6Kc-f8P-CHY_8mmA.js";import"./behavior-opTsLlOg-DESUEfXG.js";import"./aria-details-D25ORdb1-CKrM9t_f.js";import"./associated.controller-Nk9rGt1g-79sBjINT.js";import"./hide-label-xv6RFe5X-CygzMHFW.js";import"./tooltip-align-_beRPT5p-CJtt4Gz_.js";import{t as u}from"./FormFieldStateWrapper-D7aHoBTx-BbT0387o.js";import{n as d,t as f}from"./controller-icon-CDm-Tdgx-1fXsOTTn.js";import"./Input-DBGqMKkX-CeqI-wG0.js";import{t as p}from"./InputStateWrapper-BJubvgjD-BWFs-4XD.js";import{t as m}from"./suggestions-D1kwT8Bw-BqWmHzxv.js";import{t as h}from"./auto-complete-2trIwEcQ-CZHq_WeA.js";var g=class extends d{constructor(e,t,n){super(e,t,n),this.component=e}validateAutoComplete(e){h(this.component,e)}validateSuggestions(e){m(this.component,e)}validateValue(t){e(this.component,`_value`,t),this.setFormAssociatedValue(this.component.state._value)}componentWillLoad(){super.componentWillLoad(),this.validateAutoComplete(this.component._autoComplete),this.validateSuggestions(this.component._suggestions),this.validateValue(this.component._value)}},_=`@charset "UTF-8";
/*
...
}`,v=class{async getValue(){return this.ctaRef.el?.value}async focus(e){}async click(){}get hasSuggestions(){return Array.isArray(this.state._suggestions)&&this.state._suggestions.length>0}getFormFieldProps(){return{state:this.state,class:`kol-input-color`,tooltipAlign:this._tooltipAlign}}getInputColorProps(){return Object.assign(Object.assign({},this.getGenericInputProps()),{ref:this.ctaRef,type:`color`,name:this.state._name?`${this.state._name}-color`:void 0,list:this.hasSuggestions?a(this.state._id,`list`):void 0,onInput:this.onColorInput})}getGenericInputProps(){return Object.assign(Object.assign({state:Object.assign(Object.assign({},this.state),{_suggestions:[]})},this.controller.onFacade),{onBlur:this.onBlur,onFocus:this.onFocus})}render(){return n(u,Object.assign({key:`2571bc4c3d08086398012d9a8df57d7d0407495c`},this.getFormFieldProps()),n(f,{key:`08838e94ba7ba6983a06a31d00cffbb0bcc16434`,state:this.state,class:`kol-input-color__inputs-wrapper`},n(p,Object.assign({key:`c70ed733e33d51a6ecbad4077f968f2b07fa4ceb`,class:`kol-input-color__input kol-input-color__input--color`},this.getInputColorProps()))))}constructor(e){r(this,e),this.ctaRef=l(),this.onBlur=e=>{this.controller.onFacade.onBlur(e)},this.onFocus=e=>{this.controller.onFacade.onFocus(e)},this.onColorInput=e=>{let t=e.target.value;this.state._value=t,this.ctaRef.el&&(this.ctaRef.el.value=t),this.controller.onFacade.onInput(e)},this._autoComplete=`off`,this._disabled=!1,this._hideMsg=!1,this._hideLabel=!1,this._hint=``,this._tooltipAlign=`top`,this._touched=!1,this.state={_hideMsg:!1,_id:i(`input-color`),_label:``,_suggestions:[]},this.controller=new g(this,`color`,this.host)}validateAccessKey(e){this.controller.validateAccessKey(e)}validateAriaDetails(e){this.controller.validateAriaDetails(e)}validateAutoComplete(e){this.controller.validateAutoComplete(e)}validateDisabled(e){this.controller.validateDisabled(e)}validateHideMsg(e){this.controller.validateHideMsg(e)}validateHideLabel(e){this.controller.validateHideLabel(e)}validateHint(e){this.controller.validateHint(e)}validateIcons(e){this.controller.validateIcons(e)}validateLabel(e){this.controller.validateLabel(e)}validateMsg(e){this.controller.validateMsg(e)}validateName(e){this.controller.validateName(e)}validateOn(e){this.controller.validateOn(e)}validateShortKey(e){this.controller.validateShortKey(e)}validateSmartButton(e){this.controller.validateSmartButton(e)}validateSuggestions(e){this.controller.validateSuggestions(e)}validateSyncValueBySelector(e){this.controller.validateSyncValueBySelector(e)}validateTouched(e){this.controller.validateTouched(e)}validateValue(e){this.controller.validateValue(e)}validateVariant(e){this.controller.validateVariant(e)}componentDidLoad(){!this._value&&this.ctaRef&&(this._value=this.ctaRef.el?.value)}componentWillLoad(){this._touched=this._touched===!0,this.validateAriaDetails(this._ariaDetails),this.controller.componentWillLoad()}get host(){return t(this)}static get watchers(){return{_accessKey:[`validateAccessKey`],_ariaDetails:[`validateAriaDetails`],_autoComplete:[`validateAutoComplete`],_disabled:[`validateDisabled`],_hideMsg:[`validateHideMsg`],_hideLabel:[`validateHideLabel`],_hint:[`validateHint`],_icons:[`validateIcons`],_label:[`validateLabel`],_msg:[`validateMsg`],_name:[`validateName`],_on:[`validateOn`],_shortKey:[`validateShortKey`],_smartButton:[`validateSmartButton`],_suggestions:[`validateSuggestions`],_syncValueBySelector:[`validateSyncValueBySelector`],_touched:[`validateTouched`],_value:[`validateValue`],_variant:[`validateVariant`]}}};o([c(`ctaRef`)],v.prototype,`focus`,null),o([s(`ctaRef`)],v.prototype,`click`,null),v.style={default:_};export{v as kol_input_color};