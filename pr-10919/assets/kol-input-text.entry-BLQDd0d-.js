import{a as e,c as t,l as n,o as r,s as i}from"./index-bA64inZQ.js";import{n as a,t as o}from"./dev.utils-3xMYti16-kL1VUQWA.js";import"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as s}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{t as c}from"./clsx-COFh-Vc8-DWAop4cA.js";import"./Heading-SvkK2KW6-Dh-FcFLi.js";import"./disabled-DZzm72Jx-DdBTQvHR.js";import"./label-DxrksC9L-BReLqqxo.js";import{n as l,r as u,t as d}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import"./normalizers-DEevvNbZ-BE4EawTj.js";import{t as f}from"./i18n-DuzgYBgD-S1fI47eO.js";import"./component-BypIj6e1-B9_Jxhnx.js";import"./Alert-D4J4u9vt-ClUShCXt.js";import"./label-De6GKT_4-i8EdaBPQ.js";import"./variant-quote-JfuelQ4I-CiTd1MVE.js";import"./align-DglmQnOH-CodbEwR0.js";import"./variant-class-name-BFZvmFM_-_ipnSk5j.js";import"./component-DE2a2fD4-DcT0bXS0.js";import"./component-BL6pcz5a-Z0PN9dRP.js";import"./align-floating-elements-D6Kc-f8P-CHY_8mmA.js";import"./behavior-opTsLlOg-DESUEfXG.js";import{n as p}from"./controller-DW7B1_Ag-lTak5K93.js";import"./aria-details-D25ORdb1-CKrM9t_f.js";import"./associated.controller-Nk9rGt1g-79sBjINT.js";import"./hide-label-xv6RFe5X-CygzMHFW.js";import"./tooltip-align-_beRPT5p-CJtt4Gz_.js";import{t as m}from"./FormFieldStateWrapper-D7aHoBTx-BbT0387o.js";import{r as h,t as g}from"./controller-icon-CDm-Tdgx-1fXsOTTn.js";import"./Input-DBGqMKkX-CeqI-wG0.js";import{t as _}from"./InputStateWrapper-BJubvgjD-BWFs-4XD.js";import"./placeholder-D52hn5jx-DvMlKbwh.js";import"./required-DLnJj8Gs-CdQ550tv.js";import"./suggestions-D1kwT8Bw-BqWmHzxv.js";import"./auto-complete-2trIwEcQ-CZHq_WeA.js";import"./read-only-BpnKHR7_-72A_TJ2p.js";import{t as v}from"./counter-dom-updater-Ce1pP4cw-CpK4iodu.js";import"./spell-check-DvIRrpmv-BzdGptv-.js";import"./controller-gp1jIJuL-BfbNjqKJ.js";import{t as y}from"./controller-CCUro6lg-Nb_ndZel.js";var b=`@charset "UTF-8";
/*
...
}`,x=class{getClearButton(){if(this.state._type===`search`&&!this._disabled){let e=this.state._hasValue===!0;return r(h,{componentName:`button`,class:c(`kol-input-text__clear-button`,`kol-input-container__smart-button`,{"kol-input-text__clear-button--hidden":!e}),"data-testid":`kol-input-text-clear-button`,label:this.translateClearSearch,buttonVariant:`ghost`,disabled:!e,onClick:this.onClearButtonClick,icon:`kolicon-cross`})}return null}async getValue(){return this.ctaRef.el?.value}async focus(e){}async click(){}async selectionStart(){return Promise.resolve(this.ctaRef.el?.selectionStart)}async selectionEnd(){return Promise.resolve(this.ctaRef.el?.selectionEnd)}async setSelectionRange(e,t,n){var r;(r=this.ctaRef.el)==null||r.setSelectionRange(e,t,n)}async setSelectionStart(e){var t;(t=this.ctaRef.el)==null||t.setSelectionRange(e,e)}async setRangeText(e,t,n,r){var i,a;t!==void 0&&n!==void 0?(i=this.ctaRef.el)==null||i.setRangeText(e,t,n,r):(a=this.ctaRef.el)==null||a.setRangeText(e)}getFormFieldProps(){return{state:this.state,class:c(`kol-input-text`,this.state._type,{"has-value":this.state._hasValue,"kol-form-field--has-counter":this.controller.hasSoftCharacterLimit()||this.controller.hasCounter()}),tooltipAlign:this._tooltipAlign,counterRefs:{visualRef:this.counterUpdater.setVisualRef,ariaRef:this.counterUpdater.setAriaRef},infoPopover:this._infoPopover}}getInputProps(){let e=typeof this.state._maxLength==`number`&&!this.controller.hasCounter()?[o(this.state._id,`character-limit-hint`)]:void 0;return Object.assign(Object.assign({ref:this.ctaRef,state:this.state,ariaDescribedBy:e},this.controller.onFacade),{onBlur:this.onBlur,onChange:this.onChange,onFocus:this.onFocus,onInput:this.onInput,onKeyDown:this.onKeyDown})}render(){return r(m,Object.assign({key:`46a5f214a6c052abd267bf0893560d2cd634e8b2`},this.getFormFieldProps()),r(g,{key:`487e5551492106969c96083a8171698e20a303df`,state:this.state,endAdornment:this.getClearButton()},r(_,Object.assign({key:`2f95870acd5892915a6cb6fae46a5e4dbd684912`},this.getInputProps()))))}validateAriaDetails(e){this.controller.validateAriaDetails(e)}constructor(e){i(this,e),this.ctaRef=d(),this.counterUpdater=new v,this.onBlur=e=>{this.controller.onFacade.onBlur(e)},this.onChange=e=>{let t=this.ctaRef.el?.value;this.oldValue!==t&&(this.oldValue=t),this.controller.onFacade.onChange(e)},this.onFocus=e=>{this.controller.onFacade.onFocus(e),this.counterUpdater.retriggerAria(this._value?.length??0,this.state._maxLength,this.state._maxLengthBehavior??`hard`)},this.onInput=e=>{this._value=this.ctaRef.el?.value??``,this.controller.onFacade.onInput(e)},this.onKeyDown=e=>{this.controller.onFacade.onKeyDown(e),this.counterUpdater.handleKeyDown(e,this.ctaRef.el?.value.length??0,this.state._maxLength,this.state._maxLengthBehavior??`hard`),(e.code===`Enter`||e.code===`NumpadEnter`)&&p({form:this.host})},this.translateClearSearch=f(`kol-clear-search`),this.onClearButtonClick=()=>{var e;if(this._disabled===!0||this.state._hasValue!==!0)return;let r={name:this.state._name??``,value:``};this._value=``,this.ctaRef.el&&(this.ctaRef.el.value=``),this.controller.onFacade.onInput(n(t.input,r,this.ctaRef.el),!0,``),this.controller.onFacade.onChange(n(t.change,r,this.ctaRef.el),``),(e=this.ctaRef.el)==null||e.focus()},this._autoComplete=`off`,this._hasCounter=!1,this._maxLengthBehavior=`hard`,this._disabled=!1,this._hideMsg=!1,this._hideLabel=!1,this._hint=``,this._readOnly=!1,this._required=!1,this._tooltipAlign=`top`,this._touched=!1,this._type=`text`,this.state={_hasValue:!1,_hideMsg:!1,_id:a(`input-text`),_label:``,_suggestions:[],_type:`text`},this.controller=new y(this,`text`,this.host)}validateAccessKey(e){this.controller.validateAccessKey(e)}validateAutoComplete(e){this.controller.validateAutoComplete(e)}validateMaxLengthBehavior(e){this.controller.validateMaxLengthBehavior(e)}validateDisabled(e){this.controller.validateDisabled(e)}validateHideMsg(e){this.controller.validateHideMsg(e)}validateHideLabel(e){this.controller.validateHideLabel(e)}validateHasCounter(e){this.controller.validateHasCounter(e)}validateHint(e){this.controller.validateHint(e)}validateIcons(e){this.controller.validateIcons(e)}validateLabel(e){this.controller.validateLabel(e)}validateMaxLength(e){this.controller.validateMaxLength(e),this.counterUpdater.updateImmediate(this._value?.length??0,this.state._maxLength,this.state._maxLengthBehavior??`hard`)}validateMsg(e){this.controller.validateMsg(e)}validateName(e){this.controller.validateName(e)}validateOn(e){this.controller.validateOn(e)}validatePattern(e){this.controller.validatePattern(e)}validatePlaceholder(e){this.controller.validatePlaceholder(e)}validateReadOnly(e){this.controller.validateReadOnly(e)}validateRequired(e){this.controller.validateRequired(e)}validateShortKey(e){this.controller.validateShortKey(e)}validateSpellCheck(e){this.controller.validateSpellCheck(e)}validateSuggestions(e){this.controller.validateSuggestions(e)}validateSmartButton(e){this.controller.validateSmartButton(e)}validateSyncValueBySelector(e){this.controller.validateSyncValueBySelector(e)}validateTouched(e){this.controller.validateTouched(e)}validateType(e){this.controller.validateType(e)}validateValue(e){this.controller.validateValue(e),this.state._hasValue=!!e,this.oldValue=e,this.counterUpdater.update(e?.length??0,this.state._maxLength,this.state._maxLengthBehavior??`hard`)}validateVariant(e){this.controller.validateVariant(e)}componentDidLoad(){(this.controller.hasCounter()||this.controller.hasSoftCharacterLimit())&&this.counterUpdater.updateImmediate(this._value?.length??0,this.state._maxLength,this.state._maxLengthBehavior??`hard`)}disconnectedCallback(){this.counterUpdater.destroy()}componentWillLoad(){this.validateAriaDetails(this._ariaDetails),this._touched=this._touched===!0,this.oldValue=this._value,this.controller.componentWillLoad(),this.state._hasValue=!!this.state._value,this.controller.addValueChangeListener(e=>this.state._hasValue=!!e)}get host(){return e(this)}static get watchers(){return{_ariaDetails:[`validateAriaDetails`],_accessKey:[`validateAccessKey`],_autoComplete:[`validateAutoComplete`],_maxLengthBehavior:[`validateMaxLengthBehavior`],_disabled:[`validateDisabled`],_hideMsg:[`validateHideMsg`],_hideLabel:[`validateHideLabel`],_hasCounter:[`validateHasCounter`],_hint:[`validateHint`],_icons:[`validateIcons`],_label:[`validateLabel`],_maxLength:[`validateMaxLength`],_msg:[`validateMsg`],_name:[`validateName`],_on:[`validateOn`],_pattern:[`validatePattern`],_placeholder:[`validatePlaceholder`],_readOnly:[`validateReadOnly`],_required:[`validateRequired`],_shortKey:[`validateShortKey`],_spellCheck:[`validateSpellCheck`],_suggestions:[`validateSuggestions`],_smartButton:[`validateSmartButton`],_syncValueBySelector:[`validateSyncValueBySelector`],_touched:[`validateTouched`],_type:[`validateType`],_value:[`validateValue`],_variant:[`validateVariant`]}}};s([u(`ctaRef`)],x.prototype,`focus`,null),s([l(`ctaRef`)],x.prototype,`click`,null),x.style={default:b};export{x as kol_input_text};