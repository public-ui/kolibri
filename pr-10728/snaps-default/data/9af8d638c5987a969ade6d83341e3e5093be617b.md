...
Locator: locator('[data-visual-block="short-keys"]')
  Expected an image 703px by 44px, received 679px by 44px. 3538 pixels (ratio 0.12 of all image pixels) are different.

  Snapshot: button-short-key--short-keys.png

Call log:
  - Expect "toHaveScreenshot(button-short-key--short-keys.png)" with timeout 10000ms
