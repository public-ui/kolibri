...
Locator: locator('[data-visual-block="access-key-value"]')
  324 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: input-text-access-short-key-noColumns--access-key-value.png

Call log:
  - Expect "toHaveScreenshot(input-text-access-short-key-noColumns--access-key-value.png)" with timeout 10000ms
    - verifying given screenshot expectation
  - waiting for locator('[data-visual-block="access-key-value"]')
    - locator resolved to <div class="grid gap-4" data-visual-block="access-key-value">…</div>
  ...
  - generic [ref=e5]:
    ...
    - generic [ref=e10]:
      - generic [ref=e13] [cursor=pointer]:
        ...
        - text: f
      - textbox "With access key (Alt+F)" [ref=e18]: Press Alt+F to focus
    - generic [ref=e22]:
      - generic [ref=e25] [cursor=pointer]:
        - generic [ref=e26]: With short key (Alt+N)
        - text: "n"
      - textbox "With short key (Alt+N)" [ref=e30]: Press Alt+N to focus
    - generic [ref=e34]:
      - generic [ref=e37] [cursor=pointer]:
        - generic [ref=e38]: Access key (Alt+E)
        - text: e
      - textbox "Access key (Alt+E)" [ref=e42]:
        - /placeholder: Email address
    - generic [ref=e46]:
      - generic [ref=e49] [cursor=pointer]:
        - generic [ref=e50]: Short key (Alt+P)
        - text: p
      - textbox "Short key (Alt+P)" [ref=e54]:
