...
Locator: locator('[data-visual-block="access-key"]')
  Expected an image 150px by 44px, received 142px by 44px. 306 pixels (ratio 0.05 of all image pixels) are different.

  Snapshot: button-link-basic--access-key.png

Call log:
  - Expect "toHaveScreenshot(button-link-basic--access-key.png)" with timeout 10000ms
    - verifying given screenshot expectation
  - waiting for locator('[data-visual-block="access-key"]')
    - locator resolved to <div class="flex flex-col gap-2" data-visual-block="access-key">…</div>
