import{A as e,E as t,G as n,Tt as r,a as i,c as a,ft as o,kt as s,l as c,mt as l,o as u,q as d,r as f,s as p,xt as m}from"./index-CHpv7y2h.js";import{r as h}from"./label-43VWIjgW-CcF5pyV1.js";import{t as g}from"./i18n-DppON4Nc-VyxsNJqw.js";import{t as _}from"./aria-labelledby-6-ki3akM-C6lJ0lQF.js";import{t as v}from"./aria-labelledby-CGqPLd29-BXO4k0Zz.js";import{a as y,i as b,n as x,o as S,s as C,t as w}from"./table-selection-DfuW3Ke8-DYg_-UOW.js";import{t as T}from"./keyboard-DNd73LVa-BCj4IeP3.js";var E=(e,t,n={})=>{r(e,`_allowMultiSort`,t,Object.assign({defaultValue:!1},n))},D=[`top`,`bottom`,`both`],O=(e,t)=>{s(e,`_paginationPosition`,e=>typeof e==`string`&&D.includes(e),new Set([`PaginationPositionPropType {${D.join(`, `)}`]),t,{defaultValue:`bottom`})},k=`@charset "UTF-8";
/*
...
@layer kol-global {
  ...
  * {
  ...
  .kol-span--has-icon {
    /* KolSpan can have icons in all directions and a label text in the middle. If no icons are present KolSpan is just a normal inline span. */
    display: flex;
    flex-flow: column;
    align-items: center;
  ...
  .kol-span--has-icon .kol-span__container {
    display: flex;
    align-items: center;
  }
  .kol-span kbd {
    margin-left: var(--kol-span-badge-gap);
  }
  a,
  button {
    cursor: pointer;
...
@font-face {
  ...
  src: url("kolicons.eot?t=1788180947744"); /* IE9*/
  src: url("kolicons.eot?t=1788180947744#iefix") format("embedded-opentype"), url("kolicons.woff2?t=1788180947744") format("woff2"), url("kolicons.woff?t=1788180947744") format("woff"), url("kolicons.ttf?t=1788180947744") format("truetype"), url("kolicons.svg?t=1788180947744#kolicons") format("svg"); /* iOS 4.1- */
}
@layer kol-component {
