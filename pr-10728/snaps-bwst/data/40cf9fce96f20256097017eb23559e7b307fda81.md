...
Locator: locator('[data-visual-block="left-checked"]')
  ...
  Snapshot: input-checkbox-switch-noColumns--left-checked.png

Call log:
  - Expect "toHaveScreenshot(input-checkbox-switch-noColumns--left-checked.png)" with timeout 10000ms
