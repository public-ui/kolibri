...
Locator: locator('[data-visual-block="basic"]')
  ...
  Snapshot: link-basic--basic.png

Call log:
  - Expect "toHaveScreenshot(link-basic--basic.png)" with timeout 10000ms
    - verifying given screenshot expectation
  - waiting for locator('[data-visual-block="basic"]')
    - locator resolved to <div class="grid gap-4" data-visual-block="basic">…</div>
...
```yaml
- main [ref=e4]:
  - heading "link basic" [level=1] [ref=e5]
  - generic [ref=e7]:
    - link "Simple Link" [ref=e10] [cursor=pointer]:
      - /url: "#/back-page"
      - generic [ref=e13]: Simple Link
    - link "Simple Link (disabled)" [disabled] [ref=e16]:
      - /url: "#/back-page"
      - generic [ref=e19]: Simple Link (disabled)
    - link "Icon Link" [ref=e22] [cursor=pointer]:
      - /url: "#/back-page"
      - generic [ref=e25]: 
    - link "Icon Link (disabled)" [disabled] [ref=e28]:
      - /url: "#/back-page"
      - generic [ref=e31]: 
    - paragraph [ref=e32]:
      - text: In this paragraph, a link is inserted that contains no additional attributes.
      - link "Simple Link" [ref=e35] [cursor=pointer]:
        - /url: "#/back-page"
        - generic [ref=e38]: Simple Link
      - text: It is rendered by default as a
      - strong [ref=e39]: inline element
      - text: .
    - paragraph [ref=e40]:
      - text: In this paragraph, a link is inserted that is rendered as an inline-block element.
      - link "Simple Link" [ref=e43] [cursor=pointer]:
        - /url: "#/back-page"
        - generic [ref=e45]:
          - generic [ref=e46]: Simple Link
          - generic [ref=e47]: S
      ...
      - link "Simple Link" [ref=e50] [cursor=pointer]:
        - /url: "#/back-page"
        - generic [ref=e53]: Simple Link
      - text: ", therefore, I span the entire width of the parent element, causing a line break."
    - link "Special Variant Link" [ref=e56] [cursor=pointer]:
      - /url: "#/back-page"
      - generic [ref=e59]: Special Variant Link
```
