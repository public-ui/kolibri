...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 136px, received 153px by 464px. 20544 pixels (ratio 0.06 of all image pixels) are different.
...
- main [ref=e1]:
  ...
  - generic [ref=e3]:
    - heading "All Button Variants" [level=2] [ref=e5]: All Button Variants
    - generic [ref=e6]:
