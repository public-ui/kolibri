...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 548px, received 145px by 3828px. 37538 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: snapshot-for-card-headlines.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-card-headlines.png)" with timeout 10000ms
...
```yaml
- main [ref=e1]:
  - heading "card headlines" [level=1] [ref=e2]
  - generic:
    - article "Card with headline level 0" [ref=e5]:
      - strong [ref=e6]: Card with headline level 0
      - generic [ref=e8]: Card contents.
    - article "Card with headline level 1" [ref=e11]:
      - heading "Card with headline level 1" [level=1] [ref=e12]
      - generic [ref=e14]: Card contents.
    - article "Card with headline level 2" [ref=e17]:
      - heading "Card with headline level 2" [level=2] [ref=e18]
      - generic [ref=e20]: Card contents.
    - article "Card with headline level 3" [ref=e23]:
      - heading "Card with headline level 3" [level=3] [ref=e24]
      - generic [ref=e26]: Card contents.
    - article "Card with headline level 4" [ref=e29]:
      - heading "Card with headline level 4" [level=4] [ref=e30]
      - generic [ref=e32]: Card contents.
    - article "Card with headline level 5" [ref=e35]:
      - heading "Card with headline level 5" [level=5] [ref=e36]
      - generic [ref=e38]: Card contents.
    - article "Card with headline level 6" [ref=e41]:
      - heading "Card with headline level 6" [level=6] [ref=e42]
      - generic [ref=e44]: Card contents.
```
