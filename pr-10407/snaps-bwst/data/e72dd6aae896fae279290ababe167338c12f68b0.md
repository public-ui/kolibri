...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 478px, received 70px by 10730px. 25319 pixels (ratio 0.01 of all image pixels) are different.
...
- main [ref=e1]:
  ...
  - generic:
    ...
    - generic [ref=e14]:
      - strong [ref=e15]:
        - button "Open initially (disabled)" [disabled] [expanded] [ref=e17]:
          - generic [ref=e19]:
            - generic [ref=e20]: 
            - generic [ref=e21]: Open initially (disabled)
      - region "Open initially (disabled)" [ref=e24]:
