...
- Name: theme-snapshots.spec.js >> snapshot for tabs/basic
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 198px, received 67px by 1204px. 5584 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: snapshot-for-tabs-basic.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-tabs-basic.png)" with timeout 10000ms
...
```yaml
- main [ref=e1]:
  - heading "tabs basic" [level=1] [ref=e2]
  - generic:
    - generic:
      - tablist "Regular tabs" [ref=e3]:
        - tab "First tab" [selected] [ref=e5] [cursor=pointer]:
          - generic [ref=e8]: First tab
        - tab "Second Tab" [ref=e10] [cursor=pointer]:
          - generic [ref=e13]: Second Tab
        - tab "Disabled Tab" [disabled] [ref=e15]:
          - generic [ref=e18]: Disabled Tab
        - tab "Last tab" [ref=e20] [cursor=pointer]:
          - generic [ref=e23]: Last tab
      - tabpanel "First tab" [ref=e25]:
        - generic [ref=e26]: Contents of Tab 1
  - generic:
    - generic:
      - tablist "Tabs with icons" [ref=e27]:
        - tab "First tab" [selected] [ref=e29] [cursor=pointer]:
          - generic [ref=e31]:
            - generic [ref=e32]: 
            - generic [ref=e33]: First tab
        - tab "Second Tab" [ref=e35] [cursor=pointer]:
          - generic [ref=e37]:
            - generic [ref=e38]: 
            - generic [ref=e39]: Second Tab
        - tab "Disabled Tab" [disabled] [ref=e41]:
          - generic [ref=e43]:
            - generic [ref=e44]: 
            - generic [ref=e45]: Disabled Tab
        - tab "Last tab" [ref=e47] [cursor=pointer]:
          - generic [ref=e49]:
            - generic [ref=e50]: 
            - generic [ref=e51]: Last tab
      - tabpanel "First tab" [ref=e53]:
        - generic [ref=e54]: Contents of Tab 1
```
