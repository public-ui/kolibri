...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 240px, received 53px by 422px. 16573 pixels (ratio 0.05 of all image pixels) are different.

  Snapshot: snapshot-for-meter-basic.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-meter-basic.png)" with timeout 10000ms
...
```yaml
- main [ref=e1]:
  - heading "meter basic" [level=1] [ref=e2]
  - generic [ref=e3]:
    - heading "Basic" [level=2] [ref=e5]: Basic
    - generic [ref=e6]:
      - generic [ref=e9]:
        - generic [ref=e10]: Storage used
        - meter "Storage used" [ref=e12]
        - generic [ref=e13]:
          - generic [ref=e14]: "50"
          - text: "%"
      - generic [ref=e17]:
        - generic [ref=e18]: Weight
        - meter "Weight" [ref=e19]
        - generic [ref=e20]:
          - generic [ref=e21]: "75"
          - text: kg
      - generic [ref=e24]:
        - generic [ref=e25]: Temperature
        - meter "Temperature" [ref=e26]
        - generic [ref=e27]:
          - generic [ref=e28]: "-50"
          - text: °C
```
