...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 94px, received 39px by 1090px. 2646 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: snapshot-for-heading-secondary.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-heading-secondary.png)" with timeout 10000ms
...
```yaml
- main [ref=e1]:
  - heading "heading secondary" [level=1] [ref=e2]
  - generic [ref=e4]:
    - heading "This is a H1 headline" [level=1] [ref=e5]: This is a H1 headline
    - paragraph [ref=e6]: This is a secondary headline
```
