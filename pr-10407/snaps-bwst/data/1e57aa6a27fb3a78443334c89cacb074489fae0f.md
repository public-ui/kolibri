...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 123px, received 68px by 367px. 2038 pixels (ratio 0.01 of all image pixels) are different.
...
```yaml
- main [ref=e1]:
  - heading "tabs create-button" [level=1] [ref=e2]
  - generic:
    - generic:
      - tablist "Tabs with create button" [ref=e3]:
        ...
        - button "New …" [ref=e15] [cursor=pointer]:
          - generic [ref=e17]:
            - generic [ref=e18]: 
            - generic [ref=e19]: New …
      - tabpanel "First tab" [ref=e21]:
        - generic [ref=e22]: Contents of First tab
```
