...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 124px, received 171px by 926px. 7514 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: snapshot-for-card-basic.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-card-basic.png)" with timeout 10000ms
...
```yaml
- main [ref=e1]:
  - heading "card basic" [level=1] [ref=e2]
  - generic:
    - article "Card with title and content" [ref=e5]:
      - strong [ref=e6]: Card with title and content
      - generic [ref=e8]: Card contents.
    - article "Card with closer" [ref=e11]:
      - strong [ref=e12]: Card with closer
      - paragraph [ref=e14]: This card has a close button.
