...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 640px, received 286px by 2864px. 168014 pixels (ratio 0.08 of all image pixels) are different.
...
- main [ref=e1]:
  ...
  - generic:
    ...
    - generic [ref=e8]: teal
    - generic [ref=e11]: blue
    - generic [ref=e13]:
      - generic [ref=e14]: 
      - generic [ref=e15]: red with icon
    - generic [ref=e17]:
      - generic [ref=e18]: 
      - generic [ref=e19]: purple with icon
```
