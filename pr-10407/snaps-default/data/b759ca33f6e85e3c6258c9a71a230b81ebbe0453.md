...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 101px, received 108px by 120px. 9067 pixels (ratio 0.10 of all image pixels) are different.
...
- main [ref=e1]:
  - generic:
    - generic [active]:
      - generic:
        - generic [ref=e5] [cursor=pointer]: Single Select
        - generic [ref=e9]:
          - combobox "Single Select" [ref=e10]
