...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 238px, received 94px by 2342px. 7555 pixels (ratio 0.01 of all image pixels) are different.
    ...
    - generic:
      - tablist "Regular tabs":
        ...
        - tab "Disabled Tab" [disabled] [ref=e14]:
          - generic [ref=e17]: Disabled Tab
        - tab "Last tab" [ref=e19] [cursor=pointer]:
          - generic [ref=e22]: Last tab
      - generic:
        - tabpanel "First tab":
          - generic:
