...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 176px, received 72px by 8280px. 11991 pixels (ratio 0.01 of all image pixels) are different.
...
- main [ref=e1]:
  ...
  - figure "— RFC 1149 Opens in new tab." [ref=e3]:
    ...
    - generic [ref=e5]:
      - text: —
      - link "RFC 1149 Opens in new tab." [ref=e8] [cursor=pointer]:
        - /url: https://datatracker.ietf.org/doc/html/rfc1149
        - generic [ref=e11]: RFC 1149
        - img "Opens in new tab." [ref=e12]: 
```
