...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 134px, received 112px by 438px. 1736 pixels (ratio 0.01 of all image pixels) are different.
...
```yaml
- main [ref=e1]:
  - heading "abbr basic" [level=1] [ref=e2]
  - paragraph:
    - text: I am
    - generic [ref=e3]:
      - generic: e.g.
  ...
  - paragraph:
    ...
    - generic [ref=e4]:
      - generic: e.g.
    - text: an abbreviation without label.
```
