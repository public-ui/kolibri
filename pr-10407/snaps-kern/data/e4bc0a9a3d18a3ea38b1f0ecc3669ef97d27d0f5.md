...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 112px, received 34px by 1120px. 2443 pixels (ratio 0.01 of all image pixels) are different.
...
```yaml
- main [ref=e1]:
  - heading "link link-variant" [level=1] [ref=e2]
  - generic:
    - link "Normal link without a variant" [ref=e5] [cursor=pointer]:
      - /url: "#/back-page"
      - generic [ref=e8]: Normal link without a variant
    - 'link "Theme exclusive variant: small" [ref=e11] [cursor=pointer]':
      - /url: "#/back-page"
      - generic [ref=e14]: "Theme exclusive variant: small"
```
