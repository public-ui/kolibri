...
- Name: theme-snapshots.spec.js >> snapshot for scenarios/focus-elements?component=textarea
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Snapshot: snapshot-for-scenarios-focus-elements-component-textarea.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-scenarios-focus-elements-component-textarea.png)" with timeout 10000ms
...
- main [ref=e4]:
  - generic [ref=e7]:
    - generic [ref=e11] [cursor=pointer]: Textarea
