...
- Name: theme-snapshots.spec.js >> snapshot for avatar/basic
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 132px, received 116px by 480px. 16070 pixels (ratio 0.05 of all image pixels) are different.

  Snapshot: snapshot-for-avatar-basic.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-avatar-basic.png)" with timeout 10000ms
...
```yaml
- main [ref=e1]:
  - heading "avatar basic" [level=1] [ref=e2]
  - generic:
    - img "Avatar of Elke Mustermann" [ref=e3]:
      - img [ref=e4]
    - img "Avatar of Elke Mustermann" [ref=e5]:
      - generic [ref=e6]: EM
    - img "Avatar of Marianne" [ref=e7]:
      - generic [ref=e8]: M
    - img "Avatar of Christian" [ref=e9]:
      - generic [ref=e10]: C
```
