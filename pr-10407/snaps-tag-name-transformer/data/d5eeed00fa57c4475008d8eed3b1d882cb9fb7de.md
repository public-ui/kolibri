...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 118px, received 111px by 225px. 1802 pixels (ratio 0.02 of all image pixels) are different.
...
- main [ref=e1]:
  ...
  - generic:
    ...
    - paragraph [ref=e9]: This theme has no variants for this component.
```
