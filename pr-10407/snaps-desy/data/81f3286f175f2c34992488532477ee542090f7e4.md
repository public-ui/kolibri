...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 64px, received 66px by 192px. 1182 pixels (ratio 0.01 of all image pixels) are different.
...
- main [ref=e1]:
  - generic:
    - heading "skip-nav basic" [level=1] [ref=e2]
    - generic [active] [ref=e3]:
      - navigation "Hidden navigation":
        - list:
          - listitem:
            - link "To the top" [ref=e5] [cursor=pointer]:
              - /url: "#/back-page"
              - generic [ref=e8]: To the top
          - listitem:
            - generic:
              - link "To the form":
                - /url: "#/back-page"
                - generic [ref=e11] [cursor=pointer]: To the form
          - listitem:
            - generic:
              - link "To the end":
                - /url: "#/back-page"
                - generic [ref=e14] [cursor=pointer]: To the end
```
