...
- Name: theme-snapshots.spec.js >> snapshot for badge/button
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 1176px, received 444px by 2184px. 691969 pixels (ratio 0.40 of all image pixels) are different.

  Snapshot: snapshot-for-badge-button-zoom.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-badge-button-zoom.png)" with timeout 10000ms
...
```yaml
- main [ref=e1]:
  - heading "badge button" [level=1] [ref=e2]
  - generic:
    - generic [ref=e3]:
      - generic [ref=e6]: black
      - button "Remove" [ref=e8] [cursor=pointer]:
        - generic [ref=e11]: 
    - generic [ref=e12]:
      - generic [ref=e15]: teal
      - button "Remove" [ref=e17] [cursor=pointer]:
        - generic [ref=e20]: 
    - generic [ref=e21]:
      - generic [ref=e24]: blue
      - button "Remove" [ref=e26] [cursor=pointer]:
        - generic [ref=e29]: 
    - generic [ref=e30]:
      - generic [ref=e32]:
        - generic [ref=e33]: 
        - generic [ref=e34]: red with icon
      - button "Remove" [ref=e36] [cursor=pointer]:
        - generic [ref=e39]: 
    - generic [ref=e40]:
      - generic [ref=e42]:
        - generic [ref=e43]: 
        - generic [ref=e44]: purple with icon
