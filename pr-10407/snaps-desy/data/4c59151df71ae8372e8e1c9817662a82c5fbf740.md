...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 147px, received 56px by 718px. 2280 pixels (ratio 0.01 of all image pixels) are different.
...
- main [ref=e1]:
  ...
  - generic:
    - generic:
      - tablist "Tabs with create button":
        - tab "First tab" [selected] [ref=e4] [cursor=pointer]:
          - generic [ref=e7]: First tab
        - tab "Second Tab" [ref=e9] [cursor=pointer]:
          - generic [ref=e12]: Second Tab
