...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 577px, received 268px by 2184px. 379168 pixels (ratio 0.22 of all image pixels) are different.

  Snapshot: snapshot-for-badge-basic-zoom.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-badge-basic-zoom.png)" with timeout 10000ms
...
```yaml
- main [ref=e1]:
  - heading "badge basic" [level=1] [ref=e2]
  - generic:
    - generic [ref=e6]: black
    - generic [ref=e10]: teal
    - generic [ref=e14]: blue
    - generic [ref=e17]:
      - generic [ref=e18]: 
      - generic [ref=e19]: red with icon
    - generic [ref=e22]:
      - generic [ref=e23]: 
      - generic [ref=e24]: purple with icon
```
