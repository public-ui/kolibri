...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 440px, received 101px by 3320px. 7003 pixels (ratio 0.01 of all image pixels) are different.
  ...
  - generic:
    - generic [ref=e4]:
      ...
      - region "Heading Accordion Tab 1 (open)" [ref=e14]:
        - generic: Contents Accordion Tab 1
    - strong [ref=e17]:
      - button "Heading Accordion Tab 2" [ref=e19] [cursor=pointer]:
        - generic [ref=e21]:
          - generic [ref=e22]: 
          - generic [ref=e23]: Heading Accordion Tab 2
    - strong [ref=e26]:
      - button "Heading Accordion Tab 3 (deactivated)" [disabled] [ref=e28]:
        - generic [ref=e30]:
          - generic [ref=e31]: 
          - generic [ref=e32]: Heading Accordion Tab 3 (deactivated)
    - generic [ref=e34]:
      - strong [ref=e35]:
        - button "Heading Accordion Tab 4 (disabled and open)" [disabled] [expanded] [ref=e37]:
          - generic [ref=e39]:
            - generic [ref=e40]: 
            - generic [ref=e41]: Heading Accordion Tab 4 (disabled and open)
      - region "Heading Accordion Tab 4 (disabled and open)" [ref=e44]:
        - generic: Contents Accordion Tab 4
```
