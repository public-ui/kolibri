...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 174px, received 231px by 808px. 4478 pixels (ratio 0.01 of all image pixels) are different.
...
- main [ref=e1]:
  ...
  - generic:
    ...
    - article "Card with closer" [ref=e10]:
      - strong [ref=e11]: Card with closer
      - paragraph [ref=e13]: This card has a close button.
