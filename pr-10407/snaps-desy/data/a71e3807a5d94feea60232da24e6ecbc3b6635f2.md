...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 223px, received 107px by 8281px. 14935 pixels (ratio 0.01 of all image pixels) are different.
