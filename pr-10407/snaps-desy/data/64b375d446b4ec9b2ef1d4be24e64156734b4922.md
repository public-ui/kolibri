...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 1236px, received 416px by 5156px. 61756 pixels (ratio 0.02 of all image pixels) are different.
...
```yaml
- main [ref=e1]:
  - heading "link target" [level=1] [ref=e2]
  - list [ref=e3]:
    - listitem:
      - generic:
        - generic:
          - link "Link without target":
            - /url: "#/back-page"
            - generic [ref=e6] [cursor=pointer]: Link without target
    - listitem:
      - generic:
        - generic:
          - link "Link with target (_self)":
            - /url: "#/back-page"
            - generic [ref=e9] [cursor=pointer]: Link with target (_self)
    - listitem:
      - generic:
        - generic:
          - link "Link with target (_blank) Opens in new tab.":
            - /url: "#/back-page"
            - generic [ref=e12] [cursor=pointer]: Link with target (_blank)
            - img "Opens in new tab." [ref=e13] [cursor=pointer]: 
    - listitem:
      - generic:
        - generic:
          - link "Link without target":
