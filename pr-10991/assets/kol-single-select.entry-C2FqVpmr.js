import{c as e,ct as t,it as n,o as r,ot as i,s as a}from"./index-DcDxiC7I-DO3hHRcL.js";import"./behavior-CLQ45gTX-CjvcePMU.js";import{d as o,n as s,t as c}from"./index-DR4uFsXN.js";import{n as l,t as u}from"./dev.utils-BRNeztdD-DgW7fJV5.js";import"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as d}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import"./variant-quote-BEpTijLF-_u11LaMc.js";import"./label-BDgaSpkn-DokXt53_.js";import"./label-DM7-TXhv-Dh1ZQdSD.js";import{t as f}from"./clsx-COFh-Vc8-DWAop4cA.js";import"./Heading-B-bvl0rB-DLI60uiM.js";import{r as p,t as m}from"./element-interaction-DORv36BQ-BSHBQDXV.js";import"./block-bem-Cjigjm3j-Dvq9aM3N.js";import{t as h}from"./component-3DThXBTP-Dxs3WAKT.js";import"./component-BUS3CxKl-Cuxfghn3.js";import{t as g}from"./i18n-s5q4We3h-BinLy6qF.js";import"./component-DXUuz912-DFR5Oktw.js";import"./variant-class-name-D1gM1t9T-DeoIILa2.js";import"./component-qCAcaj_u-B0TNrC5s.js";import"./component-BPpQoqCu-8UEGxhRc.js";import"./component-D7XEy-_w-oQJG_SIo.js";import"./align-B29XBdiy-DGu842TL.js";import"./aria-details-CaVxOiaf-Hb0gh4Zw.js";import"./associated.controller-BBWXwdJG-CxVMVIB_.js";import"./hide-label-D2aEL3Gp-AMhU-wgC.js";import"./tooltip-align-DRLX7nih-BuRE--Cu.js";import{s as _,t as v}from"./FormFieldStateWrapper-BMC6Gn0l-Dnf4lsHJ.js";import{n as y,t as b}from"./controller-icon-CV9tbF_Y-BfEaCe0U.js";import"./Input-B_19nLPX-DPNKJDrh.js";import{t as x}from"./InputStateWrapper-D1ndAAnG-CP34HiCg.js";import{n as S,t as C}from"./CustomSuggestionsOptionsGroup-oGEVoetu-CtQCOLe5.js";import{t as w}from"./placeholder-Dgz97VWZ-BSxNLLHx.js";import{t as T}from"./required-BdCcAYf5-oj_LxFw8.js";import"./orientation-CYeJrjqQ-CiJQg9d8.js";import{i as E,r as D}from"./controller-DixFLCWq-2JgrmoMI.js";var O=class extends y{constructor(e,t,n){super(e,t,n),this.keyOptionMap=new Map,this.afterPatchOptions=(e,t,n,r)=>{r===`_value`&&this.setFormAssociatedValue(e)},this.beforePatchOptions=(e,t)=>{let n=t.has(`_options`)?t.get(`_options`):this.component.state._options;Array.isArray(n)&&n.length>0&&(this.keyOptionMap.clear(),D(this.keyOptionMap,n))},this.component=e}validateOptions(e){E(this.component,e,{hooks:{afterPatch:this.afterPatchOptions,beforePatch:this.beforePatchOptions}})}validateRequired(e){T(this.component,e)}validateValue(e){t(this.component,`_value`,e=>e!==void 0,new Set([`StencilUnknown`]),e)}validatePlaceholder(e){w(this.component,e)}validateHasClearButton(e){n(this.component,`_hasClearButton`,e)}validateRows(e){i(this.component,`_rows`,e)}componentWillLoad(){super.componentWillLoad(),this.validateOptions(this.component._options),this.validateRequired(this.component._required),this.validateValue(this.component._value),this.validatePlaceholder(this.component._placeholder),this.validateHasClearButton(this.component._hasClearButton),this.validateRows(this.component._rows)}},k=`@charset "UTF-8";
/*
...
@font-face {
  ...
  src: url("kolicons.eot?t=1790244618296"); /* IE9*/
  src: url("kolicons.eot?t=1790244618296#iefix") format("embedded-opentype"), url("kolicons.woff2?t=1790244618296") format("woff2"), url("kolicons.woff?t=1790244618296") format("woff"), url("kolicons.ttf?t=1790244618296") format("truetype"), url("kolicons.svg?t=1790244618296#kolicons") format("svg"); /* iOS 4.1- */
}
@layer kol-component {
...
}`,A=class{async getValue(){return this._value}async focus(e){}onBlur(){let e=this.state._options?.find(e=>e.label?.toLowerCase()===this._inputValue?.toLowerCase());e?this.selectOption(e):this._value!==null&&this._value!==void 0&&(this._filteredOptions=[...this.state._options??[]])}clearSelection(){var e;if(this.state._disabled)return;this._focusedOptionIndex=-1,this._value=null,this._inputValue=``,this._filteredOptions=[...this.state._options];let t=s(c.input,{name:this.state._name,value:null},this.ctaRef.el),n=s(c.change,{name:this.state._name,value:null},this.ctaRef.el);this.controller.onFacade.onInput(t,!0,{value:null}),this.controller.onFacade.onChange(n,{value:null}),(e=this.ctaRef.el)==null||e.focus(),this._isOpen=!0}selectOption(e){if(e.value===this._value){this._inputValue=e.label,this._filteredOptions=[...this.state._options];return}this._value=e.value,this._inputValue=e.label;let t=s(c.input,{name:this.state._name??``,value:e.value},this.ctaRef.el),n=s(c.change,{name:this.state._name??``,value:e.value},this.ctaRef.el);this.controller.onFacade.onInput(t,!1,e.value),this.controller.onFacade.onChange(n,e.value),this._filteredOptions=[...this.state._options],this.controller.setFormAssociatedValue(this._value)}onInput(e){let t=e.target;this._inputValue=t.value,this._isOpen=!0,this.setFilteredOptionsByQuery(t.value),this._focusedOptionIndex=-1}handleKeyDownDropdown(e){e.key.length===1&&/[a-z0-9]/i.test(e.key)&&(e.preventDefault(),this._isOpen=!0,this.focusSuggestionStartingWith(e.key))}setFilteredOptionsByQuery(e){e!==void 0&&(e?.trim()===``?this._filteredOptions=[...this.state._options]:Array.isArray(this.state._options)&&this.state._options.length>0&&e.length>0&&(this._filteredOptions=this.state._options.filter(t=>(t.label?.toLowerCase())?.includes(e?.toLowerCase()))))}moveFocus(e,t=1){if(!this._filteredOptions)return;let n=this._focusedOptionIndex+e,r=0,i=!1,a=this._filteredOptions.length;for(;r<a;){if(n>=this._filteredOptions.length&&(n=0),n<0&&(n=this._filteredOptions.length-1),!this._filteredOptions[n].disabled){i=!0;break}n+=t,r++}i&&(this._focusedOptionIndex=n,this.focusOption(this._focusedOptionIndex))}focusOption(e){this.refOptions&&this.refOptions[e]?.focus()}selectFocusedOption(){if(Array.isArray(this._filteredOptions)&&this._filteredOptions.length>0&&this._focusedOptionIndex>=0){let e=this._filteredOptions[this._focusedOptionIndex];return!e?.disabled&&(this.selectOption(e),!0)}return!1}focusSuggestionStartingWith(e){let t=e.toLowerCase(),n=Array.isArray(this._filteredOptions)&&this._filteredOptions.findIndex(e=>e.label.toLowerCase().startsWith(t)&&!e.disabled);typeof n==`number`&&n>=0&&(this._focusedOptionIndex=n,this.focusOption(n))}getFormFieldProps(){return{state:this.state,class:f(`kol-single-select`,{"kol-single-select--open":this._isOpen}),tooltipAlign:this._tooltipAlign,alert:this.showAsAlert(),infoPopover:this._infoPopover}}getInputProps(){let{ariaDescribedBy:e}=_(this.state),t=this.state._disabled===!0;return Object.assign(Object.assign({"aria-activedescendant":this._isOpen&&this._focusedOptionIndex>=0?`option-${this._focusedOptionIndex}`:void 0,"aria-autocomplete":`both`,"aria-controls":u(this.state._id,`listbox`),"aria-describedby":e.length>0?e.join(` `):void 0,"aria-expanded":this._isOpen?`true`:`false`,"aria-label":this.state._hideLabel&&typeof this.state._label==`string`?this.state._label:void 0,"aria-labelledby":u(this.state._id,`label`),"aria-keyshortcuts":this.state._shortKey,accessKey:this.state._accessKey,autocapitalize:`off`,autocorrect:`off`,autocomplete:`off`,class:`kol-single-select__input`,disabled:t,name:this.state._name,placeholder:this.state._placeholder,ref:this.ctaRef,required:this.state._required,role:`combobox`,state:this.state,type:`text`,value:this._inputValue},this.controller.onFacade),{onChange:this.onChange.bind(this),onClick:this.onClick.bind(this),onInput:this.onInput.bind(this)})}render(){let e=this.state._disabled===!0;return a(v,Object.assign({key:`04a050060ca93860b93728397dbd7acf78ff979f`},this.getFormFieldProps()),a(b,{key:`39515824d221e23218111937c8ee17895af07ceb`,state:this.state},a(`div`,{key:`b3999433ca860cd47bae78d982f7f064a6004de3`,class:`kol-single-select__group`},a(x,Object.assign({key:`89775ab0abefef76fd19d1db6a8b0726182090f1`},this.getInputProps())),this._inputValue&&this.state._hasClearButton&&a(o,{key:`524a1c330c440c6e4fd08270f6a2bc3ca225e143`,_icons:`kolicon-cross`,_label:this.translateDeleteSelection,_hideLabel:!0,_variant:`ghost`,_disabled:e,"data-testid":`single-select-delete`,class:`kol-single-select__delete`,hidden:e,_on:{onClick:()=>{var e;this.clearSelection(),(e=this.ctaRef.el)==null||e.focus(),this.clearButtonFocused=!1},onFocus:()=>{this.clearButtonFocused=!0},onBlur:()=>{this.clearButtonFocused=!1}}}),a(h,{key:`6f3a4e0a26a23ef301e96c72b29589cf0419a409`,icons:`kolicon-chevron-down`,label:``,class:f(`kol-custom-suggestions-toggle`,{"kol-custom-suggestions-toggle--disabled":e}),onClick:this.toggleListbox.bind(this)})),a(S,{key:`41f774225532309ce398fea679ba6d73cd5f2e92`,blockSuggestionMouseOver:this.blockSuggestionMouseOver,onKeyDown:this.handleKeyDownDropdown.bind(this),style:{"--visible-options":`${this._rows??5}`},hidden:!this._isOpen||e,id:u(this.state._id,`listbox`)},Array.isArray(this._filteredOptions)&&this._filteredOptions.length>0?this._filteredOptions.map((e,t)=>a(C,{index:t,option:e.label,searchTerm:this._inputValue,ref:e=>{e&&(this.refOptions[t]=e)},selected:this._value===e.value,disabled:!!e.disabled,onClick:t=>{var n;e.disabled||(t.preventDefault(),this.selectOption(e),this._isOpen=!1,(n=this.ctaRef.el)==null||n.focus())},onMouseOver:()=>{!this.blockSuggestionMouseOver&&!e.disabled&&(this._focusedOptionIndex=t,this.focusOption(t))},onFocus:()=>{e.disabled||(this._focusedOptionIndex=t,this.focusOption(t))}})):a(`li`,{class:`kol-single-select__no-results-message`,role:`alert`},this.translateNoResultsMessage,` `))))}handleKeyDown(e){var t,n,r;let i=(t,n)=>{var r;e.preventDefault(),t!==void 0&&(this._isOpen=t,t||(r=this.ctaRef.el)==null||r.focus()),n?.()};switch(e.key){case`Down`:case`ArrowDown`:this.blockSuggestionMouseOver=!0,i(!0,()=>this.moveFocus(1));break;case`Up`:case`ArrowUp`:this.blockSuggestionMouseOver=!0,i(!0,()=>this.moveFocus(-1,-1));break;case`Tab`:this._isOpen&&(this._isOpen=!this._isOpen,(t=this.ctaRef.el)==null||t.focus());break;case`Esc`:case`Escape`:this._isOpen&&(e.preventDefault(),this._isOpen=!1,(n=this.ctaRef.el)==null||n.focus());break;case` `:case`Enter`:case`NumpadEnter`:this.clearButtonFocused?(this.clearSelection(),e.preventDefault()):this._isOpen?this.selectFocusedOption()&&((r=this.ctaRef.el)==null||r.focus(),i(!1)):this.toggleListbox(e);break;case`Home`:this.blockSuggestionMouseOver=!0,i(void 0,()=>{this._isOpen&&this.moveFocus(this._focusedOptionIndex*-1)});break;case`End`:this.blockSuggestionMouseOver=!0,i(void 0,()=>{if(this._isOpen){let e=this._filteredOptions?this._filteredOptions.length-1-this._focusedOptionIndex:0;this.moveFocus(e,-1)}});break;case`PageUp`:this.blockSuggestionMouseOver=!0,i(void 0,()=>this._isOpen&&this.moveFocus(-10));break;case`PageDown`:this.blockSuggestionMouseOver=!0,i(void 0,()=>this._isOpen&&this.moveFocus(10,-1))}}validateAriaDetails(e){this.controller.validateAriaDetails(e)}constructor(t){e(this,t),this.ctaRef=m(),this.refOptions=[],this.translateDeleteSelection=g(`kol-delete-selection`),this.translateNoResultsMessage=g(`kol-no-results-message`),this.clearButtonFocused=!1,this.toggleListbox=e=>{var t;if(e?.preventDefault(),this.state._disabled!==!0){if((t=this.ctaRef.el)==null||t.focus(),this._isOpen)this._isOpen=!1;else{this._isOpen=!0;let e=Array.isArray(this._filteredOptions)?this._filteredOptions.findIndex(e=>e.label===this._inputValue):-1;this._focusedOptionIndex=e>=0?e:-1,this.focusOption(this._focusedOptionIndex)}}},this._focusedOptionIndex=-1,this._isOpen=!1,this._filteredOptions=[],this._inputValue=``,this.blockSuggestionMouseOver=!1,this._disabled=!1,this._hideMsg=!1,this._hideLabel=!1,this._hint=``,this._required=!1,this._tooltipAlign=`top`,this._touched=!1,this._value=null,this._hasClearButton=!0,this.state={_hideMsg:!1,_id:l(`single-select`),_label:``,_options:[],_hasClearButton:!0},this.inputHasFocus=!1,this.controller=new O(this,`single-select`,this.host)}showAsAlert(){return!!this.state._touched&&!this.inputHasFocus}validatePlaceholder(e){this.controller.validatePlaceholder(e)}validateAccessKey(e){this.controller.validateAccessKey(e)}validateDisabled(e){this.controller.validateDisabled(e)}validateHideMsg(e){this.controller.validateHideMsg(e)}validateHideLabel(e){this.controller.validateHideLabel(e)}validateHint(e){this.controller.validateHint(e)}validateIcons(e){this.controller.validateIcons(e)}validateLabel(e){this.controller.validateLabel(e)}validateMsg(e){this.controller.validateMsg(e)}validateName(e){this.controller.validateName(e)}validateOn(e){this.controller.validateOn(e)}validateOptions(e){this.controller.validateOptions(e),this._filteredOptions=[...this.state._options??[]],this._isOpen?this.setFilteredOptionsByQuery(this._inputValue):this.updateInputValue(this._value)}validateRequired(e){this.controller.validateRequired(e)}validateShortKey(e){this.controller.validateShortKey(e)}validateSyncValueBySelector(e){this.controller.validateSyncValueBySelector(e)}validateTouched(e){this.controller.validateTouched(e)}validateValue(e){this.controller.validateValue(e),this.oldValue=e,this.updateInputValue(e)}validateHasClearButton(e){this.controller.validateHasClearButton(e)}validateRows(e){this.controller.validateRows(e)}validateVariant(e){this.controller.validateVariant(e)}handleMouseEvent(){this.blockSuggestionMouseOver=!1}handleFocusIn(e){setTimeout(()=>{this.host?.contains(document.activeElement)&&!this.inputHasFocus&&(this.controller.onFacade.onFocus(e),this.inputHasFocus=!0)})}handleFocusOut(e){this.onBlur(),setTimeout(()=>{this.inputHasFocus&&!this.host?.contains(document.activeElement)&&(this.controller.onFacade.onBlur(e),this.inputHasFocus=!1,this._isOpen=!1)})}updateInputValue(e){let t=this.state._options?.find(t=>t.value===e);this._inputValue=t?String(t.label):``}componentWillLoad(){this.refOptions=[],this._touched=this._touched===!0,this.validateAriaDetails(this._ariaDetails),this.controller.componentWillLoad(),this.oldValue=this._value,this._filteredOptions=this.state._options,this.updateInputValue(this._value)}onChange(e){this.oldValue!==this.ctaRef.el?.value&&(this.oldValue=this.ctaRef.el?.value),this._isOpen||this.controller.onFacade.onChange(e,this._value)}onClick(e){var t;this.toggleListbox(e),(t=this.ctaRef.el)==null||t.focus(),this.controller.onFacade.onClick(e)}get host(){return r(this)}static get watchers(){return{_ariaDetails:[`validateAriaDetails`],_placeholder:[`validatePlaceholder`],_accessKey:[`validateAccessKey`],_disabled:[`validateDisabled`],_hideMsg:[`validateHideMsg`],_hideLabel:[`validateHideLabel`],_hint:[`validateHint`],_icons:[`validateIcons`],_label:[`validateLabel`],_msg:[`validateMsg`],_name:[`validateName`],_on:[`validateOn`],_options:[`validateOptions`],_required:[`validateRequired`],_shortKey:[`validateShortKey`],_syncValueBySelector:[`validateSyncValueBySelector`],_touched:[`validateTouched`],_value:[`validateValue`],_hasClearButton:[`validateHasClearButton`],_rows:[`validateRows`],_variant:[`validateVariant`]}}};d([p(`ctaRef`)],A.prototype,`focus`,null),A.style={default:k};export{A as kol_single_select};