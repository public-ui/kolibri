import{G as e,St as t,_t as n,a as r,c as i,d as a,o,r as s,s as c,st as l,u}from"./index-DpxgE-h1.js";import{i as d,n as f}from"./dev.utils-DEzQ6pd0-DPkT1eLM.js";import{t as p}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as m}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./_Uint8Array-kJnEuTzT-BYXN1zbF.js";import{a as h,c as g,f as _,i as v,o as y,r as b,u as x}from"./factory-CkUKGUPZ-RAGOa0Si.js";import"./disabled-CD5Tbz90-DCPnuWP2.js";import"./label-BJf95S0B-CM54EdXo.js";import"./label-CnjDuqYl-DJCe7odn.js";import"./variant-quote-DaD5tTvf-GS2an8nk.js";import{n as S,r as C,t as w}from"./element-interaction-DORv36BQ-BSHBQDXV.js";import"./block-bem-BUM3P35j-B6C21Ian.js";import"./component-m03svxKW-DD4p2FBa.js";import"./component-CsCzAc5k-CP9PP9iS.js";import{t as T}from"./i18n-B_vSiQA9-C3HDXvwl.js";import{n as E}from"./component-C0GKW038-CGe1-WJ6.js";import"./variant-class-name-2os1V9lQ-xoYx9P5D.js";import"./component-GVXco3vD-BeAuQiFE.js";import{t as D}from"./component-ge14UT-2-DA-kV08v.js";import"./align-Dm5aJHmk-TKAUge1l.js";import{r as O,t as k}from"./behavior-y1XpGFF1-5Dql8fFC.js";import{t as A}from"./label-with-expert-slot-BWWvmvMz-CU9lyMz5.js";import"./variant-BsmPIp1l-dst8aq50.js";import"./name-D4qyPsoS-CFPTlB1Y.js";import"./api-CnWp9V0Q-BJJqwn3_.js";import{t as j}from"./resolve-props-C_49kGck-BoHchd2s.js";import{n as M}from"./keyboard-DNd73LVa-BCj4IeP3.js";var N=b(`hasCreateButton`,!1,y),P=b(`selected`,0,x),F=[`select-automatic`,`select-manual`],I=b(`behavior`,`select-automatic`,e=>_(e),e=>v(e,F)),L=b(`tabs`,[],e=>h(e),e=>e.every(e=>typeof e==`object`&&!!e&&typeof e._label==`string`&&e._label.length>0),{hints:(e,n)=>t(`KolTabs`,n.length)}),R=b(`on`,{},e=>{let t=g(e),n={};return typeof t.onCreate==`function`&&(n.onCreate=t.onCreate),typeof t.onSelect==`function`&&(n.onSelect=t.onSelect),n}),z={required:[A,L],optional:[O,N,P,I,R]},B=()=>{let e=new k(p.stateLess),t=d(),r,a,o,s,c=(e,t)=>{o&&u(o,e,t)},l=t=>{t.stopPropagation(),e.hideTooltip();let o=r?.on.onClick;typeof o==`function`&&(n(t,s),o(t,a)),c(i.click,a)},f=e=>{var t,n;(n=r==null?void 0:(t=r.on).onMouseDown)==null||n.call(t,e),c(i.mousedown)},m=e=>{var t,n;(n=r==null?void 0:(t=r.on).onFocus)==null||n.call(t,e),c(i.focus)},h=e=>{var t,n;(n=r==null?void 0:(t=r.on).onBlur)==null||n.call(t,e),c(i.blur)},g=e=>{o=e},_=e=>{s=e};return{getButton:(n,i)=>(r=j(n,i),a=n._value,e.componentWillLoad({label:r.label,align:r.tooltipAlign}),{buttonProps:Object.assign(Object.assign({},r),{ariaDescriptionId:t,handleBlur:h,handleClick:l,handleFocus:m,handleMouseDown:f,refButton:_,refTooltip:e.setTooltipElementRef}),refBox:g}),getButtonElement:()=>s,syncListeners:()=>{s&&e.syncListeners(void 0,s,!0)},destroy:()=>{e.destroy()}}},V=a.forBlock(`kol-tabs`),H=V(`button-create`),U=V(`button-group`),W=V(`content`),G=V(`tab`),K=e=>{let{align:t,class:n,createButton:r,handleBlur:i,handleKeyDown:a,hasCreateButton:s,label:c,refContent:l,refRoot:u,tabButtons:d}=e;return o(E,{block:`kol-tabs`,modifiers:{[`align-${t}`]:!0},class:n,ref:u},o(`div`,{"aria-label":c,class:U,role:`tablist`,onKeyDown:a,onBlur:i},d.map(({buttonProps:e,refBox:t})=>o(`div`,{class:G,ref:t},o(D,Object.assign({},e)))),s&&o(`div`,{class:H,ref:r.refBox},o(D,Object.assign({},r.buttonProps)))),o(`div`,{class:W,ref:l}))},q=`@charset "UTF-8";
