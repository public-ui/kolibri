import{c as e,r as t,s as n}from"./index-DcDxiC7I-s3NaaO3L.js";import{i as r}from"./index-D4-i4HCF.js";import{t as i}from"./base-web-component--IgFgz37-CZuvR3uB.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import"./variant-quote-BEpTijLF-C90ZWlWZ.js";import"./label-BDgaSpkn-DyUisjbL.js";import{t as a}from"./label-DM7-TXhv-CH_oHTTc.js";import{t as o}from"./i18n-s5q4We3h-DTKqqqsx.js";import"./index-DCHfCGY1-DTIu0p68.js";import"./contrast-DavXWnsf-Vnm0a2qy.js";import{t as s}from"./color-BQS67vcs-Crk5FEEh.js";import{t as c}from"./src-Dox1ufOn-Ba-HYvkX.js";var l={optional:[s,c],required:[a]},u=`kol-avatar`,d=r(u,`image`),f=r(u,`initials`),p=e=>{let{color:t,initials:r,label:i,src:a}=e;return n(`div`,{"aria-label":o(`kol-avatar-alt`,{placeholders:{name:i}}),class:`kol-avatar`,role:`img`,style:{backgroundColor:t.backgroundColor,color:t.foregroundColor}},a?n(`img`,{alt:``,"aria-hidden":`true`,class:d,src:a}):n(`span`,{"aria-hidden":`true`,class:f},r))},m=`@charset "UTF-8";
...
}`,h=e=>e.length===0?``:e[0].toUpperCase(),g=e=>{let t=e.trim().split(/\s+/),n=t[0],r=t[t.length-1];return t.length>=2&&n&&r?`${h(n)}${h(r)}`:h(e)},_=class extends i{constructor(t){super(),e(this,t),this.initials=``}watchColor(e){s.apply(e,e=>this.setRenderProp(`color`,e))}watchLabel(e){a.apply(e,e=>{this.setRenderProp(`label`,e),this.setState(`initials`,g(e))})}watchSrc(e){c.apply(e,e=>this.setRenderProp(`src`,e))}componentWillLoad(){this.initRenderProps(l),s.apply(this._color,e=>this.setRenderProp(`color`,e)),a.apply(this._label,e=>{this.setRenderProp(`label`,e),this.setState(`initials`,g(e))}),c.apply(this._src,e=>this.setRenderProp(`src`,e))}render(){return n(t,{key:`bdae33043eebdcea2b4cf38760ec8211a7eb833c`},n(p,{key:`c01a05d77491c9de1dc08f37439311e668c7da19`,color:this.getRenderProp(`color`),label:this.getRenderProp(`label`),src:this.getRenderProp(`src`),initials:this.initials}))}static get watchers(){return{_color:[`watchColor`],_label:[`watchLabel`],_src:[`watchSrc`]}}};_.style={default:m};export{_ as kol_avatar};