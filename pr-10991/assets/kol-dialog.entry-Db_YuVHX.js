import{a as e,o as t,r as n,s as r}from"./index-ajH_xVPg.js";import{i,n as a}from"./dev.utils-DEzQ6pd0-BAV0qFNA.js";import"./base-web-component--IgFgz37-CZuvR3uB.js";import"./_Uint8Array-kJnEuTzT-BYXN1zbF.js";import"./factory-CkUKGUPZ-CQ_zR56z.js";import"./level-ip4k8eH2-DThlXPRR.js";import"./disabled-CD5Tbz90-Dy6hO3Ov.js";import"./label-BJf95S0B-0GTyAjto.js";import"./label-CnjDuqYl-DynbDQbF.js";import"./variant-quote-DaD5tTvf-BZGFnmaZ.js";import"./Heading-BStLDIxc-B47KNkIS.js";import"./block-bem-BUM3P35j-CYXA_Oam.js";import"./component-m03svxKW-C6-yJ7zZ.js";import"./component-CsCzAc5k-DWiGZEJ0.js";import"./i18n-B_vSiQA9-lk_bRVeT.js";import"./component-C0GKW038-gIfEPd1a.js";import"./variant-class-name-2os1V9lQ-B3HVqVPx.js";import"./component-GVXco3vD-Dc_er203.js";import"./component-ge14UT-2-VfvtnsyH.js";import"./align-Dm5aJHmk-DlCCK-70.js";import"./behavior-y1XpGFF1-BtX8ellF.js";import"./label-with-expert-slot-BWWvmvMz-Av2UXts_.js";import"./variant-BsmPIp1l-B62UE2jj.js";import"./name-D4qyPsoS-DouflODn.js";import"./api-CnWp9V0Q-BXhOuUXq.js";import"./resolve-props-C_49kGck-BkbOr6oO.js";import"./component-DeX_LOvF-A6vM_LH_.js";import{t as o}from"./base-DLcoRqYH-BiuGJe-y.js";var s=`@charset "UTF-8";
/*
...
}`,c=class extends o{constructor(e){super(),r(this,e),this.ariaDescriptionId=i(),this.headingId=a(`dialog-heading`),this.modal=!0,this._level=0,this._variant=`blank`,this._width=`100%`}componentWillLoad(){this.initDialogRenderProps(),this.watchLabel(this._label),this.watchLevel(this._level),this.watchOn(this._on),this.watchVariant(this._variant),this.watchWidth(this._width)}componentDidRender(){this.syncCardCloseTooltipListeners()}disconnectedCallback(){this.teardownDialog()}async openModal(){await this.showModal()}async showModal(){await this.show(!0)}async show(e=!1){this.showDialog(e)}async close(){this.closeDialog()}async closeModal(){await this.close()}renderSlot(){return t(`slot`,null)}render(){return t(n,{key:`0d730319c560df195298f800004bb8a0180402d7`},this.renderDialogFC())}watchLabel(e){this.applyLabel(e)}watchLevel(e){this.applyLevel(e)}watchOn(e){this.applyOn(e)}watchVariant(e){this.applyVariant(e)}watchWidth(e){this.applyWidth(e)}get host(){return e(this)}static get watchers(){return{_label:[`watchLabel`],_level:[`watchLevel`],_on:[`watchOn`],_variant:[`watchVariant`],_width:[`watchWidth`]}}};c.style={default:s};export{c as kol_dialog};