import{C as e,X as t,c as n,nt as r,o as i,r as a,s as o,z as s}from"./index-DcDxiC7I-s3NaaO3L.js";import{r as c,t as l}from"./behavior-CLQ45gTX-CenXUCao.js";import{i as u,r as d,t as f}from"./index-D4-i4HCF.js";import{i as p,n as m}from"./dev.utils-BRNeztdD-CsoyY-uQ.js";import{t as h}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as g}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{d as _,i as v,l as y,o as b,p as x,r as S,s as C}from"./variant-quote-BEpTijLF-C90ZWlWZ.js";import"./disabled-DuLXWP9d-DWmYXBED.js";import"./label-BDgaSpkn-DyUisjbL.js";import"./label-DM7-TXhv-CH_oHTTc.js";import{n as w,r as T,t as E}from"./element-interaction-DORv36BQ-BSHBQDXV.js";import"./block-bem-CFYgBvGj-BpGd6lF3.js";import"./component-C6jw-ClO-B5x_iKrI.js";import"./component-CREK6KX0-DCiqwB7l.js";import{t as D}from"./i18n-s5q4We3h-DTKqqqsx.js";import{n as O}from"./component-DAoi1zaI-DUqrXIgm.js";import"./variant-class-name-D1gM1t9T-DMsbXYKw.js";import"./component-CfSRYXOJ-C_HvIgHQ.js";import{t as k}from"./component-D1UpZm_2-BBVoI1Iw.js";import"./align-B29XBdiy-BnvqGn7_.js";import{t as A}from"./label-with-expert-slot-b97ZLUi--CddTRrP_.js";import"./variant-C3LcBTDs-DKmkUpmF.js";import"./name-CeiR719x-DM-CtkXv.js";import"./api-D28KPm1E-B5S8jwvQ.js";import{t as j}from"./resolve-props-wSpnaSAw-wXmDYu5g.js";import{n as M}from"./keyboard-DNd73LVa-BCj4IeP3.js";var N=S(`hasCreateButton`,!1,C),P=S(`selected`,0,_),F=[`select-automatic`,`select-manual`],I=S(`behavior`,`select-automatic`,e=>x(e),e=>v(e,F)),L=S(`tabs`,[],e=>b(e),e=>e.every(e=>typeof e==`object`&&!!e&&typeof e._label==`string`&&e._label.length>0),{hints:(e,t)=>r(`KolTabs`,t.length)}),R=S(`on`,{},e=>{let t=y(e),n={};return typeof t.onCreate==`function`&&(n.onCreate=t.onCreate),typeof t.onSelect==`function`&&(n.onSelect=t.onSelect),n}),z={required:[A,L],optional:[c,N,P,I,R]},B=()=>{let e=new l(h.stateLess),n=p(),r,i,a,o,s=(e,t)=>{a&&d(a,e,t)},c=n=>{n.stopPropagation(),e.hideTooltip();let a=r?.on.onClick;typeof a==`function`&&(t(n,o),a(n,i)),s(f.click,i)},u=e=>{var t,n;(n=r==null?void 0:(t=r.on).onMouseDown)==null||n.call(t,e),s(f.mousedown)},m=e=>{var t,n;(n=r==null?void 0:(t=r.on).onFocus)==null||n.call(t,e),s(f.focus)},g=e=>{var t,n;(n=r==null?void 0:(t=r.on).onBlur)==null||n.call(t,e),s(f.blur)},_=e=>{a=e},v=e=>{o=e};return{getButton:(t,a)=>(r=j(t,a),i=t._value,e.componentWillLoad({label:r.label,align:r.tooltipAlign}),{buttonProps:Object.assign(Object.assign({},r),{ariaDescriptionId:n,handleBlur:g,handleClick:c,handleFocus:m,handleMouseDown:u,refButton:v,refTooltip:e.setTooltipElementRef}),refBox:_}),getButtonElement:()=>o,syncListeners:()=>{o&&e.syncListeners(void 0,o,!0)},destroy:()=>{e.destroy()}}},V=u.forBlock(`kol-tabs`),H=V(`button-create`),U=V(`button-group`),W=V(`content`),G=V(`tab`),K=e=>{let{align:t,class:n,createButton:r,handleBlur:i,handleKeyDown:a,hasCreateButton:s,label:c,refContent:l,refRoot:u,tabButtons:d}=e;return o(O,{block:`kol-tabs`,modifiers:{[`align-${t}`]:!0},class:n,ref:u},o(`div`,{"aria-label":c,class:U,role:`tablist`,onKeyDown:a,onBlur:i},d.map(({buttonProps:e,refBox:t})=>o(`div`,{class:G,ref:t},o(k,Object.assign({},e)))),s&&o(`div`,{class:H,ref:r.refBox},o(k,Object.assign({},r.buttonProps)))),o(`div`,{class:W,ref:l}))},q=`@charset "UTF-8";
