import{St as e,U as t,_t as n,a as r,c as i,d as a,o,r as s,s as c,u as l}from"./index-ajH_xVPg.js";import{i as u}from"./dev.utils-DEzQ6pd0-BAV0qFNA.js";import{n as d,t as f}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as p}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./_Uint8Array-kJnEuTzT-BYXN1zbF.js";import{a as m,r as h}from"./factory-CkUKGUPZ-CQ_zR56z.js";import{t as g}from"./disabled-CD5Tbz90-Dy6hO3Ov.js";import"./label-BJf95S0B-0GTyAjto.js";import"./label-CnjDuqYl-DynbDQbF.js";import"./variant-quote-DaD5tTvf-BZGFnmaZ.js";import{r as _,t as v}from"./element-interaction-DORv36BQ-BSHBQDXV.js";import"./block-bem-BUM3P35j-CYXA_Oam.js";import"./component-m03svxKW-C6-yJ7zZ.js";import"./component-CsCzAc5k-DWiGZEJ0.js";import"./i18n-B_vSiQA9-lk_bRVeT.js";import"./component-C0GKW038-gIfEPd1a.js";import"./variant-class-name-2os1V9lQ-B3HVqVPx.js";import"./component-GVXco3vD-Dc_er203.js";import"./align-Dm5aJHmk-DlCCK-70.js";import{t as y}from"./behavior-y1XpGFF1-BtX8ellF.js";import{t as b}from"./label-with-expert-slot-BWWvmvMz-Av2UXts_.js";import{d as x,f as S,l as C,n as w,o as T,r as E,s as D,t as O,u as k}from"./variant-BsmPIp1l-B62UE2jj.js";import{t as A}from"./href-cJcDsjp_-d4HmGe4h.js";import{t as j}from"./link-target-DFj0y-Ob-BZtaDtTZ.js";import{a as M,i as N,n as P,o as F,t as I}from"./api-g_7goTEF-CRjGkw5e.js";import{t as L}from"./access-and-short-key-ijzCZfHm-Dx5Q-CAn.js";import{n as R,t as z}from"./unique-nav-labels-DWO8JUzQ-BODzeUo-.js";var B=h(`links`,[],e=>m(e),e=>e.every(e=>typeof e==`object`&&(typeof e._href==`string`||typeof e._label==`string`)),{hints:(t,n)=>e(`KolSkipNav`,n.length)}),V={required:[B,b]},H=a.forBlock(`kol-skip-nav`),U=H(),W=H(`list`),G=H(`list-item`),K=({label:e,linkItems:t})=>o(`nav`,{class:U,"aria-label":e},o(`ul`,{class:W},t.map((e,t)=>o(`li`,{class:G,key:t},o(I,Object.assign({},e.fcProps)))))),q=(e,t)=>{let r=new y(f.stateLess),a=v(),o=d(F);delete o.tabIndex;let s=(e,t)=>e.apply(t,t=>{o[e.propName]=t});s(O,e._accessKey),s(w,e._ariaControls),s(P,e._ariaCurrentValue),s(E,e._ariaDescription),s(g,e._disabled),s(N,e._download),s(T,e._hideLabel),s(A,e._href),s(k,e._icons),s(D,e._inline??!0),s(b,e._label),s(M,e._on),s(C,e._shortKey),typeof e._tabIndex==`number`&&s(x,e._tabIndex),s(j,e._target),s(S,e._tooltipAlign),L(e._accessKey,e._shortKey),r.componentWillLoad({label:(()=>{let e=o.label;if(typeof e==`string`&&e.length>0)return e;let t=o.href;return typeof t==`string`?t:``})(),align:o.tooltipAlign}),o.ariaCurrent=``,o.ariaDescriptionId=u(),o.expertSlot=e._label===``;let c=()=>typeof o.href==`string`?o.href:``;return o.handleAnchorClick=e=>{if(r.hideTooltip(),o.disabled===!0){e.preventDefault();return}let s=c(),u=o.on;typeof u?.onClick==`function`&&(n(e,a.el),u.onClick(e,s));let d=t();d&&l(d,i.click,s)},o.refAnchor=e=>{a(e)},o.refTooltip=r.setTooltipElementRef,{fcProps:o,getAnchor:()=>a.el,syncTooltipListeners:()=>{a.el&&r.syncListeners(void 0,a.el,!0)},destroy:()=>{r.destroy()}}},J=`@charset "UTF-8";
