import{D as e,a as t,o as n,s as r}from"./index-DAATXC1g.js";import{t as i}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{n as a,r as o,t as s}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";var c=`@charset "UTF-8";
/*
...
}`,l=class{constructor(e){r(this,e),this.ctaRef=s(),this._disabled=!1,this._hideLabel=!1,this._inline=!1,this._popoverAlign=`bottom`,this._tooltipAlign=`top`,this._type=`button`,this._variant=`normal`}async hidePopover(){var e;(e=this.ctaRef.el)==null||e.hidePopover()}async showPopover(){var e;(e=this.ctaRef.el)==null||e.showPopover()}async click(){}async focus(e){}render(){return n(e,{key:`94a60d7e6ca8c70affeaf0091ad5f53d823fd2ed`,ref:this.ctaRef,_accessKey:this._accessKey,_ariaDescription:this._ariaDescription,_customClass:this._customClass,_disabled:this._disabled,_hideLabel:this._hideLabel,_icons:this._icons,_inline:this._inline,_label:this._label,_name:this._name,_popoverAlign:this._popoverAlign,_shortKey:this._shortKey,_syncValueBySelector:this._syncValueBySelector,_tabIndex:this._tabIndex,_tooltipAlign:this._tooltipAlign,_type:this._type,_value:this._value,_variant:this._variant},n(`slot`,{key:`79a544c60d413a6cc3865af25061bbaeb575922a`,name:`expert`,slot:`expert`}),n(`slot`,{key:`294042dfa1fbe73442381a1d1d7da905fb668d35`}))}get host(){return t(this)}};i([a(`ctaRef`)],l.prototype,`click`,null),i([o(`ctaRef`)],l.prototype,`focus`,null),l.style={default:c};export{l as kol_popover_button};