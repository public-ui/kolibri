import{Ct as e,G as t,St as n,T as r,U as i,o as a,s as o,v as s,wt as c}from"./index-l37Msmat.js";import{n as l,t as u}from"./dev.utils-BLwpXbb2-YYoXsFrc.js";import{t as d}from"./clsx-COFh-Vc8-DWAop4cA.js";import{r as f}from"./label-C0rxk5dd-DJ06YcfJ.js";import{t as p}from"./i18n-6Ww8y2f3-BIPygTeq.js";import{n as m,t as h}from"./unique-nav-labels-BYgmk-Dk-DSqYOGkf.js";import{t as g}from"./hide-label-SpRnjGvL-e4ldpnz7.js";var _=(t,n)=>{e(t,`_collapsible`,n)},v=(t,n)=>{e(t,`_hasCompactButton`,n)},y=(t,n)=>{e(t,`_hasIconsWhenExpanded`,n)},b=(e,t,r)=>{c(t,`_links`,e=>typeof e==`object`&&(typeof e._href==`string`||typeof e._label==`string`),r),n(e,t.state._links.length)},x=`@charset "UTF-8";
...
}`,S=e=>typeof e._href==`string`,C=e=>e._href===void 0&&typeof e._on?.onClick==`function`,w=class{constructor(e){o(this,e),this.navId=l(`kol-nav`),this.listId=u(this.navId,`list`),this.handleToggleExpansionClick=e=>{e&&(this.state._expandedChildren.includes(e)?this.collapseChildren(e):this.expandChildren(e))},this.linkList=e=>a(`ul`,{class:d(`kol-nav__list`,{"kol-nav__list--nested":e.deep>0,"kol-nav__list--vertical":e.deep!==0}),id:e.deep>0?e.id:void 0},e.links.map((t,n)=>this.li(e.collapsible,e.deep,n,t,e.id))),this._collapsible=!0,this._hasCompactButton=!1,this._hasIconsWhenExpanded=!1,this._hideLabel=!1,this.state={_collapsible:!0,_hasCompactButton:!1,_hasIconsWhenExpanded:!1,_hideLabel:!1,_label:``,_links:[],_expandedChildren:[]}}expandChildren(e){this.state=Object.assign(Object.assign({},this.state),{_expandedChildren:[...this.state._expandedChildren,e]})}collapseChildren(e){this.state=Object.assign(Object.assign({},this.state),{_expandedChildren:this.state._expandedChildren.filter(t=>t!==e)})}buildIconObject(e,t,n){let r={left:``,right:``};return this.state._hasIconsWhenExpanded&&n&&(r.left=n),this.state._hideLabel&&(r.left=n||`kolicon-link`),e&&(r.right=t?`kolicon-minus`:`kolicon-plus`),r}entry(e,t,n,i,o){let c=typeof n._icons==`string`?n._icons:typeof n._icons?.left==`string`?n._icons.left:void 0,l=this.buildIconObject(e&&t,i,c);return a(`div`,{class:`kol-nav__entry-wrapper`},S(n)?a(r,Object.assign({class:d(`kol-nav__entry kol-nav__entry--link`,{"kol-nav__entry--collapsible":e})},n,{_hideLabel:this.state._hideLabel,_icons:l,_ariaControls:e&&t&&i?o:void 0,_ariaExpanded:e&&t?i:void 0})):a(s,{class:d(`kol-nav__entry kol-nav__entry--button`,{"kol-nav__entry--collapsible":e}),_label:n._label,_hideLabel:this.state._hideLabel,_icons:l,_ariaControls:e&&t&&i?o:void 0,_ariaExpanded:e&&t?i:void 0,_on:{onClick:(e,t)=>{C(n)&&typeof n._on.onClick==`function`&&n._on.onClick(e,t),this.handleToggleExpansionClick(n._children)}}}))}li(e,t,n,r,i){let o=!!r._active,s=Array.isArray(r._children)&&r._children.length>0,c=!!(r._children&&this.state._expandedChildren.includes(r._children)),l=u(i,`${t}-${n}`);return a(`li`,{class:d(`kol-nav__list-item`,{"kol-nav__list-item--active":o,"kol-nav__list-item--expanded":c,"kol-nav__list-item--has-children":s}),key:n},this.entry(e,s,r,c,l),c&&a(this.linkList,{collapsible:e,deep:t+1,links:r._children||[],id:l}))}initializeExpandedChildren(){this.state=Object.assign(Object.assign({},this.state),{_expandedChildren:[]});let e=t=>{if(t._active)return t._children&&this.expandChildren(t._children),!0;if(t._children){for(let n of t._children)if(e(n))return this.expandChildren(t._children),!0}return!1};this.state._links.forEach(e)}render(){let e=this.state._collapsible===!0;return a(`div`,{key:`d8a3c9d66d0b0e853e9d478529494f1848aa9879`,class:d(`kol-nav`,{"kol-nav--is-compact":this.state._hideLabel})},a(`nav`,{key:`3145a472288154e56d64947877a24e78814b0d39`,"aria-label":this.state._label,class:`kol-nav__navigation`,id:this.navId},a(this.linkList,{key:`fe0203bf05c5e49786c5a8d9c994a6b2e88da423`,collapsible:e,deep:0,links:this.state._links,id:this.listId})),this.state._hasCompactButton&&a(`div`,{key:`e8e9fd03debcb9941a39b197518396d4bd8b46f8`,class:`kol-nav__compact`},a(s,{key:`3751525bc51f54fc601c8010f22b2f1d1c2a2e0c`,class:`kol-nav__toggle-button`,_ariaControls:this.navId,_ariaExpanded:!this.state._hideLabel,_icons:this.state._hideLabel?`kolicon-chevron-right`:`kolicon-chevron-left`,_hideLabel:!0,_label:this.state._hideLabel?p(`kol-nav-maximize`):p(`kol-nav-minimize`),_on:{onClick:()=>{this.state=Object.assign(Object.assign({},this.state),{_hideLabel:!this.state._hideLabel})}},_tooltipAlign:`right`})))}validateCollapsible(e){_(this,e)}validateHasCompactButton(e){v(this,e)}validateHasIconsWhenExpanded(e){y(this,e)}validateHideLabel(e){g(this,e)}validateLabel(e,t,n=!1){n||m(this.state._label),f(this,e,{required:!0}),i(e),h(this.state._label)}validateLinks(e){b(`KolNav`,this,e),t(`[KolNav] The navigation structure is not yet validated recursively.`),this.initializeExpandedChildren()}componentWillLoad(){this.validateCollapsible(this._collapsible),this.validateHideLabel(this._hideLabel),this.validateHasCompactButton(this._hasCompactButton),this.validateHasIconsWhenExpanded(this._hasIconsWhenExpanded),this.validateLabel(this._label,void 0,!0),this.validateLinks(this._links),this.initializeExpandedChildren()}disconnectedCallback(){m(this.state._label)}static get watchers(){return{_collapsible:[`validateCollapsible`],_hasCompactButton:[`validateHasCompactButton`],_hasIconsWhenExpanded:[`validateHasIconsWhenExpanded`],_hideLabel:[`validateHideLabel`],_label:[`validateLabel`],_links:[`validateLinks`]}}};w.style={default:x};export{w as kol_nav};