import{B as e,a as t,c as n,d as r,o as i,s as a,u as o}from"./index-BfTS8Ic4.js";import{i as s,n as c}from"./dev.utils-DEzQ6pd0-J_hgi4qM.js";import{n as l,t as u}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as d}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./_Uint8Array-kJnEuTzT-BYXN1zbF.js";import"./factory-DVePsLAQ-CJTKXidp.js";import{t as f}from"./disabled-CTTZKNPl-tcGGEpVy.js";import"./label-BJf95S0B-CcjQawJL.js";import"./label-CnOLrr0w-CWRwQa7r.js";import"./variant-quote-7bJL1WOX-B4ZfmVHR.js";import{t as p}from"./clsx-COFh-Vc8-DWAop4cA.js";import{n as m,r as h,t as g}from"./element-interaction-DORv36BQ-BSHBQDXV.js";import"./block-bem-BGMd0WJH-DIQGg0xO.js";import"./component-BG05O9Id-Dl3OxfXV.js";import"./component-DIrul5pb-DcL_L0_9.js";import{t as _}from"./i18n-B_vSiQA9-jNPdSsJK.js";import{n as v}from"./component-1zt0BWKC-I_cAnMKn.js";import"./variant-class-name-2os1V9lQ-C-CZulh8.js";import"./component-COEI4VoT-D8HAFqHX.js";import{t as y}from"./component-Z2KNQIrE-C6ujK5Ky.js";import"./align-Dm5aJHmk-COubtHYh.js";import{i as b,t as x}from"./behavior-Cxx5cP6o-as9mwq6k.js";import{t as S}from"./label-with-expert-slot-Dh4zRZEb-CGwwxhFE.js";import{a as C,c as w,d as T,f as E,l as D,o as O,p as k,r as A,s as j,t as M,u as N}from"./variant-BBnlDNla-CtIWi49U.js";import{t as P}from"./name-CeY6Ud0E-B3Dbzc-u.js";import{a as F,n as I,r as L,t as R}from"./api-BdaEnkJl-DBQrREUS.js";import"./controller-BDOsSDm9-BDsKj6Gq.js";import"./aria-details-ChvorFzb-B1mZjPd0.js";import"./associated.controller-ExNQqx6z-Bp3uA447.js";import{t as z}from"./base-WZSNWAVO-t3YwkVjQ.js";import{n as B,r as V,t as H}from"./controller-Bq2iKxSt-DX8A6vym.js";var U={required:[S],optional:[M,A,R,I,L,F,C,f,O,b,j,S,w,P,V,D,N,T,E,k]},W=t=>{let r=new B,i=new x(u.stateLess),a=g(),d,p=l(U);delete p.tabIndex;let m=e=>{f.apply(e,e=>{p.disabled=e})};m(t.disabled),O.apply(t.hideLabel,e=>{p.hideLabel=e}),N.apply(t.icons,e=>{p.icons=e}),j.apply(!1,e=>{p.inline=e}),E.apply(`top`,e=>{p.tooltipAlign=e}),F.apply(`button`,e=>{p.type=e}),S.apply(t.label,e=>{p.label=e}),V.apply(t.popoverAlign,e=>{p.popoverAlign=e,r.setAlign(e)}),k.apply(e(`buttonVariantDefault`,t.getFlagHost())??`normal`,e=>{p.variant=e}),p.ariaDescriptionId=s(),p.popoverId=c(`popover`);let h=e=>{let n=t.getEventTarget();n&&o(n,e)},_=e=>{t.setOpen(e.newState===`open`)};return p.handleClick=e=>{e.stopPropagation(),i.hideTooltip(),r.setShow(!t.getOpen()),h(n.click)},p.handleMouseDown=()=>h(n.mousedown),p.handleFocus=()=>h(n.focus),p.handleBlur=()=>h(n.blur),p.refButton=e=>{a(e),r.setTriggerElement(e)},p.refPopover=e=>{d=e,r.setPopoverElementRef(e)},p.refTooltip=i.setTooltipElementRef,i.componentWillLoad({label:p.label,align:p.tooltipAlign}),{getFcProps:()=>Object.assign(Object.assign({},p),{popoverOpen:t.getOpen()}),hide:()=>r.setShow(!1),setDisabled:m,syncListeners:()=>{a.el&&i.syncListeners(void 0,a.el,!0),d?.addEventListener(`toggle`,_)},destroy:()=>{i.destroy(),d&&=(d.removeEventListener(`toggle`,_),void 0),r.destroy()}}},G=r.forBlock(`kol-split-button`),K=G(`button`),q=G(`horizontal-line`),J=G(`root`),Y=G(`secondary-button`),X=e=>{let{buttonProps:t,buttonWrapperClass:n,class:r,dropdownProps:a,refDropdown:o}=e;return i(v,{block:`kol-split-button`,class:r},i(`div`,{class:J},i(`div`,{class:p(K,n)},i(y,Object.assign({},t))),i(`div`,{class:q}),i(`div`,{class:Y,ref:o},i(H,Object.assign({},a)))))},Z=`@charset "UTF-8";
