import{Ct as e,G as t,o as n,s as r}from"./index-ycLdbSIc.js";import{t as i}from"./i18n-Cmt851J--CT-j4wkH.js";import{n as a}from"./contrast-BMisfone-C1SAG3L3.js";import{n as o}from"./color-DmnTebHy-CQuXHMSw.js";var s=`@charset "UTF-8";
...
}`,c=class{constructor(e){r(this,e),this.translateKolibriLogo=i(`kol-kolibri-logo`),this._color=`#003c78`,this._labeled=!0,this.state={_color:{red:0,green:60,blue:120},_labeled:!0},this.handleColorChange=(e,n)=>{if(typeof e==`string`){let t=a(e);n.set(`_color`,{red:t[0],green:t[1],blue:t[2]})}else t(`[KolKolibri] You used the complex color schema. For the KoliBri we use need the color as hex string.`)}}render(){let e=`rgb(${this.state._color.red},${this.state._color.green},${this.state._color.blue})`;return n(`svg`,{key:`4341d576cfd65807c33d33058ce81cf8541681a1`,class:`kol-kolibri`,role:`img`,"aria-label":this.translateKolibriLogo,xmlns:`http://www.w3.org/2000/svg`,viewBox:`0 0 600 600`,fill:e},n(`path`,{key:`f0372afcaa936cef7e7eb895d165e59758f2fe33`,d:`M353 322L213 304V434L353 322Z`}),n(`path`,{key:`674d4025434c1cb91d202798d87bf8592984d64f`,d:`M209 564V304L149 434L209 564Z`}),n(`path`,{key:`77e6aa258d29ec92d0dd7db75ef7e6d31568a2ee`,d:`M357 316L417 250L361 210L275 244L357 316Z`}),n(`path`,{key:`11c7e24da5ca279c6b9842be19f369bcda4aba8a`,d:`M329 218L237 92L250 222L272 241L329 218Z`}),n(`path`,{key:`a5c57698fed4ed533ae9887f4376c5729dba9dfe`,d:`M353 318L35 36L213 300L353 318Z`}),n(`path`,{key:`74cce58a4864153b6364b23ef4cf7f55a94ea081`,d:`M391 286L565 272L421 252L391 286Z`}),this.state._labeled===!0&&n(`text`,{key:`b013fce237fd89ff47d5786ad92a3c5b4615fa99`,class:`kol-kolibri__text`,x:`250`,y:`525`,fill:e},`KoliBri`))}validateColor(e){o(this,e,{defaultValue:`#003c78`,hooks:{beforePatch:this.handleColorChange}})}validateLabeled(t){e(this,`_labeled`,t,{defaultValue:!0})}componentWillLoad(){this.validateColor(this._color),this.validateLabeled(this._labeled)}static get watchers(){return{_color:[`validateColor`],_labeled:[`validateLabeled`]}}};c.style={default:s};export{c as kol_kolibri};