...
Locator: locator('[data-visual-block="icons"]')
  Expected an image 218px by 348px, received 218px by 453px. 1941 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: icon-font--icons.png

Call log:
  - Expect "toHaveScreenshot(icon-font--icons.png)" with timeout 10000ms
    - verifying given screenshot expectation
  - waiting for locator('[data-visual-block="icons"]')
    - locator resolved to <div data-visual-block="icons" class="grid grid-cols-2 gap-8 p-8">…</div>
...
- main [ref=e4]:
  ...
  - generic [ref=e7]:
    - generic [ref=e8]:
      - img "ecl-icons-livestreaming" [ref=e10]: 
      - generic [ref=e11]: <KolIcon _icons='ecl-icons-livestreaming' _label="ecl-icons-livestreaming" />
    - generic [ref=e12]:
      - img "ecl-icons-log-in" [ref=e14]: 
      - generic [ref=e15]: <KolIcon _icons='ecl-icons-log-in' _label="ecl-icons-log-in" />
    - generic [ref=e16]:
      - img "ecl-icons-digital" [ref=e18]: 
      - generic [ref=e19]: <KolIcon _icons='ecl-icons-digital' _label="ecl-icons-digital" />
    - generic [ref=e20]:
      - img "ecl-icons-information-round" [ref=e22]: 
      - generic [ref=e23]: <KolIcon _icons='ecl-icons-information-round' _label="ecl-icons-information-round" />
  - generic [ref=e26]:
