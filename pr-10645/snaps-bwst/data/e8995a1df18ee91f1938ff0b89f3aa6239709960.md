...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 1994px, received 500px by 2038px. 64474 pixels (ratio 0.07 of all image pixels) are different.
        ...
        - generic [ref=e14]:
          ...
          - generic [ref=e122]:
            - generic [ref=e123] [cursor=pointer]:
              - generic [ref=e126]: Passwort (Readonly)
              - text: (read-only)
