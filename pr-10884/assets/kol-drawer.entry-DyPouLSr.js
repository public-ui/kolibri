import{t as e}from"./tooltip-open-tracking-D3tCiiGP-CEtn2Gu2.js";import{Ct as t,a as n,c as r,o as i,r as a,s as o,u as s,y as c,yt as l}from"./index-BjYos9R4.js";import{n as u}from"./dev.utils-CEnY7ddq-Di7hESvq.js";import"./_Uint8Array-kJnEuTzT-BYXN1zbF.js";import"./factory-FIQX-j9Q-BCAFOh7w.js";import"./level-BC1ZCt0z-BmHFpbh9.js";import{r as d}from"./label-B7zpf3VJ-w9i54633.js";import{t as f}from"./clsx-COFh-Vc8-DWAop4cA.js";import{n as p}from"./align-CMqZvT8f-CmBRtcr-.js";import{n as m,r as h,t as g}from"./validation-DfHGBmhS-1s4xvNs2.js";import{t as _}from"./open-DXEhiDQf-B4daYRdK.js";var v=(e,n)=>{t(e,`_hasCloser`,n)},y=`@charset "UTF-8";
/*
...
}`,b=class{constructor(t){o(this,t),this.cardHeadingId=u(`drawer-heading`),this.isModal=!0,this._cardOn={onClose:()=>void this.close()},this.getWrapperRef=e=>this.dialogWrapperElement=e,this.getRef=e=>{this.dialogElement=e,setTimeout(()=>{this.openOrCloseBasedOnState()})},this._hasCloser=!1,this._level=0,this.state={_label:``,_open:!1,_align:`left`},this.handleCancelEvent=t=>{var n,i;e(t),!t.defaultPrevented&&((i=(n=this.state._on)?.onCancel)==null||i.call(n,t),!t.defaultPrevented&&this.host&&!s(this.host,r.cancel)&&t.preventDefault())},this.handleClose=()=>{m(this),(async()=>{await this.close(),this.handleCloseDialog()})()},this.handleAnimationEnd=e=>{var t,n;e.animationName.includes(`slideOut`)&&((n=(t=this.dialogElement)?.close)==null||n.call(t))}}async show(e=!1){var t,n,i,a,o,c;this.dialogElement?.open||(this.isModal=e,this.state=Object.assign(Object.assign({},this.state),{_open:!0}),e?((n=(t=this.dialogElement)?.showModal)==null||n.call(t),this.dialogElement&&g(this)):(a=(i=this.dialogElement)?.show)==null||a.call(i),(c=(o=this._on)?.onToggle)==null||c.call(o,!0),this.host&&s(this.host,r.toggle))}showModal(){return this.show(!0)}open(){return this.show(!1)}async close(){var e,t;this.state=Object.assign(Object.assign({},this.state),{_open:!1});let n=this.dialogWrapperElement;n&&window.getComputedStyle(n).animationName===`none`&&((t=(e=this.dialogElement)?.close)==null||t.call(e))}renderDialogContent(){let e=this.state._align;return i(c,{ref:this.getWrapperRef,class:f(`kol-drawer__wrapper`,`kol-drawer__wrapper--${e}`,{"kol-drawer__wrapper--open":this.state._open,"kol-drawer__wrapper--is-closing":this.state._open===!1}),_hasCloser:this.state._hasCloser,_headingId:this.cardHeadingId,_label:this.state._label,_level:this._level,_on:this._cardOn},i(`div`,{class:`kol-drawer__content`},i(`slot`,null)))}render(){return i(a,{key:`2c489456264d5f17ddf8b299df7c6a4d6d7f0379`,class:`kol-drawer`},i(`dialog`,{key:`1ec7454575caedc9bb223f1535c8f1d33fe6a0e6`,"aria-labelledby":this.cardHeadingId,"aria-modal":this.isModal?`true`:`false`,class:`kol-drawer__dialog`,onCancel:this.handleCancelEvent,ref:this.getRef},this.renderDialogContent()))}validateLabel(e){d(this,e,{required:!0})}validateAlign(e){p(this,e)}validateHasCloser(e){v(this,e)}validateLevel(e){h(this,e)}validateOpen(e){typeof e==`boolean`&&(_(this,e),this.dialogElement&&this.openOrCloseBasedOnState())}async openOrCloseBasedOnState(){this.state._open?await this.show(this.isModal):await this.close()}validateOn(e){if(typeof e==`object`&&e){let t={};typeof e.onCancel==`function`&&(t.onCancel=e.onCancel),typeof e.onClose==`function`&&(t.onClose=e.onClose),typeof e.onToggle==`function`&&(t.onToggle=e.onToggle),l(this,`_on`,t)}}handleCloseDialog(){var e,t,n,i;(t=(e=this._on)?.onClose)==null||t.call(e),(i=(n=this._on)?.onToggle)==null||i.call(n,!1),this.host&&(s(this.host,r.close),s(this.host,r.toggle))}componentDidLoad(){var e,t;(e=this.dialogElement)==null||e.addEventListener(`animationend`,this.handleAnimationEnd),(t=this.dialogElement)==null||t.addEventListener(`close`,this.handleClose)}disconnectedCallback(){var e,t;(e=this.dialogElement)==null||e.removeEventListener(`animationend`,this.handleAnimationEnd),(t=this.dialogElement)==null||t.removeEventListener(`close`,this.handleClose),m(this)}componentWillLoad(){this.validateAlign(this._align),this.validateHasCloser(this._hasCloser),this.validateLabel(this._label),this.validateOpen(this._open),this.validateLevel(this._level),this.validateOn(this._on)}get host(){return n(this)}static get watchers(){return{_label:[`validateLabel`],_align:[`validateAlign`],_hasCloser:[`validateHasCloser`],_level:[`validateLevel`],_open:[`validateOpen`],_on:[`validateOn`]}}};b.style={default:y};export{b as kol_drawer};