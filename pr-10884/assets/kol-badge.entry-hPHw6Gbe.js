import{B as e,J as t,_t as n,a as r,c as i,d as a,ft as o,o as s,r as c,s as l,u,ut as d}from"./index-BFSO_bCi.js";import{i as f,n as p}from"./dev.utils-cqmXfusu-Boj8O20J.js";import{n as m,t as h}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as g}from"./tslib.es6-DQVO_XFF-DpzS01Oy.js";import"./label-DxrksC9L-DyaO1Zx8.js";import{r as _,t as v}from"./element-interaction-BPnZMkX0-KKKn0vhi.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{n as y}from"./normalizers-82D7TWmE-eKFDWWJH.js";import"./component-CjE8A8Ns-BRwQag9m.js";import"./index-YF9sPUm--Bw5W-ElW.js";import{t as b}from"./color-DBMwWXjD-CxVJ8HDc.js";import"./label-KuopHlaW-CPgWi_vN.js";import"./variant-quote-Bs-oFesK-CoRc_G0l.js";import{t as x}from"./label-with-expert-slot-EmhE4sOM-CBH11e3b.js";import"./align-DglmQnOH-DXAgY2xB.js";import{a as S,c as ee,d as C,f as w,i as T,l as E,m as D,n as O,o as k,p as A,r as j,s as M,u as N}from"./component-BRdhcIiu-ByfUI8uI.js";import"./variant-class-name-BFZvmFM_-aso1Z-E3.js";import{n as P}from"./component-CVf171Qo-BB8_FKXw.js";import{t as F}from"./component-eGrx38ME-Bl5A3aLy.js";import"./component-CO9uVSuP-B3mKjzQC.js";import"./align-floating-elements-D6Kc-f8P-COPKxvCO.js";import{n as I,t as L}from"./behavior-BbHTNi73-C2SvT8Hg.js";import{t as R}from"./name-nC5duMmI-CIrCFXLs.js";import{a as z,i as B,o as V,r as H,t as U}from"./api-IVnWNvk0-Bams1QC4.js";function W(e){let t=typeof e==`string`?o(e):e;if(typeof t==`object`&&t)return t;throw Error(`Invalid smart button: ${typeof e}`)}var G=y(`smartButton`,{_label:``},W),K={required:[x],optional:[b,G,C]},q=a.forBlock(`kol-badge`),J=q(`label`),Y=q(`smart-button`),X=e=>{let{ariaDescriptionId:t,color:n,handleBlur:r,handleClick:i,handleFocus:a,handleMouseDown:o,icons:c,label:l,labelId:u,refSmartButton:d,refTooltip:f,smartButton:p,smartButtonProps:m}=e,h=typeof p==`object`&&!!p&&m!==void 0;return s(`div`,{class:q({"has-smart-button":h}),style:{backgroundColor:n.backgroundColor,color:n.foregroundColor}},s(F,{class:J,id:h?u:void 0,allowMarkdown:!0,icons:c,label:l}),h&&s(U,Object.assign({},m,{class:Y,ariaDescriptionId:t,handleBlur:r,handleClick:i,handleFocus:a,handleMouseDown:o,refButton:d,refTooltip:f})),s(`br`,null))},Z={disabled:!1,hideLabel:!1,inline:!1,tooltipAlign:`top`,type:`button`};function Q(t,n){let r=m(z),i=e=>t=>{r[e]=t};return x.apply(t._label,i(`label`)),O.apply(t._accessKey,i(`accessKey`)),j.apply(t._ariaControls,i(`ariaControls`)),T.apply(t._ariaDescription,i(`ariaDescription`)),S.apply(t._ariaExpanded,i(`ariaExpanded`)),H.apply(t._ariaSelected,i(`ariaSelected`)),B.apply(t._on,i(`on`)),V.apply(t._type??Z.type,i(`type`)),k.apply(t._customClass,i(`customClass`)),P.apply(t._disabled??Z.disabled,i(`disabled`)),M.apply(t._hideLabel??Z.hideLabel,i(`hideLabel`)),I.apply(t._id,i(`id`)),ee.apply(t._inline??Z.inline,i(`inline`)),E.apply(t._role,i(`role`)),R.apply(t._name,i(`name`)),N.apply(t._shortKey,i(`shortKey`)),C.apply(t._icons,i(`icons`)),A.apply(t._tooltipAlign??Z.tooltipAlign,i(`tooltipAlign`)),typeof t._tabIndex==`number`?w.apply(t._tabIndex,i(`tabIndex`)):r.tabIndex=void 0,D.apply(t._variant??e(`buttonVariantDefault`,n)??`normal`,i(`variant`)),r}var te=`@charset "UTF-8";
