import{n as e,s as t}from"./index-DcDxiC7I-DdIndnNs.js";import{t as n}from"./i18n-s5q4We3h-hRt0wBwG.js";function r(n){switch(n){case`cycle`:return t(`span`,{class:`kol-spin__loader kol-spin__spinner--${n}__element`});case`none`:return t(`slot`,{name:`expert`});default:return t(e,null,t(`span`,{class:`kol-spin__spinner-element
