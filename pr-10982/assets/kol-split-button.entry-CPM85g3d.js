import{_ as e,c as t,o as n,s as r}from"./index-DcDxiC7I-BHpRdAHa.js";import{a as i,t as a}from"./behavior-Eatm8kmr-BKKDn5kU.js";import{i as o,r as s,t as c}from"./index-CiMOOVh9.js";import{i as l,n as u}from"./dev.utils-BRNeztdD-Q7T7CVic.js";import{n as d,t as f}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as p}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./variant-quote-CPA_pFWU-Vxj5_jOd.js";import{t as m}from"./disabled-BdkcA-WS-DUBXVAoh.js";import"./label-BDgaSpkn-CdiTlhi-.js";import"./label-CDp6ht3Z-Ca1fFaOI.js";import{t as h}from"./clsx-COFh-Vc8-DWAop4cA.js";import{n as g,r as _,t as v}from"./element-interaction-DkGO5I_0-CYEJb_Yf.js";import"./block-bem-B2WJpaeb-CRk35dFP.js";import"./component-CwO0zW8_-CulZ_T4T.js";import"./component-DNi43x13-DQ2ZNlFI.js";import{t as y}from"./i18n-s5q4We3h-Bj3plSGY.js";import{t as b}from"./component-Bol9zKnv-BLulX1Un.js";import"./component-CxauMHaQ-iWAD-J9p.js";import"./component-nvIRawJq-D7eLVi2M.js";import{t as x}from"./component-DbEQyyOu-R4gTRq4y.js";import"./align-B29XBdiy-B-JWRGu-.js";import{t as S}from"./label-with-expert-slot-LdmDsdfz-D7hfrGEG.js";import{n as C}from"./variant-DKbetdU1-CYG__GN9.js";import{a as w,c as T,d as E,f as D,l as O,o as k,r as A,s as j,t as M,u as N}from"./tooltip-align-Bcuc9zWQ-C1ZT_FPB.js";import{t as P}from"./name-C-7s_t57-CaqP92LH.js";import{a as F,n as I,r as L,t as R}from"./api-0jMCoYap-B8e4o_ei.js";import"./controller-BzYze_SO-DnIK9Mxj.js";import"./aria-details-CaVxOiaf-Cg8cwcSm.js";import"./associated.controller-DFAIT7Or-BXDlCqeA.js";import{t as z}from"./base-RCeclK3Y-BiElsuXm.js";import{n as B,r as V,t as H}from"./controller-DgaV6bVa-BELRAKcJ.js";var U={required:[S],optional:[M,A,R,I,L,F,w,m,k,i,j,S,T,P,V,O,N,E,D,C]},W=t=>{let n=new B,r=new a(f.stateLess),i=v(),o,p=d(U);delete p.tabIndex;let h=e=>{m.apply(e,e=>{p.disabled=e})};h(t.disabled),k.apply(t.hideLabel,e=>{p.hideLabel=e}),N.apply(t.icons,e=>{p.icons=e}),j.apply(!1,e=>{p.inline=e}),D.apply(`top`,e=>{p.tooltipAlign=e}),F.apply(`button`,e=>{p.type=e}),S.apply(t.label,e=>{p.label=e}),V.apply(t.popoverAlign,e=>{p.popoverAlign=e,n.setAlign(e)}),C.apply(e(`buttonVariantDefault`,t.getFlagHost())??`normal`,e=>{p.variant=e}),p.ariaDescriptionId=l(),p.popoverId=u(`popover`);let g=e=>{let n=t.getEventTarget();n&&s(n,e)},_=e=>{t.setOpen(e.newState===`open`)};return p.handleClick=e=>{e.stopPropagation(),r.hideTooltip(),n.setShow(!t.getOpen()),g(c.click)},p.handleMouseDown=()=>g(c.mousedown),p.handleFocus=()=>g(c.focus),p.handleBlur=()=>g(c.blur),p.refButton=e=>{i(e),n.setTriggerElement(e)},p.refPopover=e=>{o=e,n.setPopoverElementRef(e)},p.refTooltip=r.setTooltipElementRef,r.componentWillLoad({label:p.label,align:p.tooltipAlign}),{getFcProps:()=>Object.assign(Object.assign({},p),{popoverOpen:t.getOpen()}),hide:()=>n.setShow(!1),setDisabled:h,syncListeners:()=>{i.el&&r.syncListeners(void 0,i.el,!0),o?.addEventListener(`toggle`,_)},destroy:()=>{r.destroy(),o&&=(o.removeEventListener(`toggle`,_),void 0),n.destroy()}}},G=o.forBlock(`kol-split-button`),K=G(`button`),q=G(`horizontal-line`),J=G(`root`),Y=G(`secondary-button`),X=e=>{let{buttonProps:t,buttonWrapperClass:n,class:i,dropdownProps:a,refDropdown:o}=e;return r(b,{block:`kol-split-button`,class:i},r(`div`,{class:J},r(`div`,{class:h(K,n)},r(x,Object.assign({},t))),r(`div`,{class:q}),r(`div`,{class:Y,ref:o},r(H,Object.assign({},a)))))},Z=`@charset "UTF-8";
