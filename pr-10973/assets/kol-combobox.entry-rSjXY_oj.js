import{Ct as e,Et as t,a as n,c as r,l as i,o as a,s as o,v as s}from"./index-DoSnb8JS.js";import{n as c,t as l}from"./dev.utils-DEzQ6pd0-hR5mqqva.js";import"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as u}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./_Uint8Array-kJnEuTzT-BYXN1zbF.js";import"./factory-DVePsLAQ-PRQ5E7Gw.js";import"./label-BJf95S0B-BQ-7iS-N.js";import"./label-CnOLrr0w-Bp3NoThl.js";import"./variant-quote-7bJL1WOX-YtSruFBF.js";import{t as d}from"./clsx-COFh-Vc8-DWAop4cA.js";import"./Heading-BStLDIxc-D59I-pSJ.js";import{n as f,r as p,t as m}from"./element-interaction-DORv36BQ-BSHBQDXV.js";import"./block-bem-BGMd0WJH-CvHlyD-F.js";import{t as h}from"./component-BG05O9Id-BUNwWwQ3.js";import"./component-DIrul5pb-CjLHFds8.js";import{t as g}from"./i18n-B_vSiQA9-BZaanBjD.js";import"./component-1zt0BWKC-W3A5-qXi.js";import"./variant-class-name-2os1V9lQ-BVMPiH1r.js";import"./component-COEI4VoT-DK6GowQm.js";import"./component-Z2KNQIrE-BlvWLA5s.js";import"./component-3f-og0Gs-BHIVgTGu.js";import"./align-Dm5aJHmk-B3Ja28Sh.js";import"./behavior-Cxx5cP6o-Boh52JKK.js";import"./aria-details-ChvorFzb-CLjWeli_.js";import"./associated.controller-ExNQqx6z-B50vAHRN.js";import"./hide-label-D9p4NSvH-F-Ps1kzj.js";import"./tooltip-align-DKyaSb_h-B7y20ppa.js";import{s as _,t as v}from"./FormFieldStateWrapper-DMFnY8A9-DgaNxO-F.js";import{n as y,t as b}from"./controller-icon-C4qaUbl4-D22xVttI.js";import"./Input-Z2129I7k-CvCZU58b.js";import{t as x}from"./InputStateWrapper-Bu-K9Xj3-DFEm-tQq.js";import{n as S,t as C}from"./CustomSuggestionsOptionsGroup-7ZpRlJkG-DE7UsM1A.js";import{t as w}from"./placeholder-BgFXMdY3-Cchy3c9V.js";import{t as T}from"./required-CVRZFVh4-BSOebM8V.js";import{t as E}from"./suggestions-CYx0k2sO-lOyN1BfG.js";var D=class extends y{constructor(e,t,n){super(e,t,n),this.component=e}validateHasClearButton(t){e(this.component,`_hasClearButton`,t)}validatePlaceholder(e){w(this.component,e)}validateRequired(e){T(this.component,e)}validateSuggestions(e){E(this.component,e)}validateValue(e){t(this.component,`_value`,e)}componentWillLoad(){super.componentWillLoad(),this.validateHasClearButton(this.component._hasClearButton),this.validatePlaceholder(this.component._placeholder),this.validateRequired(this.component._required),this.validateSuggestions(this.component._suggestions),this.validateValue(this.component._value)}},O=`@charset "UTF-8";
/*
...
}`,k=class{async getValue(){return this.state._value}async focus(e){}async click(){}selectOption(e){var t;this.controller.onFacade.onInput(i(r.input,{name:this.state._name,value:e},this.ctaRef.el),!0,e),this.controller.onFacade.onChange(i(r.change,{name:this.state._name,value:e},this.ctaRef.el),e),this.controller.setFormAssociatedValue(e),this._filteredSuggestions=[...this.state._suggestions],this.state._value=e,(t=this.ctaRef.el)==null||t.focus()}clearSelection(){var e;if(this.state._disabled===!0)return;this._focusedOptionIndex=-1,this._value=``,this.state._value=``,this._filteredSuggestions=[...this.state._suggestions],this._isOpen=!1;let t={name:this.state._name,value:``};this.controller.onFacade.onInput(i(r.input,t,this.ctaRef.el),!0,``),this.controller.onFacade.onChange(i(r.change,t,this.ctaRef.el),``),this.controller.setFormAssociatedValue(``),(e=this.ctaRef.el)==null||e.focus()}onInput(e){let t=e.target.value;this.state._value=t,this._value=t,this.controller.onFacade.onInput(e,!0,t),this.setFilteredSuggestionsByQuery(t),this._focusedOptionIndex=-1,e.stopImmediatePropagation()}handleKeyDownDropdown(e){e.key.length===1&&/[a-z0-9]/i.test(e.key)&&(this._isOpen=!0,this.focusSuggestionStartingWith(e.key))}setFilteredSuggestionsByQuery(e){e!==void 0&&(e.trim()===``?this._filteredSuggestions=[...this.state._suggestions]:(this._filteredSuggestions=Array.isArray(this.state._suggestions)?this.state._suggestions.filter(t=>t.toLowerCase().includes(e.trim().toLowerCase())):this._filteredSuggestions,this._isOpen=this._filteredSuggestions?.length===1&&this._filteredSuggestions[0]===e?!1:!!(this._filteredSuggestions&&this._filteredSuggestions.length>0)))}moveFocus(e){if(!this._filteredSuggestions)return;let t=this._focusedOptionIndex+e;t>=this._filteredSuggestions.length&&(t=0),t<0&&(t=this._filteredSuggestions.length-1),this.focusOption(t)}focusOption(e){this._focusedOptionIndex=e,this.refSuggestions&&this.refSuggestions[e]?.focus()}selectFocusedOption(){return this._filteredSuggestions&&this._focusedOptionIndex>=0&&this._focusedOptionIndex<this._filteredSuggestions.length?(this.selectOption(this._filteredSuggestions[this._focusedOptionIndex]),!0):!1}focusSuggestionStartingWith(e){let t=e.toLowerCase(),n=Array.isArray(this._filteredSuggestions)&&this._filteredSuggestions.length>0&&this._filteredSuggestions.findIndex(e=>e.toLowerCase().startsWith(t));typeof n==`number`&&this.focusOption(n)}getFormFieldProps(){return{state:this.state,class:d(`kol-combobox`,{"has-value":this.state._hasValue,"kol-combobox--open":this._isOpen}),tooltipAlign:this._tooltipAlign,alert:this.showAsAlert(),infoPopover:this._infoPopover}}getInputProps(){let{ariaDescribedBy:e}=_(this.state),t=this.state._disabled===!0;return Object.assign(Object.assign({ref:this.ctaRef,state:this.state,class:`kol-combobox__input`,type:`text`,role:`combobox`,"aria-activedescendant":this._isOpen&&this._focusedOptionIndex>=0?`option-${this._focusedOptionIndex}`:void 0,"aria-autocomplete":`both`,"aria-controls":l(this.state._id,`listbox`),"aria-describedby":e.length>0?e.join(` `):void 0,"aria-expanded":this._isOpen?`true`:`false`,"aria-label":this.state._hideLabel&&typeof this.state._label==`string`?this.state._label:void 0,"aria-labelledby":l(this.state._id,`label`),"aria-keyshortcuts":this.state._shortKey,value:this.state._value,accessKey:this.state._accessKey,autocapitalize:`off`,autocorrect:`off`,autocomplete:`off`,disabled:t,customSuggestions:!0,id:this.state._id,name:this.state._name,required:this.state._required},this.controller.onFacade),{onChange:this.onChange.bind(this),onInput:this.onInput.bind(this),placeholder:this.state._placeholder})}render(){let e=this.state._disabled===!0;return a(v,Object.assign({key:`c4dd1454227c195d2f18dd87407b19c15ee19615`},this.getFormFieldProps()),a(b,{key:`71cd01a4a1611eac1e0bf5db286572b7af1dd2ea`,state:this.state},a(`div`,{key:`62b8f355d2acdfb41b98c26bea1bb9f3b7cb741f`,class:`kol-combobox__group`},a(x,Object.assign({key:`3e6aa6859b4419f1fa16663194f4705c31753590`},this.getInputProps())),this.state._value&&this.state._hasClearButton&&a(s,{key:`b200af434e0b8e26774d7d9595d7b31811aa1377`,_icons:`kolicon-cross`,_label:this.translateDeleteSelection,_hideLabel:!0,_variant:`ghost`,_disabled:e,"data-testid":`combobox-delete`,class:`kol-combobox__delete`,hidden:e,_on:{onClick:()=>{this.clearSelection()},onFocus:()=>{this.clearButtonFocused=!0},onBlur:()=>{this.clearButtonFocused=!1}}}),a(`button`,{key:`ae8674d8a7249fc9c9b30670f7fed854e0184b8f`,type:`button`,tabIndex:-1,class:`kol-combobox-toggle`,onClick:this.toggleListbox.bind(this),disabled:e,hidden:e},a(h,{key:`1e744a721f4894c29ba737f0db19ddb24b8b2fce`,icons:`kolicon-chevron-down`,label:``}))),a(S,{key:`4b882eec46d12834d840b55532090d2ea0c99bee`,blockSuggestionMouseOver:this.blockSuggestionMouseOver,onKeyDown:this.handleKeyDownDropdown.bind(this),hidden:!this._isOpen||e,id:l(this.state._id,`listbox`)},Array.isArray(this._filteredSuggestions)&&this._filteredSuggestions.length>0&&this._filteredSuggestions.map((e,t)=>a(C,{disabled:!1,index:t,option:e,searchTerm:this.state._value,ref:e=>{e&&(this.refSuggestions[t]=e)},selected:this.state._value===e,onClick:()=>{this.selectOption(e),this.toggleListbox(),this._isOpen=!1},onMouseOver:()=>{this.blockSuggestionMouseOver||this.focusOption(t)},onFocus:()=>{this.focusOption(t)}})))))}handleKeyDown(e){var t,n;let r=(t,n)=>{var r;e.preventDefault(),t!==void 0&&(this._isOpen=t,t||(r=this.ctaRef.el)==null||r.focus()),n?.()};switch(e.key){case`Down`:case`ArrowDown`:this.blockSuggestionMouseOver=!0,r(!0,()=>this.moveFocus(1));break;case`Up`:case`ArrowUp`:this.blockSuggestionMouseOver=!0,r(!0,()=>this.moveFocus(-1));break;case`Tab`:this._isOpen&&(this._isOpen=!1,(t=this.ctaRef.el)==null||t.focus());break;case`Esc`:case`Escape`:this._isOpen&&(e.preventDefault(),this._isOpen=!1,(n=this.ctaRef.el)==null||n.focus());break;case`Enter`:case`NumpadEnter`:this.clearButtonFocused?this.clearSelection():this._isOpen?this.selectFocusedOption()&&(this._isOpen=!1):this.toggleListbox(),e.preventDefault();break;case` `:this.clearButtonFocused?(this.clearSelection(),e.preventDefault()):this._isOpen&&this.selectFocusedOption()&&(this._isOpen=!1,e.preventDefault());break;case`Home`:this.blockSuggestionMouseOver=!0,r(void 0,()=>{this._isOpen&&this.focusOption(0)});break;case`End`:this.blockSuggestionMouseOver=!0,r(void 0,()=>{this._isOpen&&this.focusOption(this._filteredSuggestions?this._filteredSuggestions.length-1:0)});break;case`PageUp`:this.blockSuggestionMouseOver=!0,r(void 0,()=>this._isOpen&&this.moveFocus(-10));break;case`PageDown`:this.blockSuggestionMouseOver=!0,r(void 0,()=>this._isOpen&&this.moveFocus(10))}}handleWindowClick(e){this.host!==void 0&&!this.host.contains(e.target)&&(this._isOpen=!1)}validateAriaDetails(e){this.controller.validateAriaDetails(e)}constructor(e){o(this,e),this.ctaRef=m(),this.refSuggestions=[],this._focusedOptionIndex=-1,this.translateDeleteSelection=g(`kol-delete-selection`),this.clearButtonFocused=!1,this.toggleListbox=()=>{var e;if(this.state._disabled===!0)this._isOpen=!1;else if((e=this.ctaRef.el)==null||e.focus(),this._isOpen)this._isOpen=!1;else if(Array.isArray(this._filteredSuggestions)&&this._filteredSuggestions.length>0){this._isOpen=!0;let e=this._filteredSuggestions.findIndex(e=>e===this.state._value);this._focusedOptionIndex=e>=0?e:-1,this.focusOption(this._focusedOptionIndex)}},this.blockSuggestionMouseOver=!1,this._isOpen=!1,this._disabled=!1,this._hideMsg=!1,this._hideLabel=!1,this._hint=``,this._hasClearButton=!0,this._required=!1,this._tooltipAlign=`top`,this._touched=!1,this.state={_hasValue:!1,_hasClearButton:!0,_hideMsg:!1,_id:c(`combobox`),_label:``,_suggestions:[],_value:``},this.inputHasFocus=!1,this.controller=new D(this,`combobox`,this.host),this.onInput=this.onInput.bind(this)}showAsAlert(){return!!this.state._touched&&!this.inputHasFocus}validatePlaceholder(e){this.controller.validatePlaceholder(e)}validateAccessKey(e){this.controller.validateAccessKey(e)}validateDisabled(e){this.controller.validateDisabled(e)}validateHideMsg(e){this.controller.validateHideMsg(e)}validateHideLabel(e){this.controller.validateHideLabel(e)}validateHint(e){this.controller.validateHint(e)}validateIcons(e){this.controller.validateIcons(e)}validateLabel(e){this.controller.validateLabel(e)}validateMsg(e){this.controller.validateMsg(e)}validateName(e){this.controller.validateName(e)}validateOn(e){this.controller.validateOn(e)}validateShortKey(e){this.controller.validateShortKey(e)}validateSuggestions(e){this.controller.validateSuggestions(e),this._filteredSuggestions=e,this.setFilteredSuggestionsByQuery(this._value)}validateHasClearButton(e){this.controller.validateHasClearButton(e)}validateRequired(e){this.controller.validateRequired(e)}validateSyncValueBySelector(e){this.controller.validateSyncValueBySelector(e)}validateTouched(e){this.controller.validateTouched(e)}validateValue(e){this.controller.validateValue(e),this.controller.setFormAssociatedValue(e)}validateVariant(e){this.controller.validateVariant(e)}componentWillLoad(){this.validateAriaDetails(this._ariaDetails),this.refSuggestions=[],this._touched=this._touched===!0,this.controller.componentWillLoad(),this.state._hasValue=!!this.state._value,this.controller.addValueChangeListener(e=>this.state._hasValue=!!e),this._filteredSuggestions=this.state._suggestions}handleMouseEvent(){this.blockSuggestionMouseOver=!1}handleFocusIn(e){this.host?.contains(document.activeElement)&&!this.inputHasFocus&&(this.controller.onFacade.onFocus(e),this.inputHasFocus=!0)}handleFocusOut(e){let t=e.relatedTarget,n=t&&(t===this.host||this.host?.contains(t));this.inputHasFocus&&!n&&(this.controller.onFacade.onBlur(e),this.inputHasFocus=!1,this._isOpen&&=!1)}onChange(e){e.stopPropagation();let t=this.state._value;this.controller.onFacade.onChange(e,t),this.controller.setFormAssociatedValue(t)}get host(){return n(this)}static get watchers(){return{_ariaDetails:[`validateAriaDetails`],_placeholder:[`validatePlaceholder`],_accessKey:[`validateAccessKey`],_disabled:[`validateDisabled`],_hideMsg:[`validateHideMsg`],_hideLabel:[`validateHideLabel`],_hint:[`validateHint`],_icons:[`validateIcons`],_label:[`validateLabel`],_msg:[`validateMsg`],_name:[`validateName`],_on:[`validateOn`],_shortKey:[`validateShortKey`],_suggestions:[`validateSuggestions`],_hasClearButton:[`validateHasClearButton`],_required:[`validateRequired`],_syncValueBySelector:[`validateSyncValueBySelector`],_touched:[`validateTouched`],_value:[`validateValue`],_variant:[`validateVariant`]}}};u([p(`ctaRef`)],k.prototype,`focus`,null),u([f(`ctaRef`)],k.prototype,`click`,null),k.style={default:O};export{k as kol_combobox};