import{B as e,F as t,St as n,U as r,_t as i,a,c as o,d as s,n as c,o as l,r as u,s as d,u as f}from"./index-CicnAzwE.js";import{i as p}from"./dev.utils-3xMYti16-DnVJ15RJ.js";import{n as m,t as h}from"./base-web-component--IgFgz37-CZuvR3uB.js";import"./label-DxrksC9L-BZ0SlGZ2.js";import{t as g}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{i as ee,n as _}from"./normalizers-DEevvNbZ-DrwYVtF5.js";import"./i18n-DuzgYBgD-BRI4suYb.js";import{t as v}from"./component-BypIj6e1-Bamhv-S_.js";import"./label-De6GKT_4-o1VgDupx.js";import"./variant-quote-JfuelQ4I-BT8fl1Sn.js";import{t as y}from"./label-with-expert-slot-pcKVBAqt-CPcQxBd4.js";import"./align-DglmQnOH-umAvanC0.js";import{a as b,c as x,f as S,h as C,i as w,l as T,m as E,p as D,r as O,u as k}from"./component-CY6SGsbj-DPLRzsYR.js";import"./variant-class-name-BFZvmFM_-Dr29Oc5k.js";import"./component-DE2a2fD4-wG4fMYOG.js";import"./component-BL6pcz5a-mKVcv1Hk.js";import"./align-floating-elements-D6Kc-f8P-7sKi6ms3.js";import{t as A}from"./behavior-opTsLlOg-CnyeDFpR.js";import{t as j}from"./href-Dhe7Bhko-C9zTziyk.js";import{a as M,i as N,n as P,o as F,s as I,t as te}from"./api-ChuPrzBQ-hxEA8nUb.js";import{t as L}from"./access-and-short-key-ijzCZfHm-Dx5Q-CAn.js";import{n as R,t as z}from"./unique-nav-labels-DdDotOG6-CPCcnT_G.js";var B=_(`links`,[],e=>ee(e),e=>e.every(e=>typeof e==`object`&&(typeof e._href==`string`||typeof e._label==`string`)),{hints:(e,t)=>n(`KolBreadcrumb`,t.length)}),V={required:[B,y]},H=s.forBlock(`kol-breadcrumb`),U=H(),W=H(`icon`),G=H(`link`),K=H(`list`),q=H(`list-element`),J=H(`list-element-span`),Y=H(`separator`),X=`kol-breadcrumb_icon`,Z=(e,t,n,r)=>{let i=r?t!==n:t<n-1;if(t===n&&!r)return l(c,null);let{link:a}=e;return l(`li`,{class:q,key:t},t===n?l(`span`,{class:J,"aria-current":`page`},a._hideLabel?l(v,{class:W,icons:typeof a._icons==`string`?a._icons:`kolicon-link`,label:a._label}):l(c,null,a._label)):l(`div`,{class:G},l(te,Object.assign({},e.fcProps))),i&&l(v,{class:Y,icons:`kolicon-chevron-right`,label:``}))},Q=({label:e,linkItems:t,showCurrentPage:n})=>{let r=t.length-1;return l(`nav`,{class:U,"aria-label":e},l(`ul`,{class:K},t.length===0&&l(`li`,null,l(v,{class:X,icons:`kolicon-house`,label:``}),`…`),t.map((e,t)=>Z(e,t,r,n))))},ne=(e,t)=>{let n=new A(h.stateLess),r=g(),a=m(F);delete a.tabIndex;let s=(e,t)=>e.apply(t,t=>{a[e.propName]=t});s(O,e._accessKey),s(w,e._ariaControls),s(P,e._ariaCurrentValue),s(b,e._ariaDescription),s(x,e._disabled),s(N,e._download),s(T,e._hideLabel),s(j,e._href),s(D,e._icons),s(k,e._inline??!1),s(y,e._label),s(M,e._on),s(S,e._shortKey),typeof e._tabIndex==`number`&&s(E,e._tabIndex),s(I,e._target),s(C,e._tooltipAlign),L(e._accessKey,e._shortKey),n.componentWillLoad({label:(()=>{let e=a.label;if(typeof e==`string`&&e.length>0)return e;let t=a.href;return typeof t==`string`?t:``})(),align:a.tooltipAlign}),a.ariaCurrent=``,a.ariaDescriptionId=p(),a.expertSlot=e._label===``;let c=()=>typeof a.href==`string`?a.href:``;return a.handleAnchorClick=e=>{if(n.hideTooltip(),a.disabled===!0){e.preventDefault();return}let s=c(),l=a.on;typeof l?.onClick==`function`&&(i(e,r.el),l.onClick(e,s));let u=t();u&&f(u,o.click,s)},a.refAnchor=e=>{r(e)},a.refTooltip=n.setTooltipElementRef,{link:e,fcProps:a,syncTooltipListeners:()=>{r.el&&n.syncListeners(void 0,r.el,!0)},destroy:()=>{n.destroy()}}},re=`@charset "UTF-8";
/*
