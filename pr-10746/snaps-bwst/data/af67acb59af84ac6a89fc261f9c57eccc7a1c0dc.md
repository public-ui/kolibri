...
Locator: locator('[data-visual-block="label-error"]')
  Expected an image 468px by 117px, received 468px by 116px. 182 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: textarea-basic-noColumns--label-error.png

Call log:
  - Expect "toHaveScreenshot(textarea-basic-noColumns--label-error.png)" with timeout 10000ms
    ...
    - generic [ref=e10]:
      - generic [ref=e11]:
        ...
        - generic [ref=e14]:
          ...
          - generic [ref=e86]:
            - generic [ref=e90] [cursor=pointer]: Text
            - textbox "Text" [ref=e94]:
              - /placeholder: Placeholder
            - alert [ref=e95]:
              - generic [ref=e96]: Success
              - generic [ref=e97]: 
              - generic [ref=e98]: Success message
          - generic [ref=e102]:
            - generic [ref=e106] [cursor=pointer]: Text
            - textbox "Text" [ref=e110]:
              - /placeholder: Placeholder
            - alert [ref=e111]:
          ...
          - generic [ref=e118]:
            - generic [ref=e121] [cursor=pointer]:
              - generic [ref=e122]: Text (3 rows)
              - generic [ref=e123]: T
            - textbox "Text (3 rows)" [ref=e127]
          - generic [ref=e131]:
            - generic [ref=e135] [cursor=pointer]: Text (placeholder)
            - textbox "Text (placeholder)" [ref=e139]:
              - /placeholder: Placeholder
          - generic [ref=e143]:
            - generic [ref=e147]: Text (disabled & placeholder)
            - textbox "Text (disabled & placeholder)" [disabled] [ref=e151]:
              - /placeholder: Placeholder
          - generic [ref=e155]:
            - generic [ref=e156] [cursor=pointer]:
              - generic [ref=e159]: Text (readonly)
              - generic [ref=e160]: (read-only)
            - textbox "Text (readonly)" [ref=e164]:
              - /placeholder: Placeholder
          - generic [ref=e168]:
            - generic [ref=e172]: Text (disabled & value)
            - textbox "Text (disabled & value)" [disabled] [ref=e176]:
              - /placeholder: Placeholder
              - text: Lorem ipsum
          - generic [ref=e180]:
          ...
          - generic [ref=e193]:
            - generic [ref=e196] [cursor=pointer]:
              - generic [ref=e197]: With short key
              - generic [ref=e198]: s
            - textbox "With short key" [ref=e202]:
              - /placeholder: Placeholder
              - text: Lorem ipsum
      - generic [ref=e203]:
        - heading "Text (hideLabel)" [level=2] [ref=e205]: Text (hideLabel)
        - generic [ref=e206]:
          ...
          - generic [ref=e231]:
            ...
            - alert [ref=e236]:
              ...
              - generic [ref=e238]: 
              - generic [ref=e239]: Just a hint
          - generic [ref=e243]:
            - textbox "Text" [ref=e247]:
              - /placeholder: Placeholder
            - alert [ref=e248]:
              - generic [ref=e249]: Warning
              - generic [ref=e250]: 
              - generic [ref=e251]: Small warning
          - generic [ref=e255]:
            ...
            - alert [ref=e260]:
              ...
              - generic [ref=e262]: 
              - generic [ref=e263]: Success message
          - generic [ref=e267]:
            - textbox "Text" [ref=e271]:
              - /placeholder: Placeholder
            - alert [ref=e272]:
              - generic [ref=e273]: Message
              - generic [ref=e274]: 
              - generic [ref=e275]: Default message
          - textbox "Text (3 rows)" [ref=e283]
          - textbox "Text (placeholder)" [ref=e291]:
            - /placeholder: Placeholder
          - textbox "Text (disabled & placeholder)" [disabled] [ref=e299]:
            - /placeholder: Placeholder
          - textbox "Text (readonly)" [ref=e307]:
            - /placeholder: Placeholder
          - textbox "Text (disabled & value)" [disabled] [ref=e315]:
            - /placeholder: Placeholder
            - text: Lorem ipsum
          - textbox "With access key" [ref=e323]:
            - /placeholder: Placeholder
            - text: Lorem ipsum
          - textbox "With short key" [ref=e331]:
            - /placeholder: Placeholder
            - text: Lorem ipsum
```
