...
Locator: locator('[data-visual-block="left-info-popover"]')
  ...
  Snapshot: input-checkbox-switch-noColumns--left-info-popover.png

Call log:
  - Expect "toHaveScreenshot(input-checkbox-switch-noColumns--left-info-popover.png)" with timeout 10000ms
