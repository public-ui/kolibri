...
Locator: locator('[data-visual-block="basic"]')
  647 pixels (ratio 0.06 of all image pixels) are different.

  Snapshot: split-button-basic--basic.png

Call log:
  - Expect "toHaveScreenshot(split-button-basic--basic.png)" with timeout 10000ms
    - verifying given screenshot expectation
  - waiting for locator('[data-visual-block="basic"]')
    - locator resolved to <div data-visual-block="basic" class="flex flex-col gap-4">…</div>
...
- main [ref=e4]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e17]:
      - button "Show options" [ref=e20] [cursor=pointer]:
        - generic [ref=e23]: 
      - text:   
```
