...
Locator: locator('[data-visual-block="regular"]')
  Expected an image 492px by 95px, received 484px by 95px. 1262 pixels (ratio 0.03 of all image pixels) are different.

  Snapshot: tabs-basic--regular.png

Call log:
  - Expect "toHaveScreenshot(tabs-basic--regular.png)" with timeout 10000ms
    - verifying given screenshot expectation
  - waiting for locator('[data-visual-block="regular"]')
    - locator resolved to <div class="grid gap-4" data-visual-block="regular">…</div>
...
- main [ref=e4]:
  ...
  - generic [ref=e9]:
    - tablist "Regular tabs" [ref=e10]:
      - tab "First tab" [selected] [ref=e13] [cursor=pointer]:
        - generic [ref=e16]: First tab
      - tab "Second Tab" [ref=e19] [cursor=pointer]:
        - generic [ref=e22]: Second Tab
      - tab "Disabled Tab" [disabled] [ref=e25]:
        - generic [ref=e28]: Disabled Tab
      - tab "Last tab" [ref=e31] [cursor=pointer]:
        - generic [ref=e34]: Last tab
    - tabpanel "First tab" [ref=e36]:
      - generic [ref=e37]: Contents of Tab 1
  - generic [ref=e41]:
    - tablist "Tabs with icons" [ref=e42]:
      - tab "First tab" [selected] [ref=e45] [cursor=pointer]:
        - generic [ref=e47]:
          - generic [ref=e48]: 
          - generic [ref=e49]: First tab
      - tab "Second Tab" [ref=e52] [cursor=pointer]:
        - generic [ref=e54]:
          - generic [ref=e55]: 
          - generic [ref=e56]: Second Tab
      - tab "Disabled Tab" [disabled] [ref=e59]:
        - generic [ref=e61]:
          - generic [ref=e62]: 
          - generic [ref=e63]: Disabled Tab
      - tab "Last tab" [ref=e66] [cursor=pointer]:
        - generic [ref=e68]:
          - generic [ref=e69]: 
          - generic [ref=e70]: Last tab
    - tabpanel "First tab" [ref=e72]:
      - generic [ref=e73]: Contents of Tab 1
```
