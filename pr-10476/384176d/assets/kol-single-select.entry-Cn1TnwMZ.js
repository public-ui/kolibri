import{At as e,Mt as t,Ot as n,a as r,b as i,o as a,s as o}from"./index-1Rni1avn.js";import{n as s}from"./dev.utils-CSaG5eC8-ChzzIl9K.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import"./_Uint8Array-kJHDjtoP-CTkgs_0o.js";import"./normalizers-iLdS6AQE-BP2L8vsP.js";import"./label-BwPy2Jd4-DV58eDG2.js";import"./base-web-component-BCIMb9gN-B8hh9TBJ.js";import"./base-controller-CXhqh4cR-BNzx0WwK.js";import{t as c}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{t as l}from"./clsx-COFh-Vc8-alQuJLqj.js";import{t as u}from"./component-DciMaDgX-ClWJkpG1.js";import"./component-CcBTaeMx-BBwrDqmR.js";import"./component-DSKs197E-CkpzKX0t.js";import"./align-floating-elements-Xqbu3THH-BUezONq4.js";import"./align-BdqBkiyq-BfeVeEOy.js";import"./controller-BUTW5QfH-D7Q1jaXc.js";import"./Heading-CVeAKean-BMyxCuWe.js";import"./disabled-DfW4ft-F-CYppl19x.js";import"./label-We78Dt9U-BNqz5_RL.js";import"./element-focus-BQXzaLL9-oq1SsV6e.js";import{r as d,t as f}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import{t as p}from"./i18n-CcjZRTxD-BMTPRKQn.js";import"./Alert-D6aJeH8Q-DQTpzswz.js";import"./icons-BGkS8g2K-CcG1ST4R.js";import"./access-and-short-key-DzjVTrop-fyB4VAe5.js";import"./hide-label-BDwvU6I8-DNRyWJYS.js";import"./tooltip-align-LkJ2mgrc-V_r1yNYf.js";import"./variant-class-name-D8tvX7Qv-CUAMe52Z.js";import"./aria-labelledby-6-ki3akM-C6lJ0lQF.js";import"./aria-details-Ddidnfeo-DLATXQdS.js";import"./associated.controller-yo_yku-m-B9Vr6ne0.js";import{s as m,t as h}from"./FormFieldStateWrapper-CS7WYVKE-DzS4kldK.js";import{n as g,t as _}from"./controller-icon-DyKRABQk-M5oytpc_.js";import"./Input-w9bmd111-BBLRV0Vk.js";import{t as v}from"./InputStateWrapper-B2BEMdqQ-igOqqy5I.js";import{n as y,t as b}from"./CustomSuggestionsOptionsGroup-DX5c5ai5-DdAAK9t0.js";import{t as x}from"./placeholder-fpeae7fK-AvZ75ahB.js";import{t as S}from"./required-BYwM0tPO-BEHJOdsv.js";import"./orientation-DPjc47G2-BTapkg5Y.js";import{i as C,r as w}from"./controller-DpxIqBIY-DbJI2N6X.js";var T=class extends g{constructor(e,t,n){super(e,t,n),this.keyOptionMap=new Map,this.afterPatchOptions=(e,t,n,r)=>{r===`_value`&&this.setFormAssociatedValue(e)},this.beforePatchOptions=(e,t)=>{let n=t.has(`_options`)?t.get(`_options`):this.component.state._options;Array.isArray(n)&&n.length>0&&(this.keyOptionMap.clear(),w(this.keyOptionMap,n))},this.component=e}validateOptions(e){C(this.component,e,{hooks:{afterPatch:this.afterPatchOptions,beforePatch:this.beforePatchOptions}})}validateRequired(e){S(this.component,e)}validateValue(e){t(this.component,`_value`,e=>e!==void 0,new Set([`StencilUnknown`]),e)}validatePlaceholder(e){x(this.component,e)}validateHasClearButton(e){n(this.component,`_hasClearButton`,e)}validateRows(t){e(this.component,`_rows`,t)}componentWillLoad(){super.componentWillLoad(),this.validateOptions(this.component._options),this.validateRequired(this.component._required),this.validateValue(this.component._value),this.validatePlaceholder(this.component._placeholder),this.validateHasClearButton(this.component._hasClearButton),this.validateRows(this.component._rows)}},E=`@charset "UTF-8";
/*
