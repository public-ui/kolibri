import{J as e,a as t,d as n,ft as r,o as i,r as a,s as o,ut as s,v as c}from"./index-DOWfQjdk.js";import{n as l}from"./dev.utils-BmTQEa3D-DbgB9Qsa.js";import{t as u}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as d}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{r as f,t as p}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{n as m}from"./normalizers-DIgs35at-CY6Wdhu_.js";import"./component-D54mEGnI-BWy8Gy5z.js";import"./index-MqtDd4Ig-C2I0w63d.js";import{t as h}from"./color-FKmXzDHF-BSsct3YF.js";import"./variant-quote-B6eZsHRm-ybfpdskG.js";import{t as g}from"./label-with-expert-slot-DLVlF4oq-DTOyLRM6.js";import{t as _}from"./span-icons-C0_vzbmJ-BftYrok3.js";import{t as v}from"./component-BVqKsFfP-D8RZF2uB.js";function y(e){let t=typeof e==`string`?r(e):e;if(typeof t==`object`&&t)return t;throw Error(`Invalid smart button: ${typeof e}`)}var b=m(`smartButton`,{_label:``},y),x={required:[g],optional:[h,b,_]},S=n.forBlock(`kol-badge`),C=S(`label`),w=S(`smart-button`);function T(e,t,n){return i(c,{ref:n,class:w,_ariaControls:t,_ariaDescription:e._ariaDescription,_variant:e._variant,_customClass:e._customClass,_disabled:e._disabled,_hideLabel:!0,_icons:e._icons,_id:e._id,_label:e._label,_on:e._on,_tooltipAlign:e._tooltipAlign})}var E=e=>{let{color:t,icons:n,label:r,labelId:a,refSmartButton:o,smartButton:s}=e,c=typeof s==`object`&&!!s;return i(`span`,{class:S({"has-smart-button":c}),style:{backgroundColor:t.backgroundColor,color:t.foregroundColor}},i(v,{class:C,id:c?a:void 0,allowMarkdown:!0,icons:n,label:r}),c&&T(s,a,o))},D=`@charset "UTF-8";
...
}`;e(`[KolBadge] Optimierung des _color-Properties (rgba, rgb, hex usw.).`);var O=class extends u{constructor(e){super(),o(this,e),this.ctaRef=p(),this.labelId=l(`badge-label`),this._color=`#000`}componentWillLoad(){this.initRenderProps(x),this.unsetRenderProp(`smartButton`),this.watchColor(this._color),this.watchIcons(this._icons),this.watchLabel(this._label),this.watchSmartButton(this._smartButton)}applySmartButton(e){s(e,()=>{this.unsetRenderProp(`smartButton`),e!=null&&b.apply(e,e=>this.setRenderProp(`smartButton`,e))})}async focus(e){}render(){return i(a,{key:`5820ef366f8039a459f6f12e027a36826923ade3`},i(E,{key:`237e77800a887cd94ca15bc93830329b4362ecdb`,color:this.getRenderProp(`color`),icons:this.getRenderProp(`icons`),label:this.getRenderProp(`label`),labelId:this.labelId,refSmartButton:this.ctaRef,smartButton:this.getRenderProp(`smartButton`)}))}watchColor(e){h.apply(e,e=>this.setRenderProp(`color`,e))}watchIcons(e){_.apply(e,e=>this.setRenderProp(`icons`,e))}watchLabel(e){g.apply(e,e=>this.setRenderProp(`label`,e))}watchSmartButton(e){this.applySmartButton(e)}get host(){return t(this)}static get watchers(){return{_color:[`watchColor`],_icons:[`watchIcons`],_label:[`watchLabel`],_smartButton:[`watchSmartButton`]}}};d([f(`ctaRef`)],O.prototype,`focus`,null),O.style={default:D};export{O as kol_badge};