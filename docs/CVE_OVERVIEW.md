...
| -------------------- | -------- | ------------------- | ----------------- | --------------------------------------------------------------------------------- |
| seroval              | critical | CVE-2026-59940      | v2, v1            | seroval: `seroval.fromJSON()` Promise resolver type confusion invokes attacker-c  |
| shell-quote          | critical | CVE-2026-9277       | v4                | shell-quote quote() does not escape newlines in object .op values                 |
| websocket-driver     | critical | CVE-2026-54466      | v1                | websocket-driver: Message corruption via abuse of protocol length headers         |
| axios                | high     | GHSA-gcfj-64vw-6mp9 | v1                | Axios Node HTTP adapter can use an inherited proxy after interceptor config clon  |
| brace-expansion      | high     | CVE-2026-13149      | v4, v1            | brace-expansion: DoS via exponential-time expansion of consecutive non-expanding  |
...
| fast-uri             | high     | CVE-2026-16221      | v4, v3, v1        | fast-uri vulnerable to host confusion via literal backslash authority delimiter   |
| fast-uri             | high     | CVE-2026-13676      | v4, v3, v1        | fast-uri vulnerable to host confusion via failed IDN canonicalization             |
| find-my-way          | high     | CVE-2026-47219      | v4, v3            | find-my-way: DDoS with HTTP2                                                      |
| form-data            | high     | CVE-2026-12143      | v4                | form-data: CRLF injection in form-data via unescaped multipart field names and f  |
| immutable            | high     | CVE-2026-59879      | v4, v3, v2, v1    | Immutable.js `List` 32-bit trie overflow → unrecoverable DoS                      |
| immutable            | high     | CVE-2026-59880      | v4, v3, v2, v1    | Immutabl: Hash-collision algorithmic complexity denial of service in Immutable.M  |
| js-yaml              | high     | CVE-2026-59869      | v4, v1            | js-yaml: YAML merge-key chains can force quadratic CPU consumption                |
| linkify-it           | high     | CVE-2026-59887      | v4, v3, v2, v1    | linkify-it: Quadratic-complexity DoS via the `mailto:` validator scan-loop on at  |
...
| postcss              | high     | GHSA-r28c-9q8g-f849 | v4, v3, v2, v1    | PostCSS: Path Traversal in Previous Source Map Auto-Loading (sourceMappingURL) l  |
| protobufjs           | high     | CVE-2026-48712      | v4                | protobufjs: Denial of service through unbounded Any expansion during JSON conver  |
| react-router         | high     | GHSA-qwww-vcr4-c8h2 | v4, v3, v2        | React Router: RSC Mode CSRF Bypass Allows Action Execution Before 400 Response    |
| react-router         | high     | CVE-2026-55685      | v4                | React Router: Unauthenticated Denial of Service via Inefficient Route Matching    |
...
| shell-quote          | high     | CVE-2026-13311      | v4, v2, v1        | shell-quote: Quadratic-complexity Denial of Service in `parse()` (CWE-407)        |
| ws                   | high     | CVE-2026-48779      | v4                | ws: Memory exhaustion DoS from tiny fragments and data chunks                     |
| @hono/node-server    | moderate | GHSA-frvp-7c67-39w9 | v4, v3            | Node.js Adapter for Hono: Path traversal in `serve-static` on Windows via encode  |
| axios                | moderate | GHSA-42h9-826w-cgv3 | v1                | Axios: Excessive recursion in formDataToJSON can cause denial of service          |
| axios                | moderate | GHSA-xj6q-8x83-jv6g | v1                | Axios: Prototype pollution auth subfields can inject Basic auth                   |
| axios                | moderate | GHSA-pmv8-rq9r-6j72 | v1                | Axios: Deep formToJSON Key Recursion Can Cause Denial of Service                  |
| axios                | moderate | GHSA-jqh4-m9w3-8hp9 | v1                | Axios: Fetch adapter `ReadableStream` uploads bypass `maxBodyLength`              |
| axios                | moderate | GHSA-mmx7-hfxf-jppx | v1                | Axios: Prototype pollution gadgets can alter axios request construction           |
| axios                | moderate | GHSA-f4gw-2p7v-4548 | v1                | Axios: NO_PROXY bypass for 0.0.0.0 local addresses in axios                       |
| axios                | moderate | GHSA-hcpx-6fm6-wx23 | v1                | Axios form serializer maxDepth bypass via {} metatoken                            |
| axios                | moderate | GHSA-7q8q-rj6j-mhjq | v1                | Axios: Nested axios option objects can consume polluted prototype values          |
| axios                | moderate | GHSA-mwf2-3pr3-8698 | v1                | Axios: HTTP/2 streamed uploads bypass `maxBodyLength`                             |
| brace-expansion      | moderate | CVE-2026-45149      | v1                | brace-expansion: Large numeric range defeats documented `max` DoS protection      |
| hono                 | moderate | CVE-2026-59897      | v4, v3            | Hono: API Gateway v1 adapter can drop a distinct repeated request header value d  |
| hono                 | moderate | CVE-2026-59896      | v4, v3            | hono/jsx does not isolate context per request, leading to cross-request data dis  |
| hono                 | moderate | CVE-2026-59895      | v4, v3            | Hono: Server-Side XSS via JSX Escaping Bypass in cx() Utility                     |
| js-yaml              | moderate | CVE-2026-53550      | v4                | JS-YAML: Quadratic-complexity DoS in merge key handling via repeated aliases      |
| protobufjs           | moderate | CVE-2026-59876      | v3                | protobufjs: Text Format string map parsing can mutate returned map object protot  |
| protobufjs           | moderate | CVE-2026-59877      | v4, v3            | protobufjs: Denial of Service via infinite loop in .proto option parsing          |
| protobufjs           | moderate | CVE-2026-54269      | v4                | protobufjs : Schema-derived names can shadow runtime-significant properties       |
| qs                   | moderate | CVE-2026-8723       | v1                | qs has a remotely triggerable DoS: qs.stringify crashes with TypeError on null/u  |
| react-router         | moderate | CVE-2026-53669      | v4, v1            | React Router: Open redirect via backslash in <Link> and useNavigate (CVE-2025-68  |
| react-router         | moderate | CVE-2026-53666      | v4, v1            | React Router: Arbitrary Constructor Injection via deserializeErrors() in React R  |
| react-router         | moderate | CVE-2026-53667      | v4                | React Router: RSCErrorHandler Missing Protocol Validation (XSS)                   |
...
| webpack-dev-server   | moderate | CVE-2026-14620      | v1                | webpack-dev-server vulnerable to cross-site request forgery via internal develop  |
| webpack-dev-server   | moderate | CVE-2026-14631      | v1                | webpack-dev-server vulnerable to denial of service via a malformed Host or Origi  |
| websocket-driver     | moderate | CVE-2026-54490      | v1                | websocket-driver: Resource limit bypass via message compression                   |
| @babel/core          | low      | CVE-2026-49356      | v4                | @babel/core: Arbitrary File Read via sourceMappingURL Comment                     |
| body-parser          | low      | CVE-2026-12590      | v4, v3, v1        | body-parser vulnerable to denial of service when invalid limit value silently di  |
| dompurify            | low      | GHSA-c2j3-45gr-mqc4 | v1                | DOMPurify: `CUSTOM_ELEMENT_HANDLING` bypasses `afterSanitizeElements` for allowe  |
...
| shell-quote           | critical | CVE-2026-9277       | v4, v3            | shell-quote quote() does not escape newlines in object .op values                  |
| tar                   | critical | CVE-2026-59873      | v4, v3, v2, v1    | node-tar: Decompression/parse DoS via unlimited input                              |
| websocket-driver      | critical | CVE-2026-54466      | v4, v3, v2, v1    | websocket-driver: Message corruption via abuse of protocol length headers          |
...
| axios                 | high     | GHSA-gcfj-64vw-6mp9 | v4, v1            | Axios Node HTTP adapter can use an inherited proxy after interceptor config clon   |
...
| brace-expansion       | high     | CVE-2026-13149      | v4, v3, v2, v1    | brace-expansion: DoS via exponential-time expansion of consecutive non-expanding   |
...
| fast-uri              | high     | CVE-2026-16221      | v4, v3, v2, v1    | fast-uri vulnerable to host confusion via literal backslash authority delimiter    |
| fast-uri              | high     | CVE-2026-13676      | v4, v3, v2, v1    | fast-uri vulnerable to host confusion via failed IDN canonicalization              |
...
| form-data             | high     | CVE-2026-12143      | v4, v3, v2, v1    | form-data: CRLF injection in form-data via unescaped multipart field names and f   |
...
| http-proxy-middleware | high     | CVE-2026-55603      | v4, v3, v2        | http-proxy-middleware: multipart/form-data field injection via unescaped CRLF in   |
| immutable             | high     | CVE-2026-59879      | v4, v3, v2, v1    | Immutable.js `List` 32-bit trie overflow → unrecoverable DoS                       |
| immutable             | high     | CVE-2026-59880      | v4, v3, v2, v1    | Immutabl: Hash-collision algorithmic complexity denial of service in Immutable.M   |
| immutable             | high     | CVE-2026-29063      | v2                | Immutable is vulnerable to Prototype Pollution                                     |
| js-yaml               | high     | CVE-2026-59869      | v4, v3, v2, v1    | js-yaml: YAML merge-key chains can force quadratic CPU consumption                 |
| linkify-it            | high     | CVE-2026-59887      | v4, v3, v2, v1    | linkify-it: Quadratic-complexity DoS via the `mailto:` validator scan-loop on at   |
...
| shell-quote           | high     | CVE-2026-13311      | v4, v3, v2, v1    | shell-quote: Quadratic-complexity Denial of Service in `parse()` (CWE-407)         |
...
| vite                  | high     | CVE-2026-53571      | v4, v3, v2, v1    | vite: `server.fs.deny` bypass on Windows alternate paths                           |
| ws                    | high     | CVE-2026-48779      | v4, v3, v2, v1    | ws: Memory exhaustion DoS from tiny fragments and data chunks                      |
...
| @hono/node-server     | moderate | GHSA-frvp-7c67-39w9 | v4, v3, v2        | Node.js Adapter for Hono: Path traversal in `serve-static` on Windows via encode   |
...
| axios                 | moderate | GHSA-42h9-826w-cgv3 | v4, v3, v2, v1    | Axios: Excessive recursion in formDataToJSON can cause denial of service           |
| axios                 | moderate | GHSA-xj6q-8x83-jv6g | v4, v1            | Axios: Prototype pollution auth subfields can inject Basic auth                    |
| axios                 | moderate | GHSA-pmv8-rq9r-6j72 | v4, v3, v2, v1    | Axios: Deep formToJSON Key Recursion Can Cause Denial of Service                   |
| axios                 | moderate | GHSA-jqh4-m9w3-8hp9 | v4, v3, v2, v1    | Axios: Fetch adapter `ReadableStream` uploads bypass `maxBodyLength`               |
| axios                 | moderate | GHSA-mmx7-hfxf-jppx | v4, v3, v2, v1    | Axios: Prototype pollution gadgets can alter axios request construction            |
| axios                 | moderate | GHSA-f4gw-2p7v-4548 | v4, v1            | Axios: NO_PROXY bypass for 0.0.0.0 local addresses in axios                        |
| axios                 | moderate | GHSA-hcpx-6fm6-wx23 | v4, v1            | Axios form serializer maxDepth bypass via {} metatoken                             |
| axios                 | moderate | GHSA-7q8q-rj6j-mhjq | v4, v3, v2, v1    | Axios: Nested axios option objects can consume polluted prototype values           |
| axios                 | moderate | GHSA-mwf2-3pr3-8698 | v4, v1            | Axios: HTTP/2 streamed uploads bypass `maxBodyLength`                              |
...
| hono                  | moderate | CVE-2026-59897      | v4, v3, v2        | Hono: API Gateway v1 adapter can drop a distinct repeated request header value d   |
| hono                  | moderate | CVE-2026-59895      | v4, v3, v2        | Hono: Server-Side XSS via JSX Escaping Bypass in cx() Utility                      |
| hono                  | moderate | CVE-2026-59896      | v4, v3            | hono/jsx does not isolate context per request, leading to cross-request data dis   |
...
| js-yaml               | moderate | CVE-2026-53550      | v4, v3, v2, v1    | JS-YAML: Quadratic-complexity DoS in merge key handling via repeated aliases       |
...
| vite                  | moderate | CVE-2026-53632      | v4, v3, v2, v1    | launch-editor: NTLMv2 hash disclosure via UNC path handling on Windows             |
| webpack               | moderate | CVE-2024-43788      | v2                | Webpack's AutoPublicPathRuntimeModule has a DOM Clobbering Gadget that leads to    |
| webpack-dev-server    | moderate | CVE-2026-14620      | v4, v3, v2, v1    | webpack-dev-server vulnerable to cross-site request forgery via internal develop   |
| webpack-dev-server    | moderate | CVE-2026-14631      | v4, v3, v2, v1    | webpack-dev-server vulnerable to denial of service via a malformed Host or Origi   |
...
| webpack-dev-server    | moderate | CVE-2026-6402       | v4, v2            | webpack-dev-server vulnerable to cross-origin source code exposure on non-HTTPS    |
| webpack-dev-server    | moderate | CVE-2026-9595       | v4, v2            | webpack-dev-server vulnerable to HMR WebSocket interception via permissive user    |
| websocket-driver      | moderate | CVE-2026-54490      | v4, v3, v2, v1    | websocket-driver: Resource limit bypass via message compression                    |
...
| @babel/core           | low      | CVE-2026-49356      | v4, v3, v2        | @babel/core: Arbitrary File Read via sourceMappingURL Comment                      |
...
| body-parser           | low      | CVE-2026-12590      | v4, v3, v2, v1    | body-parser vulnerable to denial of service when invalid limit value silently di   |
