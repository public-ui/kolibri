...
| extract-zip              | high     | CVE-2026-19693      | v1                | extract-zip allows arbitrary file writes through symlink archive entries         |
...
| image-size               | high     | CVE-2025-71330      | v3, v2, v1        | image-size: ICNS parser allows denial of service through an infinite loop        |
| image-size               | high     | CVE-2025-71329      | v3, v2, v1        | image-size: JXL and HEIF parsers allow denial of service through infinite loops  |
...
| js-yaml                  | high     | CVE-2026-84375      | v4, v1            | js-yaml: maxTotalMergeKeys does not limit CPU use for empty merge sources        |
...
| @angular/common          | moderate | CVE-2026-88059      | v3                | Angular: Information Leak via `HttpTransferCache` Bypass When Using `withRequest |
| @angular/compiler        | moderate | CVE-2026-88057      | v3                | Angular: Sanitization bypass via directive host bindings on concrete host elemen |
| @angular/core            | moderate | CVE-2026-88057      | v3                | Angular: Sanitization bypass via directive host bindings on concrete host elemen |
...
| baseline-browser-mapping | moderate | CVE-2026-45819      | v1                | baseline-browser-mapping process termination on invalid input causes denial of s |
...
| hono                     | moderate | CVE-2026-84365      | v3                | Hono: Incomplete fix for CVE-2026-39408: `toSSG()` still writes files outside th |
| hono                     | moderate | CVE-2026-84364      | v3                | Hono: Unbounded dot-notation nesting in `parseBody()` can cause memory exhaustio |
| hono                     | moderate | CVE-2026-84363      | v3                | Hono: Query parser reads parameters after the URL fragment, causing cache-key an |
...
| @angular/common          | high     | CVE-2026-54268      | v3, v1            | @angular/common: Denial of Service (DoS) via OOM in Date Formatting (formatDate) |
| @angular/common          | high     | CVE-2026-54266      | v3, v1            | @angular/common: Weak 32-Bit Cache Key Hashing in `HttpTransferCache` Leading to |
...
| @angular/common          | high     | CVE-2026-68945      | v3, v1            | Angular: Cache-Key Ambiguity in HttpTransferCache Leading to Cross-Request Respo |
...
| @angular/compiler        | high     | CVE-2026-69151      | v4, v3, v1        | Angular i18n: Cross-Site Scripting (XSS) via event-handler attributes            |
...
| @angular/core            | high     | CVE-2026-54267      | v4, v3, v1        | Angular Client Hydration DOM Clobbering & Response-Cache Poisoning               |
...
| @xmldom/xmldom           | high     | CVE-2026-83612      | v4                | xmldom: HTML raw-text closing-tag case mismatch causes output amplification      |
| @xmldom/xmldom           | high     | CVE-2026-83606      | v4                | xmldom PI grammar regex ReDoS: quadratic backtracking on unterminated processing |
| @xmldom/xmldom           | high     | CVE-2026-83607      | v4                | xmldom: Element name injection via createElement() bypasses requireWellFormed    |
| @xmldom/xmldom           | high     | CVE-2026-83605      | v4                | xmldom: Attribute name injection via setAttribute() bypasses requireWellFormed   |
| @xmldom/xmldom           | high     | CVE-2026-83616      | v4                | xmldom: Processing Instruction Target Injection Bypasses requireWellFormed       |
| @xmldom/xmldom           | high     | CVE-2026-83608      | v4                | xmldom: DocType `name` Injection Bypasses requireWellFormed                      |
| @xmldom/xmldom           | high     | CVE-2026-83609      | v4                | xmldom: Creation-time XML Name/QName validation is bypassable via an embedded li |
| @xmldom/xmldom           | high     | CVE-2026-83618      | v4                | xmldom: requireWellFormed DocType publicId/systemId validation is bypassable via |
| @xmldom/xmldom           | high     | CVE-2026-83613      | v4                | xmldom: Quadratic-time attribute deduplication                                   |
| @xmldom/xmldom           | high     | CVE-2026-83615      | v4                | xmldom: Quadratic-memory consumption                                             |
| @xmldom/xmldom           | high     | CVE-2026-83614      | v4                | xmldom: Quadratic-time parsing via the malformed-input recovery path — `parseEle |
| adm-zip                  | high     | CVE-2026-77301      | v4, v2            | adm-zip: Uncontrolled memory allocation via the declared uncompressed size (DoS) |
...
| deepmerge-ts             | high     | CVE-2026-40345      | v3, v2            | DeepmergeTS has stack exhaustion when merging recursive object graphs            |
...
| extract-zip              | high     | CVE-2026-19693      | v4, v3, v2, v1    | extract-zip allows arbitrary file writes through symlink archive entries         |
...
| js-yaml                  | high     | CVE-2026-84375      | v4, v3, v2, v1    | js-yaml: maxTotalMergeKeys does not limit CPU use for empty merge sources        |
...
| smol-toml                | high     | CVE-2026-85730      | v3, v2, v1        | smol-toml: Denial of Service via malformed TOML documents                        |
...
| svgo                     | high     | CVE-2026-84370      | v4, v3, v2, v1    | SVGO: removeScripts allows executable links through namespace and control-charac |
...
| @angular/common          | moderate | CVE-2026-88059      | v3, v2, v1        | Angular: Information Leak via `HttpTransferCache` Bypass When Using `withRequest |
| @angular/compiler        | moderate | CVE-2026-54265      | v4, v3, v1        | @angular/compiler: Two-Way Property Binding Sanitization Bypass (XSS)            |
| @angular/compiler        | moderate | CVE-2026-50557      | v4, v1            | Angular: Template and Attribute Namespace Sanitization Bypass (XSS)              |
| @angular/compiler        | moderate | CVE-2026-88057      | v4, v3, v2, v1    | Angular: Sanitization bypass via directive host bindings on concrete host elemen |
...
| @angular/core            | moderate | CVE-2026-88057      | v4, v3, v2, v1    | Angular: Sanitization bypass via directive host bindings on concrete host elemen |
...
| @xmldom/xmldom           | moderate | CVE-2026-83611      | v4                | xmldom: Parser silently accepts a not-well-formed end tag whose name is followed |
| adm-zip                  | moderate | CVE-2026-76845      | v4, v2            | adm-zip extraction follows destination symlinks, allowing arbitrary file overwri |
...
| baseline-browser-mapping | moderate | CVE-2026-45819      | v3, v1            | baseline-browser-mapping process termination on invalid input causes denial of s |
...
| colord                   | moderate | CVE-2026-85062      | v4, v3, v2, v1    | Colord: Slow rejection of oversized malformed color strings                      |
...
| devalue                  | moderate | CVE-2026-81176      | v4                | Svelte devalue: DoS via malformed input                                          |
| dompurify                | moderate | GHSA-55q2-fjhq-7xh7 | v1                | DOMPurify: IN_PLACE hook removal leaves a detached subtree executable, causing X |
...
| hono                     | moderate | CVE-2026-84365      | v3, v2            | Hono: Incomplete fix for CVE-2026-39408: `toSSG()` still writes files outside th |
| hono                     | moderate | CVE-2026-84364      | v3, v2            | Hono: Unbounded dot-notation nesting in `parseBody()` can cause memory exhaustio |
| hono                     | moderate | CVE-2026-84363      | v3, v2            | Hono: Query parser reads parameters after the URL fragment, causing cache-key an |
| hono                     | moderate | CVE-2026-59896      | v3                | hono/jsx does not isolate context per request, leading to cross-request data dis |
| hono                     | moderate | CVE-2026-71848      | v3                | Hono: Algorithmic Complexity DoS in Language Middleware                          |
...
| svgo                     | moderate | CVE-2026-84369      | v4, v3, v2, v1    | SVGO: removeScripts incompletely sanitizes executable HTML in SVG foreignObject  |
