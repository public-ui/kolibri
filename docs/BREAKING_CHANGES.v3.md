...
- The property `_hasCounter` has been removed. To show a visual hint about allowed characters of an input, use `_characterLimit` instead. Consult documentation for more details.
