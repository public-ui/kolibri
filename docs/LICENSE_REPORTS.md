...
| @public-ui/components | EUPL-1.2      | 4.4.0   | Informationstechnikzentrum Bund kolibri@itzbund.de |
| @angular/common       | MIT           | 20.3.31 | angular                                            |
| @angular/compiler     | MIT           | 20.3.20 | angular                                            |
| @angular/compiler-cli | MIT           | 20.3.31 | n/a                                                |
| @angular/core         | MIT           | 20.3.20 | angular                                            |
| @angular/core         | MIT           | 20.3.20 | angular                                            |
| zone.js               | MIT           | 0.16.3  | Brian Ford                                         |
...
| rimraf                | BlueOak-1.0.0 | 6.1.3   | Isaac Z. Schlueter                                 |
| @public-ui/components | EUPL-1.2      | 4.4.0   | Informationstechnikzentrum Bund kolibri@itzbund.de |
| @angular/common       | MIT           | 21.2.23 | angular                                            |
| @angular/compiler     | MIT           | 21.2.12 | angular                                            |
| @angular/compiler-cli | MIT           | 21.2.23 | n/a                                                |
...
| typescript            | Apache-2.0 | 5.9.3   | Microsoft Corp.                                    |
| @public-ui/components | EUPL-1.2   | 4.4.0   | Informationstechnikzentrum Bund kolibri@itzbund.de |
| @public-ui/react      | EUPL-1.2   | 4.4.0   | Informationstechnikzentrum Bund kolibri@itzbund.de |
...
| react                 | MIT           | 18.3.1  | n/a                                                           |
| react-dom             | MIT           | 18.3.1  | n/a                                                           |
| webpack               | MIT           | 5.110.3 | Tobias Koppers @sokra                                         |
| webpack-cli           | MIT           | 7.2.3   | n/a                                                           |
...
| minimatch             | BlueOak-1.0.0 | 10.2.6  | Isaac Z. Schlueter                                 |
| @public-ui/components | EUPL-1.2      | 4.4.0   | Informationstechnikzentrum Bund kolibri@itzbund.de |
| solid-js              | MIT           | 1.9.15  | Ryan Carniato                                      |
| solid-js              | MIT           | 1.9.15  | Ryan Carniato                                      |
| unbuild               | MIT           | 3.6.1   | n/a                                                |
...
| minimatch             | BlueOak-1.0.0 | 10.2.6  | Isaac Z. Schlueter                                 |
| @public-ui/components | EUPL-1.2      | 4.4.0   | Informationstechnikzentrum Bund kolibri@itzbund.de |
| @babel/types          | MIT           | 8.0.5   | The Babel Team (https://babel.dev/team)            |
| svelte                | MIT           | 5.57.0  | n/a                                                |
| svelte                | MIT           | 5.57.0  | n/a                                                |
| unbuild               | MIT           | 3.6.1   | n/a                                                |
...
| knip                                     | ISC           | 6.37.0      | Lars Kappert lars@webpro.nl                                    |
...
| autoprefixer                             | MIT           | 10.6.1      | Andrey Sitnik                                                  |
...
| markdown-it                              | MIT           | 14.3.2      | n/a                                                            |
| mustache                                 | MIT           | 4.2.0       | mustache.js Authors                                            |
| postcss                                  | MIT           | 8.5.28      | Andrey Sitnik                                                  |
...
| Package                           | License | Version | Author                                            |
| --------------------------------- | ------- | ------- | ------------------------------------------------- |
| @evilmartians/lefthook            | MIT     | 2.1.14  | mrexox                                            |
| js-yaml                           | MIT     | 5.4.2   | Vladimir Zapparov                                 |
...
| typescript                         | Apache-2.0        | 5.9.3       | Microsoft Corp.                                                |
| @public-ui/components              | EUPL-1.2          | 4.4.0       | Informationstechnikzentrum Bund kolibri@itzbund.de             |
| @public-ui/react-hook-form-adapter | EUPL-1.2          | 4.4.0       | Informationstechnikzentrum Bund kolibri@itzbund.de             |
| @public-ui/react-v19               | EUPL-1.2          | 4.4.0       | Informationstechnikzentrum Bund kolibri@itzbund.de             |
| adopted-style-sheets               | EUPL-1.2          | 1.1.9-rc.25 | Martin Oppitz github@martinoppitz.com https://martinoppitz.com |
| knip                               | ISC               | 6.37.0      | Lars Kappert lars@webpro.nl                                    |
...
| react-router                       | MIT               | 8.3.1       | Remix Software                                                 |
| stylelint                          | MIT               | 17.14.1     | stylelint                                                      |
...
| typescript                       | Apache-2.0 | 5.9.3      | Microsoft Corp.                                    |
| @public-ui/components            | EUPL-1.2   | 4.4.0      | Informationstechnikzentrum Bund kolibri@itzbund.de |
| @public-ui/visual-tests          | EUPL-1.2   | 4.4.0      | Informationstechnikzentrum Bund kolibri@itzbund.de |
...
| prettier                         | MIT        | 3.9.8      | James Long                                         |
| prettier-plugin-organize-imports | MIT        | 4.3.0      | Simon Haenisch (https://github.com/simonhaenisch)  |
| rollup                           | MIT        | 4.63.3     | Rich Harris                                        |
| rollup-plugin-postcss            | MIT        | 4.0.2      | EGOIST                                             |
| sass-embedded                    | MIT        | 1.104.1    | Google Inc.                                        |
| stylelint                        | MIT        | 17.14.1    | stylelint                                          |
| unbuild                          | MIT        | 3.6.1      | n/a                                                |
| @public-ui/eslint-config         | n/a        | 4.3.0-rc.1 | n/a                                                |
| @public-ui/stylelint-rules       | n/a        | 4.1.2-rc.1 | n/a                                                |
...
| @public-ui/components            | EUPL-1.2      | 4.4.0      | Informationstechnikzentrum Bund kolibri@itzbund.de |
| knip                             | ISC           | 6.37.0     | Lars Kappert lars@webpro.nl                        |
| @modelcontextprotocol/inspector  | MIT           | 2.7.0      | The MCP Maintainers and Community                  |
...
| tsx                              | MIT           | 4.23.13    | Hiroki Osame hiroki.osame@gmail.com                |
| unbuild                          | MIT           | 3.6.1      | n/a                                                |
| zod                              | MIT           | 4.4.3      | Colin McDonnell                                    |
| @public-ui/eslint-config         | n/a           | 4.3.0-rc.1 | n/a                                                |
...
| @public-ui/components            | EUPL-1.2   | 4.4.0       | Informationstechnikzentrum Bund kolibri@itzbund.de             |
| @public-ui/react-v19             | EUPL-1.2   | 4.4.0       | Informationstechnikzentrum Bund kolibri@itzbund.de             |
| @public-ui/sample-react          | EUPL-1.2   | 4.4.0       | n/a                                                            |
| adopted-style-sheets             | EUPL-1.2   | 1.1.9-rc.25 | Martin Oppitz github@martinoppitz.com https://martinoppitz.com |
| knip                             | ISC        | 6.37.0      | Lars Kappert lars@webpro.nl                                    |
| @types/node                      | MIT        | 26.4.0      | n/a                                                            |
| @types/react                     | MIT        | 19.2.18     | n/a                                                            |
