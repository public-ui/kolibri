import{B as e,a as t,c as n,d as r,o as i,s as a,u as o}from"./index-jyxfBogJ.js";import{i as s,n as c}from"./dev.utils-BLwpXbb2-B2UnUrTn.js";import{n as l,t as u}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as d}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{t as f}from"./clsx-COFh-Vc8-DWAop4cA.js";import"./label-C0rxk5dd-INRe_E03.js";import{n as p,r as m,t as h}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import"./normalizers-bmigMYOh-Dc2Lo-q3.js";import{t as g}from"./i18n-6Ww8y2f3-Bsaf4PVi.js";import"./label-0amhC2jU-DHU3GWr_.js";import"./variant-quote-BXzSlO96-CxjmUwoE.js";import{n as _}from"./component-CjoGjBSK-BLIgcgts.js";import"./variant-class-name-CJmwIdCX-CUwGS5aW.js";import"./component-DBqOcqx9-DKRT7qOc.js";import"./component-ar6u1Opn-Cr112fc0.js";import{t as v}from"./component-CcIq1MkT-3d71SbRB.js";import"./align-66zR6LwD-D1jaSWJH.js";import{i as y,t as b}from"./behavior-CiucxZYe-EPigPvsX.js";import{t as x}from"./label-with-expert-slot-vheHAMen-CdQ9anuP.js";import{a as S,c as C,d as w,f as T,l as E,m as D,o as O,p as k,r as A,s as j,t as M,u as N}from"./variant-DIChpbq4-BPXDIYOz.js";import{t as P}from"./name-C4xBDY63-KGJdCW6n.js";import{a as F,n as I,r as L,t as R}from"./api-BbOLRb-o-BNytTO5F.js";import"./controller-B0L6Za5M-XJ9amSpO.js";import"./aria-details-BejeJE6g-DqJd8Tln.js";import"./associated.controller-CPRyns3K-DeX-HfFw.js";import{t as z}from"./base-CNKGvGR8-Dxa9g63h.js";import{n as B,r as V,t as H}from"./controller-DZSZsCPe-Cap-fkIH.js";var U={required:[x],optional:[M,A,R,I,L,F,S,O,j,y,C,x,E,P,V,N,w,T,k,D]},W=t=>{let r=new B,i=new b(u.stateLess),a=h(),d,f=l(U);delete f.tabIndex;let p=e=>{O.apply(e,e=>{f.disabled=e})};p(t.disabled),j.apply(t.hideLabel,e=>{f.hideLabel=e}),w.apply(t.icons,e=>{f.icons=e}),C.apply(!1,e=>{f.inline=e}),k.apply(`top`,e=>{f.tooltipAlign=e}),F.apply(`button`,e=>{f.type=e}),x.apply(t.label,e=>{f.label=e}),V.apply(t.popoverAlign,e=>{f.popoverAlign=e,r.setAlign(e)}),D.apply(e(`buttonVariantDefault`,t.getFlagHost())??`normal`,e=>{f.variant=e}),f.ariaDescriptionId=s(),f.popoverId=c(`popover`);let m=e=>{let n=t.getEventTarget();n&&o(n,e)},g=e=>{t.setOpen(e.newState===`open`)};return f.handleClick=e=>{e.stopPropagation(),i.hideTooltip(),r.setShow(!t.getOpen()),m(n.click)},f.handleMouseDown=()=>m(n.mousedown),f.handleFocus=()=>m(n.focus),f.handleBlur=()=>m(n.blur),f.refButton=e=>{a(e),r.setTriggerElement(e)},f.refPopover=e=>{d=e,r.setPopoverElementRef(e)},f.refTooltip=i.setTooltipElementRef,i.componentWillLoad({label:f.label,align:f.tooltipAlign}),{getFcProps:()=>Object.assign(Object.assign({},f),{popoverOpen:t.getOpen()}),hide:()=>r.setShow(!1),setDisabled:p,syncListeners:()=>{a.el&&i.syncListeners(void 0,a.el,!0),d?.addEventListener(`toggle`,g)},destroy:()=>{i.destroy(),d&&=(d.removeEventListener(`toggle`,g),void 0),r.destroy()}}},G=r.forBlock(`kol-split-button`),K=G(`button`),q=G(`horizontal-line`),J=G(`root`),Y=G(`secondary-button`),X=e=>{let{buttonProps:t,buttonWrapperClass:n,class:r,dropdownProps:a,refDropdown:o}=e;return i(_,{block:`kol-split-button`,class:r},i(`div`,{class:J},i(`div`,{class:f(K,n)},i(v,Object.assign({},t))),i(`div`,{class:q}),i(`div`,{class:Y,ref:o},i(H,Object.assign({},a)))))},Z=`@charset "UTF-8";
