import{Tt as e,a as t,kt as n,o as r,rt as i,s as a,xt as o}from"./index-ChGcQiyp.js";import{n as s}from"./dev.utils-Bp48T7K--DL94U13m.js";import"./base-web-component-BT6jbe_v-Vp21XLG3.js";import{n as c,t as l}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{t as u}from"./clsx-COFh-Vc8-alQuJLqj.js";import"./Heading-B1x6PKRk-DyF5iYzl.js";import"./disabled-BcXSZaDo-CZ7F2wm2.js";import"./label-Ftw1VCQG-uwcXRPiO.js";import{n as d,r as f,t as p}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import"./_Uint8Array-kJHDjtoP-CTkgs_0o.js";import"./normalizers-Dmgd1cXp-WUjOCrl_.js";import"./i18n-BsXYYo8j-DC1mod03.js";import{t as m}from"./component-C0fGqGE4-BiBateBn.js";import"./Alert-B0-brpb4-CApWh557.js";import"./label-RX8TPr4R-CV_wB5LP.js";import"./variant-quote-BI3zVSZn-DQT9DLX_.js";import"./component-D7UTo-Wg-lGoOWVFU.js";import"./access-and-short-key-Mj1AS76I-BnBpeiyD.js";import"./hide-label-B9ipEhG8-Bu_jS6Rb.js";import"./align-DpNc6EKs-oh6dmw9k.js";import"./tooltip-align-ChjYN8Pt-CgpEMRzp.js";import"./variant-class-name-DFWOlDkF-D2fFHoXQ.js";import"./component-ta0hHoH--n2wdFWQL.js";import"./align-floating-elements-BgsKEL5o-B8AiIVCN.js";import"./controller-DV0N3zXZ-D8yBnDJv.js";import{n as h}from"./controller-CY_VvCRp-KHbhUMeL.js";import"./aria-details-8nY2-PPr-ytIpelDs.js";import"./associated.controller-CKYHZabJ-DYTgV1aZ.js";import{c as g,l as _,o as v,s as y,t as b}from"./FormFieldStateWrapper-wmlObx8_-TX-8XL0p.js";import{t as x}from"./Input-BD1yT05J-VeS_iXEn.js";import"./required-DSzN5_9V-Be5JyIHm.js";import"./orientation-BOSiSKDw-33THBNZe.js";import{t as S}from"./controller-CdN52bNb-CJiSVptO.js";import{t as C}from"./FieldControlStateWrapper-CYBj-_e1-DzCozIfg.js";var w=(t,n)=>{e(t,`_checked`,n)},T=(t,n)=>{e(t,`_indeterminate`,n)},E=[`left`,`right`],D=(e,t)=>{n(e,`_labelAlign`,e=>typeof e==`string`&&E.includes(e),new Set([`KoliBriLabelAlign {${E.join(`, `)}`]),t)},O=[`button`,`default`,`switch`],k=e=>typeof e==`string`&&O.includes(e),A=(e,t)=>{n(e,`_variant`,k,new Set(O),t)},j=class extends S{constructor(e,t,n){super(e,t,n),this.setFormAssociatedCheckboxValue=e=>{this.component._checked?this.setFormAssociatedValue(e):this.setFormAssociatedValue(null)},this.component=e}validateChecked(e){w(this.component,e),this.setFormAssociatedCheckboxValue(this.component.state._value)}validateIcons(e){n(this.component,`_icons`,e=>{let t=e;return typeof t==`object`&&!!t&&(i(t.checked,1)||i(t.indeterminate,1)||i(t.unchecked,1))},new Set([`InputCheckboxIcons`]),e,{hooks:{beforePatch:(e,t,n)=>{t.set(`_icons`,Object.assign(Object.assign({},n.state._icons),e))}}})}validateIndeterminate(e){T(this.component,e)}validateLabelAlign(e){D(this.component,e)}validateValue(e){o(this.component,`_value`,e),this.setFormAssociatedCheckboxValue(this.component.state._value)}validateVariant(e){A(this.component,e)}componentWillLoad(){super.componentWillLoad(),this.validateChecked(this.component._checked),this.validateIcons(this.component._icons),this.validateIndeterminate(this.component._indeterminate),this.validateValue(this.component._value),this.validateVariant(this.component._variant),this.validateLabelAlign(this.component._labelAlign)}},M=e=>{var{class:t,variant:n=`default`,icon:i,inputProps:a}=e,o=c(e,[`class`,`variant`,`icon`,`inputProps`]);let{class:s}=a,l=c(a,[`class`]),d={[`kol-checkbox--variant-${n}`]:!0,"kol-checkbox--checked":a?.checked,"kol-checkbox--indeterminate":a?.indeterminate,"kol-checkbox--disabled":!!a?.disabled,"kol-checkbox--required":!!a?.required,"kol-checkbox--touched":!!a?.touched,[`kol-checkbox--${v(a?.msg)}`]:!!_(a?.msg,a?.touched)};return r(`label`,Object.assign({class:u(`kol-checkbox`,d,t)},o),r(m,{label:``,icons:i,class:u(`kol-checkbox__icon`)}),r(x,Object.assign({class:u(`kol-checkbox__input`,s)},l,{type:`checkbox`})))};function N(e,t={}){let{ariaDescribedBy:n,hasError:r}=y(e),i={id:e._id,hideLabel:e._hideLabel,label:e._label,value:e._value,accessKey:e._accessKey,disabled:e._disabled,name:e._name,ariaDescribedBy:n};return`_required`in e&&(i.required=e._required),`_checked`in e&&(i.checked=e._checked),`_indeterminate`in e&&(i.indeterminate=e._indeterminate),`_touched`in e&&(i.touched=e._touched),`_msg`in e&&(i.msg=e._msg),`_shortKey`in e&&(i[`aria-keyshortcuts`]=e._shortKey),Object.assign(Object.assign(Object.assign({},i),t),{"aria-invalid":r?`true`:void 0})}var P=e=>{var{state:t,inputProps:n}=e,i=c(e,[`state`,`inputProps`]);let a=t?._variant||`default`;return r(M,Object.assign({variant:a,inputProps:N(t,n)},i))},F=`@charset "UTF-8";
/*
