import{W as e,a as t,kt as n,o as r,s as i,xt as a}from"./index-ChGcQiyp.js";import{n as o}from"./dev.utils-Bp48T7K--DL94U13m.js";import"./base-web-component-BT6jbe_v-Vp21XLG3.js";import{t as s}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{t as c}from"./clsx-COFh-Vc8-alQuJLqj.js";import"./Heading-B1x6PKRk-DyF5iYzl.js";import"./disabled-BcXSZaDo-CZ7F2wm2.js";import"./label-Ftw1VCQG-uwcXRPiO.js";import{n as l,r as u,t as d}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import"./_Uint8Array-kJHDjtoP-CTkgs_0o.js";import"./normalizers-Dmgd1cXp-WUjOCrl_.js";import"./i18n-BsXYYo8j-DC1mod03.js";import"./component-C0fGqGE4-BiBateBn.js";import"./Alert-B0-brpb4-CApWh557.js";import"./label-RX8TPr4R-CV_wB5LP.js";import"./variant-quote-BI3zVSZn-DQT9DLX_.js";import"./component-D7UTo-Wg-lGoOWVFU.js";import"./icons-BX75HD_Y-D0xquq_K.js";import"./access-and-short-key-Mj1AS76I-BnBpeiyD.js";import"./hide-label-B9ipEhG8-Bu_jS6Rb.js";import"./align-DpNc6EKs-oh6dmw9k.js";import"./tooltip-align-ChjYN8Pt-CgpEMRzp.js";import"./variant-class-name-DFWOlDkF-D2fFHoXQ.js";import"./component-ta0hHoH--n2wdFWQL.js";import"./align-floating-elements-BgsKEL5o-B8AiIVCN.js";import"./controller-DV0N3zXZ-D8yBnDJv.js";import{n as f}from"./controller-CY_VvCRp-KHbhUMeL.js";import"./aria-details-8nY2-PPr-ytIpelDs.js";import"./associated.controller-CKYHZabJ-DYTgV1aZ.js";import{c as p,t as m}from"./FormFieldStateWrapper-wmlObx8_-TX-8XL0p.js";import{n as h,t as g}from"./controller-icon-ByNo1HLL-3vIGQwzd.js";import"./Input-BD1yT05J-VeS_iXEn.js";import{t as _}from"./InputStateWrapper-Blwlv32p-BokdK_VJ.js";import{t as v}from"./required-DSzN5_9V-Be5JyIHm.js";import{t as y}from"./suggestions-Bqlc1vUw-C5eV9Oh4.js";import{t as b}from"./auto-complete-Bnrpv_sN-DuBzW9a3.js";import{t as x}from"./read-only-CR_961Fh-DKPp2yMt.js";var S=[`date`,`datetime-local`,`month`,`time`,`week`],C=e=>typeof e==`string`&&S.includes(e),w=(e,t)=>{n(e,`_type`,C,new Set(S),t)},T=class e extends h{constructor(t,r,i){super(t,r,i),this.validateIso8601=(t,r,i)=>n(this.component,t,e=>e==null||e===``||this.validateDateString(e),new Set([`Date`,`string{ISO-8601}`]),e.tryParseToString(r,this.component._type,this.component._step),{hooks:{afterPatch:e=>{typeof e==`string`&&i&&i(e)}}}),this.component=t}validateAutoComplete(e){b(this.component,e)}validateSuggestions(e){y(this.component,e)}static tryParseToString(e,t,n){if(typeof e==`string`||e===null)return e;if(typeof e==`object`&&e instanceof Date){let r=e.getFullYear(),i=String(e.getMonth()+1).padStart(2,`0`),a=String(e.getDate()).padStart(2,`0`),o=String(e.getHours()).padStart(2,`0`),s=String(e.getMinutes()).padStart(2,`0`),c=String(e.getSeconds()).padStart(2,`0`),l=[r,i,a].join(`-`),u=[o,s,c].join(`:`);switch(t){case`date`:return l;case`datetime-local`:return`${l}T${u}`;case`month`:return`${r}-${i}`;case`time`:return n===void 0||String(n)===`60`?`${o}:${s}`:u;case`week`:return`${r}-W${this.getWeekNumberOfDate(e)}`}}}static getWeekNumberOfDate(e){let t=new Date(e),n=(t.getDay()+6)%7;t.setDate(t.getDate()-n+3);let r=t.valueOf();return t.setMonth(0,1),t.getDay()!==4&&t.setMonth(0,1+(4-t.getDay()+7)%7),(1+Math.ceil((r-t.valueOf())/6048e5)).toString().padStart(2,`0`)}validateDateString(t){switch(this.component._type){case`date`:return e.isoDateRegex.test(t);case`datetime-local`:return e.isoLocalDateTimeRegex.test(t);case`month`:return e.isoMonthRegex.test(t);case`time`:return e.isoTimeRegex.test(t);case`week`:return e.isoWeekRegex.test(t);default:return!1}}onBlur(e){super.onBlur(e),!!e.target.value!=!!this.component._value&&(this.component._value=e.target.value)}validateMax(e){this.validateIso8601(`_max`,e)}validateMin(e){this.validateIso8601(`_min`,e)}validateOn(e){a(this.component,`_on`,Object.assign(Object.assign({},e),{onChange:(t,n)=>{!!n!=!!this.component._value&&(this.component._value=n),e?.onChange&&e.onChange(t,n)}}))}validateReadOnly(e){x(this.component,e)}validateRequired(e){v(this.component,e)}validateStep(e){this.validateNumber(`_step`,e)}validateType(e){w(this.component,e)}validateValue(e){this.validateValueEx(e)}validateValueEx(e,t){this.validateIso8601(`_value`,e,t),this.setFormAssociatedValue(this.component.state._value)}componentWillLoad(){super.componentWillLoad(),this.validateAutoComplete(this.component._autoComplete),this.validateMax(this.component._max),this.validateMin(this.component._min),this.validateLabel(this.component._label),this.validateSuggestions(this.component._suggestions),this.validateOn(this.component._on),this.validateReadOnly(this.component._readOnly),this.validateRequired(this.component._required),this.validateStep(this.component._step),this.validateType(this.component._type),this.validateValue(this.component._value)}};T.isoDateRegex=/^\d{4}-([0]\d|1[0-2])-([0-2]\d|3[01])/,T.isoLocalDateTimeRegex=/^\d{4}-([0]\d|1[0-2])-([0-2]\d|3[01])[T ][0-2]\d:[0-5]\d(:[0-5]\d(?:\.\d+)?)?/,T.isoMonthRegex=/^\d{4}-([0]\d|1[0-2])/,T.isoTimeRegex=/^[0-2]\d:[0-5]\d(:[0-5]\d(?:\.\d+)?)?/,T.isoWeekRegex=/^\d{4}-W(?:[0-4]\d|5[0-3])$/;var E=`@charset "UTF-8";
/*
