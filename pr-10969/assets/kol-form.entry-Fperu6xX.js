import{_t as e,a as t,c as n,d as r,o as i,r as a,s as o,u as s}from"./index-h2kE_xJ4.js";import{i as c,n as l}from"./dev.utils-CC48c_cN-Tp9dBQKv.js";import{n as u,t as d}from"./base-web-component--IgFgz37-CZuvR3uB.js";import"./_Uint8Array-kJnEuTzT-BYXN1zbF.js";import{a as f,r as p}from"./factory-DVePsLAQ-CwbQTnAV.js";import"./disabled-CTTZKNPl-B6SIB0vK.js";import"./variant-quote-7bJL1WOX-DdpqQxbQ.js";import"./Heading-Bkb5uwR6-Cnx_yx-6.js";import"./block-bem-BGMd0WJH-CXALS1VJ.js";import"./component-wTp3zmEk-DKsUFUzK.js";import"./component-DqQBSWec-DkJExCl5.js";import{t as m}from"./i18n-B_vSiQA9-RFxqseld.js";import"./component-GFL3dMKL-8ILDKPvJ.js";import"./variant-class-name-2os1V9lQ-JQbo8bqk.js";import"./component-Di0X6n_E-Dr7rFxop.js";import"./component-B40Ezxeq-BiL50STV.js";import{t as h}from"./component-nk7GR0Zi-Ct5Kb7vL.js";import"./align-Dm5aJHmk-v4fr4gHN.js";import{t as g}from"./label-with-expert-slot-Dh4zRZEb-Cw8ke8vN.js";import"./variant-BBnlDNla-C5K8uv0S.js";import{t as _}from"./href-C8BqY9-O-CZiItrXT.js";import"./link-target-Dn2nOGYR-Cxs0mmk4.js";import{a as v,o as y,t as b}from"./api-qTiH1Ds4-rU85zvPE.js";function x(e){if(typeof e!=`object`||!e)return!1;let{message:t,selector:n}=e;return typeof t==`string`&&(typeof n==`string`||typeof n==`function`)}var S=p(`errorList`,[],e=>f(e),e=>e.every(x));function C(e){if(typeof e==`object`&&e)return e;throw Error(`Invalid on callbacks: expected object, got ${typeof e}`)}var w=p(`on`,{},C);function T(e){if(typeof e==`boolean`||typeof e==`string`)return e;throw Error(`Invalid requiredText: expected boolean or string, got ${typeof e}`)}var E=p(`requiredText`,!0,T),D={optional:[S,w,E]},O=r.forBlock(`kol-form`),k=O(),A=O(`mandatory-fields-hint`),j=({handleReset:e,handleSubmit:t,requiredText:n})=>{let r=n===!0?m(`kol-form-description`):typeof n==`string`&&n.length>0?n:``;return i(`form`,{class:k,method:`post`,onSubmit:t,onReset:e,noValidate:!0},r.length>0&&i(`p`,{class:A},r),i(`slot`,null))},M=(t,n)=>{let r=u(y),i;return r.tabIndex=void 0,_.apply(``,e=>r.href=e),g.apply(t.message,e=>r.label=e),v.apply({onClick:typeof t.selector==`string`?()=>n(String(t.selector),t.options):t.selector},e=>r.on=e),r.ariaCurrent=``,r.ariaDescriptionId=c(),r.expertSlot=t.message===``,r.handleAnchorClick=t=>{let n=r.on?.onClick;typeof n==`function`&&(e(t,i),n(t,r.href))},r.refAnchor=e=>{i=e},r.refTooltip=()=>void 0,{fcProps:r,focus:e=>i?.focus(e)}},N=r.forBlock(`kol-form`),P=N(`alert`),F=N(`link`),I=({alertHeadingId:e,closerAriaDescriptionId:t,errorLinkItems:n})=>i(h,{alert:!1,class:P,closerAriaDescriptionId:t,handleCloserClick:()=>void 0,hasCloser:!1,headingId:e,label:m(`kol-error-list-message`),level:0,refCloserButton:()=>void 0,refCloserTooltip:()=>void 0,type:`error`,variant:`card`},i(`nav`,{"aria-label":m(`kol-error-list`)},i(`ul`,null,n.map((e,t)=>i(`li`,{key:t},i(`span`,{class:F},i(b,Object.assign({},e.fcProps)))))))),L=`@charset "UTF-8";
