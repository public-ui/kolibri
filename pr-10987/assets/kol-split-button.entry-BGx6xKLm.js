import{B as e,a as t,c as n,d as r,o as i,s as a,u as o}from"./index-Ccv333Ra.js";import{i as s,n as c}from"./dev.utils-DEzQ6pd0-Bmkk7H0b.js";import{n as l,t as u}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as d}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./_Uint8Array-kJnEuTzT-BYXN1zbF.js";import"./factory-DVePsLAQ-DphD6_Tx.js";import{t as f}from"./disabled-CTTZKNPl-C4wjBF_O.js";import"./label-BJf95S0B-CMRkl4om.js";import"./label-CnOLrr0w-BwoJUwzn.js";import"./variant-quote-7bJL1WOX-DWvHDFQG.js";import{t as p}from"./clsx-COFh-Vc8-DWAop4cA.js";import{n as m,r as h,t as g}from"./element-interaction-DORv36BQ-BSHBQDXV.js";import"./block-bem-BGMd0WJH-B3rj00xz.js";import"./component-BG05O9Id-D_rtgrP-.js";import"./component-DIrul5pb-Ce3MwTBL.js";import{t as _}from"./i18n-B_vSiQA9-DIKl7eEn.js";import{n as v}from"./component-1zt0BWKC-f5sJOvX0.js";import"./variant-class-name-2os1V9lQ-DrZNm5P8.js";import"./component-COEI4VoT-MhTR67qf.js";import{t as y}from"./component-Z2KNQIrE-C8eg8axd.js";import"./align-Dm5aJHmk-BmxcjOkn.js";import{i as b,t as x}from"./behavior-Cxx5cP6o-C8_FCjRC.js";import{t as S}from"./label-with-expert-slot-Dh4zRZEb-BVekLeYt.js";import{a as C,c as w,d as T,f as E,l as D,o as O,p as k,r as A,s as j,t as M,u as N}from"./variant-BBnlDNla-BMSNzgRF.js";import{t as P}from"./name-CeY6Ud0E-BJFlH9QN.js";import{a as F,n as I,r as L,t as R}from"./api-BdaEnkJl-DBS3wMe9.js";import"./controller-BDOsSDm9-DRFUNRii.js";import"./aria-details-ChvorFzb-T34c2MTB.js";import"./associated.controller-ExNQqx6z-D36QM94W.js";import{t as z}from"./base-WZSNWAVO-DkhMbDsp.js";import{n as B,r as V,t as H}from"./controller-Bq2iKxSt-hd-mHffw.js";var U={required:[S],optional:[M,A,R,I,L,F,C,f,O,b,j,S,w,P,V,D,N,T,E,k]},W=t=>{let r=new B,i=new x(u.stateLess),a=g(),d,p=l(U);delete p.tabIndex;let m=e=>{f.apply(e,e=>{p.disabled=e})};m(t.disabled),O.apply(t.hideLabel,e=>{p.hideLabel=e}),N.apply(t.icons,e=>{p.icons=e}),j.apply(!1,e=>{p.inline=e}),E.apply(`top`,e=>{p.tooltipAlign=e}),F.apply(`button`,e=>{p.type=e}),S.apply(t.label,e=>{p.label=e}),V.apply(t.popoverAlign,e=>{p.popoverAlign=e,r.setAlign(e)}),k.apply(e(`buttonVariantDefault`,t.getFlagHost())??`normal`,e=>{p.variant=e}),p.ariaDescriptionId=s(),p.popoverId=c(`popover`);let h=e=>{let n=t.getEventTarget();n&&o(n,e)},_=e=>{t.setOpen(e.newState===`open`)};return p.handleClick=e=>{e.stopPropagation(),i.hideTooltip(),r.setShow(!t.getOpen()),h(n.click)},p.handleMouseDown=()=>h(n.mousedown),p.handleFocus=()=>h(n.focus),p.handleBlur=()=>h(n.blur),p.refButton=e=>{a(e),r.setTriggerElement(e)},p.refPopover=e=>{d=e,r.setPopoverElementRef(e)},p.refTooltip=i.setTooltipElementRef,i.componentWillLoad({label:p.label,align:p.tooltipAlign}),{getFcProps:()=>Object.assign(Object.assign({},p),{popoverOpen:t.getOpen()}),hide:()=>r.setShow(!1),setDisabled:m,syncListeners:()=>{a.el&&i.syncListeners(void 0,a.el,!0),d?.addEventListener(`toggle`,_)},destroy:()=>{i.destroy(),d&&=(d.removeEventListener(`toggle`,_),void 0),r.destroy()}}},G=r.forBlock(`kol-split-button`),K=G(`button`),q=G(`horizontal-line`),J=G(`root`),Y=G(`secondary-button`),X=e=>{let{buttonProps:t,buttonWrapperClass:n,class:r,dropdownProps:a,refDropdown:o}=e;return i(v,{block:`kol-split-button`,class:r},i(`div`,{class:J},i(`div`,{class:p(K,n)},i(y,Object.assign({},t))),i(`div`,{class:q}),i(`div`,{class:Y,ref:o},i(H,Object.assign({},a)))))},Z=`@charset "UTF-8";
