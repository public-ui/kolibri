import{B as e,J as t,_t as n,a as r,c as i,ft as a,o,r as s,s as c,u as l,ut as u}from"./index-B78ZJg3V.js";import{i as d,n as f}from"./dev.utils-Cm98PsUP-BYNaZFnM.js";import{n as p,t as m}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as h}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./label-CCp3kSSJ-CFxuJUSC.js";import{r as g,t as _}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{n as v}from"./normalizers-mEN6hK4a-cSVcwEv1.js";import"./component-Dyb5i2o5-DUqXZFe8.js";import"./index-BPOci8qG-DM28wNmm.js";import{t as y}from"./color-CvloPgow-0NXviEEr.js";import"./label-Bwcd5gdJ-ByQ3HE3J.js";import"./variant-quote-YMS0sWqd-D8tDJXR_.js";import{t as b}from"./label-with-expert-slot-Cc6WMDpu-D_QLRCaj.js";import"./align-KoOYfK0y-7sWRZGVV.js";import{a as x,c as S,d as C,f as w,i as T,l as E,m as D,n as O,o as k,p as A,r as j,s as M,t as N,u as P}from"./variant-BeF3EuAc-Cos31R1F.js";import"./variant-class-name-CEvwl2un-DQgv7cAk.js";import"./component-C3U3GW2r-DSiv-PeP.js";import"./component-jqzT5NAU-CH88Jeo2.js";import"./component-DNXm5P5D-jG_ikjgB.js";import"./component-CLCFvCN3-BIwe61Y-.js";import{t as F}from"./component-DaecDkue-DaarfjM6.js";import"./align-floating-elements-DSBK8khX-SrwzdRKk.js";import{n as I,t as L}from"./behavior-C7IEehtg-DLSknF53.js";import{t as R}from"./name-BKUXDlWV-qGeiVB9y.js";import{a as z,i as B,n as V,r as H}from"./api-C0Gi8Q2e-BareMq5r.js";function U(e){let t=typeof e==`string`?a(e):e;if(typeof t==`object`&&t)return t;throw Error(`Invalid smart button: ${typeof e}`)}var W=v(`smartButton`,{_label:``},U),G={required:[b],optional:[y,W,C]},K={disabled:!1,hideLabel:!1,inline:!1,tooltipAlign:`top`,type:`button`};function q(t,n){let r=p(B),i=e=>t=>{r[e]=t};return b.apply(t._label,i(`label`)),N.apply(t._accessKey,i(`accessKey`)),O.apply(t._ariaControls,i(`ariaControls`)),j.apply(t._ariaDescription,i(`ariaDescription`)),T.apply(t._ariaExpanded,i(`ariaExpanded`)),V.apply(t._ariaSelected,i(`ariaSelected`)),H.apply(t._on,i(`on`)),z.apply(t._type??K.type,i(`type`)),x.apply(t._customClass,i(`customClass`)),k.apply(t._disabled??K.disabled,i(`disabled`)),M.apply(t._hideLabel??K.hideLabel,i(`hideLabel`)),I.apply(t._id,i(`id`)),S.apply(t._inline??K.inline,i(`inline`)),E.apply(t._role,i(`role`)),R.apply(t._name,i(`name`)),P.apply(t._shortKey,i(`shortKey`)),C.apply(t._icons,i(`icons`)),A.apply(t._tooltipAlign??K.tooltipAlign,i(`tooltipAlign`)),typeof t._tabIndex==`number`?w.apply(t._tabIndex,i(`tabIndex`)):r.tabIndex=void 0,D.apply(t._variant??e(`buttonVariantDefault`,n)??`normal`,i(`variant`)),r}var J=`@charset "UTF-8";
