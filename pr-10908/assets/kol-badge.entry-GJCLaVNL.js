import{B as e,J as t,_t as n,a as r,c as i,d as a,ft as o,o as s,r as c,s as l,u,ut as d}from"./index-pvtv-KaX.js";import{i as f,n as p}from"./dev.utils-3xMYti16-CNBcQcEI.js";import{n as m,t as h}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as g}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./label-DxrksC9L-uLeM8iBN.js";import{r as _,t as v}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{n as y}from"./normalizers-DEevvNbZ-CFO2mxQG.js";import"./component-Bdz1RxPH-D0VfIVem.js";import"./index-YF9sPUm--BEd9vHF6.js";import{t as b}from"./color-CeyCa7cR-CdZluZnW.js";import"./label-De6GKT_4-Dtc46KxV.js";import"./variant-quote-JfuelQ4I-CmAA8Kpf.js";import{t as x}from"./label-with-expert-slot-pcKVBAqt-Ds5WAG4C.js";import"./align-DglmQnOH-CoZmuJ6M.js";import{a as S,c as ee,d as C,f as w,h as T,i as E,l as D,m as O,n as k,o as A,p as j,r as M,s as N,u as P}from"./component-Dk-SHEgV-ERdVpnST.js";import"./variant-class-name-BFZvmFM_-CiWXESnb.js";import"./component-yp5ABYm1-DxgTp8NM.js";import{t as F}from"./component-DIwPebtD-Cfm3NcsO.js";import"./component-BaPMMEoL-BLBx92_f.js";import"./align-floating-elements-D6Kc-f8P-CxjRSXoD.js";import{n as I,t as L}from"./behavior-opTsLlOg-BD7-msO6.js";import{t as R}from"./name-BOMzcWdF-BQI3Q7bQ.js";import{a as z,i as B,o as V,r as H,t as U}from"./api-up6UdHpl-pfbMf4o0.js";function W(e){let t=typeof e==`string`?o(e):e;if(typeof t==`object`&&t)return t;throw Error(`Invalid smart button: ${typeof e}`)}var G=y(`smartButton`,{_label:``},W),K={required:[x],optional:[b,G,w]},q=a.forBlock(`kol-badge`),J=q(`label`),Y=q(`smart-button`),X=e=>{let{ariaDescriptionId:t,color:n,handleBlur:r,handleClick:i,handleFocus:a,handleMouseDown:o,icons:c,label:l,labelId:u,refSmartButton:d,refTooltip:f,smartButton:p,smartButtonProps:m}=e,h=typeof p==`object`&&!!p&&m!==void 0;return s(`div`,{class:q({"has-smart-button":h}),style:{backgroundColor:n.backgroundColor,color:n.foregroundColor}},s(F,{class:J,id:h?u:void 0,allowMarkdown:!0,icons:c,label:l}),h&&s(U,Object.assign({},m,{class:Y,ariaDescriptionId:t,handleBlur:r,handleClick:i,handleFocus:a,handleMouseDown:o,refButton:d,refTooltip:f})),s(`br`,null))},Z={disabled:!1,hideLabel:!1,inline:!1,tooltipAlign:`top`,type:`button`};function Q(t,n){let r=m(z),i=e=>t=>{r[e]=t};return x.apply(t._label,i(`label`)),k.apply(t._accessKey,i(`accessKey`)),M.apply(t._ariaControls,i(`ariaControls`)),E.apply(t._ariaDescription,i(`ariaDescription`)),S.apply(t._ariaExpanded,i(`ariaExpanded`)),H.apply(t._ariaSelected,i(`ariaSelected`)),B.apply(t._on,i(`on`)),V.apply(t._type??Z.type,i(`type`)),A.apply(t._customClass,i(`customClass`)),N.apply(t._disabled??Z.disabled,i(`disabled`)),ee.apply(t._hideLabel??Z.hideLabel,i(`hideLabel`)),I.apply(t._id,i(`id`)),D.apply(t._inline??Z.inline,i(`inline`)),P.apply(t._role,i(`role`)),R.apply(t._name,i(`name`)),C.apply(t._shortKey,i(`shortKey`)),w.apply(t._icons,i(`icons`)),O.apply(t._tooltipAlign??Z.tooltipAlign,i(`tooltipAlign`)),typeof t._tabIndex==`number`?j.apply(t._tabIndex,i(`tabIndex`)):r.tabIndex=void 0,T.apply(t._variant??e(`buttonVariantDefault`,n)??`normal`,i(`variant`)),r}var te=`@charset "UTF-8";
