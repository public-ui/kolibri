...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 310px, received 500px by 318px. 1847 pixels (ratio 0.02 of all image pixels) are different.
...
- main [ref=e4]:
  - generic [ref=e5]:
    ...
    - generic [ref=e28]:
      ...
      - generic [ref=e31]:
        - group "Test (horizontal)" [ref=e33]:
          - generic [ref=e37] [cursor=pointer]: Test (horizontal)
          - generic [ref=e38]:
            - generic [ref=e39]:
              - radio "Field 1" [ref=e42] [cursor=pointer]
              - generic [ref=e46] [cursor=pointer]: Field 1
            - generic [ref=e47]:
              - radio "Field 2" [ref=e50] [cursor=pointer]
              - generic [ref=e54] [cursor=pointer]: Field 2
        - group "Test (horizontal)" [ref=e57]:
          - generic [ref=e61] [cursor=pointer]: Test (horizontal)
          - generic [ref=e62]:
            - radio "Field 1" [ref=e66] [cursor=pointer]
            - radio "Field 2" [ref=e70] [cursor=pointer]
```
