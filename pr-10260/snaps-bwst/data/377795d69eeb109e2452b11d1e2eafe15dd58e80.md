...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 408px by 665px, received 408px by 669px. 1791 pixels (ratio 0.01 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e34]:
    ...
    - generic [ref=e48]: <KolInputText _icons='kolicon-version' _label="Input with Icon" />
```
