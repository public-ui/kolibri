...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 186px, received 500px by 194px. 6088 pixels (ratio 0.07 of all image pixels) are different.

  Snapshot: snapshot-for-input-text-smart-button-noColumns.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-input-text-smart-button-noColumns.png)" with timeout 10000ms
...
```yaml
- main [ref=e4]:
  - heading "input-text smart-button" [level=1] [ref=e5]
  - generic [ref=e6]:
    - generic [ref=e8]:
      - generic [ref=e12] [cursor=pointer]: Input with button and icons
      - generic [ref=e14]:
        - generic [ref=e16]: 
        - textbox "Input with button and icons" [ref=e18]
        - generic [ref=e19]:
          - button "Open Toast" [ref=e21] [cursor=pointer]:
            - generic [ref=e24]: 
          - generic [ref=e25]: 
    - generic [ref=e28]:
      - generic [ref=e32]: Disabled input with button and icons
      - generic [ref=e34]:
        - generic [ref=e36]: 
        - textbox "Disabled input with button and icons" [disabled] [ref=e38]
        - generic [ref=e39]:
          - button "Disabled Button" [disabled] [ref=e41]:
            - generic [ref=e44]: 
          - generic [ref=e45]: 
```
