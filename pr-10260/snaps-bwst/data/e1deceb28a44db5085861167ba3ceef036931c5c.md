...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 293px, received 500px by 305px. 8564 pixels (ratio 0.06 of all image pixels) are different.
      ...
      - generic [ref=e11]:
        ...
        - generic [ref=e17]:
          ...
          - button "Show" [ref=e22] [cursor=pointer]:
            - generic [ref=e25]: 
      - generic [ref=e28]:
        - generic [ref=e32] [cursor=pointer]: Password
        - generic [ref=e34]:
          - textbox "Password" [ref=e36]:
            - /placeholder: With 'Show password' button
          - button "Show" [ref=e39] [cursor=pointer]:
            - generic [ref=e42]: 
      - generic [ref=e45]:
