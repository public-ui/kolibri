...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 439px, received 500px by 455px. 16813 pixels (ratio 0.08 of all image pixels) are different.
  ...
  - generic [ref=e6]:
    ...
    - generic [ref=e19]:
      - generic [ref=e20] [cursor=pointer]:
        ...
        - text: (read-only)
      - textbox "Readonly with value" [ref=e27]: This field is readonly
    - generic [ref=e30]:
      - generic [ref=e31] [cursor=pointer]:
        - generic [ref=e34]: Readonly with info message
        - text: (read-only)
      - textbox "Readonly with info message" [ref=e38]: Read-only value
      - alert [ref=e40]:
        - generic [ref=e41]:
