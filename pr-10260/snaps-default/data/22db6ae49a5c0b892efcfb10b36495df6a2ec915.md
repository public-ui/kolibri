...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 441px, received 500px by 461px. 17515 pixels (ratio 0.08 of all image pixels) are different.

  Snapshot: snapshot-for-input-text-placeholder-noColumns.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-input-text-placeholder-noColumns.png)" with timeout 10000ms
...
```yaml
- main [ref=e4]:
  - heading "input-text placeholder" [level=1] [ref=e5]
  - generic [ref=e6]:
    - generic [ref=e8]:
      - generic [ref=e12] [cursor=pointer]: First name
      - textbox "First name" [ref=e16]:
        - /placeholder: Enter your first name
    - generic [ref=e19]:
      - generic [ref=e23] [cursor=pointer]: Email address
      - textbox "Email address" [ref=e27]:
        - /placeholder: user@example.com
    - generic [ref=e30]:
      - generic [ref=e34] [cursor=pointer]: Phone number
      - textbox "Phone number" [ref=e38]:
        - /placeholder: +49 123 456789
    - generic [ref=e41]:
      - generic [ref=e45] [cursor=pointer]: Website
      - textbox "Website" [ref=e49]:
        - /placeholder: https://example.com
    - generic [ref=e52]:
      - generic [ref=e56] [cursor=pointer]: Search
