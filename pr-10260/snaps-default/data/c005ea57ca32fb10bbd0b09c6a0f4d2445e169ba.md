...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 379px, received 500px by 395px. 14085 pixels (ratio 0.08 of all image pixels) are different.
  ...
  - generic [ref=e6]:
    - generic [ref=e8]:
      - generic [ref=e9] [cursor=pointer]:
        - generic [ref=e12]: Readonly with placeholder
        - generic [ref=e13]: (read-only)
      - textbox "Readonly with placeholder" [ref=e17]:
        - /placeholder: Placeholder text
    - generic [ref=e20]:
      - generic [ref=e21] [cursor=pointer]:
        - generic [ref=e24]: Readonly with value
        - generic [ref=e25]: (read-only)
      - textbox "Readonly with value" [ref=e29]: This field is readonly
    - generic [ref=e32]:
      - generic [ref=e33] [cursor=pointer]:
        - generic [ref=e36]: Readonly with info message
        - generic [ref=e37]: (read-only)
      - textbox "Readonly with info message" [ref=e41]: Read-only value
      - alert [ref=e43]:
        - generic [ref=e44]:
          - generic [ref=e45]: Note
          - generic [ref=e46]: 
          - generic [ref=e48]: This field cannot be edited
    - generic [ref=e50]:
