...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 434px, received 500px by 442px. 1933 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: snapshot-for-input-radio-object-noColumns.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-input-radio-object-noColumns.png)" with timeout 10000ms
...
- main [ref=e4]:
  - generic [ref=e5]:
    ...
    - generic [ref=e8]:
      - paragraph [ref=e9]:
        - generic [ref=e10]: Form fields marked with an asterisk (*) are mandatory.
      - generic:
        - paragraph [ref=e11]:
          - text: In this example for
          - code [ref=e12]: KolInputRadio
