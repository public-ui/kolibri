...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 356px, received 500px by 372px. 14701 pixels (ratio 0.08 of all image pixels) are different.

  Snapshot: snapshot-for-input-text-access-short-key-noColumns.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-input-text-access-short-key-noColumns.png)" with timeout 10000ms
...
```yaml
- main [ref=e4]:
  - heading "input-text access-short-key" [level=1] [ref=e5]
  - generic [ref=e6]:
    - generic [ref=e8]:
      - generic [ref=e11] [cursor=pointer]:
        - generic [ref=e12]: With access key (Alt+F)
        - generic [ref=e13]: f
      - textbox "With access key (Alt+F)" [ref=e17]: Press Alt+F to focus
    - generic [ref=e20]:
      - generic [ref=e23] [cursor=pointer]:
        - generic [ref=e24]: With short key (Alt+N)
        - generic [ref=e25]: "n"
      - textbox "With short key (Alt+N)" [ref=e29]: Press Alt+N to focus
    - generic [ref=e32]:
      - generic [ref=e35] [cursor=pointer]:
        - generic [ref=e36]: Access key (Alt+E)
        - generic [ref=e37]: e
      - textbox "Access key (Alt+E)" [ref=e41]:
        - /placeholder: Email address
    - generic [ref=e44]:
      - generic [ref=e47] [cursor=pointer]:
        - generic [ref=e48]: Short key (Alt+P)
        - generic [ref=e49]: p
      - textbox "Short key (Alt+P)" [ref=e53]:
