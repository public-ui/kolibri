...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 379px, received 500px by 395px. 11987 pixels (ratio 0.07 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    ...
    - generic [ref=e19]:
      - generic [ref=e23]: Disabled with value
      - textbox "Disabled with value" [disabled] [ref=e27]: This field is disabled
    - generic [ref=e30]:
      - generic [ref=e34]: Disabled with error message
      - textbox "Disabled with error message" [disabled] [ref=e38]: Invalid value
      - alert [ref=e40]:
        - generic [ref=e41]:
          - generic [ref=e42]: Error
          - generic [ref=e43]: 
          - generic [ref=e45]: Error message
    - generic [ref=e47]:
      - generic [ref=e51] [cursor=pointer]: "Comparison: Enabled"
      - 'textbox "Comparison: Enabled" [ref=e55]': This field is enabled
```
