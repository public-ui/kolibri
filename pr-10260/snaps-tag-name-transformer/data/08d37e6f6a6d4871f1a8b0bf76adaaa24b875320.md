...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  912 pixels (ratio 0.01 of all image pixels) are different.
...
- generic [active] [ref=e1]:
  ...
  - main [ref=e81]:
    ...
    - generic [ref=e99]:
      ...
      - generic [ref=e148]:
        - button "Open default toast" [ref=e151] [cursor=pointer]:
          - generic [ref=e154]: Open default toast
        - button "Close all toasts" [ref=e157] [cursor=pointer]:
          - generic [ref=e160]: Close all toasts
```
