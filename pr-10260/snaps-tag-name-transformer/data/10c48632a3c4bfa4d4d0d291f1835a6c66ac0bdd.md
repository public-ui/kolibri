...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 128px, received 500px by 213px. 7307 pixels (ratio 0.07 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    ...
    - generic [ref=e22]:
      - generic [ref=e26] [cursor=pointer]: max length ohne counter?
      - generic [ref=e28]:
        - generic [ref=e30]: 
        - textbox "max length ohne counter?" [ref=e32]: "12"
```
