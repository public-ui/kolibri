...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 700px, received 500px by 736px. 8340 pixels (ratio 0.03 of all image pixels) are different.
  ...
  - generic [active] [ref=e6]:
    ...
    - generic [ref=e28]:
      ...
      - generic [ref=e31]:
        ...
        - button "ScrollTo" [ref=e80] [cursor=pointer]:
          - generic [ref=e83]: ScrollTo
```
