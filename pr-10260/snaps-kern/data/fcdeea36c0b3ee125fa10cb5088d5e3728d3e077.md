...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 321px by 753px, received 321px by 765px. 2708 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: snapshot-for-icon-font.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-icon-font.png)" with timeout 10000ms
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    - generic [ref=e7]:
      - generic [ref=e9]: 
      - generic [ref=e10]: <KolIcon _icons='icon icon-dark-mode' _label="" />
    - generic [ref=e11]:
      - generic [ref=e13]: 
      - generic [ref=e14]: <KolIcon _icons='icon icon-light-mode' _label="" />
    - generic [ref=e15]:
      - generic [ref=e17]: 
      - generic [ref=e18]: <KolIcon _icons='icon icon-brightness-medium' _label="" />
    - generic [ref=e19]:
      - generic [ref=e21]: 
      - generic [ref=e22]: <KolIcon _icons='icon icon-warning' _label="" />
  - generic [ref=e24]:
    - button "Button" [ref=e27] [cursor=pointer]:
      - generic [ref=e29]:
        - generic [ref=e30]: 
        - generic [ref=e31]: Button
    - generic [ref=e32]: <KolButton _icons='icon icon-settings' _label="Button" _variant="primary" />
  - generic [ref=e34]:
    - generic [ref=e36]:
      - generic [ref=e40] [cursor=pointer]: Input with Icon
      - generic [ref=e42]:
        - generic [ref=e44]: 
        - textbox "Input with Icon" [ref=e46]
    - generic [ref=e48]: <KolInputText _icons='icon icon-content-copy' _label="Input with Icon" />
```
