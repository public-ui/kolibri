...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 76px, received 300px by 88px. 1119 pixels (ratio 0.05 of all image pixels) are different.

  Snapshot: snapshot-for-scenarios-focus-elements-component-inputCheckbox.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-scenarios-focus-elements-component-inputCheckbox.png)" with timeout 10000ms
