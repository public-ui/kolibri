...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 546px, received 500px by 570px. 7648 pixels (ratio 0.03 of all image pixels) are different.

  Snapshot: snapshot-for-input-number-number-formatter.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-input-number-number-formatter.png)" with timeout 10000ms
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    - generic [ref=e7]:
      - generic [ref=e9]:
        - paragraph [ref=e10]:
          - generic [ref=e11]: Form fields marked with an asterisk (*) are mandatory.
        - generic [ref=e13]:
          ...
          - generic [ref=e19]:
            ...
            - button [ref=e26] [cursor=pointer]:
              - generic [ref=e27]: 
      - generic [ref=e29]: "{ \"value\": -128, \"touched\": false }"
    - generic [ref=e30]:
      - generic [ref=e32]:
        - paragraph [ref=e33]:
          - generic [ref=e34]: Form fields marked with an asterisk (*) are mandatory.
        - generic [ref=e36]:
          - generic [ref=e40] [cursor=pointer]: Currency
          - textbox "Currency" [ref=e44]: 1,000,000€
      - generic [ref=e46]: "{ \"currency\": 1000000 }"
```
