...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 200px by 504px, received 200px by 516px. 5962 pixels (ratio 0.06 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    ...
    - generic [ref=e34]:
      - strong [ref=e35]:
        - button "With Table" [expanded] [ref=e37] [cursor=pointer]:
          - generic [ref=e39]:
            - generic [ref=e40]: 
            - generic [ref=e41]: With Table
      - region "With Table" [ref=e44]:
        - table "Table for demonstration purposes with different text align properties" [ref=e49]:
          - caption [ref=e50]: Table for demonstration purposes with different text align properties
          - rowgroup [ref=e51]:
            - row "left center right" [ref=e52]:
              - columnheader "left" [ref=e53]
              - columnheader "center" [ref=e54]
              - columnheader "right" [ref=e55]
          - rowgroup [ref=e56]:
