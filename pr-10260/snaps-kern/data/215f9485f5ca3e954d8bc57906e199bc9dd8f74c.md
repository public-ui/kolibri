...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 124px, received 300px by 136px. 4913 pixels (ratio 0.13 of all image pixels) are different.

  Snapshot: snapshot-for-scenarios-focus-elements-component-select.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-scenarios-focus-elements-component-select.png)" with timeout 10000ms
