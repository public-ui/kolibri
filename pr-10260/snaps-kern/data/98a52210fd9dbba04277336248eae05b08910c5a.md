...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 336px, received 800px by 360px. 13272 pixels (ratio 0.05 of all image pixels) are different.
...
- main [ref=e4]:
  - generic [ref=e5]:
    ...
    - group "Combined input field" [ref=e26]:
      - generic [ref=e27]: Combined input field
      - generic [ref=e31]:
      ...
      - generic [ref=e37]:
        - generic [ref=e41] [cursor=pointer]: First input
        - textbox "First input" [ref=e45]
      - generic [ref=e48]:
        - generic [ref=e52] [cursor=pointer]: Second input with error
        - textbox "Second input with error" [ref=e56]
```
