...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 329px, received 500px by 353px. 3655 pixels (ratio 0.03 of all image pixels) are different.
  ...
  - generic [ref=e5]:
    ...
    - generic [ref=e27]:
      ...
      - generic [ref=e30]:
        ...
        - group "Test (horizontal)" [ref=e56]:
          - generic [ref=e60] [cursor=pointer]: Test (horizontal)
          - generic [ref=e61]:
            - radio "Field 1" [ref=e65] [cursor=pointer]
            - radio "Field 2" [ref=e69] [cursor=pointer]
```
