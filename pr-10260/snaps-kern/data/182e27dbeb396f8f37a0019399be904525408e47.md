...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 120px, received 300px by 132px. 5750 pixels (ratio 0.15 of all image pixels) are different.

  Snapshot: snapshot-for-scenarios-focus-elements-component-inputRange.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-scenarios-focus-elements-component-inputRange.png)" with timeout 10000ms
