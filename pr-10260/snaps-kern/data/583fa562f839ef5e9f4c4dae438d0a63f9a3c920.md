...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 170px, received 300px by 182px. 6083 pixels (ratio 0.12 of all image pixels) are different.

  Snapshot: snapshot-for-scenarios-focus-elements-component-selectMultiple.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-scenarios-focus-elements-component-selectMultiple.png)" with timeout 10000ms
