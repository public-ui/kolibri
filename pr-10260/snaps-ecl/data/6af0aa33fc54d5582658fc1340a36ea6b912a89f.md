...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 412px, received 500px by 444px. 12522 pixels (ratio 0.06 of all image pixels) are different.
    ...
    - generic [ref=e30]:
      ...
      - alert [ref=e40]:
        - generic [ref=e41]:
          ...
          - generic [ref=e43]: 
          - generic [ref=e44]: Error message
    - generic [ref=e46]:
      - generic [ref=e50] [cursor=pointer]: "Comparison: Enabled"
      - 'textbox "Comparison: Enabled" [ref=e54]': This field is enabled
```
