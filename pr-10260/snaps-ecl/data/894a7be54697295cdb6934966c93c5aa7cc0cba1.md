...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 618px, received 500px by 642px. 7571 pixels (ratio 0.03 of all image pixels) are different.
  ...
  - generic [active] [ref=e6]:
    - generic [ref=e7]:
      ...
      - navigation "Error list" [ref=e14]:
        - list [ref=e15]:
          - listitem [ref=e16]:
            - link "Error in Input 2" [ref=e18] [cursor=pointer]:
              - /url: javascript:void(0);
              - generic [ref=e21]: Error in Input 2
          - listitem [ref=e22]:
            - link "Error in Input 3" [ref=e24] [cursor=pointer]:
              - /url: javascript:void(0);
              - generic [ref=e27]: Error in Input 3
    - generic [ref=e28]:
      - paragraph [ref=e29]:
        - generic [ref=e30]: Form fields marked with an asterisk (*) are mandatory.
      - generic [ref=e31]:
        - generic [ref=e33]:
          - generic [ref=e37] [cursor=pointer]: Input 1
          - textbox "Input 1" [ref=e41]
        - generic [ref=e44]:
          - generic [ref=e48] [cursor=pointer]: Input 2
          - textbox "Input 2" [ref=e52]
          - alert [ref=e54]:
            - generic [ref=e55]:
              - generic [ref=e56]: Error
              - generic [ref=e57]: 
              - generic [ref=e58]: Input error
        - generic [ref=e60]:
        ...
        - button "ScrollTo" [ref=e78] [cursor=pointer]:
          - generic [ref=e81]: ScrollTo
```
