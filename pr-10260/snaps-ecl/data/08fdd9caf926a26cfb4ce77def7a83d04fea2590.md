...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 301px, received 800px by 317px. 12042 pixels (ratio 0.05 of all image pixels) are different.
...
- main [ref=e4]:
  - generic [ref=e5]:
    ...
    - group "Combined input field" [ref=e25]:
      ...
      - generic [ref=e47]:
        - generic [ref=e51] [cursor=pointer]: Second input with error
        - textbox "Second input with error" [ref=e55]
```
