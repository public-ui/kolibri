...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 110px, received 300px by 133px. 5783 pixels (ratio 0.15 of all image pixels) are different.

  Snapshot: snapshot-for-scenarios-focus-elements-component-inputFile.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-scenarios-focus-elements-component-inputFile.png)" with timeout 10000ms
