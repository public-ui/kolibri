...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 412px, received 500px by 444px. 13709 pixels (ratio 0.07 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    ...
    - generic [ref=e19]:
      - generic [ref=e23] [cursor=pointer]: Readonly with value
      - textbox "Readonly with value" [ref=e27]: This field is readonly
    - generic [ref=e30]:
      - generic [ref=e34] [cursor=pointer]: Readonly with info message
      - textbox "Readonly with info message" [ref=e38]: Read-only value
      - alert [ref=e40]:
        - generic [ref=e41]:
          - generic [ref=e42]: Note
          - generic [ref=e43]: 
          - generic [ref=e44]: This field cannot be edited
    - generic [ref=e46]:
      - generic [ref=e50] [cursor=pointer]: "Comparison: Editable"
      - 'textbox "Comparison: Editable" [ref=e54]': This field is editable
```
