...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 108px, received 300px by 116px. 3193 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: snapshot-for-scenarios-focus-elements-component-inputDate.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-scenarios-focus-elements-component-inputDate.png)" with timeout 10000ms
