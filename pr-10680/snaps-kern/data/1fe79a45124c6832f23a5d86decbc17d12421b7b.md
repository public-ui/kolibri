...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  1755 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: snapshot-for-input-radio-horizontal-noColumns.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-input-radio-horizontal-noColumns.png)" with timeout 10000ms
...
- main [ref=e4]:
  - generic [ref=e5]:
    ...
    - generic [ref=e26]:
      - paragraph [ref=e27]:
        - generic [ref=e28]: Form fields marked with an asterisk (*) are mandatory.
      - generic [ref=e29]:
