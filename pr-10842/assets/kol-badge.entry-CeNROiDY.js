import{_ as e,a as t,dt as n,lt as r,o as i,q as a,s as o,vt as s}from"./index-Dbu5an4X.js";import{n as c}from"./dev.utils-CNUPRHqD-DSUJE956.js";import{t as l}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{t as u}from"./clsx-COFh-Vc8-DWAop4cA.js";import{r as d,t as f}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import"./component-_umTbs5q-BeYMojJ-.js";import"./contrast-CfpcBNuJ-CqlbPBmF.js";import{t as p}from"./component-D8Ih3vau-whO4_A6d.js";import{n as m,t as h}from"./color-Kw-dy30z-CX8zTu1A.js";import{t as g}from"./icons-DcQuwLiH-CW5wsCaD.js";var _=`@charset "UTF-8";
...
}`;a(`[KolBadge] Optimierung des _color-Properties (rgba, rgb, hex usw.).`);var v=class{constructor(e){o(this,e),this.bgColorStr=`#000`,this.colorStr=`#fff`,this.id=c(`badge-label`),this.ctaRef=f(),this._color=`#000`,this.state={_color:{backgroundColor:`#000`,foregroundColor:`#fff`},_icons:{}},this.handleColorChange=e=>{let t=h(e);this.bgColorStr=t.backgroundColor,this.colorStr=t.foregroundColor}}renderSmartButton(t){return i(e,{ref:this.ctaRef,class:`kol-badge__smart-button`,_ariaControls:this.id,_ariaDescription:t._ariaDescription,_variant:t._variant,_customClass:t._customClass,_disabled:t._disabled,_hideLabel:!0,_icons:t._icons,_id:t._id,_label:t._label,_on:t._on,_tooltipAlign:t._tooltipAlign})}async focus(e){}render(){let e=typeof this.state._smartButton==`object`&&this.state._smartButton!==null;return i(`div`,{key:`9de90462ecc0668cf717371caa13f0320481c424`,class:u(`kol-badge`,{"kol-badge--has-smart-button":typeof this.state._smartButton==`object`&&this.state._smartButton!==null}),style:{backgroundColor:this.bgColorStr,color:this.colorStr}},i(p,{key:`0d131ef8109cf96b7d97d547fc2488b9d90e19b2`,class:`kol-badge__label`,id:e?this.id:void 0,allowMarkdown:!0,icons:this.state._icons,label:this._label}),e&&this.renderSmartButton(this.state._smartButton),i(`br`,{key:`1ff1c7c9429960480029c52b844b1cc2b8504a12`}))}validateIcons(e){g(this,e)}validateColor(e){m(this,e,{defaultValue:`#000`,hooks:{beforePatch:this.handleColorChange}})}validateSmartButton(e){r(e,()=>{try{e=n(e)}catch{}s(this,`_smartButton`,e)})}componentWillLoad(){this.validateIcons(this._icons),this.validateColor(this._color),this.validateSmartButton(this._smartButton)}get host(){return t(this)}static get watchers(){return{_icons:[`validateIcons`],_color:[`validateColor`],_smartButton:[`validateSmartButton`]}}};l([d(`ctaRef`)],v.prototype,`focus`,null),v.style={default:_};export{v as kol_badge};