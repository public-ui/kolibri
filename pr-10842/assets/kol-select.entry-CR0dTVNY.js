import{D as e,a as t,o as n,r,s as i}from"./index-T4fuSg0V.js";import{t as a}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{r as o,t as s}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import{t as c}from"./aria-details-hRfn8aN9-C0Iqp789.js";var l=`@charset "UTF-8";
/*
...
}`,u=class{constructor(e){i(this,e),this.ctaRef=s(),this._disabled=!1,this._hideMsg=!1,this._hideLabel=!1,this._hint=``,this._multiple=!1,this._required=!1,this._tooltipAlign=`top`,this._touched=!1}async getValue(){return this.ctaRef.el?.getValue()}async focus(e){}render(){return n(r,{key:`77ae4996531fa00ad5f1f3647524bee884f87d62`,class:`kol-select`},n(e,{key:`2548bcb77e9fd4cd0e53d1ce133bfb2a25c1cd79`,ref:this.ctaRef,_accessKey:this._accessKey,_ariaDetails:this._ariaDetails,_disabled:this._disabled,_hideLabel:this._hideLabel,_hideMsg:this._hideMsg,_hint:this._hint,_icons:this._icons,_infoPopover:this._infoPopover,_label:this._label,_msg:this._msg,_multiple:this._multiple,_name:this._name,_on:this._on,_options:this._options,_required:this._required,_rows:this._rows,_shortKey:this._shortKey,_syncValueBySelector:this._syncValueBySelector,_tabIndex:this._tabIndex,_tooltipAlign:this._tooltipAlign,_touched:this._touched,_value:this._value,_variant:this._variant},n(`slot`,{key:`64a0fe6647427a3016d54757abc6f7df0a9b607e`,name:`expert`,slot:`expert`})))}validateAriaDetails(e){c(this,this.host,void 0,e)}get host(){return t(this)}static get watchers(){return{_ariaDetails:[`validateAriaDetails`]}}};a([o(`ctaRef`)],u.prototype,`focus`,null),u.style={default:l};export{u as kol_select};