import{D as e,a as t,o as n,r,s as i}from"./index-DkwVgvlc.js";import{t as a}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{r as o,t as s}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import{t as c}from"./aria-details-CJRXDn9Y-BMTTaSdL.js";var l=`@charset "UTF-8";
/*
...
}`,u=class{constructor(e){i(this,e),this.ctaRef=s(),this._disabled=!1,this._hideMsg=!1,this._hideLabel=!1,this._hint=``,this._multiple=!1,this._required=!1,this._tooltipAlign=`top`,this._touched=!1}async getValue(){return this.ctaRef.el?.getValue()}async focus(e){}render(){return n(r,{key:`abe68f92a8672001a2536b3d73db4830718f7df9`,class:`kol-select`},n(e,{key:`9a789dfc5faf2f06604870d8314f4989a5761b0c`,ref:this.ctaRef,_accessKey:this._accessKey,_ariaDetails:this._ariaDetails,_disabled:this._disabled,_hideLabel:this._hideLabel,_hideMsg:this._hideMsg,_hint:this._hint,_icons:this._icons,_infoPopover:this._infoPopover,_label:this._label,_msg:this._msg,_multiple:this._multiple,_name:this._name,_on:this._on,_options:this._options,_required:this._required,_rows:this._rows,_shortKey:this._shortKey,_syncValueBySelector:this._syncValueBySelector,_tabIndex:this._tabIndex,_tooltipAlign:this._tooltipAlign,_touched:this._touched,_value:this._value,_variant:this._variant},n(`slot`,{key:`c6571ea450e066038a3876fef039e79ce46dc09b`,name:`expert`,slot:`expert`})))}validateAriaDetails(e){c(this,this.host,void 0,e)}get host(){return t(this)}static get watchers(){return{_ariaDetails:[`validateAriaDetails`]}}};a([o(`ctaRef`)],u.prototype,`focus`,null),u.style={default:l};export{u as kol_select};