...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 561px, received 106px by 1449px. 13390 pixels (ratio 0.02 of all image pixels) are different.
    ...
    - paragraph [ref=e35]:
      ...
      - link "Simple Link" [ref=e38] [cursor=pointer]:
        ...
        - generic [ref=e40]:
          ...
          - generic [ref=e42]: S
      - text: . This allows you to assign width, height, and other properties to it using CSS styles.After that, there is a link that is rendered as a block element.
