...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 452px, received 240px by 980px. 20891 pixels (ratio 0.03 of all image pixels) are different.
...
```yaml
- main [ref=e1]:
  - heading "details basic" [level=1] [ref=e2]
  - generic:
    - strong [ref=e5]:
      - button "Closed initially" [ref=e7] [cursor=pointer]:
        - generic [ref=e9]:
          - generic [ref=e10]: 
          - generic [ref=e11]: Closed initially
    - generic [ref=e13]:
      - strong [ref=e14]:
        - button "Open initially (disabled)" [disabled] [expanded] [ref=e16]:
          - generic [ref=e18]:
            - generic [ref=e19]: 
            - generic [ref=e20]: Open initially (disabled)
      - region "Open initially (disabled)" [ref=e23]:
        - paragraph [ref=e24]: Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt.
    - generic [ref=e26]:
      - strong [ref=e27]:
        - button "Open initially" [expanded] [ref=e29] [cursor=pointer]:
          - generic [ref=e31]:
            - generic [ref=e32]: 
            - generic [ref=e33]: Open initially
      - region "Open initially" [ref=e36]:
        - paragraph [ref=e37]: Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt.
```
