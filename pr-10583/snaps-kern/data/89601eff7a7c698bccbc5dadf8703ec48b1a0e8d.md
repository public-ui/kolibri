...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 368px, received 97px by 1766px. 75096 pixels (ratio 0.06 of all image pixels) are different.
...
- main [ref=e1]:
  ...
  - generic:
    - generic [ref=e3]:
      - heading "Disabled Buttons" [level=2] [ref=e5]
      - generic [ref=e6]:
    ...
    - generic [ref=e49]:
      - 'heading "Comparison: Enabled vs Disabled" [level=2] [ref=e51]'
      - generic [ref=e52]:
