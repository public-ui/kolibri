...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 88px, received 99px by 280px. 2870 pixels (ratio 0.02 of all image pixels) are different.
        ...
        - list:
          - listitem:
            - link "To the top" [ref=e5] [cursor=pointer]:
              - /url: "#/back-page"
          - listitem:
            - link "To the form" [ref=e9] [cursor=pointer]:
              - /url: "#/back-page"
          - listitem:
            - link "To the end" [ref=e13] [cursor=pointer]:
              - /url: "#/back-page"
```
