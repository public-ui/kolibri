...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 506px, received 70px by 3314px. 19468 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: snapshot-for-accordion-basic.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-accordion-basic.png)" with timeout 10000ms
...
```yaml
- main [ref=e1]:
  - heading "accordion basic" [level=1] [ref=e2]
  - generic:
    - generic [ref=e4]:
      - strong [ref=e5]:
        - button "Heading Accordion Tab 1 (open)" [expanded] [ref=e7] [cursor=pointer]:
          - generic [ref=e9]:
            - generic [ref=e10]: 
            - generic [ref=e11]: Heading Accordion Tab 1 (open)
      - region "Heading Accordion Tab 1 (open)" [ref=e14]:
        - paragraph [ref=e15]: Contents Accordion Tab 1
    - strong [ref=e18]:
      - button "Heading Accordion Tab 2" [ref=e20] [cursor=pointer]:
        - generic [ref=e22]:
          - generic [ref=e23]: 
          - generic [ref=e24]: Heading Accordion Tab 2
    - strong [ref=e27]:
      - button "Heading Accordion Tab 3 (deactivated)" [disabled] [ref=e29]:
        - generic [ref=e31]:
          - generic [ref=e32]: 
          - generic [ref=e33]: Heading Accordion Tab 3 (deactivated)
    - generic [ref=e35]:
      - strong [ref=e36]:
        - button "Heading Accordion Tab 4 (disabled and open)" [disabled] [expanded] [ref=e38]:
          - generic [ref=e40]:
            - generic [ref=e41]: 
            - generic [ref=e42]: Heading Accordion Tab 4 (disabled and open)
      - region "Heading Accordion Tab 4 (disabled and open)" [ref=e45]:
        - paragraph [ref=e46]: Contents Accordion Tab 4
```
