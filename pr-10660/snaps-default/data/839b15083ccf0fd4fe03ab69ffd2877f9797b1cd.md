...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  1873 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: snapshot-for-card-linked.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-card-linked.png)" with timeout 10000ms
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    - article "Card with title and content" [ref=e9]:
      - link "Card with title and content" [ref=e10] [cursor=pointer]:
        - /url: "#/back-page"
        - strong [ref=e11]: Card with title and content
      - paragraph [ref=e13]: This card has a link.
    - article "Card with title and content" [ref=e16]:
      - link "Card with title and content" [ref=e17] [cursor=pointer]:
        - /url: "#/back-page"
        - strong [ref=e18]: Card with title and content
      - paragraph [ref=e20]: This card has a link and a target.
```
