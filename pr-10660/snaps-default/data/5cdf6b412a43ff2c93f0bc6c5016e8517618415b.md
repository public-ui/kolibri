...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  1413 pixels (ratio 0.05 of all image pixels) are different.

  Snapshot: snapshot-for-scenarios-focus-elements-component-card.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-scenarios-focus-elements-component-card.png)" with timeout 10000ms
