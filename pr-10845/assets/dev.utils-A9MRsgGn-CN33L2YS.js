import{L as e,Q as t,X as n,_t as r,ht as i,it as a,t as o}from"./index-4VHeixsR.js";var s=()=>{try{let e=n();if(!e||typeof e.querySelector!=`function`)return;let t=e.querySelector(`meta[name="kolibri"]`);if(t&&t.hasAttribute(`content`)){let e=t.getAttribute(`content`);typeof e==`string`&&(r(e.includes(`experimental-mode=true`)),i(e.includes(`color-contrast-analysis=true`)))}}catch{}},c=()=>{let e=t().KoliBri;return e===void 0&&(e={},Object.defineProperty(t(),"KoliBri",{value:e,writable:!1})),e},l=()=>{s(),e.debug(`
,--. ,--.         ,--. ,--. ,-----.           ,--.
|  .'   /  ,---.  |  | \`--' |  |) /_  ,--.--. \`--'
|  .   '  | .-. | |  | ,--. |  .-.  \\ |  .--' ,--.
|  |\\   \\ | '-' | |  | |  | |  '--' / |  |    |  |
