import{St as e,U as t,_t as n,a as r,c as i,d as a,o,r as s,s as c,u as l}from"./index-CC5JgMeE.js";import{i as u}from"./dev.utils-3xMYti16-DWKImxZT.js";import{n as d,t as f}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as p}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./label-DxrksC9L-CWo1vNkH.js";import{r as m,t as h}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{i as g,n as _}from"./normalizers-DEevvNbZ-CqZsdy5b.js";import"./i18n-DuzgYBgD-J4nNRT6N.js";import"./component-Dq3RdBMb-Bdsc60Jo.js";import"./label-De6GKT_4-CgnNDwmd.js";import"./variant-quote-JfuelQ4I-D8ZpsWHK.js";import{t as v}from"./label-with-expert-slot-pcKVBAqt-DeAjVewQ.js";import"./align-DglmQnOH-D8LD2IUe.js";import{a as y,c as b,f as x,h as S,i as C,l as w,m as T,p as E,r as D,u as O}from"./component-Dneay8dg-zsVfguJe.js";import"./variant-class-name-BFZvmFM_-DEDRX26P.js";import"./component-d--MHZEE-BuIHsknp.js";import"./component-ByZavll8-KUSqoe4J.js";import"./align-floating-elements-D6Kc-f8P-6WdiQa90.js";import{t as k}from"./behavior-opTsLlOg-B1OwYUhB.js";import{t as A}from"./href-Dhe7Bhko-C3d6s6dg.js";import{a as j,i as M,n as N,o as P,s as F,t as I}from"./api-CRvPDrQj-ButV15Gc.js";import{t as L}from"./access-and-short-key-ijzCZfHm-Dx5Q-CAn.js";import{n as R,t as z}from"./unique-nav-labels-DdDotOG6-SE7W6gXk.js";var B=_(`links`,[],e=>g(e),e=>e.every(e=>typeof e==`object`&&(typeof e._href==`string`||typeof e._label==`string`)),{hints:(t,n)=>e(`KolSkipNav`,n.length)}),V={required:[B,v]},H=a.forBlock(`kol-skip-nav`),U=H(),W=H(`list`),G=H(`list-item`),K=({label:e,linkItems:t})=>o(`nav`,{class:U,"aria-label":e},o(`ul`,{class:W},t.map((e,t)=>o(`li`,{class:G,key:t},o(I,Object.assign({},e.fcProps)))))),q=(e,t)=>{let r=new k(f.stateLess),a=h(),o=d(P);delete o.tabIndex;let s=(e,t)=>e.apply(t,t=>{o[e.propName]=t});s(D,e._accessKey),s(C,e._ariaControls),s(N,e._ariaCurrentValue),s(y,e._ariaDescription),s(b,e._disabled),s(M,e._download),s(w,e._hideLabel),s(A,e._href),s(E,e._icons),s(O,e._inline??!0),s(v,e._label),s(j,e._on),s(x,e._shortKey),typeof e._tabIndex==`number`&&s(T,e._tabIndex),s(F,e._target),s(S,e._tooltipAlign),L(e._accessKey,e._shortKey),r.componentWillLoad({label:(()=>{let e=o.label;if(typeof e==`string`&&e.length>0)return e;let t=o.href;return typeof t==`string`?t:``})(),align:o.tooltipAlign}),o.ariaCurrent=``,o.ariaDescriptionId=u(),o.expertSlot=e._label===``;let c=()=>typeof o.href==`string`?o.href:``;return o.handleAnchorClick=e=>{if(r.hideTooltip(),o.disabled===!0){e.preventDefault();return}let s=c(),u=o.on;typeof u?.onClick==`function`&&(n(e,a.el),u.onClick(e,s));let d=t();d&&l(d,i.click,s)},o.refAnchor=e=>{a(e)},o.refTooltip=r.setTooltipElementRef,{fcProps:o,getAnchor:()=>a.el,syncTooltipListeners:()=>{a.el&&r.syncListeners(void 0,a.el,!0)},destroy:()=>{r.destroy()}}},J=`@charset "UTF-8";
