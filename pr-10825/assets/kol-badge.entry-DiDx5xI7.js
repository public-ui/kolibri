import{J as e,a as t,ft as n,o as r,s as i,ut as a,v as o,yt as s}from"./index-BBMLONQZ.js";import{n as c}from"./dev.utils-A9MRsgGn-B6n0lBxC.js";import{t as l}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{t as u}from"./clsx-COFh-Vc8-DWAop4cA.js";import{r as d,t as f}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import"./component-CFj3Bexm-B7YNFIHo.js";import"./contrast-BMisfone-Bux6ljqR.js";import{t as p}from"./component-CRnCniDf-BaozdTlY.js";import{n as m,t as h}from"./color-DmnTebHy-C-0W7nCM.js";import{t as g}from"./icons-CbRjDakd-DWjHiEOV.js";var _=`@charset "UTF-8";
...
}`;e(`[KolBadge] Optimierung des _color-Properties (rgba, rgb, hex usw.).`);var v=class{constructor(e){i(this,e),this.bgColorStr=`#000`,this.colorStr=`#fff`,this.id=c(`badge-label`),this.ctaRef=f(),this._color=`#000`,this.state={_color:{backgroundColor:`#000`,foregroundColor:`#fff`},_icons:{}},this.handleColorChange=e=>{let t=h(e);this.bgColorStr=t.backgroundColor,this.colorStr=t.foregroundColor}}renderSmartButton(e){return r(o,{ref:this.ctaRef,class:`kol-badge__smart-button`,_ariaControls:this.id,_ariaDescription:e._ariaDescription,_variant:e._variant,_customClass:e._customClass,_disabled:e._disabled,_hideLabel:!0,_icons:e._icons,_id:e._id,_label:e._label,_on:e._on,_tooltipAlign:e._tooltipAlign})}async focus(e){}render(){let e=typeof this.state._smartButton==`object`&&this.state._smartButton!==null;return r(`div`,{key:`9de90462ecc0668cf717371caa13f0320481c424`,class:u(`kol-badge`,{"kol-badge--has-smart-button":typeof this.state._smartButton==`object`&&this.state._smartButton!==null}),style:{backgroundColor:this.bgColorStr,color:this.colorStr}},r(p,{key:`0d131ef8109cf96b7d97d547fc2488b9d90e19b2`,class:`kol-badge__label`,id:e?this.id:void 0,allowMarkdown:!0,icons:this.state._icons,label:this._label}),e&&this.renderSmartButton(this.state._smartButton),r(`br`,{key:`1ff1c7c9429960480029c52b844b1cc2b8504a12`}))}validateIcons(e){g(this,e)}validateColor(e){m(this,e,{defaultValue:`#000`,hooks:{beforePatch:this.handleColorChange}})}validateSmartButton(e){a(e,()=>{try{e=n(e)}catch{}s(this,`_smartButton`,e)})}componentWillLoad(){this.validateIcons(this._icons),this.validateColor(this._color),this.validateSmartButton(this._smartButton)}get host(){return t(this)}static get watchers(){return{_icons:[`validateIcons`],_color:[`validateColor`],_smartButton:[`validateSmartButton`]}}};l([d(`ctaRef`)],v.prototype,`focus`,null),v.style={default:_};export{v as kol_badge};