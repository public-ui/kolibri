import{c as e,r as t,s as n}from"./index-DcDxiC7I-BjOnfrN3.js";import{g as r,i}from"./index-B-rIfgz_.js";import{t as a}from"./base-web-component--IgFgz37-CZuvR3uB.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{f as o,m as s,r as c}from"./variant-quote-g1yu-uOI-ZlSLrj5V.js";import"./label-BDgaSpkn-AOyhaYtA.js";import{t as l}from"./label-04api6ef-BuJEdNvB.js";import{t as u}from"./href-tBKQXlhZ-DA3wMo88.js";var d=c(`quote`,``,o),f={optional:[l,s],required:[u,d]},p=i.forBlock(`kol-quote`),m=p(`blockquote`),h=p(`cite`),g=p(`figcaption`),_=p(`quote`),v=e=>{let{href:t,label:i,quote:a,variant:o}=e,s=a===``,c=p({[o]:!0});return n(`figure`,{class:c},o===`block`?n(`blockquote`,{class:m,cite:t},a,n(`span`,{"aria-hidden":s?void 0:`true`,hidden:!s},n(`slot`,{name:`expert`}))):n(`q`,{class:_,cite:t},a,n(`span`,{"aria-hidden":s?void 0:`true`,hidden:!s},n(`slot`,{name:`expert`}))),typeof i==`string`&&i.length>0&&n(`figcaption`,{class:g},n(`cite`,{class:h},n(r,{_href:t,_label:i,_target:`_blank`}))))},y=`@charset "UTF-8";
