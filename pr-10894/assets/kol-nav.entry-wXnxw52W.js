import{Ct as e,G as t,T as n,U as r,o as i,s as a,v as o}from"./index-BW1oLv3r.js";import{n as s,t as c}from"./dev.utils-vg27Ig_f-BoIIhOHj.js";import{r as l}from"./label-DQP9fH5r-DqYZgPLr.js";import{t as u}from"./clsx-COFh-Vc8-DWAop4cA.js";import{t as d}from"./i18n-BwqAqpKC-DAhfB0ao.js";import{n as f,t as p}from"./unique-nav-labels-Dhm4SQU8-IP90q4xb.js";import{t as m}from"./hide-label-sHkGD_L7-CuCf16Ol.js";import{t as h}from"./validation-JzDpw8Fx-V8DzDxkj.js";var g=(t,n)=>{e(t,`_collapsible`,n)},_=(t,n)=>{e(t,`_hasCompactButton`,n)},v=(t,n)=>{e(t,`_hasIconsWhenExpanded`,n)},y=`@charset "UTF-8";
...
}`,b=e=>typeof e._href==`string`,x=e=>e._href===void 0&&typeof e._on?.onClick==`function`,S=class{constructor(e){a(this,e),this.navId=s(`kol-nav`),this.listId=c(this.navId,`list`),this.handleToggleExpansionClick=e=>{e&&(this.state._expandedChildren.includes(e)?this.collapseChildren(e):this.expandChildren(e))},this.linkList=e=>i(`ul`,{class:u(`kol-nav__list`,{"kol-nav__list--nested":e.deep>0,"kol-nav__list--vertical":e.deep!==0}),id:e.deep>0?e.id:void 0},e.links.map((t,n)=>this.li(e.collapsible,e.deep,n,t,e.id))),this._collapsible=!0,this._hasCompactButton=!1,this._hasIconsWhenExpanded=!1,this._hideLabel=!1,this.state={_collapsible:!0,_hasCompactButton:!1,_hasIconsWhenExpanded:!1,_hideLabel:!1,_label:``,_links:[],_expandedChildren:[]}}expandChildren(e){this.state=Object.assign(Object.assign({},this.state),{_expandedChildren:[...this.state._expandedChildren,e]})}collapseChildren(e){this.state=Object.assign(Object.assign({},this.state),{_expandedChildren:this.state._expandedChildren.filter(t=>t!==e)})}buildIconObject(e,t,n){let r={left:``,right:``};return this.state._hasIconsWhenExpanded&&n&&(r.left=n),this.state._hideLabel&&(r.left=n||`kolicon-link`),e&&(r.right=t?`kolicon-minus`:`kolicon-plus`),r}entry(e,t,r,a,s){let c=typeof r._icons==`string`?r._icons:typeof r._icons?.left==`string`?r._icons.left:void 0,l=this.buildIconObject(e&&t,a,c);return i(`div`,{class:`kol-nav__entry-wrapper`},b(r)?i(n,Object.assign({class:u(`kol-nav__entry kol-nav__entry--link`,{"kol-nav__entry--collapsible":e})},r,{_hideLabel:this.state._hideLabel,_icons:l,_ariaControls:e&&t&&a?s:void 0,_ariaExpanded:e&&t?a:void 0})):i(o,{class:u(`kol-nav__entry kol-nav__entry--button`,{"kol-nav__entry--collapsible":e}),_label:r._label,_hideLabel:this.state._hideLabel,_icons:l,_ariaControls:e&&t&&a?s:void 0,_ariaExpanded:e&&t?a:void 0,_on:{onClick:(e,t)=>{x(r)&&typeof r._on.onClick==`function`&&r._on.onClick(e,t),this.handleToggleExpansionClick(r._children)}}}))}li(e,t,n,r,a){let o=!!r._active,s=Array.isArray(r._children)&&r._children.length>0,l=!!(r._children&&this.state._expandedChildren.includes(r._children)),d=c(a,`${t}-${n}`);return i(`li`,{class:u(`kol-nav__list-item`,{"kol-nav__list-item--active":o,"kol-nav__list-item--expanded":l,"kol-nav__list-item--has-children":s}),key:n},this.entry(e,s,r,l,d),l&&i(this.linkList,{collapsible:e,deep:t+1,links:r._children||[],id:d}))}initializeExpandedChildren(){this.state=Object.assign(Object.assign({},this.state),{_expandedChildren:[]});let e=t=>{if(t._active)return t._children&&this.expandChildren(t._children),!0;if(t._children){for(let n of t._children)if(e(n))return this.expandChildren(t._children),!0}return!1};this.state._links.forEach(e)}render(){let e=this.state._collapsible===!0;return i(`div`,{key:`d8a3c9d66d0b0e853e9d478529494f1848aa9879`,class:u(`kol-nav`,{"kol-nav--is-compact":this.state._hideLabel})},i(`nav`,{key:`3145a472288154e56d64947877a24e78814b0d39`,"aria-label":this.state._label,class:`kol-nav__navigation`,id:this.navId},i(this.linkList,{key:`fe0203bf05c5e49786c5a8d9c994a6b2e88da423`,collapsible:e,deep:0,links:this.state._links,id:this.listId})),this.state._hasCompactButton&&i(`div`,{key:`e8e9fd03debcb9941a39b197518396d4bd8b46f8`,class:`kol-nav__compact`},i(o,{key:`3751525bc51f54fc601c8010f22b2f1d1c2a2e0c`,class:`kol-nav__toggle-button`,_ariaControls:this.navId,_ariaExpanded:!this.state._hideLabel,_icons:this.state._hideLabel?`kolicon-chevron-right`:`kolicon-chevron-left`,_hideLabel:!0,_label:this.state._hideLabel?d(`kol-nav-maximize`):d(`kol-nav-minimize`),_on:{onClick:()=>{this.state=Object.assign(Object.assign({},this.state),{_hideLabel:!this.state._hideLabel})}},_tooltipAlign:`right`})))}validateCollapsible(e){g(this,e)}validateHasCompactButton(e){_(this,e)}validateHasIconsWhenExpanded(e){v(this,e)}validateHideLabel(e){m(this,e)}validateLabel(e,t,n=!1){n||f(this.state._label),l(this,e,{required:!0}),r(e),p(this.state._label)}validateLinks(e){h(`KolNav`,this,e),t(`[KolNav] The navigation structure is not yet validated recursively.`),this.initializeExpandedChildren()}componentWillLoad(){this.validateCollapsible(this._collapsible),this.validateHideLabel(this._hideLabel),this.validateHasCompactButton(this._hasCompactButton),this.validateHasIconsWhenExpanded(this._hasIconsWhenExpanded),this.validateLabel(this._label,void 0,!0),this.validateLinks(this._links),this.initializeExpandedChildren()}disconnectedCallback(){f(this.state._label)}static get watchers(){return{_collapsible:[`validateCollapsible`],_hasCompactButton:[`validateHasCompactButton`],_hasIconsWhenExpanded:[`validateHasIconsWhenExpanded`],_hideLabel:[`validateHideLabel`],_label:[`validateLabel`],_links:[`validateLinks`]}}};S.style={default:y};export{S as kol_nav};