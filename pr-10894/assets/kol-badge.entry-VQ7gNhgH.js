import{B as e,J as t,_t as n,a as r,c as i,d as a,ft as o,o as s,r as c,s as l,u,ut as d}from"./index-0e2C-qJw.js";import{i as f,n as p}from"./dev.utils-vg27Ig_f-olL1uWfs.js";import{n as m,t as h}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as g}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./_Uint8Array-kJnEuTzT-BYXN1zbF.js";import{r as ee}from"./factory-CA4gfImU-CnF9P1LC.js";import{t as _}from"./block-bem-D-vtzDos-MwyQpqGZ.js";import"./label-DQP9fH5r-PcQik2Qf.js";import"./label-Dqv37gCG-CGLv2w-f.js";import"./variant-quote-B6S4ZebR-bRN8kW_8.js";import"./component-DJJa0Eke-OjIL4hEc.js";import{t as v}from"./component-BS4RD5Nj-B2xLQPg7.js";import{r as y,t as b}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./index-BSUMLd4d-BxCutrbV.js";import{t as x}from"./color-B69Vfupy-DF17lRtV.js";import{t as S}from"./label-with-expert-slot-oNSDxaPk-VA1grf6G.js";import"./align-lbYx-vvu-BxC_ab9-.js";import{a as C,c as w,d as T,f as E,h as D,i as O,l as k,m as A,o as j,p as M,r as N,s as P,u as F}from"./component-Dmoa74gb-DChObGKu.js";import"./variant-class-name-BG-fhwg4-CE6FaYqq.js";import"./component-DBLRWX9x-BnlCbodm.js";import"./align-floating-elements-BG_1SL89-Cz5H3OI4.js";import{n as I,t as L}from"./behavior-CZppoCzR-BaLAzRpy.js";import{t as R}from"./name-D4L8iTOY-KZhIjsOU.js";import{a as z,i as B,o as V,r as H,t as U}from"./api-BDd7Nz_K-Dvy8gY2o.js";function W(e){let t=typeof e==`string`?o(e):e;if(typeof t==`object`&&t)return t;throw Error(`Invalid smart button: ${typeof e}`)}var G=ee(`smartButton`,{_label:``},W),K={required:[S],optional:[x,G,E]},q=a.forBlock(`kol-badge`),J=q(`label`),Y=q(`smart-button`),X=e=>{let{ariaDescriptionId:t,color:n,handleBlur:r,handleClick:i,handleFocus:a,handleMouseDown:o,icons:c,label:l,labelId:u,refSmartButton:d,refTooltip:f,smartButton:p,smartButtonProps:m}=e,h=typeof p==`object`&&!!p&&m!==void 0;return s(`div`,{class:q({"has-smart-button":h}),style:{backgroundColor:n.backgroundColor,color:n.foregroundColor}},s(v,{class:J,id:h?u:void 0,allowMarkdown:!0,icons:c,label:l}),h&&s(U,Object.assign({},m,{class:Y,ariaDescriptionId:t,handleBlur:r,handleClick:i,handleFocus:a,handleMouseDown:o,refButton:d,refTooltip:f})),s(`br`,null))},Z={disabled:!1,hideLabel:!1,inline:!1,tooltipAlign:`top`,type:`button`};function Q(t,n){let r=m(z),i=e=>t=>{r[e]=t};return S.apply(t._label,i(`label`)),N.apply(t._accessKey,i(`accessKey`)),O.apply(t._ariaControls,i(`ariaControls`)),C.apply(t._ariaDescription,i(`ariaDescription`)),j.apply(t._ariaExpanded,i(`ariaExpanded`)),H.apply(t._ariaSelected,i(`ariaSelected`)),B.apply(t._on,i(`on`)),V.apply(t._type??Z.type,i(`type`)),P.apply(t._customClass,i(`customClass`)),_.apply(t._disabled??Z.disabled,i(`disabled`)),w.apply(t._hideLabel??Z.hideLabel,i(`hideLabel`)),I.apply(t._id,i(`id`)),k.apply(t._inline??Z.inline,i(`inline`)),F.apply(t._role,i(`role`)),R.apply(t._name,i(`name`)),T.apply(t._shortKey,i(`shortKey`)),E.apply(t._icons,i(`icons`)),A.apply(t._tooltipAlign??Z.tooltipAlign,i(`tooltipAlign`)),typeof t._tabIndex==`number`?M.apply(t._tabIndex,i(`tabIndex`)):r.tabIndex=void 0,D.apply(t._variant??e(`buttonVariantDefault`,n)??`normal`,i(`variant`)),r}var te=`@charset "UTF-8";
