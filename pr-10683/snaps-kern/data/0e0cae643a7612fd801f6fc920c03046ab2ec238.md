...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 500px by 492px, received 500px by 496px. 5653 pixels (ratio 0.03 of all image pixels) are different.
  ...
  - generic [ref=e5]:
    ...
    - generic [ref=e8]:
      ...
      - generic:
        ...
        - group "Test (without value)" [ref=e41]:
          - generic [ref=e45] [cursor=pointer]: Test (without value)
          - generic [ref=e46]:
            - generic [ref=e47]:
              - radio "Field 1" [ref=e50] [cursor=pointer]
              - generic [ref=e54] [cursor=pointer]: Field 1
            - generic [ref=e55]:
              - radio "Field 2" [ref=e58] [cursor=pointer]
              - generic [ref=e62] [cursor=pointer]: Field 2
```
