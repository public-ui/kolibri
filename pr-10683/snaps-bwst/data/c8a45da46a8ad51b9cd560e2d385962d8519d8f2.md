...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1000px by 83px, received 1000px by 85px. 963 pixels (ratio 0.02 of all image pixels) are different.
...
- main [ref=e4]:
  - generic [ref=e5]:
    ...
    - paragraph [ref=e8]: This theme has no variants for tables.
```
