...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 284px, received 800px by 286px. 7570 pixels (ratio 0.04 of all image pixels) are different.

  Snapshot: snapshot-for-input-text-hide-msg-noColumns.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-input-text-hide-msg-noColumns.png)" with timeout 10000ms
...
- main [ref=e4]:
  - generic [ref=e5]:
    ...
    - generic [ref=e9]:
      - generic [ref=e13] [cursor=pointer]: Input with error
      - textbox "Input with error" [ref=e17]
      - alert [ref=e18]:
        - generic [ref=e19]: Error
        - generic [ref=e20]: 
        - generic [ref=e21]: Error message
    - group "Combined input field" [ref=e23]:
      - generic [ref=e24]: Combined input field
      - generic [ref=e27]:
