...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 118px, received 800px by 120px. 1179 pixels (ratio 0.02 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    ...
    - paragraph [ref=e13]: This theme has no variants for this component.
```
