...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 76px, received 300px by 77px. 1656 pixels (ratio 0.08 of all image pixels) are different.

  Snapshot: snapshot-for-scenarios-focus-elements-component-popoverButton.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-scenarios-focus-elements-component-popoverButton.png)" with timeout 10000ms
