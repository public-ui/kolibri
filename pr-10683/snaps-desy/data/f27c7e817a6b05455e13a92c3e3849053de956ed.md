...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  4010 pixels (ratio 0.03 of all image pixels) are different.
  ...
  - generic [ref=e6]:
    ...
    - generic [ref=e28]:
      ...
      - alert [ref=e37]:
        ...
        - text: Error message
    - generic [ref=e41]:
      - generic [ref=e45] [cursor=pointer]: "Comparison: Enabled"
      - 'textbox "Comparison: Enabled" [ref=e49]': This field is enabled
```
