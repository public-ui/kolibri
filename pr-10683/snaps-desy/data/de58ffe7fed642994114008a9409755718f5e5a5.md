...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  7266 pixels (ratio 0.05 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e7]:
    ...
    - generic [ref=e10]:
      - button "primary" [ref=e13] [cursor=pointer]:
        - generic [ref=e15]:
          - generic [ref=e16]: 
      ...
      - button "tertiary" [ref=e27] [cursor=pointer]:
        - generic [ref=e29]:
          - generic [ref=e30]: 
          - generic [ref=e31]: tertiary
      - button "normal" [ref=e34] [cursor=pointer]:
        - generic [ref=e36]:
          - generic [ref=e37]: 
          - generic [ref=e38]: normal
      - button "danger" [ref=e41] [cursor=pointer]:
        - generic [ref=e43]:
          - generic [ref=e44]: 
          - generic [ref=e45]: danger
      - button "ghost" [ref=e48] [cursor=pointer]:
        - generic [ref=e50]:
          - generic [ref=e51]: 
          - generic [ref=e52]: ghost
    - generic [ref=e53]:
      - button "primary" [ref=e56] [cursor=pointer]:
        - generic [ref=e59]: 
      - button "secondary" [ref=e62] [cursor=pointer]:
        - generic [ref=e65]: 
      - button "tertiary" [ref=e68] [cursor=pointer]:
        - generic [ref=e71]: 
      - button "normal" [ref=e74] [cursor=pointer]:
        - generic [ref=e77]: 
      - button "danger" [ref=e80] [cursor=pointer]:
        - generic [ref=e83]: 
      - button "ghost" [ref=e86] [cursor=pointer]:
        - generic [ref=e89]: 
```
