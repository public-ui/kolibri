...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 495px, received 800px by 507px. 15997 pixels (ratio 0.04 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - figure [ref=e7]:
    - generic [ref=e8]: Avian carriers can provide high delay.
```
