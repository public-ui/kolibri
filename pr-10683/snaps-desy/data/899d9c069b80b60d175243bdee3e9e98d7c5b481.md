...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 53px, received 300px by 54px. 523 pixels (ratio 0.04 of all image pixels) are different.

  Snapshot: snapshot-for-scenarios-focus-elements-component-link.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-scenarios-focus-elements-component-link.png)" with timeout 10000ms
