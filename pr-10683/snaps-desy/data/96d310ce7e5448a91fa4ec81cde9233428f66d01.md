...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 223px, received 800px by 216px. 13331 pixels (ratio 0.08 of all image pixels) are different.
