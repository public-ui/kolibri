...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 270px, received 800px by 271px. 9050 pixels (ratio 0.05 of all image pixels) are different.
  ...
  - generic [ref=e5]:
    ...
    - generic [ref=e9]:
      ...
      - alert [ref=e18]:
        ...
        - generic [ref=e20]: 
        - text: Error message
    - group "Combined input field" [ref=e22]:
      - generic [ref=e23]: Combined input field
      - generic [ref=e26]:
      ...
      - generic [ref=e31]:
        - generic [ref=e35] [cursor=pointer]: First input
        - textbox "First input" [ref=e39]
      - generic [ref=e41]:
        - generic [ref=e45] [cursor=pointer]: Second input with error
        - textbox "Second input with error" [ref=e49]
```
