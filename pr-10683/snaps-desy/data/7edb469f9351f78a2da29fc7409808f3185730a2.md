...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 229px, received 800px by 241px. 20659 pixels (ratio 0.11 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e7]:
    ...
    - generic [ref=e10]:
      - generic [ref=e13]:
        - generic [ref=e14]: Storage used
        - meter "Storage used" [ref=e16]
        - generic [ref=e17]:
          - generic [ref=e18]: "50"
          - text: "%"
      - generic [ref=e21]:
        - generic [ref=e22]: Weight
        - meter "Weight" [ref=e24]
        - generic [ref=e25]:
          - generic [ref=e26]: "75"
          - text: kg
      - generic [ref=e29]:
        - generic [ref=e30]: Temperature
        - meter "Temperature" [ref=e32]
        - generic [ref=e33]:
          - generic [ref=e34]: "-50"
          - text: °C
```
