...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  3618 pixels (ratio 0.05 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e8]:
    - heading "This is a H1 headline" [level=1] [ref=e9]: This is a H1 headline
    - paragraph [ref=e10]: This is a secondary headline
```
