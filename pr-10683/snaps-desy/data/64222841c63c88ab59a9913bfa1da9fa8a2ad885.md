...
- Name: theme-snapshots.spec.js >> snapshot for spin/custom
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 100px by 84px, received 100px by 85px. 

  Snapshot: snapshot-for-spin-custom.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-spin-custom.png)" with timeout 10000ms
...
```yaml
- main [ref=e4]:
  - heading "spin custom" [level=1] [ref=e5]
  - alert [ref=e9]: Action is running...
```
