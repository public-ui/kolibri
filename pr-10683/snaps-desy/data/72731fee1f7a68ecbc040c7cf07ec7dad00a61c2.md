...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  10911 pixels (ratio 0.03 of all image pixels) are different.

  Snapshot: snapshot-for-scenarios-same-height-of-all-form-elements-with-label.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-scenarios-same-height-of-all-form-elements-with-label.png)" with timeout 10000ms
