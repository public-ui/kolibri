...
- Name: theme-snapshots.spec.js >> snapshot for scenarios/focus-elements?component=toolbar
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 71px, received 300px by 70px. 1745 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: snapshot-for-scenarios-focus-elements-component-toolbar.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-scenarios-focus-elements-component-toolbar.png)" with timeout 10000ms
...
```yaml
- main [ref=e4]:
  - toolbar "Toolbar here" [ref=e7]:
    - button "Action 1" [ref=e9] [cursor=pointer]:
      - generic [ref=e12]: Action 1
    - button "Action 2" [ref=e14] [cursor=pointer]:
      - generic [ref=e17]: Action 2
```
