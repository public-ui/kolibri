...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 276px, received 800px by 277px. 8201 pixels (ratio 0.04 of all image pixels) are different.
...
- main [ref=e4]:
  - generic [ref=e5]:
    ...
    - group "Street Address" [ref=e25]:
      - generic [ref=e26]: Street Address
      - generic [ref=e29]:
