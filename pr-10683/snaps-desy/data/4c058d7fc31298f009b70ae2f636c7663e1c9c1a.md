...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 450px, received 800px by 428px. 20891 pixels (ratio 0.06 of all image pixels) are different.

  Snapshot: snapshot-for-details-basic.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-details-basic.png)" with timeout 10000ms
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    - strong [ref=e9]:
      - button "Closed initially" [ref=e11] [cursor=pointer]:
        - generic [ref=e13]:
          - generic [ref=e14]: 
          - generic [ref=e15]: Closed initially
    - generic [ref=e17]:
      - strong [ref=e18]:
        - button "Open initially (disabled)" [disabled] [expanded] [ref=e20]:
          - generic [ref=e22]:
            - generic [ref=e23]: 
            - generic [ref=e24]: Open initially (disabled)
      - region "Open initially (disabled)" [ref=e27]:
        - paragraph [ref=e28]: Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt.
    - generic [ref=e30]:
      - strong [ref=e31]:
        - button "Open initially" [expanded] [ref=e33] [cursor=pointer]:
          - generic [ref=e35]:
            - generic [ref=e36]: 
            - generic [ref=e37]: Open initially
      - region "Open initially" [ref=e40]:
        - paragraph [ref=e41]: Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt.
```
