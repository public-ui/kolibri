...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  5191 pixels (ratio 0.03 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    ...
    - generic [ref=e41]:
      - generic [ref=e45] [cursor=pointer]: "Comparison: Editable"
      - 'textbox "Comparison: Editable" [ref=e49]': This field is editable
```
