...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  10284 pixels (ratio 0.03 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    - article "Card with headline level 0" [ref=e9]:
      - strong [ref=e10]: Card with headline level 0
      - paragraph [ref=e12]: Card contents.
    - article "Card with headline level 1" [ref=e15]:
      - heading "Card with headline level 1" [level=1] [ref=e16]
      - paragraph [ref=e18]: Card contents.
    - article "Card with headline level 2" [ref=e21]:
      - heading "Card with headline level 2" [level=2] [ref=e22]
      - paragraph [ref=e24]: Card contents.
    - article "Card with headline level 3" [ref=e27]:
      - heading "Card with headline level 3" [level=3] [ref=e28]
      - paragraph [ref=e30]: Card contents.
    - article "Card with headline level 4" [ref=e33]:
      - heading "Card with headline level 4" [level=4] [ref=e34]
      - paragraph [ref=e36]: Card contents.
    - article "Card with headline level 5" [ref=e39]:
      - heading "Card with headline level 5" [level=5] [ref=e40]
      - paragraph [ref=e42]: Card contents.
    - article "Card with headline level 6" [ref=e45]:
      - heading "Card with headline level 6" [level=6] [ref=e46]
      - paragraph [ref=e48]: Card contents.
```
