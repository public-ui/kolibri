...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 150px by 54px, received 150px by 55px. 135 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: snapshot-for-version-basic.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-version-basic.png)" with timeout 10000ms
...
- main [ref=e4]:
  ...
  - generic [ref=e10]:
    - img "Version number" [ref=e11]: 
    - generic [ref=e12]: 1.1.1
```
