...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1000px by 149px, received 1000px by 150px. 870 pixels (ratio 0.01 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - paragraph [ref=e7]: This theme has no variants for inputs.
```
