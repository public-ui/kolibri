...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 832px by 798px, received 832px by 822px. 111365 pixels (ratio 0.17 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    - link "Link Button Target default" [ref=e9] [cursor=pointer]:
      - /url: "#/back-page"
      - generic [ref=e12]: Link Button Target default
    - link "Link Button Target _self Opens in new tab." [ref=e15] [cursor=pointer]:
      - /url: "#/back-page"
      - generic [ref=e18]: Link Button Target _self
