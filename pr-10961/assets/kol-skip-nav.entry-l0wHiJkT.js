import{St as e,U as t,_t as n,a as r,c as i,d as a,o,r as s,s as c,u as l}from"./index-WqMVmI93.js";import{i as u}from"./dev.utils-BLwpXbb2-Dzl2J2T8.js";import{n as d,t as f}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as p}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./label-C0rxk5dd-AJST2O06.js";import{r as m,t as h}from"./element-interaction-C5-6aPzz-CwUv4L8C.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{i as g,n as _}from"./normalizers-bmigMYOh-DUt89Dgy.js";import"./i18n-6Ww8y2f3-B8WnGpXP.js";import"./label-0amhC2jU-DzV2Fbje.js";import"./variant-quote-Ch1VGFiN-BhDnC0wn.js";import"./component-DSERKzTV-BqPDo3Nn.js";import"./variant-class-name-CJmwIdCX-r2ovJPPa.js";import"./component-ASKmbxEX-F6sdc_Lm.js";import"./component-B7DNhbVq-DW_3BJbU.js";import"./align-66zR6LwD-Dbs4uQkm.js";import{t as v}from"./behavior-BAuOL8Z9-Df4D8ZUV.js";import{t as y}from"./label-with-expert-slot-vheHAMen-CwN0ClPe.js";import{c as b,d as x,f as S,n as C,o as w,p as T,r as E,s as D,t as O,u as k}from"./variant-DIChpbq4-CrHgBI_7.js";import{t as A}from"./href-BFuwoamu-B6apyyzk.js";import{t as j}from"./link-target-BAILFtyC-QR3IQXl_.js";import{a as M,i as N,n as P,o as F,t as I}from"./api-BqQUkBbP-CF1eMnT9.js";import{t as L}from"./access-and-short-key-ijzCZfHm-Dx5Q-CAn.js";import{n as R,t as z}from"./unique-nav-labels-BYgmk-Dk-r4pWMcBU.js";var B=_(`links`,[],e=>g(e),e=>e.every(e=>typeof e==`object`&&(typeof e._href==`string`||typeof e._label==`string`)),{hints:(t,n)=>e(`KolSkipNav`,n.length)}),V={required:[B,y]},H=a.forBlock(`kol-skip-nav`),U=H(),W=H(`list`),G=H(`list-item`),K=({label:e,linkItems:t})=>o(`nav`,{class:U,"aria-label":e},o(`ul`,{class:W},t.map((e,t)=>o(`li`,{class:G,key:t},o(I,Object.assign({},e.fcProps)))))),q=(e,t)=>{let r=new v(f.stateLess),a=h(),o=d(F);delete o.tabIndex;let s=(e,t)=>e.apply(t,t=>{o[e.propName]=t});s(O,e._accessKey),s(C,e._ariaControls),s(P,e._ariaCurrentValue),s(E,e._ariaDescription),s(w,e._disabled),s(N,e._download),s(D,e._hideLabel),s(A,e._href),s(x,e._icons),s(b,e._inline??!0),s(y,e._label),s(M,e._on),s(k,e._shortKey),typeof e._tabIndex==`number`&&s(S,e._tabIndex),s(j,e._target),s(T,e._tooltipAlign),L(e._accessKey,e._shortKey),r.componentWillLoad({label:(()=>{let e=o.label;if(typeof e==`string`&&e.length>0)return e;let t=o.href;return typeof t==`string`?t:``})(),align:o.tooltipAlign}),o.ariaCurrent=``,o.ariaDescriptionId=u(),o.expertSlot=e._label===``;let c=()=>typeof o.href==`string`?o.href:``;return o.handleAnchorClick=e=>{if(r.hideTooltip(),o.disabled===!0){e.preventDefault();return}let s=c(),u=o.on;typeof u?.onClick==`function`&&(n(e,a.el),u.onClick(e,s));let d=t();d&&l(d,i.click,s)},o.refAnchor=e=>{a(e)},o.refTooltip=r.setTooltipElementRef,{fcProps:o,getAnchor:()=>a.el,syncTooltipListeners:()=>{a.el&&r.syncListeners(void 0,a.el,!0)},destroy:()=>{r.destroy()}}},J=`@charset "UTF-8";
