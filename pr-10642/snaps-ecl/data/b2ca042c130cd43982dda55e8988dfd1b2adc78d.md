...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 200px by 610px, received 200px by 658px. 5745 pixels (ratio 0.05 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    - generic [ref=e8]:
      ...
      - generic [ref=e17]:
        - text: kol-character-limit-remaining
        - generic [ref=e18]: kol-character-limit-remaining
    - generic [ref=e20]:
      - generic [ref=e24] [cursor=pointer]: Textarea with max length
      - textbox "Textarea with max length" [ref=e28]: Lorem Ipsum
      - generic [ref=e29]: kol-character-limit-hint
    - generic [ref=e31]:
      - generic [ref=e35] [cursor=pointer]: Textarea with max length and counter
      - textbox "Textarea with max length and counter" [ref=e39]: Lorem Ipsum
      - generic [ref=e40]:
        - text: kol-character-counter-current-of-max
        - generic [ref=e41]: kol-character-counter-current-of-max-aria
    - generic [ref=e43]:
      - generic [ref=e47] [cursor=pointer]: Textarea with counter
      - textbox "Textarea with counter" [ref=e51]: Lorem Ipsum
      - generic [ref=e52]:
        - text: kol-character-counter-current
        - generic [ref=e53]: kol-character-counter-current
```
