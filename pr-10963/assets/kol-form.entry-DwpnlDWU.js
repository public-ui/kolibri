import{Ct as e,Dt as t,Et as n,T as r,a as i,c as a,o,r as s,s as c,u as l}from"./index-DZuhAQ9L.js";import{i as u,n as d}from"./dev.utils-BLwpXbb2-DzEWcykR.js";import"./Heading-D8NENhP8-BAr1XWga.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import{t as f}from"./i18n-6Ww8y2f3-CymBPCT3.js";import"./component-1G20GKPQ-C74iJOFz.js";import"./variant-class-name-CJmwIdCX-DM2Q1VrU.js";import"./component-Cjepysli-CP_oIeuf.js";import"./component-DkGg8T8t-DzRk1iFo.js";import"./component-C2hvnxIE-D19XPQ4E.js";import{t as p}from"./component-Co2z-Jl3-D_jaa6WD.js";var m=(e,n)=>{t(e,`errorList`,e=>Array.isArray(e)&&e.find(e=>typeof e!=`string`&&typeof e!=`function`)===void 0,new Set([`string`,`function`]),n)},h=`@charset "UTF-8";
...
}`,g=class{constructor(e){c(this,e),this.scrollOptionsFallback={behavior:`smooth`,block:`nearest`},this.translateErrorListMessage=f(`kol-error-list-message`),this.translateErrorList=f(`kol-error-list`),this.translateFormDescription=f(`kol-form-description`),this.alertHeadingId=d(`alert-heading`),this.closerAriaDescriptionId=u(),this.onSubmit=e=>{var t;e.preventDefault(),typeof this.state._on?.onSubmit==`function`&&((t=this.state._on)==null||t.onSubmit(e)),this.host&&l(this.host,a.submit)},this.onReset=e=>{var t;e.preventDefault(),typeof this.state._on?.onReset==`function`&&((t=this.state._on)==null||t.onReset(e)),this.host&&l(this.host,a.reset)},this.handleLinkClick=(e,t)=>{let n=document.querySelector(e);n&&typeof n.focus==`function`&&n.focus(t||this.scrollOptionsFallback)},this.setBlockElement=e=>this.errorListBlock=e,this.setFirstLinkElement=e=>this.errorListFirstLink=e,this._requiredText=!0,this.state={}}renderErrorList(e){return o(p,{alert:!1,class:`kol-form__alert`,closerAriaDescriptionId:this.closerAriaDescriptionId,handleCloserClick:()=>void 0,hasCloser:!1,headingId:this.alertHeadingId,label:this.translateErrorListMessage,level:0,ref:this.setBlockElement,refCloserButton:()=>void 0,refCloserTooltip:()=>void 0,type:`error`,variant:`card`},o(`nav`,{"aria-label":this.translateErrorList},o(`ul`,null,e?.map((e,t)=>o(`li`,{key:t},o(r,{class:`kol-form__link`,_href:``,_label:e.message,_on:{onClick:typeof e.selector==`string`?()=>this.handleLinkClick(String(e.selector),e.options):e.selector},ref:t===0?this.setFirstLinkElement:void 0}))))))}renderFormElement(){return o(`form`,{class:`kol-form`,method:`post`,onSubmit:this.onSubmit,onReset:this.onReset,noValidate:!0},this.state._requiredText===!0?o(`p`,{class:`kol-form__mandatory-fields-hint`},this.translateFormDescription):typeof this.state._requiredText==`string`&&this.state._requiredText.length>0?o(`p`,{class:`kol-form__mandatory-fields-hint`},this.state._requiredText):null,o(`slot`,null))}render(){let e=Array.isArray(this._errorList)&&this._errorList.length>0;return o(s,{key:`684e268a11334fc6f56045faff445c83f8f1099f`},e&&this.renderErrorList(this._errorList),this.renderFormElement())}scrollToErrorList(e){setTimeout(()=>{var t;(t=this.errorListFirstLink?.querySelector(`a`))==null||t.focus(e||this.scrollOptionsFallback)},250)}async focusErrorList(e){return this.scrollToErrorList(e),Promise.resolve()}validateOn(e){typeof e==`object`&&e&&(this.state=Object.assign(Object.assign({},this.state),{_on:e}))}validateRequiredText(t){typeof t==`boolean`?e(this,`_requiredText`,t):n(this,`_requiredText`,t)}validateErrorList(e){m(this,e)}componentWillLoad(){this.validateOn(this._on),this.validateRequiredText(this._requiredText),this.validateErrorList(this._errorList)}get host(){return i(this)}static get watchers(){return{_on:[`validateOn`],_requiredText:[`validateRequiredText`],_errorList:[`validateErrorList`]}}};g.style={default:h};export{g as kol_form};