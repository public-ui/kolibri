import{M as e,o as t,s as n}from"./index-DZuhAQ9L.js";var r=`@charset "UTF-8";
...
}`,i=class{constructor(e){n(this,e)}async focus(e){return this.element?.focus(e)}async expand(){return Promise.resolve(this.element?.expand())}async collapse(){return Promise.resolve(this.element?.collapse())}async isOpen(){return await this.element?.isOpen()??!1}render(){return t(e,{key:`86b0e50c76e9aebeb851336d250f00b99382c3ad`,_active:this._active,_label:this._label,_open:this._open,_href:this._href,ref:e=>this.element=e},t(`slot`,{key:`63682b239464eac6ef32c167fcda0bc433caabbf`}))}};i.style={default:r};export{i as kol_tree_item};