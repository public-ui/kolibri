...
- Name: theme-snapshots.spec.js >> snapshot for drawer/basic?align=left&closer=true
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Snapshot: snapshot-for-drawer-basic-align-left-closer-true.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-drawer-basic-align-left-closer-true.png)" with timeout 10000ms
...
- main [ref=e4]:
  ...
  - group "Drawer alignment" [ref=e9]:
    ...
    - generic [ref=e14]:
      - generic [ref=e15]:
        - radio "left" [checked] [ref=e18] [cursor=pointer]
        - generic [ref=e22] [cursor=pointer]: left
      - generic [ref=e23]:
        - radio "top" [ref=e26] [cursor=pointer]
  ...
  - generic [ref=e50]:
    - generic [ref=e52] [cursor=pointer]:
      - generic: 
      - checkbox "Drawer has closer" [checked] [ref=e53]
    - generic [ref=e57] [cursor=pointer]: Drawer has closer
  - generic [ref=e58]:
    - generic [active]:
      - dialog "I am a drawer":
        - article "I am a drawer" [ref=e60]:
          - strong [ref=e61]: I am a drawer
          - generic [ref=e64]:
            - paragraph [ref=e65]: Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.
            - button "Close drawer" [ref=e68] [cursor=pointer]:
              - generic [ref=e71]: Close drawer
          - generic [ref=e72]:
            - button "Close" [ref=e73] [cursor=pointer]:
              - generic [ref=e76]: 
            - generic [ref=e81]: Close
    - button "Open drawer" [ref=e84] [cursor=pointer]:
      - generic [ref=e87]: Open drawer
```
