import{d as e,o as t,r as n,s as r,w as i}from"./index-Hx1qrgOY.js";import{t as a}from"./base-web-component--IgFgz37-CZuvR3uB.js";import"./label-DxrksC9L-C4OmgSz2.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{n as o,u as s}from"./normalizers-DEevvNbZ-hACvL0fq.js";import{t as c}from"./label-De6GKT_4-l8TnnqaV.js";import{n as l}from"./variant-quote-JfuelQ4I-CQJgj8IZ.js";import{t as u}from"./href-Dhe7Bhko-BhRGZcGJ.js";var d=o(`quote`,``,s),f={optional:[c,l],required:[u,d]},p=e.forBlock(`kol-quote`),m=p(`blockquote`),h=p(`cite`),g=p(`figcaption`),_=p(`quote`),v=e=>{let{href:n,label:r,quote:a,variant:o}=e,s=a===``,c=p({[o]:!0});return t(`figure`,{class:c},o===`block`?t(`blockquote`,{class:m,cite:n},a,t(`span`,{"aria-hidden":s?void 0:`true`,hidden:!s},t(`slot`,{name:`expert`}))):t(`q`,{class:_,cite:n},a,t(`span`,{"aria-hidden":s?void 0:`true`,hidden:!s},t(`slot`,{name:`expert`}))),typeof r==`string`&&r.length>0&&t(`figcaption`,{class:g},t(`cite`,{class:h},t(i,{_href:n,_label:r,_target:`_blank`}))))},y=`@charset "UTF-8";
