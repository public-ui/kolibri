import{_ as e,c as t,o as n,s as r}from"./index-DcDxiC7I-TkVEMpF8.js";import{a as i,t as a}from"./behavior-Eatm8kmr-BwmgjMoQ.js";import{i as o,r as s,t as c}from"./index-C1s4Zfnw.js";import{i as l,n as u}from"./dev.utils-BRNeztdD-7WcXZw4l.js";import{n as d,t as f}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as p}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./variant-quote-CPA_pFWU-smOr6nPc.js";import{t as m}from"./disabled-BdkcA-WS-CtBDGUqs.js";import"./label-BDgaSpkn-C8lhqGaV.js";import"./label-CDp6ht3Z-CHxBO-oM.js";import{t as h}from"./clsx-COFh-Vc8-DWAop4cA.js";import{n as g,r as _,t as v}from"./element-interaction-DkGO5I_0-CYEJb_Yf.js";import"./block-bem-B2WJpaeb-DpkV1zTA.js";import"./component-CwO0zW8_-a9_xEcDE.js";import"./component-DNi43x13-DJ7SrC79.js";import{t as y}from"./i18n-s5q4We3h-BOQ-K0Ni.js";import{t as b}from"./component-Bol9zKnv-DCOEI-Ij.js";import"./component-CxauMHaQ-DCIyXieH.js";import"./component-nvIRawJq-CaX_w4vS.js";import{t as x}from"./component-DbEQyyOu-DL7345cI.js";import"./align-B29XBdiy-BvxpG2BG.js";import{t as S}from"./label-with-expert-slot-LdmDsdfz-mQlMzAXn.js";import{n as C}from"./variant-DKbetdU1-BPGldEQL.js";import{a as w,c as T,d as E,f as D,l as O,o as k,r as A,s as j,t as M,u as N}from"./tooltip-align-Bcuc9zWQ-kOz2mEgj.js";import{t as P}from"./name-C-7s_t57-DuNI5Sf9.js";import{a as F,n as I,r as L,t as R}from"./api-0jMCoYap-DVEXwxad.js";import"./controller-BzYze_SO-COQYQPg9.js";import"./aria-details-CaVxOiaf-BwCxEZ9X.js";import"./associated.controller-DFAIT7Or-zfJ8Q_Ze.js";import{t as z}from"./base-RCeclK3Y-FsUK0tRQ.js";import{n as B,r as V,t as H}from"./controller-DgaV6bVa-TM0yPJeR.js";var U={required:[S],optional:[M,A,R,I,L,F,w,m,k,i,j,S,T,P,V,O,N,E,D,C]},W=t=>{let n=new B,r=new a(f.stateLess),i=v(),o,p=d(U);delete p.tabIndex;let h=e=>{m.apply(e,e=>{p.disabled=e})};h(t.disabled),k.apply(t.hideLabel,e=>{p.hideLabel=e}),N.apply(t.icons,e=>{p.icons=e}),j.apply(!1,e=>{p.inline=e}),D.apply(`top`,e=>{p.tooltipAlign=e}),F.apply(`button`,e=>{p.type=e}),S.apply(t.label,e=>{p.label=e}),V.apply(t.popoverAlign,e=>{p.popoverAlign=e,n.setAlign(e)}),C.apply(e(`buttonVariantDefault`,t.getFlagHost())??`normal`,e=>{p.variant=e}),p.ariaDescriptionId=l(),p.popoverId=u(`popover`);let g=e=>{let n=t.getEventTarget();n&&s(n,e)},_=e=>{t.setOpen(e.newState===`open`)};return p.handleClick=e=>{e.stopPropagation(),r.hideTooltip(),n.setShow(!t.getOpen()),g(c.click)},p.handleMouseDown=()=>g(c.mousedown),p.handleFocus=()=>g(c.focus),p.handleBlur=()=>g(c.blur),p.refButton=e=>{i(e),n.setTriggerElement(e)},p.refPopover=e=>{o=e,n.setPopoverElementRef(e)},p.refTooltip=r.setTooltipElementRef,r.componentWillLoad({label:p.label,align:p.tooltipAlign}),{getFcProps:()=>Object.assign(Object.assign({},p),{popoverOpen:t.getOpen()}),hide:()=>n.setShow(!1),setDisabled:h,syncListeners:()=>{i.el&&r.syncListeners(void 0,i.el,!0),o?.addEventListener(`toggle`,_)},destroy:()=>{r.destroy(),o&&=(o.removeEventListener(`toggle`,_),void 0),n.destroy()}}},G=o.forBlock(`kol-split-button`),K=G(`button`),q=G(`horizontal-line`),J=G(`root`),Y=G(`secondary-button`),X=e=>{let{buttonProps:t,buttonWrapperClass:n,class:i,dropdownProps:a,refDropdown:o}=e;return r(b,{block:`kol-split-button`,class:i},r(`div`,{class:J},r(`div`,{class:h(K,n)},r(x,Object.assign({},t))),r(`div`,{class:q}),r(`div`,{class:Y,ref:o},r(H,Object.assign({},a)))))},Z=`@charset "UTF-8";
