import{C as e,X as t,c as n,nt as r,o as i,r as a,s as o,z as s}from"./index-DcDxiC7I-CN0esn1Q.js";import{r as c,t as l}from"./behavior-Eatm8kmr-BSnr3-RA.js";import{i as u,r as d,t as f}from"./index-XeabMg4n.js";import{i as p,n as m}from"./dev.utils-BRNeztdD-DwZBho4n.js";import{t as h}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as g}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{_,d as v,h as y,i as b,o as x,p as S,u as C}from"./variant-quote-CPA_pFWU-G18cFZqJ.js";import"./disabled-BdkcA-WS-DMfi19xl.js";import"./label-BDgaSpkn-CyxmuOrV.js";import"./label-CDp6ht3Z-V9l0Sitr.js";import{n as w,r as T,t as E}from"./element-interaction-DkGO5I_0-CYEJb_Yf.js";import"./block-bem-B2WJpaeb-C0J1nony.js";import"./component-CwO0zW8_-DiHkgLIQ.js";import"./component-DNi43x13-CzK1UDE9.js";import{t as D}from"./i18n-s5q4We3h-DTW7yueL.js";import{t as O}from"./component-Bol9zKnv-Z0teC1mq.js";import"./component-CxauMHaQ-Isx0Ar4e.js";import"./component-nvIRawJq-C0cE7vzn.js";import{t as k}from"./component-DbEQyyOu-Bvvxwcbz.js";import"./align-B29XBdiy-B4fT2wzJ.js";import{t as A}from"./label-with-expert-slot-LdmDsdfz-c436JZRg.js";import"./variant-DKbetdU1-CFpUxAK3.js";import"./tooltip-align-Bcuc9zWQ-CNj8nbkb.js";import"./name-C-7s_t57-ByQcVFQ5.js";import"./api-0jMCoYap-BceViUxS.js";import{t as j}from"./resolve-props-Cb0i2cmC-C5QVAmof.js";import{n as M}from"./keyboard-DNd73LVa-BCj4IeP3.js";var N=b(`hasCreateButton`,!1,v),P=b(`selected`,0,y),F=[`select-automatic`,`select-manual`],I=b(`behavior`,`select-automatic`,e=>_(e),e=>x(e,F)),L=b(`tabs`,[],e=>C(e),e=>e.every(e=>typeof e==`object`&&!!e&&typeof e._label==`string`&&e._label.length>0),{hints:(e,t)=>r(`KolTabs`,t.length)}),R=b(`on`,{},e=>{let t=S(e),n={};return typeof t.onCreate==`function`&&(n.onCreate=t.onCreate),typeof t.onSelect==`function`&&(n.onSelect=t.onSelect),n}),z={required:[A,L],optional:[c,N,P,I,R]},B=()=>{let e=new l(h.stateLess),n=p(),r,i,a,o,s=(e,t)=>{a&&d(a,e,t)},c=n=>{n.stopPropagation(),e.hideTooltip();let a=r?.on.onClick;typeof a==`function`&&(t(n,o),a(n,i)),s(f.click,i)},u=e=>{var t,n;(n=r==null?void 0:(t=r.on).onMouseDown)==null||n.call(t,e),s(f.mousedown)},m=e=>{var t,n;(n=r==null?void 0:(t=r.on).onFocus)==null||n.call(t,e),s(f.focus)},g=e=>{var t,n;(n=r==null?void 0:(t=r.on).onBlur)==null||n.call(t,e),s(f.blur)},_=e=>{a=e},v=e=>{o=e};return{getButton:(t,a)=>(r=j(t,a),i=t._value,e.componentWillLoad({label:r.label,align:r.tooltipAlign}),{buttonProps:Object.assign(Object.assign({},r),{ariaDescriptionId:n,handleBlur:g,handleClick:c,handleFocus:m,handleMouseDown:u,refButton:v,refTooltip:e.setTooltipElementRef}),refBox:_}),getButtonElement:()=>o,syncListeners:()=>{o&&e.syncListeners(void 0,o,!0)},destroy:()=>{e.destroy()}}},V=u.forBlock(`kol-tabs`),H=V(`button-create`),U=V(`button-group`),W=V(`content`),G=V(`tab`),K=e=>{let{align:t,class:n,createButton:r,handleBlur:i,handleKeyDown:a,hasCreateButton:s,label:c,refContent:l,refRoot:u,tabButtons:d}=e;return o(O,{block:`kol-tabs`,modifiers:{[`align-${t}`]:!0},class:n,ref:u},o(`div`,{"aria-label":c,class:U,role:`tablist`,onKeyDown:a,onBlur:i},d.map(({buttonProps:e,refBox:t})=>o(`div`,{class:G,ref:t},o(k,Object.assign({},e)))),s&&o(`div`,{class:H,ref:r.refBox},o(k,Object.assign({},r.buttonProps)))),o(`div`,{class:W,ref:l}))},q=`@charset "UTF-8";
