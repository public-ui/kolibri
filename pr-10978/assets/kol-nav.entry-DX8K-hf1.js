import{C as e,at as t,b as n,c as r,it as i,nt as a,s as o}from"./index-DcDxiC7I-CLeJTg5k.js";import{_ as s,d as c}from"./index-BJhX3wQE.js";import{n as l,t as u}from"./dev.utils-BRNeztdD-DFQvxemk.js";import{r as d}from"./label-BDgaSpkn-Cl9dUoop.js";import{t as f}from"./clsx-COFh-Vc8-DWAop4cA.js";import{t as p}from"./i18n-s5q4We3h-BqsMlip0.js";import{n as m,t as h}from"./unique-nav-labels-DhBmrHgI-Ddkp_7ff.js";import{t as g}from"./hide-label-D2aEL3Gp-Bwclmmoi.js";var _=(e,t)=>{i(e,`_collapsible`,t)},v=(e,t)=>{i(e,`_hasCompactButton`,t)},y=(e,t)=>{i(e,`_hasIconsWhenExpanded`,t)},b=(e,n,r)=>{t(n,`_links`,e=>typeof e==`object`&&(typeof e._href==`string`||typeof e._label==`string`),r),a(e,n.state._links.length)},x=`@charset "UTF-8";
...
}`,S=e=>typeof e._href==`string`,C=e=>e._href===void 0&&typeof e._on?.onClick==`function`,w=class{constructor(e){r(this,e),this.navId=l(`kol-nav`),this.listId=u(this.navId,`list`),this.handleToggleExpansionClick=e=>{e&&(this.state._expandedChildren.includes(e)?this.collapseChildren(e):this.expandChildren(e))},this.linkList=e=>o(`ul`,{class:f(`kol-nav__list`,{"kol-nav__list--nested":e.deep>0,"kol-nav__list--vertical":e.deep!==0}),id:e.deep>0?e.id:void 0},e.links.map((t,n)=>this.li(e.collapsible,e.deep,n,t,e.id))),this._collapsible=!0,this._hasCompactButton=!1,this._hasIconsWhenExpanded=!1,this._hideLabel=!1,this.state={_collapsible:!0,_hasCompactButton:!1,_hasIconsWhenExpanded:!1,_hideLabel:!1,_label:``,_links:[],_expandedChildren:[]}}expandChildren(e){this.state=Object.assign(Object.assign({},this.state),{_expandedChildren:[...this.state._expandedChildren,e]})}collapseChildren(e){this.state=Object.assign(Object.assign({},this.state),{_expandedChildren:this.state._expandedChildren.filter(t=>t!==e)})}buildIconObject(e,t,n){let r={left:``,right:``};return this.state._hasIconsWhenExpanded&&n&&(r.left=n),this.state._hideLabel&&(r.left=n||`kolicon-link`),e&&(r.right=t?`kolicon-minus`:`kolicon-plus`),r}entry(e,t,n,r,i){let a=typeof n._icons==`string`?n._icons:typeof n._icons?.left==`string`?n._icons.left:void 0,l=this.buildIconObject(e&&t,r,a);return o(`div`,{class:`kol-nav__entry-wrapper`},S(n)?o(s,Object.assign({class:f(`kol-nav__entry kol-nav__entry--link`,{"kol-nav__entry--collapsible":e})},n,{_hideLabel:this.state._hideLabel,_icons:l,_ariaControls:e&&t&&r?i:void 0,_ariaExpanded:e&&t?r:void 0})):o(c,{class:f(`kol-nav__entry kol-nav__entry--button`,{"kol-nav__entry--collapsible":e}),_label:n._label,_disabled:C(n)?n._disabled:void 0,_hideLabel:this.state._hideLabel,_icons:l,_ariaControls:e&&t&&r?i:void 0,_ariaExpanded:e&&t?r:void 0,_on:{onClick:(e,t)=>{C(n)&&typeof n._on.onClick==`function`&&n._on.onClick(e,t),this.handleToggleExpansionClick(n._children)}}}))}li(e,t,n,r,i){let a=!!r._active,s=Array.isArray(r._children)&&r._children.length>0,c=!!(r._children&&this.state._expandedChildren.includes(r._children)),l=u(i,`${t}-${n}`);return o(`li`,{class:f(`kol-nav__list-item`,{"kol-nav__list-item--active":a,"kol-nav__list-item--expanded":c,"kol-nav__list-item--has-children":s}),key:n},this.entry(e,s,r,c,l),c&&o(this.linkList,{collapsible:e,deep:t+1,links:r._children||[],id:l}))}initializeExpandedChildren(){this.state=Object.assign(Object.assign({},this.state),{_expandedChildren:[]});let e=t=>{if(t._active)return t._children&&this.expandChildren(t._children),!0;if(t._children){for(let n of t._children)if(e(n))return this.expandChildren(t._children),!0}return!1};this.state._links.forEach(e)}render(){let e=this.state._collapsible===!0;return o(`div`,{key:`fe7a5997ec870cd4979ee5faecb1df246e423c38`,class:f(`kol-nav`,{"kol-nav--is-compact":this.state._hideLabel})},o(`nav`,{key:`cf8c831be0be6e7f0e3fec2bbc1abacc62bd2f61`,"aria-label":this.state._label,class:`kol-nav__navigation`,id:this.navId},o(this.linkList,{key:`2f9df5d2bccdb4af292206708a8e9e3e4710a0cf`,collapsible:e,deep:0,links:this.state._links,id:this.listId})),this.state._hasCompactButton&&o(`div`,{key:`c043a1080fde16a130c1d843d8e1165c3a9c17ae`,class:`kol-nav__compact`},o(c,{key:`406074be88ddd898b106000511ce4938df7bb410`,class:`kol-nav__toggle-button`,_ariaControls:this.navId,_ariaExpanded:!this.state._hideLabel,_icons:this.state._hideLabel?`kolicon-chevron-right`:`kolicon-chevron-left`,_hideLabel:!0,_label:this.state._hideLabel?p(`kol-nav-maximize`):p(`kol-nav-minimize`),_on:{onClick:()=>{this.state=Object.assign(Object.assign({},this.state),{_hideLabel:!this.state._hideLabel})}},_tooltipAlign:`right`})))}validateCollapsible(e){_(this,e)}validateHasCompactButton(e){v(this,e)}validateHasIconsWhenExpanded(e){y(this,e)}validateHideLabel(e){g(this,e)}validateLabel(e,t,r=!1){r||m(this.state._label),d(this,e,{required:!0}),n(e),h(this.state._label)}validateLinks(t){b(`KolNav`,this,t),e(`[KolNav] The navigation structure is not yet validated recursively.`),this.initializeExpandedChildren()}componentWillLoad(){this.validateCollapsible(this._collapsible),this.validateHideLabel(this._hideLabel),this.validateHasCompactButton(this._hasCompactButton),this.validateHasIconsWhenExpanded(this._hasIconsWhenExpanded),this.validateLabel(this._label,void 0,!0),this.validateLinks(this._links),this.initializeExpandedChildren()}disconnectedCallback(){m(this.state._label)}static get watchers(){return{_collapsible:[`validateCollapsible`],_hasCompactButton:[`validateHasCompactButton`],_hasIconsWhenExpanded:[`validateHasIconsWhenExpanded`],_hideLabel:[`validateHideLabel`],_label:[`validateLabel`],_links:[`validateLinks`]}}};w.style={default:x};export{w as kol_nav};