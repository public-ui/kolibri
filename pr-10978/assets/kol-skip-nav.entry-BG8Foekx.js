import{X as e,b as t,c as n,nt as r,o as i,r as a,s as o}from"./index-DcDxiC7I-3RHFioJp.js";import{t as s}from"./behavior-iJpU4AKD-DyyYcbfh.js";import{i as c,r as l,t as u}from"./index-DdkAqVN0.js";import{i as d}from"./dev.utils-BRNeztdD-Dlb1H2t6.js";import{n as f,t as p}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as m}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{o as h,r as g}from"./variant-quote-DeZzWGZI-DJo3Wbdl.js";import{t as _}from"./disabled-DPo78Oje-CDmyMtao.js";import"./label-BDgaSpkn-hHNinR9j.js";import"./label-C-mcs1F6-DD4xaE5l.js";import{r as v,t as y}from"./element-interaction-DkGO5I_0-CYEJb_Yf.js";import"./block-bem-UDOF3rAN-D9DBkNYc.js";import"./component-Bh3trbTp-qXHvVgNx.js";import"./component-zqA_GCVc-DnU3y87_.js";import"./i18n-s5q4We3h-BOKiZ4wQ.js";import"./component-D2A6cZw8-LIm2Fgrj.js";import"./variant-class-name-D1gM1t9T-C1idc72R.js";import"./component-JTlUjHZD-BBEBKdbC.js";import"./align-B29XBdiy-CV3u_nkC.js";import{t as b}from"./label-with-expert-slot-DQT5alA4-Bs4yhJUR.js";import{d as x,f as S,l as C,n as w,o as T,r as E,s as D,t as O,u as k}from"./variant-Bd451cbV-DGiGnAbF.js";import{t as A}from"./href-D5Num3co-kmv2QICW.js";import{t as j}from"./link-target-CRLfzp48-CTZapWyn.js";import{a as M,i as N,n as P,o as F,t as I}from"./api-BzHujZS4-B-dEAAv6.js";import{t as L}from"./access-and-short-key-ijzCZfHm-Dx5Q-CAn.js";import{n as R,t as z}from"./unique-nav-labels-DhBmrHgI-CdSBIAiJ.js";var B=g(`links`,[],e=>h(e),e=>e.every(e=>typeof e==`object`&&(typeof e._href==`string`||typeof e._label==`string`)),{hints:(e,t)=>r(`KolSkipNav`,t.length)}),V={required:[B,b]},H=c.forBlock(`kol-skip-nav`),U=H(),W=H(`list`),G=H(`list-item`),K=({label:e,linkItems:t})=>o(`nav`,{class:U,"aria-label":e},o(`ul`,{class:W},t.map((e,t)=>o(`li`,{class:G,key:t},o(I,Object.assign({},e.fcProps)))))),q=(t,n)=>{let r=new s(p.stateLess),i=y(),a=f(F);delete a.tabIndex;let o=(e,t)=>e.apply(t,t=>{a[e.propName]=t});o(O,t._accessKey),o(w,t._ariaControls),o(P,t._ariaCurrentValue),o(E,t._ariaDescription),o(_,t._disabled),o(N,t._download),o(T,t._hideLabel),o(A,t._href),o(k,t._icons),o(D,t._inline??!0),o(b,t._label),o(M,t._on),o(C,t._shortKey),typeof t._tabIndex==`number`&&o(x,t._tabIndex),o(j,t._target),o(S,t._tooltipAlign),L(t._accessKey,t._shortKey),r.componentWillLoad({label:(()=>{let e=a.label;if(typeof e==`string`&&e.length>0)return e;let t=a.href;return typeof t==`string`?t:``})(),align:a.tooltipAlign}),a.ariaCurrent=``,a.ariaDescriptionId=d(),a.expertSlot=t._label===``;let c=()=>typeof a.href==`string`?a.href:``;return a.handleAnchorClick=t=>{if(r.hideTooltip(),a.disabled===!0){t.preventDefault();return}let o=c(),s=a.on;typeof s?.onClick==`function`&&(e(t,i.el),s.onClick(t,o));let d=n();d&&l(d,u.click,o)},a.refAnchor=e=>{i(e)},a.refTooltip=r.setTooltipElementRef,{fcProps:a,getAnchor:()=>i.el,syncTooltipListeners:()=>{i.el&&r.syncListeners(void 0,i.el,!0)},destroy:()=>{r.destroy()}}},J=`@charset "UTF-8";
...
}`,Y=class extends p{constructor(e){super(),n(this,e),this.ctaRef=y(),this.linkItems=[]}componentWillLoad(){this.initRenderProps(V),this.applyLabel(this._label,!0),this.applyLinks(this._links)}componentDidRender(){this.ctaRef(this.linkItems[0]?.getAnchor()),this.linkItems.forEach(e=>e.syncTooltipListeners())}disconnectedCallback(){this.linkItems.forEach(e=>e.destroy()),R(this.getRenderProp(`label`))}applyLabel(e,n=!1){n||R(this.getRenderProp(`label`)),b.apply(e,e=>this.setRenderProp(`label`,e)),t(e),z(this.getRenderProp(`label`))}applyLinks(e){B.apply(e,e=>{this.setRenderProp(`links`,e),this.linkItems.forEach(e=>e.destroy()),this.linkItems=e.map(e=>q(e,()=>this.host))})}render(){return o(a,{key:`86bab79ba2d02baea4abe92206b2205373647776`},o(K,{key:`d5554182317be8dc3d4f019396e3cfe8f1674299`,label:this.getRenderProp(`label`),links:this.getRenderProp(`links`),linkItems:this.linkItems}))}async focus(e){}watchLabel(e){this.applyLabel(e)}watchLinks(e){this.applyLinks(e)}get host(){return i(this)}static get watchers(){return{_label:[`watchLabel`],_links:[`watchLinks`]}}};m([v(`ctaRef`)],Y.prototype,`focus`,null),Y.style={default:J};export{Y as kol_skip_nav};