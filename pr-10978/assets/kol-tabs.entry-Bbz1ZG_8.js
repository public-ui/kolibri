import{C as e,X as t,c as n,nt as r,o as i,r as a,s as o,z as s}from"./index-DcDxiC7I-Dz6eZxyW.js";import{r as c,t as l}from"./behavior-iJpU4AKD-DadsQbG3.js";import{i as u,r as d,t as f}from"./index-BgVO7cPp.js";import{i as p,n as m}from"./dev.utils-BRNeztdD-197_Q3Dd.js";import{t as h}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as g}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{d as _,i as v,l as y,o as b,p as x,r as S,s as C}from"./variant-quote-DeZzWGZI-D2LpM5Be.js";import"./disabled-DPo78Oje-BKXAbyM1.js";import"./label-BDgaSpkn-BGh4RaZi.js";import"./label-C-mcs1F6-BXI-XuqL.js";import{n as w,r as T,t as E}from"./element-interaction-DkGO5I_0-CYEJb_Yf.js";import"./block-bem-UDOF3rAN-H6vzwq73.js";import"./component-Bh3trbTp-xM1zbU9b.js";import"./component-zqA_GCVc-B91LGqmA.js";import{t as D}from"./i18n-s5q4We3h-CKW6q6jB.js";import{n as O}from"./component-D2A6cZw8-C9Kb1YeV.js";import"./variant-class-name-D1gM1t9T-yluQwyH7.js";import"./component-JTlUjHZD-wxLKW7i2.js";import{t as k}from"./component-DWslkzV8-D3mJCVpR.js";import"./align-B29XBdiy-ClnHtKLV.js";import{t as A}from"./label-with-expert-slot-DQT5alA4-B4wSSWAX.js";import"./variant-Bd451cbV-D683697X.js";import"./name-ygfuf6Ck-Be5iKre3.js";import"./api-DquRPbhk-BMuny9gR.js";import{t as j}from"./resolve-props-30YuzYBw-BLFQjuap.js";import{n as M}from"./keyboard-DNd73LVa-BCj4IeP3.js";var N=S(`hasCreateButton`,!1,C),P=S(`selected`,0,_),F=[`select-automatic`,`select-manual`],I=S(`behavior`,`select-automatic`,e=>x(e),e=>v(e,F)),L=S(`tabs`,[],e=>b(e),e=>e.every(e=>typeof e==`object`&&!!e&&typeof e._label==`string`&&e._label.length>0),{hints:(e,t)=>r(`KolTabs`,t.length)}),R=S(`on`,{},e=>{let t=y(e),n={};return typeof t.onCreate==`function`&&(n.onCreate=t.onCreate),typeof t.onSelect==`function`&&(n.onSelect=t.onSelect),n}),z={required:[A,L],optional:[c,N,P,I,R]},B=()=>{let e=new l(h.stateLess),n=p(),r,i,a,o,s=(e,t)=>{a&&d(a,e,t)},c=n=>{n.stopPropagation(),e.hideTooltip();let a=r?.on.onClick;typeof a==`function`&&(t(n,o),a(n,i)),s(f.click,i)},u=e=>{var t,n;(n=r==null?void 0:(t=r.on).onMouseDown)==null||n.call(t,e),s(f.mousedown)},m=e=>{var t,n;(n=r==null?void 0:(t=r.on).onFocus)==null||n.call(t,e),s(f.focus)},g=e=>{var t,n;(n=r==null?void 0:(t=r.on).onBlur)==null||n.call(t,e),s(f.blur)},_=e=>{a=e},v=e=>{o=e};return{getButton:(t,a)=>(r=j(t,a),i=t._value,e.componentWillLoad({label:r.label,align:r.tooltipAlign}),{buttonProps:Object.assign(Object.assign({},r),{ariaDescriptionId:n,handleBlur:g,handleClick:c,handleFocus:m,handleMouseDown:u,refButton:v,refTooltip:e.setTooltipElementRef}),refBox:_}),getButtonElement:()=>o,syncListeners:()=>{o&&e.syncListeners(void 0,o,!0)},destroy:()=>{e.destroy()}}},V=u.forBlock(`kol-tabs`),H=V(`button-create`),U=V(`button-group`),W=V(`content`),G=V(`tab`),K=e=>{let{align:t,class:n,createButton:r,handleBlur:i,handleKeyDown:a,hasCreateButton:s,label:c,refContent:l,refRoot:u,tabButtons:d}=e;return o(O,{block:`kol-tabs`,modifiers:{[`align-${t}`]:!0},class:n,ref:u},o(`div`,{"aria-label":c,class:U,role:`tablist`,onKeyDown:a,onBlur:i},d.map(({buttonProps:e,refBox:t})=>o(`div`,{class:G,ref:t},o(k,Object.assign({},e)))),s&&o(`div`,{class:H,ref:r.refBox},o(k,Object.assign({},r.buttonProps)))),o(`div`,{class:W,ref:l}))},q=`@charset "UTF-8";
