import{E as e,H as t,W as n,X as r,c as i,o as a,r as o,s}from"./index-DcDxiC7I-Dz6eZxyW.js";import{t as c}from"./behavior-iJpU4AKD-DadsQbG3.js";import{r as l,t as u}from"./index-BgVO7cPp.js";import{i as d,n as f}from"./dev.utils-BRNeztdD-197_Q3Dd.js";import{t as p}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as m}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{r as h}from"./variant-quote-DeZzWGZI-D2LpM5Be.js";import"./disabled-DPo78Oje-BKXAbyM1.js";import"./label-BDgaSpkn-BGh4RaZi.js";import"./label-C-mcs1F6-BXI-XuqL.js";import{r as g,t as _}from"./element-interaction-DkGO5I_0-CYEJb_Yf.js";import"./block-bem-UDOF3rAN-H6vzwq73.js";import"./component-Bh3trbTp-xM1zbU9b.js";import"./component-zqA_GCVc-B91LGqmA.js";import"./component-D2A6cZw8-C9Kb1YeV.js";import"./variant-class-name-D1gM1t9T-yluQwyH7.js";import"./component-JTlUjHZD-wxLKW7i2.js";import"./component-DWslkzV8-D3mJCVpR.js";import"./align-B29XBdiy-ClnHtKLV.js";import"./index-DCHfCGY1-CbzK-_or.js";import"./contrast-DavXWnsf-CEwQLw3n.js";import{t as v}from"./color-Cu7sXfmV-CqtVnQyP.js";import{t as y}from"./label-with-expert-slot-DQT5alA4-B4wSSWAX.js";import{u as b}from"./variant-Bd451cbV-D683697X.js";import{t as x}from"./component-Cw0XCiGk-YyfA6cAU.js";import"./name-ygfuf6Ck-Be5iKre3.js";import"./api-DquRPbhk-BMuny9gR.js";import{t as S}from"./resolve-props-30YuzYBw-BLFQjuap.js";function C(e){let t=typeof e==`string`?n(e):e;if(typeof t==`object`&&t)return t;throw Error(`Invalid smart button: ${typeof e}`)}var w=h(`smartButton`,{_label:``},C),T={required:[y],optional:[v,w,b]},E=`@charset "UTF-8";
...
}`;e(`[KolBadge] Optimierung des _color-Properties (rgba, rgb, hex usw.).`);var D=class extends p{constructor(e){super(),i(this,e),this.ctaRef=_(),this.tooltipBehavior=new c(this.stateAccess),this.handleClick=e=>{e.stopPropagation(),this.tooltipBehavior.hideTooltip();let t=this.smartButtonProps?.on.onClick;typeof t==`function`&&(r(e,this.ctaRef.el),t(e,void 0)),this.host&&l(this.host,u.click)},this.handleMouseDown=e=>{var t,n,r;(r=(t=this.smartButtonProps)==null?void 0:(n=t.on).onMouseDown)==null||r.call(n,e),this.host&&l(this.host,u.mousedown)},this.handleFocus=e=>{var t,n,r;(r=(t=this.smartButtonProps)==null?void 0:(n=t.on).onFocus)==null||r.call(n,e),this.host&&l(this.host,u.focus)},this.handleBlur=e=>{var t,n,r;(r=(t=this.smartButtonProps)==null?void 0:(n=t.on).onBlur)==null||r.call(n,e),this.host&&l(this.host,u.blur)},this.labelId=f(`badge-label`),this.ariaDescriptionId=d(),this._color=`#000`}componentWillLoad(){this.initRenderProps(T),this.unsetRenderProp(`smartButton`),this.watchColor(this._color),this.watchIcons(this._icons),this.watchLabel(this._label),this.watchSmartButton(this._smartButton)}componentDidRender(){this.ctaRef.el&&this.tooltipBehavior.syncListeners(void 0,this.ctaRef.el,!0)}disconnectedCallback(){this.tooltipBehavior.destroy()}applySmartButton(e){t(e,()=>{this.unsetRenderProp(`smartButton`),this.smartButtonProps=void 0,e!=null&&w.apply(e,e=>{this.setRenderProp(`smartButton`,e),this.smartButtonProps=S(Object.assign(Object.assign({},e),{_hideLabel:!0,_ariaControls:this.labelId}),this.host),this.tooltipBehavior.componentWillLoad({label:this.smartButtonProps.label,align:this.smartButtonProps.tooltipAlign})})})}async focus(e){}render(){let e=this.getRenderProp(`smartButton`),t=this.smartButtonProps;return s(o,{key:`79dd22ea6e733b39a3d9f2d30130ef51066c8a8c`},s(x,{key:`e0083bad9a0f351675d363d3057bd2a76fa4f9f5`,color:this.getRenderProp(`color`),icons:this.getRenderProp(`icons`),label:this.getRenderProp(`label`),smartButton:typeof e==`object`&&e&&t!==void 0?{ariaDescriptionId:this.ariaDescriptionId,handleBlur:this.handleBlur,handleClick:this.handleClick,handleFocus:this.handleFocus,handleMouseDown:this.handleMouseDown,labelId:this.labelId,refSmartButton:this.ctaRef,refTooltip:this.tooltipBehavior.setTooltipElementRef,resolvedButton:t}:void 0}))}watchColor(e){v.apply(e,e=>this.setRenderProp(`color`,e))}watchIcons(e){b.apply(e,e=>this.setRenderProp(`icons`,e))}watchLabel(e){y.apply(e,e=>this.setRenderProp(`label`,e))}watchSmartButton(e){this.applySmartButton(e)}get host(){return a(this)}static get watchers(){return{_color:[`watchColor`],_icons:[`watchIcons`],_label:[`watchLabel`],_smartButton:[`watchSmartButton`]}}};m([g(`ctaRef`)],D.prototype,`focus`,null),D.style={default:E};export{D as kol_badge};