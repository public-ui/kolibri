...
```
Error: A snapshot doesn't exist at /home/runner/work/kolibri/kolibri/packages/test-tag-name-transformer/snapshots/theme-default/snapshot-for-avatar-size-firefox-linux.png, writing actual.
```
