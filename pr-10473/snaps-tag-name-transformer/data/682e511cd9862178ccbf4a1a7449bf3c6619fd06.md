...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 800px by 182px, received 800px by 286px. 10644 pixels (ratio 0.05 of all image pixels) are different.

  Snapshot: snapshot-for-avatar-size.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-avatar-size.png)" with timeout 10000ms
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    - img "Avatar of Elke Mustermann" [ref=e8]:
      - generic [ref=e9]: EM
    - img "Avatar of Marianne" [ref=e11]:
      - generic [ref=e12]: M
    - img "Avatar of Christian" [ref=e14]:
      - generic [ref=e15]: C
    - img "Avatar of Elke Mustermann" [ref=e17]:
      - img [ref=e18]
    - img "Avatar of Elke Mustermann" [ref=e20]:
      - img [ref=e21]
  - heading "avatar size" [level=1] [ref=e22]
  - generic [ref=e23]:
    - img "Avatar of Wide host, tall size" [ref=e25]:
      - generic [ref=e26]: WS
    - img "Avatar of Tall host, wide size" [ref=e28]:
      - generic [ref=e29]: TS
```
