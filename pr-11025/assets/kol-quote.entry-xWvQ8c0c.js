import{c as e,r as t,s as n}from"./index-DcDxiC7I-DL_Fa4k7.js";import{g as r,i}from"./index-Buqv7EWA.js";import{t as a}from"./base-web-component--IgFgz37-CZuvR3uB.js";import{_ as o,i as s,y as c}from"./variant-quote-CPA_pFWU-BLd7k0sN.js";import"./label-BDgaSpkn-Ug5u5pm3.js";import{t as l}from"./label-CDp6ht3Z-DkuHE6pN.js";import{t as u}from"./href-B3UMHW6_-Q-_sclfo.js";var d=s(`quote`,``,o),f={optional:[l,c],required:[u,d]},p=i.forBlock(`kol-quote`),m=p(`blockquote`),h=p(`cite`),g=p(`figcaption`),_=p(`quote`),v=e=>{let{href:t,label:i,quote:a,variant:o}=e,s=a===``,c=p({[o]:!0});return n(`figure`,{class:c},o===`block`?n(`blockquote`,{class:m,cite:t},a,n(`span`,{"aria-hidden":s?void 0:`true`,hidden:!s},n(`slot`,{name:`expert`}))):n(`q`,{class:_,cite:t},a,n(`span`,{"aria-hidden":s?void 0:`true`,hidden:!s},n(`slot`,{name:`expert`}))),typeof i==`string`&&i.length>0&&n(`figcaption`,{class:g},n(`cite`,{class:h},n(r,{_href:t,_label:i,_target:`_blank`}))))},y=`@charset "UTF-8";
