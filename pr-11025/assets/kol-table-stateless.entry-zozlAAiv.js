import{c as e,o as t,r as n,s as r}from"./index-DcDxiC7I-DL_Fa4k7.js";import"./index-Buqv7EWA.js";import"./dev.utils-BRNeztdD-Qwg1HQQR.js";import"./base-web-component--IgFgz37-CZuvR3uB.js";import"./variant-quote-CPA_pFWU-BLd7k0sN.js";import"./block-bem-B2WJpaeb-BSIn4Vgx.js";import"./component-CwO0zW8_-dzwhhgEm.js";import"./component-DNi43x13-CobWgMUd.js";import"./i18n-s5q4We3h-DEUqe8gt.js";import"./component-Bol9zKnv-Bi45N4GN.js";import"./component-nvIRawJq-BnFAYFM8.js";import"./label-with-expert-slot-LdmDsdfz-D6QAWGxC.js";import"./variant-DKbetdU1-BGYnEhSi.js";import{t as i}from"./aria-labelledby-6-ki3akM-C6lJ0lQF.js";import"./component-24FieOYf-DHjV7OUU.js";import{t as a}from"./aria-labelledby-D8sZtnnh-ChPmZdkP.js";import"./keyboard-DNd73LVa-BCj4IeP3.js";import{t as o}from"./base-DHvy2Gak-C0MnG_lc.js";var s=`@charset "UTF-8";
/*
...
}`,c=class extends o{constructor(t){super(),e(this,t),this.externalLabelElements=[],this.hasScrollbar=!1,this.rowKeys=new Map,this.settingsChangedCounter=0,this.stickyColsDisabled=!1}componentWillLoad(){this.initTableRenderProps(),this.watchData(this._data),this.watchDataFoot(this._dataFoot),this.watchFixedCols(this._fixedCols),this.watchHasSettingsMenu(this._hasSettingsMenu),this.watchHeaders(this._headers),this.watchLabel(this._label),this.watchLoading(this._loading),this.watchOn(this._on),this.watchSelection(this._selection),this.watchVariant(this._variant),this.internals=i(this.host),this.resolveExternalLabel(this._ariaLabelledby)}componentDidLoad(){this.externalLabelElements.length||this.resolveExternalLabel(this._ariaLabelledby),this.observeScrollContainer()}componentDidRender(){this.updateScrollbarState()}disconnectedCallback(){this.teardownTable()}resolveExternalLabel(e){this.externalLabelElements=a(this,this.host,this.internals,e),this.syncTableLabel(this.externalLabelElements)}onChangeHeaderCells(e){this.applyChangedHeaderCells(e)}onKeydown(e){this.moveCheckboxFocus(e)}render(){return r(n,{key:`b3911a0aa7ec8d9f5129938ce336e46982955aa1`},this.renderTableStatelessFC())}watchAriaLabelledby(e){this.resolveExternalLabel(e)}watchData(e){this.applyData(e)}watchDataFoot(e){this.applyDataFoot(e)}watchFixedCols(e){this.applyFixedCols(e)}watchHeaders(e){this.applyHeaders(e||this._headerCells)}watchHeaderCells(e){this.applyHeaders(this._headers?this._headers:e)}watchLabel(e){this.applyLabel(e)}watchLoading(e){this.applyLoading(e)}watchOn(e){this.applyOn(e)}watchSelection(e){this.applySelection(e)}watchHasSettingsMenu(e){this.applyHasSettingsMenu(e)}watchVariant(e){this.applyVariant(e)}get host(){return t(this)}static get watchers(){return{_ariaLabelledby:[`watchAriaLabelledby`],_data:[`watchData`],_dataFoot:[`watchDataFoot`],_fixedCols:[`watchFixedCols`],_headers:[`watchHeaders`],_headerCells:[`watchHeaderCells`],_label:[`watchLabel`],_loading:[`watchLoading`],_on:[`watchOn`],_selection:[`watchSelection`],_hasSettingsMenu:[`watchHasSettingsMenu`],_variant:[`watchVariant`]}}};c.style={default:s};export{c as kol_table_stateless};