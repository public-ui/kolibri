import{M as e,o as t,s as n}from"./index-tqQGPufc.js";var r=`@charset "UTF-8";
...
}`,i=class{constructor(e){n(this,e)}async focus(e){return this.element?.focus(e)}async expand(){return Promise.resolve(this.element?.expand())}async collapse(){return Promise.resolve(this.element?.collapse())}async isOpen(){return await this.element?.isOpen()??!1}render(){return t(e,{key:`5cc90aa425ed700dc8a1b889a92340f5762f5e9a`,_active:this._active,_label:this._label,_open:this._open,_href:this._href,ref:e=>this.element=e},t(`slot`,{key:`3832c301625907e0ef1e38dad33daaa9beab37ee`}))}};i.style={default:r};export{i as kol_tree_item};