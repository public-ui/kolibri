...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 600px by 648px, received 600px by 336px. 17828 pixels (ratio 0.05 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    ...
    - toolbar "Toolbar" [ref=e10]:
      - link "Simple Link 1" [ref=e12] [cursor=pointer]:
        - /url: "#/back-page"
        - generic [ref=e15]: Simple Link 1
      - link "Simple Link 3" [ref=e17] [cursor=pointer]:
        - /url: "#/back-page"
        - generic [ref=e20]: Simple Link 3
    - heading "Orientation vertical" [level=2] [ref=e22]: Orientation vertical
    - toolbar "Toolbar" [ref=e24]:
      - link "Simple Link 1" [ref=e26] [cursor=pointer]:
        - /url: "#/back-page"
        - generic [ref=e29]: Simple Link 1
      - link "Simple Link 3" [ref=e31] [cursor=pointer]:
        - /url: "#/back-page"
        - generic [ref=e34]: Simple Link 3
```
