import{Tt as e,a as t,at as n,kt as r,o as i,s as a,xt as o}from"./index-Dwz0KUxk.js";import{n as s}from"./dev.utils-BRffKFmN-DfgFyiW1.js";import"./normalizers-BZrXYlGW-IA99kYF5.js";import"./label-CSEcI_DU-DU7moXSD.js";import"./variant-quote-eRKNTY3d-CUBcXZAZ.js";import"./base-controller-CXhqh4cR-BNzx0WwK.js";import"./base-web-component-BT6jbe_v-Vp21XLG3.js";import{n as c,t as l}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{t as u}from"./clsx-COFh-Vc8-alQuJLqj.js";import{t as d}from"./component-BKvFZabC--6IhDapF.js";import"./component-pgZmf771-A5IBN1Dx.js";import"./align-tkjswpJx-k6TkMTs9.js";import"./controller-CCnMMH-B-j4r2joqG.js";import"./component-Bpa5h0dJ-D_uNXajI.js";import"./label-with-expert-slot-Drx1G6Cn-n-3-zyhn.js";import"./name-CRrqyGmF-DmELLQJe.js";import"./controller-1CY9C0KT-DH0x59Ot.js";import"./render-DtYN9-tn-C8PlU7Ve.js";import"./Heading-CU0xxgIR-B9aHndr_.js";import"./disabled-ZHo6H_KF-yzU1BxE5.js";import"./label-BRWfnFOs-BckIpy8M.js";import"./element-focus-Cp994Rrk-BCxGGpIg.js";import"./element-click-CCljCb-a-Bw1_18r4.js";import{n as f,r as p,t as m}from"./element-interaction-Cfs3SP0D-C57YAP3J.js";import"./i18n-Apwu2-qw-gPnbzDp0.js";import"./Alert-BwexkSpu-NAXCyylp.js";import{n as h}from"./controller-DrnbiMMb-B9Me7vux.js";import"./aria-labelledby-6-ki3akM-C6lJ0lQF.js";import"./aria-details-DR-Z9997-U-Sv937B.js";import"./associated.controller-CT6Lmd81-BwSdF5fR.js";import"./hide-label-BhB7rwXD-B0EBVTtN.js";import"./tooltip-align-B74tZ8---o2mn4SWh.js";import"./isObject-Ciga7TRp-C01na7Ox.js";import"./access-and-short-key-ijzCZfHm-Dx5Q-CAn.js";import{c as g,o as _,s as v,t as y}from"./FormFieldStateWrapper-5fqguHtJ-CdJsJkKf.js";import{t as b}from"./Input-Dkrr-i12-BKQv5kLY.js";import"./required-C5vGoMQK-Cq-FKW0G.js";import"./orientation-BVJmIODT-RVPPfHHd.js";import{t as x}from"./controller-DeqLeuPb-Bl6_hZBc.js";import{t as S}from"./FieldControlStateWrapper-bQG9Envy-B2caSWXn.js";var C=(t,n)=>{e(t,`_checked`,n)},w=(t,n)=>{e(t,`_indeterminate`,n)},T=[`left`,`right`],E=(e,t)=>{r(e,`_labelAlign`,e=>typeof e==`string`&&T.includes(e),new Set([`KoliBriLabelAlign {${T.join(`, `)}`]),t)},D=[`button`,`default`,`switch`],O=e=>typeof e==`string`&&D.includes(e),k=(e,t)=>{r(e,`_variant`,O,new Set(D),t)},A=class extends x{constructor(e,t,n){super(e,t,n),this.setFormAssociatedCheckboxValue=e=>{this.component._checked?this.setFormAssociatedValue(e):this.setFormAssociatedValue(null)},this.component=e}validateChecked(e){C(this.component,e),this.setFormAssociatedCheckboxValue(this.component.state._value)}validateIcons(e){r(this.component,`_icons`,e=>{let t=e;return typeof t==`object`&&!!t&&(n(t.checked,1)||n(t.indeterminate,1)||n(t.unchecked,1))},new Set([`InputCheckboxIcons`]),e,{hooks:{beforePatch:(e,t,n)=>{t.set(`_icons`,Object.assign(Object.assign({},n.state._icons),e))}}})}validateIndeterminate(e){w(this.component,e)}validateLabelAlign(e){E(this.component,e)}validateValue(e){o(this.component,`_value`,e),this.setFormAssociatedCheckboxValue(this.component.state._value)}validateVariant(e){k(this.component,e)}componentWillLoad(){super.componentWillLoad(),this.validateChecked(this.component._checked),this.validateIcons(this.component._icons),this.validateIndeterminate(this.component._indeterminate),this.validateValue(this.component._value),this.validateVariant(this.component._variant),this.validateLabelAlign(this.component._labelAlign)}},j=e=>{var{class:t,variant:n=`default`,icon:r,inputProps:a}=e,o=c(e,[`class`,`variant`,`icon`,`inputProps`]);let{class:s}=a,l=c(a,[`class`]),f={[`kol-checkbox--variant-${n}`]:!0,"kol-checkbox--checked":a?.checked,"kol-checkbox--indeterminate":a?.indeterminate,"kol-checkbox--disabled":!!a?.disabled,"kol-checkbox--required":!!a?.required,"kol-checkbox--touched":!!a?.touched,[`kol-checkbox--${_(a?.msg)}`]:!!g(a?.msg,a?.touched)};return i(`label`,Object.assign({class:u(`kol-checkbox`,f,t)},o),i(d,{label:``,icons:r,class:u(`kol-checkbox__icon`)}),i(b,Object.assign({class:u(`kol-checkbox__input`,s)},l,{type:`checkbox`})))};function M(e,t={}){let{ariaDescribedBy:n}=v(e),r={id:e._id,hideLabel:e._hideLabel,label:e._label,value:e._value,accessKey:e._accessKey,disabled:e._disabled,name:e._name,ariaDescribedBy:n};return`_required`in e&&(r.required=e._required),`_checked`in e&&(r.checked=e._checked),`_indeterminate`in e&&(r.indeterminate=e._indeterminate),`_touched`in e&&(r.touched=e._touched),`_msg`in e&&(r.msg=e._msg),`_shortKey`in e&&(r[`aria-keyshortcuts`]=e._shortKey),Object.assign(Object.assign({},r),t)}var N=e=>{var{state:t,inputProps:n}=e,r=c(e,[`state`,`inputProps`]);let a=t?._variant||`default`;return i(j,Object.assign({variant:a,inputProps:M(t,n)},r))},P=`@charset "UTF-8";
/*
