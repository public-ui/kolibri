...
- Name: theme-snapshots.spec.js >> snapshot for popover-button/basic
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  1125 pixels (ratio 0.03 of all image pixels) are different.

  Snapshot: snapshot-for-popover-button-basic.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-popover-button-basic.png)" with timeout 10000ms
...
```yaml
- main [ref=e4]:
  - heading "popover-button basic" [level=1] [ref=e5]
  - generic [ref=e6]:
    - generic [ref=e8]:
      - button "Actions" [expanded] [ref=e10] [cursor=pointer]:
        - generic [ref=e12]:
          - generic [ref=e13]: Actions
          - generic [ref=e14]: 
      - generic:
        - generic:
          - generic:
