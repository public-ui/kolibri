...
- Name: theme-snapshots.spec.js >> snapshot for skip-nav/basic
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  1488 pixels (ratio 0.03 of all image pixels) are different.

  Snapshot: snapshot-for-skip-nav-basic.png

Call log:
  - Expect "toHaveScreenshot(snapshot-for-skip-nav-basic.png)" with timeout 10000ms
...
- main [ref=e4]:
  - generic [ref=e5]:
    - heading "skip-nav basic" [level=1] [ref=e6]
    - generic [active] [ref=e7]:
      - navigation "Hidden navigation":
        - list:
          - listitem:
            - link "To the top" [ref=e9] [cursor=pointer]:
              - /url: "#/back-page"
              - generic [ref=e12]: To the top
          - listitem:
            - link "To the form" [ref=e13] [cursor=pointer]:
              - /url: "#/back-page"
              - generic [ref=e16]: To the form
          - listitem:
            - link "To the end" [ref=e17] [cursor=pointer]:
              - /url: "#/back-page"
              - generic [ref=e20]: To the end
```
