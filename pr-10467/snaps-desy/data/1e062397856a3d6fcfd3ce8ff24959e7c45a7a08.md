...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 300px by 150px, received 300px by 110px. 1435 pixels (ratio 0.04 of all image pixels) are different.
...
- main [ref=e4]:
  ...
  - toolbar "Toolbar" [ref=e7]:
    - link "Simple Link 1" [ref=e9] [cursor=pointer]:
      - /url: "#/back-page"
      - generic [ref=e12]: Simple Link 1
    - link "Simple Link 3" [disabled] [ref=e14]:
      - /url: "#/back-page"
      - generic [ref=e17]: Simple Link 3
```
