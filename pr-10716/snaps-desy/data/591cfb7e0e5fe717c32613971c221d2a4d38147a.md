...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  844 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: scenarios-focus-elements-component-tree.png

Call log:
  - Expect "toHaveScreenshot(scenarios-focus-elements-component-tree.png)" with timeout 10000ms
