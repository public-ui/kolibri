...
- Name: theme-snapshots.spec.js >> snapshot for scenarios/focus-elements?component=skipNav
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  2330 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: scenarios-focus-elements-component-skipNav.png

Call log:
  - Expect "toHaveScreenshot(scenarios-focus-elements-component-skipNav.png)" with timeout 10000ms
