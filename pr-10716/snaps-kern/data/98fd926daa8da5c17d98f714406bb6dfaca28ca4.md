...
Locator: locator('[data-visual-block="disabled"]')
  209 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: toolbar-disabled--disabled.png

Call log:
  - Expect "toHaveScreenshot(toolbar-disabled--disabled.png)" with timeout 10000ms
    - verifying given screenshot expectation
  - waiting for locator('[data-visual-block="disabled"]')
    - locator resolved to <div class="grid gap-4" data-visual-block="disabled">…</div>
...
- main [ref=e4]:
  ...
  - toolbar "Toolbar" [ref=e9]:
    ...
    - link "Simple Link 3" [disabled] [ref=e28]:
      - /url: "#/back-page"
