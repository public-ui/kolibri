import{o as e,r as t,s as n}from"./index-9vMV5hoz.js";import{t as r}from"./base-web-component-BT6jbe_v-Vp21XLG3.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import"./_Uint8Array-kJHDjtoP-CTkgs_0o.js";import{n as i,o as a,r as o}from"./normalizers-RsAiP75w-B_Eo3QYo.js";import"./i18n-DgDFcMJR-BZ64DbK8.js";import{t as s}from"./label-MOYwy6Oe-CRYzJGd9.js";import"./variant-quote-De3z_dUL-uEfcbIFi.js";import{t as c}from"./base-controller-CXhqh4cR-BNzx0WwK.js";import{t as l}from"./component-D7oQikTL-DPvLNNY1.js";var u=i(`show`,!1,o),d=[`dot`,`cycle`,`none`],f=i(`variant`,`dot`,e=>{let t=a(e);if(d.includes(t))return t;throw Error(`Invalid spin variant: ${t}`)},()=>!0),p={optional:[s,u,f]},m=class extends c{constructor(e){super(e,p)}componentWillLoad(e){let{show:t,label:n,variant:r}=e;this.watchShow(t),this.watchLabel(n),this.watchVariant(r)}watchShow(e){u.apply(e,e=>{this.setRenderProp(`show`,e)})}watchLabel(e){s.apply(e,e=>{this.setRenderProp(`label`,e)})}watchVariant(e){f.apply(e,e=>{this.setRenderProp(`variant`,e)})}},h=`@charset "UTF-8";
