...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/default/snapshots/theme-default/form-error-list--error-list-firefox-linux.png, writing actual.
```
      ...
      - generic [ref=e36]:
        ...
        - generic [ref=e48]:
          ...
          - alert [ref=e57]:
            ...
            - generic [ref=e59]: 
            - generic [ref=e60]: Input error
        - generic [ref=e62]:
          - generic [ref=e66] [cursor=pointer]: Input 3
          - textbox "Input 3" [ref=e70]
          - alert [ref=e71]:
            - generic [ref=e72]: Error
            - generic [ref=e73]: 
            - generic [ref=e74]: Input error
        - generic [ref=e76]:
