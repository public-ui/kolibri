...
- Name: theme-snapshots.spec.js >> snapshot for card/linked
- Location: tests/theme-snapshots.spec.js:82:2

# Error details

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/default/snapshots/theme-default/card-linked--linked-firefox-linux.png, writing actual.
```
...
```yaml
- main [ref=e4]:
  - heading "card linked" [level=1] [ref=e5]
  - generic [ref=e7]:
    - article "Card with title and content" [ref=e10]:
      - link "Card with title and content" [ref=e11] [cursor=pointer]:
        - /url: "#/back-page"
        - strong [ref=e12]: Card with title and content
      - paragraph [ref=e14]: This card has a link.
    - article "Card with title and content" [ref=e17]:
      - link "Card with title and content" [ref=e18] [cursor=pointer]:
        - /url: "#/back-page"
        - strong [ref=e19]: Card with title and content
      - paragraph [ref=e21]: This card has a link and a target.
```
