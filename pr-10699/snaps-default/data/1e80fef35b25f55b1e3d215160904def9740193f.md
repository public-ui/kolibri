...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/default/snapshots/theme-default/split-button-basic--basic-firefox-linux.png, writing actual.
```
