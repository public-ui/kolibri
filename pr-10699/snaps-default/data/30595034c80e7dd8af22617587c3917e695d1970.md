...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/default/snapshots/theme-default/tabs-create-button--create-button-firefox-linux.png, writing actual.
```
