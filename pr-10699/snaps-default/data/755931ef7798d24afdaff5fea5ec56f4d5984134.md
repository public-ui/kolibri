...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/default/snapshots/theme-default/textarea-with-counter--with-counter-firefox-linux.png, writing actual.
```
