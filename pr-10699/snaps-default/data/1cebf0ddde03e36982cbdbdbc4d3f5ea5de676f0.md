...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/default/snapshots/theme-default/table-stateless-with-single-selection--single-selection-firefox-linux.png, writing actual.
```
...
- main [ref=e4]:
  ...
  - table "Table with selection checkboxes" [ref=e12]:
    - caption [ref=e13]: Table with selection checkboxes
    - rowgroup [ref=e14]:
      - 'row "Selection #ID Name Action" [ref=e15]':
    ...
    - rowgroup [ref=e21]:
      - alert [ref=e22]: Data in table Table with selection checkboxes got loaded.
      - row "Selection for Foo Bar 1001 Foo Bar Click 1001" [ref=e23]:
        - cell "Selection for Foo Bar" [ref=e24]:
          - radio "Selection for Foo Bar" [ref=e27] [cursor=pointer]
        - cell "1001" [ref=e28]
      ...
      - row "Selection for Foo Baz 1002 Foo Baz Click 1002" [ref=e37]:
        - cell "Selection for Foo Baz" [ref=e38]:
          - radio "Selection for Foo Baz" [ref=e41] [cursor=pointer]
        - cell "1002" [ref=e42]
        - cell "Foo Baz" [ref=e43]
        - cell "Click 1002" [ref=e44]:
          - button "Click 1002" [ref=e47] [cursor=pointer]:
            - generic [ref=e50]: Click 1002
      - row "Selection for Foo Disabled 1003 Foo Disabled Click 1003" [ref=e51]:
        - cell "Selection for Foo Disabled" [ref=e52]:
          - radio "Selection for Foo Disabled" [disabled] [ref=e55]
        - cell "1003" [ref=e56]
        - cell "Foo Disabled" [ref=e57]
