...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/default/snapshots/theme-default/input-password-show-password-noColumns--show-password-firefox-linux.png, writing actual.
```
    ...
    - generic:
      - generic [ref=e12]:
        ...
        - generic [ref=e18]:
          ...
          - button "Show" [ref=e24] [cursor=pointer]:
            - generic [ref=e27]: 
      - generic [ref=e29]:
        ...
        - generic [ref=e35]:
          - textbox "Password" [ref=e38]:
            - /placeholder: With 'Show password' button
          - button "Show" [ref=e41] [cursor=pointer]:
            - generic [ref=e44]: 
      - generic [ref=e46]:
        - generic [ref=e50]: Password
        - generic [ref=e52]:
          - textbox "Password" [disabled] [ref=e55]:
            - /placeholder: With 'Show password' button and disabled
          - button "Show" [disabled] [ref=e58]:
            - generic [ref=e61]: 
```
