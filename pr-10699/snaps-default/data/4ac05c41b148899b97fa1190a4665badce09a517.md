...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/default/snapshots/theme-default/table-stateful-with-single-selection--single-selection-firefox-linux.png, writing actual.
```
