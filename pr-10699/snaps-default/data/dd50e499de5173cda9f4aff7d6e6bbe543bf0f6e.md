...
- Name: theme-snapshots.spec.js >> snapshot for input-radio/object?noColumns
- Location: tests/theme-snapshots.spec.js:82:2

# Error details

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/default/snapshots/theme-default/input-radio-object-noColumns--object-value-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/default/snapshots/theme-default/input-radio-object-noColumns--no-value-firefox-linux.png, writing actual.
```
...
- main [ref=e4]:
  - generic [ref=e5]:
    - heading "input-radio object" [level=1] [ref=e6]
    - generic [ref=e8]:
      - paragraph [ref=e9]: Form fields marked with an asterisk (*) are mandatory.
      - generic:
        - paragraph [ref=e10]:
          - text: In this example for
          - code [ref=e11]: KolInputRadio
          - text: ", the values of the options are defined as objects."
        - group "Test (with object value)" [ref=e15]:
          - generic [ref=e19] [cursor=pointer]: Test (with object value)
          - generic [ref=e20]:
            - generic [ref=e21]:
              - radio "Field 1" [ref=e24] [cursor=pointer]
              - generic [ref=e28] [cursor=pointer]: Field 1
            - generic [ref=e29]:
              - radio "Field 2" [checked] [ref=e32] [cursor=pointer]
              - generic [ref=e36] [cursor=pointer]: Field 2
        - paragraph [ref=e37]:
          - text: In this example for
          - code [ref=e38]: KolInputRadio
          - text: ", no value is set."
        - group "Test (without value)" [ref=e42]:
          - generic [ref=e46] [cursor=pointer]: Test (without value)
          - generic [ref=e47]:
            - generic [ref=e48]:
              - radio "Field 1" [ref=e51] [cursor=pointer]
              - generic [ref=e55] [cursor=pointer]: Field 1
            - generic [ref=e56]:
              - radio "Field 2" [ref=e59] [cursor=pointer]
              - generic [ref=e63] [cursor=pointer]: Field 2
```
