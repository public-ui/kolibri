...
- Name: theme-snapshots.spec.js >> snapshot for scenarios/focus-elements?component=inputEmail
- Location: tests/theme-snapshots.spec.js:82:2

# Error details

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/default/snapshots/theme-default/scenarios-focus-elements-component-inputEmail-firefox-linux.png, writing actual.
```
