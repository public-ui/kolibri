...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/default/snapshots/theme-default/table-stateless-with-selection--selection-firefox-linux.png, writing actual.
```
