...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/default/snapshots/theme-default/popover-button-basic-firefox-linux.png, writing actual.
```
