...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/default/snapshots/theme-default/link-target--target-firefox-linux.png, writing actual.
```
...
- main [ref=e4]:
  ...
  - list [ref=e8]:
    - listitem [ref=e9]:
      - link "Link without target" [ref=e12] [cursor=pointer]:
        - /url: "#/back-page"
        - generic [ref=e15]: Link without target
    - listitem [ref=e16]:
      - link "Link with target (_self)" [ref=e19] [cursor=pointer]:
        - /url: "#/back-page"
        - generic [ref=e22]: Link with target (_self)
    - listitem [ref=e23]:
      - link "Link with target (_blank) Opens in new tab." [ref=e26] [cursor=pointer]:
        - /url: "#/back-page"
        - generic [ref=e29]: Link with target (_blank)
        - img "Opens in new tab." [ref=e30]: 
    - listitem [ref=e31]:
      - link "Link without target" [ref=e34] [cursor=pointer]:
        - /url: "#/back-page"
        - generic [ref=e37]: 
    - listitem [ref=e38]:
      - link "Link with target (_self)" [ref=e41] [cursor=pointer]:
        - /url: "#/back-page"
        - generic [ref=e44]: 
    - listitem [ref=e45]:
      - link "Link with target (_blank) (Opens in new tab.)" [ref=e48] [cursor=pointer]:
        - /url: "#/back-page"
        - generic [ref=e51]: 
        - generic [ref=e52]: 
```
