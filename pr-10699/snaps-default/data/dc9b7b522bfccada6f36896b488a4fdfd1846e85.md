...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/default/snapshots/theme-default/scenarios-focus-elements-component-inputText-firefox-linux.png, writing actual.
```
