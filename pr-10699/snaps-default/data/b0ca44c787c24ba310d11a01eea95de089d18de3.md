...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/default/snapshots/theme-default/link-button-basic--variants-firefox-linux.png, writing actual.
```
