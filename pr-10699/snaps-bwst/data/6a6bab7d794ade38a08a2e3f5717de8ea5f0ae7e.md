...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/bwst/snapshots/theme-bwst/input-text-counter-noColumns--counter-firefox-linux.png, writing actual.
```
