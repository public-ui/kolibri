...
- Name: theme-snapshots.spec.js >> snapshot for input-text/readonly?noColumns
- Location: tests/theme-snapshots.spec.js:82:2

# Error details

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/bwst/snapshots/theme-bwst/input-text-readonly-noColumns--placeholder-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/bwst/snapshots/theme-bwst/input-text-readonly-noColumns--value-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/bwst/snapshots/theme-bwst/input-text-readonly-noColumns--info-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/bwst/snapshots/theme-bwst/input-text-readonly-noColumns--editable-firefox-linux.png, writing actual.
```
...
- main [ref=e4]:
  - generic [ref=e5]:
    - heading "input-text readonly" [level=1] [ref=e6]
    - generic [ref=e10]:
      - generic [ref=e11] [cursor=pointer]:
        - generic [ref=e14]: Readonly with placeholder
        - generic [ref=e15]: (read-only)
      - textbox "Readonly with placeholder" [ref=e19]:
        - /placeholder: Placeholder text
    - generic [ref=e23]:
      - generic [ref=e24] [cursor=pointer]:
        - generic [ref=e27]: Readonly with value
        - generic [ref=e28]: (read-only)
      - textbox "Readonly with value" [ref=e32]: This field is readonly
    - generic [ref=e36]:
      - generic [ref=e37] [cursor=pointer]:
        - generic [ref=e40]: Readonly with info message
        - generic [ref=e41]: (read-only)
      - textbox "Readonly with info message" [ref=e45]: Read-only value
      - alert [ref=e46]:
        - generic [ref=e47]: Note
        - generic [ref=e48]: 
        - generic [ref=e49]: This field cannot be edited
    - generic [ref=e53]:
      - generic [ref=e57] [cursor=pointer]: "Comparison: Editable"
      - 'textbox "Comparison: Editable" [ref=e61]': This field is editable
```
