...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/bwst/snapshots/theme-bwst/input-password-show-password-noColumns--show-password-firefox-linux.png, writing actual.
```
