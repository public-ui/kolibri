...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/bwst/snapshots/theme-bwst/popover-button-inline--inline-firefox-linux.png, writing actual.
```
...
```yaml
- main [ref=e4]:
  - heading "popover-button inline" [level=1] [ref=e5]
  - paragraph [ref=e8]:
    - text: Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur aut dolore dolores itaque praesentium.
    - button "Help" [ref=e12] [cursor=pointer]:
      - generic [ref=e15]: 
    - text: Exercitationem ipsa magni maiores modi, placeat quas quos reprehenderit rerum sit veniam vitae.
```
