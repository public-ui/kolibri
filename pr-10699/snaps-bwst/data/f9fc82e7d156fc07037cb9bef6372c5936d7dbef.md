...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/bwst/snapshots/theme-bwst/table-column-alignment--column-alignment-firefox-linux.png, writing actual.
```
