...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/bwst/snapshots/theme-bwst/link-button-basic--variants-firefox-linux.png, writing actual.
```
