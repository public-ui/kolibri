...
- Name: theme-snapshots.spec.js >> snapshot for quote/basic
- Location: tests/theme-snapshots.spec.js:82:2

# Error details

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/bwst/snapshots/theme-bwst/quote-basic--basic-firefox-linux.png, writing actual.
```
...
```yaml
- main [ref=e4]:
  - heading "quote basic" [level=1] [ref=e5]
  - figure [ref=e9]:
    - generic [ref=e10]: Avian carriers can provide high delay.
```
