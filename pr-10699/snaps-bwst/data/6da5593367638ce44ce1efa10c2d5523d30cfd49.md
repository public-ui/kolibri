...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/bwst/snapshots/theme-bwst/select-multiple-dropdown--kol-select-firefox-linux.png, writing actual.
```
