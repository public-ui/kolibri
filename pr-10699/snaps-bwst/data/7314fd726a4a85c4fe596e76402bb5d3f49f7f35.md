...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/bwst/snapshots/theme-bwst/scenarios-focus-elements-component-inputRange-firefox-linux.png, writing actual.
```
