...
- Name: theme-snapshots.spec.js >> snapshot for tabs/icons-only
- Location: tests/theme-snapshots.spec.js:82:2

# Error details

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/bwst/snapshots/theme-bwst/tabs-icons-only--icons-only-firefox-linux.png, writing actual.
```
...
```yaml
- main [ref=e4]:
  - heading "tabs icons-only" [level=1] [ref=e5]
  - generic [ref=e9]:
    - tablist "Tabs with icons" [ref=e10]:
      - tab "First tab" [selected] [ref=e12] [cursor=pointer]:
        - generic [ref=e15]: 
      - tab "Second Tab" [ref=e17] [cursor=pointer]:
        - generic [ref=e20]: 
      - tab "Disabled Tab" [disabled] [ref=e22]:
        - generic [ref=e25]: 
      - tab "Last tab" [ref=e27] [cursor=pointer]:
        - generic [ref=e30]: 
    - tabpanel "First tab" [ref=e32]:
      - generic [ref=e33]: Contents of Tab 1
```
