...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/bwst/snapshots/theme-bwst/scenarios-focus-elements-component-inputNumber-firefox-linux.png, writing actual.
```
