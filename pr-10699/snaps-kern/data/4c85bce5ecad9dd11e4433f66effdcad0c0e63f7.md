...
- Name: theme-snapshots.spec.js >> snapshot for input-number/number-formatter
- Location: tests/theme-snapshots.spec.js:82:2

# Error details

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/kern/snapshots/theme-kern_v2/input-number-number-formatter--whole-number-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/kern/snapshots/theme-kern_v2/input-number-number-formatter--currency-firefox-linux.png, writing actual.
```
...
```yaml
- main [ref=e4]:
  - heading "input-number number-formatter" [level=1] [ref=e5]
  - generic [ref=e6]:
    - generic [ref=e8]:
      - generic [ref=e10]:
        - paragraph [ref=e11]: Form fields marked with an asterisk (*) are mandatory.
        - generic [ref=e13]:
          - generic [ref=e17] [cursor=pointer]: Whole number
          - spinbutton "Whole number" [ref=e21]: "-128"
      - generic [ref=e22]: "{ \"value\": -128, \"touched\": false }"
    - generic [ref=e24]:
      - generic [ref=e26]:
        - paragraph [ref=e27]: Form fields marked with an asterisk (*) are mandatory.
        - generic [ref=e29]:
          - generic [ref=e33] [cursor=pointer]: Currency
          - textbox "Currency" [ref=e37]: 1,000,000€
      - generic [ref=e38]: "{ \"currency\": 1000000 }"
```
