...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/kern/snapshots/theme-kern_v2/form-error-list--error-list-firefox-linux.png, writing actual.
```
