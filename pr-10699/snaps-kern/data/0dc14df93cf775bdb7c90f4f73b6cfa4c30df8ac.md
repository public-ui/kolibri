...
- Name: theme-snapshots.spec.js >> snapshot for button-link/basic
- Location: tests/theme-snapshots.spec.js:82:2

# Error details

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/kern/snapshots/theme-kern_v2/button-link-basic--basic-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/kern/snapshots/theme-kern_v2/button-link-basic--disabled-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/kern/snapshots/theme-kern_v2/button-link-basic--access-key-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/kern/snapshots/theme-kern_v2/button-link-basic--short-key-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/kern/snapshots/theme-kern_v2/button-link-basic--variant-firefox-linux.png, writing actual.
```
...
```yaml
- main [ref=e4]:
  - heading "button-link basic" [level=1] [ref=e5]
  - heading "Button-Link with _inline" [level=2] [ref=e7]: Button-Link with _inline
  - paragraph [ref=e8]:
    - text: In this paragraph, a link is inserted that contains no additional attributes.
    - button "Simple Link" [ref=e11] [cursor=pointer]:
      - generic [ref=e14]: Simple Link
    - text: It is rendered by default as an
    - strong [ref=e15]: inline element
    - text: .
  - paragraph [ref=e16]:
    - text: In this paragraph, a link is inserted that is rendered as an inline-block element.
    - button "Simple Link" [ref=e19] [cursor=pointer]:
      - generic [ref=e22]: Simple Link
    ...
    - button "Simple Link" [ref=e25] [cursor=pointer]:
      - generic [ref=e28]: Simple Link
    - text: Therefore, I go over the entire width of the parent element to create a line break.
  - 'heading "Button-Link with _inline={false}" [level=2] [ref=e30]': "Button-Link with _inline={false}"
  - paragraph [ref=e31]: Use the boolean _inline property to render the link inline (default) or standalone.
  - button "Standalone ButtonLink" [ref=e36] [cursor=pointer]:
    - generic [ref=e39]: Standalone ButtonLink
  - button "Disabled ButtonLink" [disabled] [ref=e44]:
    - generic [ref=e47]: Disabled ButtonLink
  - button "With access key" [ref=e52] [cursor=pointer]:
    - generic [ref=e54]:
      - generic [ref=e55]: With access key
      - generic [ref=e56]: c
  - button "With short key" [ref=e61] [cursor=pointer]:
    - generic [ref=e63]:
      - generic [ref=e64]: With short key
      - generic [ref=e65]: s
  - button "Special Variant ButtonLink" [ref=e70] [cursor=pointer]:
    - generic [ref=e73]: Special Variant ButtonLink
```
