...
- Name: theme-snapshots.spec.js >> snapshot for badge/basic
- Location: tests/theme-snapshots.spec.js:82:2

# Error details

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/kern/snapshots/theme-kern_v2/badge-basic--basic-vertical-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/kern/snapshots/theme-kern_v2/badge-basic--basic-horizontal-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/kern/snapshots/theme-kern_v2/badge-basic--smart-button-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/kern/snapshots/theme-kern_v2/badge-basic--formatted-label-firefox-linux.png, writing actual.
```
...
```yaml
- main [ref=e4]:
  - heading "badge basic" [level=1] [ref=e5]
  - generic [ref=e6]:
    - generic [ref=e7]:
      - heading "Basic Badges vertical" [level=2] [ref=e9]: Basic Badges vertical
      - generic [ref=e10]:
        - generic [ref=e15]: black (default)
        - generic [ref=e20]: blue
        - generic [ref=e24]:
          - generic [ref=e25]: 
          - generic [ref=e26]: red with icon
        - generic [ref=e30]:
          - generic [ref=e31]: 
          - generic [ref=e32]: purple with icon
    - generic [ref=e33]:
      - heading "Basic Badges horizontal" [level=2] [ref=e35]: Basic Badges horizontal
      - generic [ref=e36]:
        - generic [ref=e41]: black
        - generic [ref=e46]: blue
        - generic [ref=e50]:
          - generic [ref=e51]: 
          - generic [ref=e52]: red with icon
    - generic [ref=e53]:
      - heading "Badges with Smart Button" [level=2] [ref=e55]: Badges with Smart Button
      - generic [ref=e56]:
        - generic [ref=e58]:
          - generic [ref=e61]: blue
          - generic [ref=e62]:
            - button "Remove" [ref=e63] [cursor=pointer]:
              - generic [ref=e66]: 
            - generic [ref=e67]: blue
        - generic [ref=e69]:
          - generic [ref=e71]:
            - generic [ref=e72]: 
            - generic [ref=e73]: purple with icon
          - generic [ref=e74]:
            - button "Remove" [ref=e75] [cursor=pointer]:
              - generic [ref=e78]: 
            - generic [ref=e79]: purple with icon
    - generic [ref=e80]:
      - heading "Formatted Label" [level=2] [ref=e82]: Formatted Label
      - generic [ref=e83]:
        - generic [ref=e88]:
          - strong [ref=e89]: Bold
          - text: and
          - emphasis [ref=e90]: italic
          - text: Markdown label
        - generic [ref=e95]: This is strikethrough text
        - generic [ref=e100]:
          - text: Source code like
          - code [ref=e101]: y = mx + n
          - text: is possible
```
