...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/kern/snapshots/theme-kern_v2/scenarios-focus-elements-component-inputFileMultiple-firefox-linux.png, writing actual.
```
...
- main [ref=e4]:
  - generic [ref=e7]:
    ...
    - generic [ref=e14]:
      - button "Files (multiple)" [ref=e15] [cursor=pointer]
