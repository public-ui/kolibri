...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/kern/snapshots/theme-kern_v2/popover-button-inline--inline-firefox-linux.png, writing actual.
```
