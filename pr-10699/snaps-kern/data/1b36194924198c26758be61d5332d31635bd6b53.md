...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/kern/snapshots/theme-kern_v2/input-password-show-password-noColumns--show-password-firefox-linux.png, writing actual.
```
...
- main [ref=e4]:
  ...
  - generic [ref=e9]:
    ...
    - generic:
      - generic [ref=e12]:
        - generic [ref=e16] [cursor=pointer]: Password
        - generic [ref=e18]:
      ...
      - generic [ref=e44]:
        ...
        - generic [ref=e50]:
          - textbox "Password" [disabled] [ref=e52]:
            - /placeholder: With 'Show password' button and disabled
          - button "Show" [disabled] [ref=e55]:
            - generic [ref=e58]: 
```
