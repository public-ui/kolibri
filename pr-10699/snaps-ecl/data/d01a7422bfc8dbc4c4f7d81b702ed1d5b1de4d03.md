...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/ecl/snapshots/theme-ecl_ec/scenarios-focus-elements-component-card-firefox-linux.png, writing actual.
```
