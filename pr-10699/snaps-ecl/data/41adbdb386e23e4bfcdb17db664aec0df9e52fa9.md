...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/ecl/snapshots/theme-ecl_ec/toolbar-basic--horizontal-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/ecl/snapshots/theme-ecl_ec/toolbar-basic--vertical-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/ecl/snapshots/theme-ecl_ec/toolbar-basic--horizontal-320-firefox-linux.png, writing actual.
```
...
- main [ref=e4]:
  ...
  - generic [ref=e6]:
    ...
    - toolbar "Toolbar" [ref=e11]:
      - button "Back" [ref=e13] [cursor=pointer]:
        - generic [ref=e16]: 
      - button "Next" [ref=e18] [cursor=pointer]:
        - generic [ref=e21]: 
      - link "Simple Link 1" [ref=e23] [cursor=pointer]:
        - /url: "#/back-page"
        - generic [ref=e26]: Simple Link 1
      - link "Simple Link 3" [ref=e28] [cursor=pointer]:
        - /url: "#/back-page"
        - generic [ref=e31]: Simple Link 3
      - button "Bold" [ref=e33] [cursor=pointer]:
        - generic [ref=e36]: Bold
      - button "Delete" [ref=e38] [cursor=pointer]:
        - generic [ref=e40]:
          - generic [ref=e41]: Delete
          - generic [ref=e42]: 
  - generic [ref=e43]:
    - heading "Orientation vertical" [level=2] [ref=e45]: Orientation vertical
    - toolbar "Toolbar" [ref=e48]:
      - button "Back" [ref=e50] [cursor=pointer]:
        - generic [ref=e53]: 
      - button "Next" [ref=e55] [cursor=pointer]:
        - generic [ref=e58]: 
      - link "Simple Link 1" [ref=e60] [cursor=pointer]:
        - /url: "#/back-page"
        - generic [ref=e63]: Simple Link 1
      - link "Simple Link 3" [ref=e65] [cursor=pointer]:
        - /url: "#/back-page"
        - generic [ref=e68]: Simple Link 3
      - button "Bold" [ref=e70] [cursor=pointer]:
        - generic [ref=e73]: Bold
      - button "Delete" [ref=e75] [cursor=pointer]:
        - generic [ref=e77]:
          - generic [ref=e78]: Delete
          - generic [ref=e79]: 
```
