...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/ecl/snapshots/theme-ecl_ec/select-multiple-dropdown--kol-select-firefox-linux.png, writing actual.
```
