...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/ecl/snapshots/theme-ecl_ec/input-password-show-password-noColumns--show-password-firefox-linux.png, writing actual.
```
