...
- Name: theme-snapshots.spec.js >> snapshot for input-text/basic?noColumns
- Location: tests/theme-snapshots.spec.js:82:2

# Error details

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/ecl/snapshots/theme-ecl_ec/input-text-basic-noColumns--events-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/ecl/snapshots/theme-ecl_ec/input-text-basic-noColumns--error-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/ecl/snapshots/theme-ecl_ec/input-text-basic-noColumns--hint-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/ecl/snapshots/theme-ecl_ec/input-text-basic-noColumns--disabled-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/ecl/snapshots/theme-ecl_ec/input-text-basic-noColumns--info-popover-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/ecl/snapshots/theme-ecl_ec/input-text-basic-noColumns--readonly-popover-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/ecl/snapshots/theme-ecl_ec/input-text-basic-noColumns--icon-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/ecl/snapshots/theme-ecl_ec/input-text-basic-noColumns--search-firefox-linux.png, writing actual.
```
...
- main [ref=e4]:
  - generic [ref=e5]:
    - heading "input-text basic" [level=1] [ref=e6]
    - generic [ref=e10]:
      - generic [ref=e14] [cursor=pointer]: Name
      - textbox "Name" [ref=e18]: Anderson-Clark
    - generic [ref=e22]:
      - generic [ref=e26] [cursor=pointer]: Name
      - textbox "Name" [ref=e30]
      - alert [ref=e31]:
        - generic [ref=e32]: Error
        - generic [ref=e33]: 
        - generic [ref=e34]: Please enter your name
    - generic [ref=e38]:
      - generic [ref=e42] [cursor=pointer]: Name
      - textbox "Name" [ref=e46]
      - generic [ref=e47]: Enter your surname
    - generic [ref=e51]:
      - generic [ref=e55]: Name
      - textbox "Name" [disabled] [ref=e59]: Anderson-Clark
    - generic [ref=e63]:
      - generic [ref=e64] [cursor=pointer]:
        - generic [ref=e67]: Name
        - button "hint" [ref=e70]:
          - generic [ref=e73]: 
      - textbox "Name hint" [ref=e77]: Anderson-Clark
    - generic [ref=e81]:
      - generic [ref=e82] [cursor=pointer]:
        - generic [ref=e85]: Name
        - button "hint" [ref=e88]:
          - generic [ref=e91]: 
      - textbox "Name hint" [ref=e95]: Anderson-Clark
    - generic [ref=e99]:
      - generic [ref=e103] [cursor=pointer]: Name
      - generic [ref=e105]:
        - generic [ref=e107]: 
        - textbox "Name" [ref=e109]: Anderson-Clark
    - generic [ref=e114]:
      - generic [ref=e118] [cursor=pointer]: Search
      - generic [ref=e120]:
        - searchbox "Search" [ref=e123]: test
        - button "Clear search" [ref=e126] [cursor=pointer]:
          - generic [ref=e129]: 
```
