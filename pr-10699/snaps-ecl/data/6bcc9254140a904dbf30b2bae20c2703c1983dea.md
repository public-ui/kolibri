...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/ecl/snapshots/theme-ecl_ec/heading-secondary--secondary-firefox-linux.png, writing actual.
```
