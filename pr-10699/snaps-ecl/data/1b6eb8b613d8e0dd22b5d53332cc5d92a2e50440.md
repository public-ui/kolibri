...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/ecl/snapshots/theme-ecl_ec/modal-basic-show-dialog-true-firefox-linux.png, writing actual.
```
