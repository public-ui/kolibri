...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/scenarios-focus-elements-component-textarea-firefox-linux.png, writing actual.
```
