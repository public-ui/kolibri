...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/heading-basic--basic-firefox-linux.png, writing actual.
```
