...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/scenarios-focus-elements-component-card-firefox-linux.png, writing actual.
```
