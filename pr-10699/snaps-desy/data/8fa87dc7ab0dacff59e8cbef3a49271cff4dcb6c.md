...
- Name: theme-snapshots.spec.js >> snapshot for meter/basic
- Location: tests/theme-snapshots.spec.js:82:2

# Error details

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/meter-basic--basic-firefox-linux.png, writing actual.
```
...
```yaml
- main [ref=e4]:
  - heading "meter basic" [level=1] [ref=e5]
  - generic [ref=e7]:
    - heading "Basic" [level=2] [ref=e9]: Basic
    - generic [ref=e11]:
      - generic [ref=e14]:
        - generic [ref=e15]: Storage used
        - meter "Storage used" [ref=e17]
        - generic [ref=e18]:
          - generic [ref=e19]: "50"
          - text: "%"
      - generic [ref=e22]:
        - generic [ref=e23]: Weight
        - meter "Weight" [ref=e25]
        - generic [ref=e26]:
          - generic [ref=e27]: "75"
          - text: kg
      - generic [ref=e30]:
        - generic [ref=e31]: Temperature
        - meter "Temperature" [ref=e33]
        - generic [ref=e34]:
          - generic [ref=e35]: "-50"
          - text: °C
```
