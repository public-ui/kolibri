...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/input-email-basic-noColumns--label-black-bg-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/input-email-basic-noColumns--label-suggestions-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/input-email-basic-noColumns--label-info-popover-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/input-email-basic-noColumns--label-msg-info-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/input-email-basic-noColumns--label-msg-warning-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/input-email-basic-noColumns--label-msg-success-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/input-email-basic-noColumns--label-msg-default-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/input-email-basic-noColumns--label-disabled-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/input-email-basic-noColumns--label-readonly-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/input-email-basic-noColumns--label-access-key-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/input-email-basic-noColumns--label-short-key-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/input-email-basic-noColumns--hide-label-suggestions-firefox-linux.png, writing actual.
```
        ...
        - generic [ref=e14]:
          ...
          - generic [ref=e51]:
            - generic [ref=e52] [cursor=pointer]:
              ...
              - button "hint" [ref=e58]:
                - generic [ref=e61]: 
            - textbox "E-Mail hint" [ref=e65]
          - generic [ref=e69]:
            - generic [ref=e73] [cursor=pointer]: E-Mail
            ...
            - alert [ref=e78]:
              ...
              - text: Just a hint
          - generic [ref=e84]:
            - generic [ref=e88] [cursor=pointer]: E-Mail
            ...
            - alert [ref=e93]:
              ...
              - text: Small warning
          - generic [ref=e99]:
            - generic [ref=e103] [cursor=pointer]: E-Mail
          ...
          - generic [ref=e114]:
            - generic [ref=e118] [cursor=pointer]: E-Mail
            - textbox "E-Mail" [ref=e122]
            - alert [ref=e123]:
              - generic [ref=e124]: Message
              - text:  Default message
          - generic [ref=e128]:
            - generic [ref=e132]: E-Mail (Disabled)
            - textbox "E-Mail (Disabled)" [disabled] [ref=e136]: test@mail.de
          - generic [ref=e140]:
            - generic [ref=e144] [cursor=pointer]: E-Mail (Readonly)
            - textbox "E-Mail (Readonly)" [ref=e148]: test@mail.de
          - generic [ref=e152]:
            - generic [ref=e155] [cursor=pointer]:
              - generic [ref=e156]: With access key
              - generic [ref=e157]: c
            - textbox "With access key" [ref=e161]: test@mail.de
          - generic [ref=e165]:
            - generic [ref=e168] [cursor=pointer]:
              - generic [ref=e169]: With short key
              - generic [ref=e170]: s
            - textbox "With short key" [ref=e174]: test@mail.de
      - generic [ref=e175]:
        - heading "Email (hideLabel)" [level=2] [ref=e177]: Email (hideLabel)
        - generic [ref=e178]:
          - textbox "E-Mail (Black background test)" [ref=e186]: test@mail.de
          - generic [ref=e190]:
            - generic [ref=e192]:
              - generic [ref=e194]: 
              - combobox "E-Mail (list)" [ref=e196]
              - generic [ref=e198]: 
            - alert [ref=e199]:
          ...
          - generic [ref=e214]:
            ...
            - alert [ref=e219]:
              - generic [ref=e220]: Note
              - generic [ref=e221]: 
              - text: Just a hint
          - generic [ref=e225]:
            - textbox "E-Mail" [ref=e229]
            - alert [ref=e230]:
              - generic [ref=e231]: Warning
              - generic [ref=e232]: 
              - text: Small warning
          - generic [ref=e236]:
            - textbox "E-Mail" [ref=e240]
            - alert [ref=e241]:
              - generic [ref=e242]: Success
              - generic [ref=e243]: 
              - text: Success message
          - generic [ref=e247]:
            ...
            - alert [ref=e252]:
              ...
              - text:  Default message
          - textbox "E-Mail (Disabled)" [disabled] [ref=e261]: test@mail.de
          - textbox "E-Mail (Readonly)" [ref=e269]: test@mail.de
          - textbox "With access key" [ref=e277]: test@mail.de
          - textbox "With short key" [ref=e285]: test@mail.de
```
