...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/input-text-readonly-noColumns--placeholder-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/input-text-readonly-noColumns--value-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/input-text-readonly-noColumns--info-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/input-text-readonly-noColumns--editable-firefox-linux.png, writing actual.
```
...
- main [ref=e4]:
  - generic [ref=e5]:
    ...
    - generic [ref=e49]:
      - generic [ref=e53] [cursor=pointer]: "Comparison: Editable"
      - 'textbox "Comparison: Editable" [ref=e57]': This field is editable
```
