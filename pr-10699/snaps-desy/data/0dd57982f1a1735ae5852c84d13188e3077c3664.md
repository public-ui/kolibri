...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/table-complex-headers--complex-headers-firefox-linux.png, writing actual.
```
