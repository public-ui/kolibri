...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/tabs-icons-only--icons-only-firefox-linux.png, writing actual.
```
