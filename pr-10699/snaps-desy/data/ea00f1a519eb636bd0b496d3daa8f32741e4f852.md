...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/table-non-hidable-columns--non-hidable-firefox-linux.png, writing actual.
```
