...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/input-password-show-password-noColumns--show-password-firefox-linux.png, writing actual.
```
