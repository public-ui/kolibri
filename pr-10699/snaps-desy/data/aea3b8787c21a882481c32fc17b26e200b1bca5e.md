...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/input-text-message-types-noColumns--msg-default-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/input-text-message-types-noColumns--msg-error-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/input-text-message-types-noColumns--msg-info-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/input-text-message-types-noColumns--msg-success-firefox-linux.png, writing actual.
```

```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/input-text-message-types-noColumns--msg-warning-firefox-linux.png, writing actual.
```
...
- main [ref=e4]:
  - generic [ref=e5]:
    ...
    - generic [ref=e39]:
      - generic [ref=e43] [cursor=pointer]: Info message
      - textbox "Info message" [ref=e47]: Some value
      - alert [ref=e48]:
        - generic [ref=e49]: Note
        - generic [ref=e50]: 
        - text: This is an informational message
    - generic [ref=e54]:
      - generic [ref=e58] [cursor=pointer]: Success message
      - textbox "Success message" [ref=e62]: Valid value
      - alert [ref=e63]:
        - generic [ref=e64]: Success
        - generic [ref=e65]: 
        - text: This is a success message
    - generic [ref=e69]:
      - generic [ref=e73] [cursor=pointer]: Warning message
      - textbox "Warning message" [ref=e77]: Valid value
      - alert [ref=e78]:
