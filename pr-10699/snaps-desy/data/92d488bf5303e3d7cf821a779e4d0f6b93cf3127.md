...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/form-basic--form-basic-firefox-linux.png, writing actual.
```
