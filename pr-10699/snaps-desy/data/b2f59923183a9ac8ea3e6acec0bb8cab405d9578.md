...
```
Error: A snapshot doesn't exist at /__w/kolibri/kolibri/packages/themes/desy/snapshots/theme-desyv11/dialog-basic-show-dialog-true-firefox-linux.png, writing actual.
```
