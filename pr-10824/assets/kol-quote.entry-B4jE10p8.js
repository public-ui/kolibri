import{C as e,o as t,r as n,s as r,u as i}from"./index-CtK6XjUl.js";import{t as a}from"./base-web-component--IgFgz37-CZuvR3uB.js";import"./label-BIbocgr4-ZJ6o5kgE.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import"./_Uint8Array-kJHDjtoP-CTkgs_0o.js";import{l as o,n as s}from"./normalizers-Cjgf2IMC-Lz1dcNZL.js";import{t as c}from"./label-BSRwCo1I-DrQhjRQv.js";import{n as l}from"./variant-quote-BOqtghM5-CQiQ2wpD.js";import{t as u}from"./href-DNLGL3Wj-BelQGBEF.js";var d=s(`quote`,``,o),f={optional:[c,l],required:[u,d]},p=i.forBlock(`kol-quote`),m=p(`blockquote`),h=p(`cite`),g=p(`figcaption`),_=p(`quote`),v=n=>{let{href:r,label:i,quote:a,variant:o}=n,s=a===``,c=p({[o]:!0});return t(`figure`,{class:c},o===`block`?t(`blockquote`,{class:m,cite:r},a,t(`span`,{"aria-hidden":s?void 0:`true`,hidden:!s},t(`slot`,{name:`expert`}))):t(`q`,{class:_,cite:r},a,t(`span`,{"aria-hidden":s?void 0:`true`,hidden:!s},t(`slot`,{name:`expert`}))),typeof i==`string`&&i.length>0&&t(`figcaption`,{class:g},t(`cite`,{class:h},t(e,{_href:r,_label:i,_target:`_blank`}))))},y=`@charset "UTF-8";
