import{c as e,r as t,s as n}from"./index-DcDxiC7I-CBikqsYt.js";import{g as r,i}from"./index-4pMwksqo.js";import{t as a}from"./base-web-component--IgFgz37-CZuvR3uB.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{h as o,p as s,r as c}from"./variant-quote-DeZzWGZI-CxSIGEUd.js";import"./label-BDgaSpkn-C3_GA53E.js";import{t as l}from"./label-C-mcs1F6-BzWxHvby.js";import{t as u}from"./href-D5Num3co-u798i9DC.js";var d=c(`quote`,``,s),f={optional:[l,o],required:[u,d]},p=i.forBlock(`kol-quote`),m=p(`blockquote`),h=p(`cite`),g=p(`figcaption`),_=p(`quote`),v=e=>{let{href:t,label:i,quote:a,variant:o}=e,s=a===``,c=p({[o]:!0});return n(`figure`,{class:c},o===`block`?n(`blockquote`,{class:m,cite:t},a,n(`span`,{"aria-hidden":s?void 0:`true`,hidden:!s},n(`slot`,{name:`expert`}))):n(`q`,{class:_,cite:t},a,n(`span`,{"aria-hidden":s?void 0:`true`,hidden:!s},n(`slot`,{name:`expert`}))),typeof i==`string`&&i.length>0&&n(`figcaption`,{class:g},n(`cite`,{class:h},n(r,{_href:t,_label:i,_target:`_blank`}))))},y=`@charset "UTF-8";
...
}`,b=class extends a{constructor(t){super(),e(this,t),this._variant=`inline`}watchHref(e){u.apply(e,e=>this.setRenderProp(`href`,e))}watchLabel(e){l.apply(e,e=>this.setRenderProp(`label`,e))}watchQuote(e){d.apply(e,e=>this.setRenderProp(`quote`,e))}watchVariant(e){o.apply(e,e=>this.setRenderProp(`variant`,e))}componentWillLoad(){this.initRenderProps(f),u.apply(this._href,e=>this.setRenderProp(`href`,e)),l.apply(this._label,e=>this.setRenderProp(`label`,e)),d.apply(this._quote,e=>this.setRenderProp(`quote`,e)),o.apply(this._variant,e=>this.setRenderProp(`variant`,e))}render(){return n(t,{key:`4fca1eb865e8abbbee0acda89b60eec7e1719778`},n(v,{key:`e229647d57f9e9f50be6b9e0d5dab4246da79120`,href:this.getRenderProp(`href`),label:this.getRenderProp(`label`),quote:this.getRenderProp(`quote`),variant:this.getRenderProp(`variant`)}))}static get watchers(){return{_href:[`watchHref`],_label:[`watchLabel`],_quote:[`watchQuote`],_variant:[`watchVariant`]}}};b.style={default:y};export{b as kol_quote};