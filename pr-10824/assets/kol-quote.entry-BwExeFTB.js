import{d as e,o as t,r as n,s as r,w as i}from"./index-B-EyGJlD.js";import{t as a}from"./base-web-component--IgFgz37-CZuvR3uB.js";import"./label-BIbocgr4-Dendd1UV.js";import"./isArray-CcrBs4JM-DiEJ1b3e.js";import"./_Uint8Array-kJHDjtoP-CTkgs_0o.js";import{l as o,n as s}from"./normalizers-Cjgf2IMC-CK5jY0BH.js";import{t as c}from"./label-BSRwCo1I-CuLLTwq0.js";import{n as l}from"./variant-quote-BOqtghM5-GdcWnxrQ.js";import{t as u}from"./href-DNLGL3Wj-BO75xiTk.js";var d=s(`quote`,``,o),f={optional:[c,l],required:[u,d]},p=e.forBlock(`kol-quote`),m=p(`blockquote`),h=p(`cite`),g=p(`figcaption`),_=p(`quote`),v=e=>{let{href:n,label:r,quote:a,variant:o}=e,s=a===``,c=p({[o]:!0});return t(`figure`,{class:c},o===`block`?t(`blockquote`,{class:m,cite:n},a,t(`span`,{"aria-hidden":s?void 0:`true`,hidden:!s},t(`slot`,{name:`expert`}))):t(`q`,{class:_,cite:n},a,t(`span`,{"aria-hidden":s?void 0:`true`,hidden:!s},t(`slot`,{name:`expert`}))),typeof r==`string`&&r.length>0&&t(`figcaption`,{class:g},t(`cite`,{class:h},t(i,{_href:n,_label:r,_target:`_blank`}))))},y=`@charset "UTF-8";
