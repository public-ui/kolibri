import{c as e,o as t,r as n,s as r}from"./index-DcDxiC7I-CXur8i3n.js";import{b as i}from"./index-CPHkQERw.js";import{t as a}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import{r as o,t as s}from"./element-interaction-DkGO5I_0-CYEJb_Yf.js";import{t as c}from"./aria-details-CaVxOiaf-Ch9Y1V3k.js";var l=`@charset "UTF-8";
/*
...
}`,u=class{constructor(t){e(this,t),this.ctaRef=s(),this._disabled=!1,this._hideMsg=!1,this._hideLabel=!1,this._hint=``,this._multiple=!1,this._required=!1,this._tooltipAlign=`top`,this._touched=!1}async getValue(){return this.ctaRef.el?.getValue()}async focus(e){}render(){return r(n,{key:`407ca37454091bbe0d1b3bfbf558a5d738725a63`,class:`kol-select`},r(i,{key:`5624f2dbbbf97b8fb127334eeb3b8b5336cc9fc1`,ref:this.ctaRef,_accessKey:this._accessKey,_ariaDetails:this._ariaDetails,_disabled:this._disabled,_hideLabel:this._hideLabel,_hideMsg:this._hideMsg,_hint:this._hint,_icons:this._icons,_infoPopover:this._infoPopover,_label:this._label,_msg:this._msg,_multiple:this._multiple,_name:this._name,_on:this._on,_options:this._options,_required:this._required,_rows:this._rows,_shortKey:this._shortKey,_syncValueBySelector:this._syncValueBySelector,_tabIndex:this._tabIndex,_tooltipAlign:this._tooltipAlign,_touched:this._touched,_value:this._value,_variant:this._variant},r(`slot`,{key:`f324a7f338ff34a06085495ad07abb10421613b8`,name:`expert`,slot:`expert`})))}validateAriaDetails(e){c(this,this.host,void 0,e)}get host(){return t(this)}static get watchers(){return{_ariaDetails:[`validateAriaDetails`]}}};a([o(`ctaRef`)],u.prototype,`focus`,null),u.style={default:l};export{u as kol_select};