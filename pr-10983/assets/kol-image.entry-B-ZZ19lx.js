import{c as e,o as t,r as n,s as r}from"./index-DcDxiC7I-VrcWmB2Z.js";import{r as i,t as a}from"./index-D7LtgQXR.js";import{t as o}from"./base-web-component--IgFgz37-CZuvR3uB.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import{a as s,p as c,r as l}from"./variant-quote-DeZzWGZI-CJ2Bp4uB.js";import{t as u}from"./src-WBolqZgb-CxEnNPaG.js";var d=l(`alt`,``,c,e=>typeof e==`string`),f=l(`sizes`,``,c),p=l(`srcset`,``,c),m={optional:[s,f,p],required:[d,u]},h=e=>{let{alt:t,loading:n,sizes:i,src:a,srcset:o,handleError:s,handleLoad:c}=e;return r(`img`,{class:`kol-image`,alt:t,loading:n,sizes:i||void 0,src:a,srcset:o||void 0,onError:e=>s(e),onLoad:e=>c(e)})},g=`@charset "UTF-8";
/*
...
}`,_=class extends o{constructor(t){super(),e(this,t),this.handleError=e=>{var t,n;(n=(t=this._on)?.onError)==null||n.call(t,e),this.host&&i(this.host,a.error,e)},this.handleLoad=e=>{var t,n;(n=(t=this._on)?.onLoad)==null||n.call(t,e),this.host&&i(this.host,a.load,e)}}watchAlt(e){d.apply(e,e=>this.setRenderProp(`alt`,e))}watchLoading(e){s.apply(e,e=>this.setRenderProp(`loading`,e))}watchSizes(e){f.apply(e,e=>this.setRenderProp(`sizes`,e))}watchSrc(e){u.apply(e,e=>this.setRenderProp(`src`,e))}watchSrcset(e){p.apply(e,e=>this.setRenderProp(`srcset`,e))}componentWillLoad(){this.initRenderProps(m),d.apply(this._alt,e=>this.setRenderProp(`alt`,e)),s.apply(this._loading,e=>this.setRenderProp(`loading`,e)),f.apply(this._sizes,e=>this.setRenderProp(`sizes`,e)),u.apply(this._src,e=>this.setRenderProp(`src`,e)),p.apply(this._srcset,e=>this.setRenderProp(`srcset`,e))}render(){return r(n,{key:`c595ae7a514842f73340e655d52ae3ad57b87459`},r(h,{key:`45e1d2e947087aa9ccd2f8fdc5f634c85f43050f`,alt:this.getRenderProp(`alt`),loading:this.getRenderProp(`loading`),sizes:this.getRenderProp(`sizes`),src:this.getRenderProp(`src`),srcset:this.getRenderProp(`srcset`),handleError:this.handleError,handleLoad:this.handleLoad}))}get host(){return t(this)}static get watchers(){return{_alt:[`watchAlt`],_loading:[`watchLoading`],_sizes:[`watchSizes`],_src:[`watchSrc`],_srcset:[`watchSrcset`]}}};_.style={default:g};export{_ as kol_image};