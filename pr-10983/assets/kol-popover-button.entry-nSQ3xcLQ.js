import{c as e,o as t,r as n,s as r}from"./index-DcDxiC7I-C9GRf0M3.js";import"./behavior-iJpU4AKD-Bv7k_8Jh.js";import"./index-CivAf0E5.js";import{i}from"./dev.utils-BRNeztdD-BQIicJb6.js";import"./base-web-component--IgFgz37-CZuvR3uB.js";import{t as a}from"./tslib.es6-QNbPBOk5-DpzS01Oy.js";import"./_Uint8Array-CuELS0_2-BYXN1zbF.js";import"./variant-quote-DeZzWGZI-UGCUepDb.js";import"./disabled-DPo78Oje-Bzgcj23b.js";import"./label-BDgaSpkn-CG7QQa_y.js";import"./label-C-mcs1F6-Ddc8x9OA.js";import{n as o,r as s}from"./element-interaction-DkGO5I_0-CYEJb_Yf.js";import"./block-bem-UDOF3rAN-oAKITaiS.js";import"./component-Bh3trbTp-CxeFMAnS.js";import"./component-zqA_GCVc-mv3oTZul.js";import"./component-D2A6cZw8-DdzHUEKw.js";import"./variant-class-name-D1gM1t9T-BZbzUzQJ.js";import"./component-JTlUjHZD-DZaMxQQS.js";import"./component-DWslkzV8-w9NvNyNy.js";import"./align-B29XBdiy-lknP2_yo.js";import"./label-with-expert-slot-DQT5alA4-BQ2Pzvao.js";import"./variant-Bd451cbV-BgDeMLs3.js";import"./name-ygfuf6Ck-CBtOrh6x.js";import"./api-DquRPbhk-aKW2dSUI.js";import"./controller-DM5oLtDk-NQPEm7rW.js";import"./aria-details-CaVxOiaf-D6qH5qDt.js";import"./associated.controller-DxVdCvBV-DL_taSku.js";import"./base-CNBT1A3h-ClJeb2Ms.js";import"./controller-Dudry2jv-3XTMaIXR.js";import{t as c}from"./base-BXnq9Eo3-4wiC-A8l.js";var l=`@charset "UTF-8";
/*
...
}`,u=class extends c{constructor(t){super(),e(this,t),this.ariaDescriptionId=i(),this.popoverOpen=!1,this._disabled=!1,this._hideLabel=!1,this._inline=!1,this._popoverAlign=`bottom`,this._tooltipAlign=`top`,this._type=`button`,this._variant=`normal`,this.initFormAssociation()}componentWillLoad(){this.initPopoverButtonRenderProps(),this.watchAccessKey(this._accessKey),this.watchAriaDescription(this._ariaDescription),this.watchCustomClass(this._customClass),this.watchDisabled(this._disabled),this.watchHideLabel(this._hideLabel),this.watchIcons(this._icons),this.watchInline(this._inline),this.watchLabel(this._label),this.watchName(this._name),this.watchPopoverAlign(this._popoverAlign),this.watchShortKey(this._shortKey),this.watchSyncValueBySelector(this._syncValueBySelector),this.watchTabIndex(this._tabIndex),this.watchTooltipAlign(this._tooltipAlign),this.watchType(this._type),this.watchValue(this._value),this.watchVariant(this._variant),this.initTooltipBehavior()}componentDidRender(){this.syncTooltipListeners(),this.syncPopoverToggleListener()}disconnectedCallback(){this.destroyTooltipBehavior(),this.destroyPopover()}async hidePopover(){this.closePopover()}async showPopover(){this.openPopover()}async click(){}async focus(e){}render(){return r(n,{key:`7fe1f6eaed484ae8fe7d724c6b5b9bdca3146f68`},this.renderPopoverButtonFC())}watchAccessKey(e){this.applyAccessKey(e,this._shortKey)}watchAriaDescription(e){this.applyAriaDescription(e)}watchCustomClass(e){this.applyCustomClass(e)}watchDisabled(e){this.applyDisabled(e)}watchHideLabel(e){this.applyHideLabel(e)}watchIcons(e){this.applyIcons(e)}watchInline(e){this.applyInline(e)}watchLabel(e){this.applyLabel(e)}watchName(e){this.applyName(e)}watchPopoverAlign(e){this.applyPopoverAlign(e)}watchShortKey(e){this.applyShortKey(e,this._accessKey)}watchSyncValueBySelector(e){this.applySyncValueBySelector(e)}watchTabIndex(e){this.applyTabIndex(e)}watchTooltipAlign(e){this.applyTooltipAlign(e)}watchType(e){this.applyType(e)}watchValue(e){this.applyValue(e)}watchVariant(e){this.applyVariant(e)}get host(){return t(this)}static get watchers(){return{_accessKey:[`watchAccessKey`],_ariaDescription:[`watchAriaDescription`],_customClass:[`watchCustomClass`],_disabled:[`watchDisabled`],_hideLabel:[`watchHideLabel`],_icons:[`watchIcons`],_inline:[`watchInline`],_label:[`watchLabel`],_name:[`watchName`],_popoverAlign:[`watchPopoverAlign`],_shortKey:[`watchShortKey`],_syncValueBySelector:[`watchSyncValueBySelector`],_tabIndex:[`watchTabIndex`],_tooltipAlign:[`watchTooltipAlign`],_type:[`watchType`],_value:[`watchValue`],_variant:[`watchVariant`]}}};a([o(`ctaRef`)],u.prototype,`click`,null),a([s(`ctaRef`)],u.prototype,`focus`,null),u.style={default:l};export{u as kol_popover_button};